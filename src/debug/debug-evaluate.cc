...
#define INTRINSIC_ALLOWLIST(V)                                                 \
  ...
  V(ArrayIsArray)                                                              \
  V(GetFunctionName)                                                           \
  IF_NOT_OFFICIAL_BUILD(V, GlobalPrint)                                        \
  V(HasProperty)                                                               \
  V(ObjectCreate)                                                              \
  V(ObjectEntries)                                                             \
  ...
  /* Test */                                                                   \
  IF_NOT_OFFICIAL_BUILD(V, GetOptimizationStatus)                              \
  IF_NOT_OFFICIAL_BUILD(V, OptimizeFunctionOnNextCall)                         \
  IF_NOT_OFFICIAL_BUILD(V, OptimizeOsr)
