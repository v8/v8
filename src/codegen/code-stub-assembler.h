...
#error Unknown architecture.
  ...
  // Word-to-Word32:
  template <>
  TNode<Int32T> Convert(TNode<IntPtrT> from) {
    return TruncateIntPtrToInt32(from);
  }
  template <>
  TNode<Uint32T> Convert(TNode<IntPtrT> from) {
    return Unsigned(TruncateIntPtrToInt32(from));
  }
  template <>
  TNode<Uint32T> Convert(TNode<WordT> from) {
    return Convert<Uint32T>(Signed(from));
  }
  template <>
  TNode<Int32T> Convert(TNode<UintPtrT> from) {
    return Convert<Int32T>(Signed(from));
  }
  template <>
  TNode<Uint32T> Convert(TNode<UintPtrT> from) {
    return Convert<Uint32T>(Signed(from));
  }

  // Word32-to-Word.
  template <>
  TNode<UintPtrT> Convert(TNode<Uint32T> from) {
    // Zero-extend.
    return ChangeUint32ToWord(from);
  }
  template <>
  TNode<UintPtrT> Convert(TNode<Word32T> from) {
    // Zero-extend.
    return Convert<UintPtrT>(Unsigned(from));
  }
  template <>
  TNode<IntPtrT> Convert(TNode<Uint32T> from) {
    // Zero-extend.
    return Signed(ChangeUint32ToWord(from));
  }
  template <>
  TNode<IntPtrT> Convert(TNode<Int32T> from) {
    // Sign-extend.
  ...
  // To-tagged.
  template <>
  TNode<Smi> Convert(TNode<IntPtrT> from) {
    return SmiFromIntPtr(from);
  }
  template <>
  TNode<Smi> Convert(TNode<Int32T> from) {
    return SmiFromInt32(from);
  }
  template <>
  TNode<Smi> Convert(TNode<Uint32T> from) {
    return SmiFromUint32(from);
  }

  // From-tagged.
  template <>
  TNode<IntPtrT> Convert(TNode<Smi> from) {
    return SmiToIntPtr(from);
  }
  template <>
  TNode<Int32T> Convert(TNode<Smi> from) {
    return SmiToInt32(from);
  }
  template <>
  TNode<Uint32T> Convert(TNode<Smi> from) {
