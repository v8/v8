...
class V8_EXPORT_PRIVATE ConservativeStackVisitor
 ...
 public:
  ...
  // already marked as live. The allocator_ field is used to provide the set of
  // valid heap pages. The collector_ field is used to determine which kind of
  ...
  Address FindBasePtrForMarking(Address maybe_inner_ptr) const;
