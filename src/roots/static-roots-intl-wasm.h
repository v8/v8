...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kadoptText_string = 0x225d;
  static constexpr Tagged_t kapproximatelySign_string = 0x2275;
  static constexpr Tagged_t kbaseName_string = 0x2295;
  static constexpr Tagged_t kaccounting_string = 0x22a9;
  static constexpr Tagged_t kbreakType_string = 0x22c1;
  static constexpr Tagged_t kcalendars_string = 0x22d9;
  static constexpr Tagged_t kcardinal_string = 0x22f1;
  static constexpr Tagged_t kcaseFirst_string = 0x2305;
  static constexpr Tagged_t kceil_string = 0x231d;
  static constexpr Tagged_t kcompare_string = 0x232d;
  static constexpr Tagged_t kcollation_string = 0x2341;
  static constexpr Tagged_t kcollations_string = 0x2359;
  static constexpr Tagged_t kcompact_string = 0x2371;
  static constexpr Tagged_t kcompactDisplay_string = 0x2385;
  static constexpr Tagged_t kcurrency_string = 0x23a1;
  static constexpr Tagged_t kcurrencyDisplay_string = 0x23b5;
  static constexpr Tagged_t kcurrencySign_string = 0x23d1;
  static constexpr Tagged_t kdateStyle_string = 0x23e9;
  static constexpr Tagged_t kdateTimeField_string = 0x2401;
  static constexpr Tagged_t kdayPeriod_string = 0x241d;
  static constexpr Tagged_t kdaysDisplay_string = 0x2435;
  static constexpr Tagged_t kdecimal_string = 0x244d;
  static constexpr Tagged_t kdialect_string = 0x2461;
  static constexpr Tagged_t kdigital_string = 0x2475;
  static constexpr Tagged_t kendRange_string = 0x2489;
  static constexpr Tagged_t kengineering_string = 0x249d;
  static constexpr Tagged_t kexceptZero_string = 0x24b5;
  static constexpr Tagged_t kexpand_string = 0x24cd;
  static constexpr Tagged_t kexponentInteger_string = 0x24e1;
  static constexpr Tagged_t kexponentMinusSign_string = 0x24fd;
  static constexpr Tagged_t kexponentSeparator_string = 0x251d;
  static constexpr Tagged_t kfallback_string = 0x253d;
  static constexpr Tagged_t kfirst_string = 0x2551;
  static constexpr Tagged_t kfirstDay_string = 0x2565;
  static constexpr Tagged_t kfirstDayOfWeek_string = 0x2579;
  static constexpr Tagged_t kfloor_string = 0x2595;
  static constexpr Tagged_t kformat_string = 0x25a9;
  static constexpr Tagged_t kformatMatcher_string = 0x25bd;
  static constexpr Tagged_t kfraction_string = 0x25d9;
  static constexpr Tagged_t kfractionalDigits_string = 0x25ed;
  static constexpr Tagged_t kfractionalSecond_string = 0x2609;
  static constexpr Tagged_t kfull_string = 0x2625;
  static constexpr Tagged_t kgranularity_string = 0x2635;
  static constexpr Tagged_t kgrapheme_string = 0x264d;
  static constexpr Tagged_t kgroup_string = 0x2661;
  static constexpr Tagged_t kh11_string = 0x2675;
  static constexpr Tagged_t kh12_string = 0x2685;
  static constexpr Tagged_t kh23_string = 0x2695;
  static constexpr Tagged_t kh24_string = 0x26a5;
  static constexpr Tagged_t khalfCeil_string = 0x26b5;
  static constexpr Tagged_t khalfEven_string = 0x26c9;
  static constexpr Tagged_t khalfExpand_string = 0x26dd;
  static constexpr Tagged_t khalfFloor_string = 0x26f5;
  static constexpr Tagged_t khalfTrunc_string = 0x270d;
  static constexpr Tagged_t khour12_string = 0x2725;
  static constexpr Tagged_t khourCycle_string = 0x2739;
  static constexpr Tagged_t khourCycles_string = 0x2751;
  static constexpr Tagged_t khoursDisplay_string = 0x2769;
  static constexpr Tagged_t kideo_string = 0x2781;
  static constexpr Tagged_t kignorePunctuation_string = 0x2791;
  static constexpr Tagged_t kInvalid_Date_string = 0x27b1;
  static constexpr Tagged_t kinteger_string = 0x27c9;
  static constexpr Tagged_t kisWordLike_string = 0x27dd;
  static constexpr Tagged_t kkana_string = 0x27f5;
  static constexpr Tagged_t klanguage_string = 0x2805;
  static constexpr Tagged_t klanguageDisplay_string = 0x2819;
  static constexpr Tagged_t klessPrecision_string = 0x2835;
  static constexpr Tagged_t kletter_string = 0x2851;
  static constexpr Tagged_t klist_string = 0x2865;
  static constexpr Tagged_t kliteral_string = 0x2875;
  static constexpr Tagged_t klocale_string = 0x2889;
  static constexpr Tagged_t klocaleMatcher_string = 0x289d;
  static constexpr Tagged_t kloose_string = 0x28b9;
  static constexpr Tagged_t klower_string = 0x28cd;
  static constexpr Tagged_t kltr_string = 0x28e1;
  static constexpr Tagged_t kmaximumFractionDigits_string = 0x28f1;
  static constexpr Tagged_t kmaximumSignificantDigits_string = 0x2915;
  static constexpr Tagged_t kmicrosecondsDisplay_string = 0x2939;
  static constexpr Tagged_t kmillisecondsDisplay_string = 0x2959;
  static constexpr Tagged_t kmin2_string = 0x2979;
  static constexpr Tagged_t kminimalDays_string = 0x2989;
  static constexpr Tagged_t kminimumFractionDigits_string = 0x29a1;
  static constexpr Tagged_t kminimumIntegerDigits_string = 0x29c5;
  static constexpr Tagged_t kminimumSignificantDigits_string = 0x29e5;
  static constexpr Tagged_t kminus_0 = 0x2a09;
  static constexpr Tagged_t kminusSign_string = 0x2a19;
  static constexpr Tagged_t kminutesDisplay_string = 0x2a31;
  static constexpr Tagged_t kmonthsDisplay_string = 0x2a4d;
  static constexpr Tagged_t kmorePrecision_string = 0x2a69;
  static constexpr Tagged_t knan_string = 0x2a85;
  static constexpr Tagged_t knanosecondsDisplay_string = 0x2a95;
  static constexpr Tagged_t knarrowSymbol_string = 0x2ab5;
  static constexpr Tagged_t knegative_string = 0x2acd;
  static constexpr Tagged_t knever_string = 0x2ae1;
  static constexpr Tagged_t knone_string = 0x2af5;
  static constexpr Tagged_t knotation_string = 0x2b05;
  static constexpr Tagged_t knormal_string = 0x2b19;
  static constexpr Tagged_t knumberingSystem_string = 0x2b2d;
  static constexpr Tagged_t knumberingSystems_string = 0x2b49;
  static constexpr Tagged_t knumeric_string = 0x2b65;
  static constexpr Tagged_t kordinal_string = 0x2b79;
  static constexpr Tagged_t kpercentSign_string = 0x2b8d;
  static constexpr Tagged_t kplusSign_string = 0x2ba5;
  static constexpr Tagged_t kquarter_string = 0x2bb9;
  static constexpr Tagged_t kregion_string = 0x2bcd;
  static constexpr Tagged_t krelatedYear_string = 0x2be1;
  static constexpr Tagged_t kroundingPriority_string = 0x2bf9;
  static constexpr Tagged_t krtl_string = 0x2c15;
  static constexpr Tagged_t kscientific_string = 0x2c25;
  static constexpr Tagged_t ksecondsDisplay_string = 0x2c3d;
  static constexpr Tagged_t ksegment_string = 0x2c59;
  static constexpr Tagged_t kSegmentIterator_string = 0x2c6d;
  static constexpr Tagged_t kSegments_string = 0x2c89;
  static constexpr Tagged_t ksensitivity_string = 0x2c9d;
  static constexpr Tagged_t ksep_string = 0x2cb5;
  static constexpr Tagged_t kshared_string = 0x2cc5;
  static constexpr Tagged_t ksignDisplay_string = 0x2cd9;
  static constexpr Tagged_t kstandard_string = 0x2cf1;
  static constexpr Tagged_t kstartRange_string = 0x2d05;
  static constexpr Tagged_t kstrict_string = 0x2d1d;
  static constexpr Tagged_t kstripIfInteger_string = 0x2d31;
  static constexpr Tagged_t kstyle_string = 0x2d4d;
  static constexpr Tagged_t kterm_string = 0x2d61;
  static constexpr Tagged_t ktextInfo_string = 0x2d71;
  static constexpr Tagged_t ktimeStyle_string = 0x2d85;
  static constexpr Tagged_t ktimeZones_string = 0x2d9d;
  static constexpr Tagged_t ktrailingZeroDisplay_string = 0x2db5;
  static constexpr Tagged_t ktrunc_string = 0x2dd5;
  static constexpr Tagged_t ktwo_digit_string = 0x2de9;
  static constexpr Tagged_t ktype_string = 0x2dfd;
  static constexpr Tagged_t kunknown_string = 0x2e0d;
  static constexpr Tagged_t kupper_string = 0x2e21;
  static constexpr Tagged_t kusage_string = 0x2e35;
  static constexpr Tagged_t kuseGrouping_string = 0x2e49;
  static constexpr Tagged_t kunitDisplay_string = 0x2e61;
  static constexpr Tagged_t kvariants_string = 0x2e79;
  static constexpr Tagged_t kweekday_string = 0x2e8d;
  static constexpr Tagged_t kweekend_string = 0x2ea1;
  static constexpr Tagged_t kweeksDisplay_string = 0x2eb5;
  static constexpr Tagged_t kweekInfo_string = 0x2ecd;
  static constexpr Tagged_t kyearName_string = 0x2ee1;
  static constexpr Tagged_t kyearsDisplay_string = 0x2ef5;
  static constexpr Tagged_t kascii_nul_string = 0x2f0d;
  static constexpr Tagged_t kascii_soh_string = 0x2f1d;
  static constexpr Tagged_t kascii_stx_string = 0x2f2d;
  static constexpr Tagged_t kascii_etx_string = 0x2f3d;
  static constexpr Tagged_t kascii_eot_string = 0x2f4d;
  static constexpr Tagged_t kascii_enq_string = 0x2f5d;
  static constexpr Tagged_t kascii_ack_string = 0x2f6d;
  static constexpr Tagged_t kascii_bel_string = 0x2f7d;
  static constexpr Tagged_t kascii_bs_string = 0x2f8d;
  static constexpr Tagged_t kascii_ht_string = 0x2f9d;
  static constexpr Tagged_t kascii_lf_string = 0x2fad;
  static constexpr Tagged_t kascii_vt_string = 0x2fbd;
  static constexpr Tagged_t kascii_ff_string = 0x2fcd;
  static constexpr Tagged_t kascii_cr_string = 0x2fdd;
  static constexpr Tagged_t kascii_so_string = 0x2fed;
  static constexpr Tagged_t kascii_si_string = 0x2ffd;
  static constexpr Tagged_t kascii_dle_string = 0x300d;
  static constexpr Tagged_t kascii_dc1_string = 0x301d;
  static constexpr Tagged_t kascii_dc2_string = 0x302d;
  static constexpr Tagged_t kascii_dc3_string = 0x303d;
  static constexpr Tagged_t kascii_dc4_string = 0x304d;
  static constexpr Tagged_t kascii_nak_string = 0x305d;
  static constexpr Tagged_t kascii_syn_string = 0x306d;
  static constexpr Tagged_t kascii_etb_string = 0x307d;
  static constexpr Tagged_t kascii_can_string = 0x308d;
  static constexpr Tagged_t kascii_em_string = 0x309d;
  static constexpr Tagged_t kascii_sub_string = 0x30ad;
  static constexpr Tagged_t kascii_esc_string = 0x30bd;
  static constexpr Tagged_t kascii_fs_string = 0x30cd;
  static constexpr Tagged_t kascii_gs_string = 0x30dd;
  static constexpr Tagged_t kascii_rs_string = 0x30ed;
  static constexpr Tagged_t kascii_us_string = 0x30fd;
  static constexpr Tagged_t kspace_string = 0x310d;
  static constexpr Tagged_t kexclamation_mark_string = 0x311d;
  static constexpr Tagged_t kdouble_quotes_string = 0x312d;
  static constexpr Tagged_t khash_string = 0x313d;
  static constexpr Tagged_t kdollar_string = 0x314d;
  static constexpr Tagged_t kpercent_sign_string = 0x315d;
  static constexpr Tagged_t kampersand_string = 0x316d;
  static constexpr Tagged_t ksingle_quote_string = 0x317d;
  static constexpr Tagged_t kopen_parenthesis_string = 0x318d;
  static constexpr Tagged_t kclose_parenthesis_string = 0x319d;
  static constexpr Tagged_t kasterisk_string = 0x31ad;
  static constexpr Tagged_t kplus_string = 0x31bd;
  static constexpr Tagged_t kcomma_string = 0x31cd;
  static constexpr Tagged_t kminus_string = 0x31dd;
  static constexpr Tagged_t kdot_string = 0x31ed;
  static constexpr Tagged_t kslash_string = 0x31fd;
  static constexpr Tagged_t kzero_string = 0x320d;
  static constexpr Tagged_t kone_string = 0x321d;
  static constexpr Tagged_t ktwo_string = 0x322d;
  static constexpr Tagged_t kthree_string = 0x323d;
  static constexpr Tagged_t kfour_string = 0x324d;
  static constexpr Tagged_t kfive_string = 0x325d;
  static constexpr Tagged_t ksix_string = 0x326d;
  static constexpr Tagged_t kseven_string = 0x327d;
  static constexpr Tagged_t keight_string = 0x328d;
  static constexpr Tagged_t knine_string = 0x329d;
  static constexpr Tagged_t kcolon_string = 0x32ad;
  static constexpr Tagged_t ksemicolon_string = 0x32bd;
  static constexpr Tagged_t kless_than_string = 0x32cd;
  static constexpr Tagged_t kequals_string = 0x32dd;
  static constexpr Tagged_t kgreater_than_string = 0x32ed;
  static constexpr Tagged_t kquestion_mark_string = 0x32fd;
  static constexpr Tagged_t kat_sign_string = 0x330d;
  static constexpr Tagged_t kA_string = 0x331d;
  static constexpr Tagged_t kB_string = 0x332d;
  static constexpr Tagged_t kC_string = 0x333d;
  static constexpr Tagged_t kD_string = 0x334d;
  static constexpr Tagged_t kE_string = 0x335d;
  static constexpr Tagged_t kF_string = 0x336d;
  static constexpr Tagged_t kG_string = 0x337d;
  static constexpr Tagged_t kH_string = 0x338d;
  static constexpr Tagged_t kI_string = 0x339d;
  static constexpr Tagged_t kJ_string = 0x33ad;
  static constexpr Tagged_t kK_string = 0x33bd;
  static constexpr Tagged_t kL_string = 0x33cd;
  static constexpr Tagged_t kM_string = 0x33dd;
  static constexpr Tagged_t kN_string = 0x33ed;
  static constexpr Tagged_t kO_string = 0x33fd;
  static constexpr Tagged_t kP_string = 0x340d;
  static constexpr Tagged_t kQ_string = 0x341d;
  static constexpr Tagged_t kR_string = 0x342d;
  static constexpr Tagged_t kS_string = 0x343d;
  static constexpr Tagged_t kT_string = 0x344d;
  static constexpr Tagged_t kU_string = 0x345d;
  static constexpr Tagged_t kV_string = 0x346d;
  static constexpr Tagged_t kW_string = 0x347d;
  static constexpr Tagged_t kX_string = 0x348d;
  static constexpr Tagged_t kY_string = 0x349d;
  static constexpr Tagged_t kZ_string = 0x34ad;
  static constexpr Tagged_t kopen_bracket_string = 0x34bd;
  static constexpr Tagged_t kbackslash_string = 0x34cd;
  static constexpr Tagged_t kclose_bracket_string = 0x34dd;
  static constexpr Tagged_t kcaret_string = 0x34ed;
  static constexpr Tagged_t kunderscore_string = 0x34fd;
  static constexpr Tagged_t kbacktick_string = 0x350d;
  static constexpr Tagged_t ka_string = 0x351d;
  static constexpr Tagged_t kb_string = 0x352d;
  static constexpr Tagged_t kc_string = 0x353d;
  static constexpr Tagged_t kd_string = 0x354d;
  static constexpr Tagged_t ke_string = 0x355d;
  static constexpr Tagged_t kf_string = 0x356d;
  static constexpr Tagged_t kg_string = 0x357d;
  static constexpr Tagged_t kh_string = 0x358d;
  static constexpr Tagged_t ki_string = 0x359d;
  static constexpr Tagged_t kj_string = 0x35ad;
  static constexpr Tagged_t kk_string = 0x35bd;
  static constexpr Tagged_t kl_string = 0x35cd;
  static constexpr Tagged_t km_string = 0x35dd;
  static constexpr Tagged_t kn_string = 0x35ed;
  static constexpr Tagged_t ko_string = 0x35fd;
  static constexpr Tagged_t kp_string = 0x360d;
  static constexpr Tagged_t kq_string = 0x361d;
  static constexpr Tagged_t kr_string = 0x362d;
  static constexpr Tagged_t ks_string = 0x363d;
  static constexpr Tagged_t kt_string = 0x364d;
  static constexpr Tagged_t ku_string = 0x365d;
  static constexpr Tagged_t kv_string = 0x366d;
  static constexpr Tagged_t kw_string = 0x367d;
  static constexpr Tagged_t kx_string = 0x368d;
  static constexpr Tagged_t ky_string = 0x369d;
  static constexpr Tagged_t kz_string = 0x36ad;
  static constexpr Tagged_t kopen_brace_string = 0x36bd;
  static constexpr Tagged_t kpipe_string = 0x36cd;
  static constexpr Tagged_t kclose_brace_string = 0x36dd;
  static constexpr Tagged_t ktilde_string = 0x36ed;
  static constexpr Tagged_t kascii_del_string = 0x36fd;
  static constexpr Tagged_t klatin1_80_string = 0x370d;
  static constexpr Tagged_t klatin1_81_string = 0x371d;
  static constexpr Tagged_t klatin1_82_string = 0x372d;
  static constexpr Tagged_t klatin1_83_string = 0x373d;
  static constexpr Tagged_t klatin1_84_string = 0x374d;
  static constexpr Tagged_t klatin1_85_string = 0x375d;
  static constexpr Tagged_t klatin1_86_string = 0x376d;
  static constexpr Tagged_t klatin1_87_string = 0x377d;
  static constexpr Tagged_t klatin1_88_string = 0x378d;
  static constexpr Tagged_t klatin1_89_string = 0x379d;
  static constexpr Tagged_t klatin1_8a_string = 0x37ad;
  static constexpr Tagged_t klatin1_8b_string = 0x37bd;
  static constexpr Tagged_t klatin1_8c_string = 0x37cd;
  static constexpr Tagged_t klatin1_8d_string = 0x37dd;
  static constexpr Tagged_t klatin1_8e_string = 0x37ed;
  static constexpr Tagged_t klatin1_8f_string = 0x37fd;
  static constexpr Tagged_t klatin1_90_string = 0x380d;
  static constexpr Tagged_t klatin1_91_string = 0x381d;
  static constexpr Tagged_t klatin1_92_string = 0x382d;
  static constexpr Tagged_t klatin1_93_string = 0x383d;
  static constexpr Tagged_t klatin1_94_string = 0x384d;
  static constexpr Tagged_t klatin1_95_string = 0x385d;
  static constexpr Tagged_t klatin1_96_string = 0x386d;
  static constexpr Tagged_t klatin1_97_string = 0x387d;
  static constexpr Tagged_t klatin1_98_string = 0x388d;
  static constexpr Tagged_t klatin1_99_string = 0x389d;
  static constexpr Tagged_t klatin1_9a_string = 0x38ad;
  static constexpr Tagged_t klatin1_9b_string = 0x38bd;
  static constexpr Tagged_t klatin1_9c_string = 0x38cd;
  static constexpr Tagged_t klatin1_9d_string = 0x38dd;
  static constexpr Tagged_t klatin1_9e_string = 0x38ed;
  static constexpr Tagged_t klatin1_9f_string = 0x38fd;
  static constexpr Tagged_t klatin1_a0_string = 0x390d;
  static constexpr Tagged_t klatin1_a1_string = 0x391d;
  static constexpr Tagged_t klatin1_a2_string = 0x392d;
  static constexpr Tagged_t klatin1_a3_string = 0x393d;
  static constexpr Tagged_t klatin1_a4_string = 0x394d;
  static constexpr Tagged_t klatin1_a5_string = 0x395d;
  static constexpr Tagged_t klatin1_a6_string = 0x396d;
  static constexpr Tagged_t klatin1_a7_string = 0x397d;
  static constexpr Tagged_t klatin1_a8_string = 0x398d;
  static constexpr Tagged_t klatin1_a9_string = 0x399d;
  static constexpr Tagged_t klatin1_aa_string = 0x39ad;
  static constexpr Tagged_t klatin1_ab_string = 0x39bd;
  static constexpr Tagged_t klatin1_ac_string = 0x39cd;
  static constexpr Tagged_t klatin1_ad_string = 0x39dd;
  static constexpr Tagged_t klatin1_ae_string = 0x39ed;
  static constexpr Tagged_t klatin1_af_string = 0x39fd;
  static constexpr Tagged_t klatin1_b0_string = 0x3a0d;
  static constexpr Tagged_t klatin1_b1_string = 0x3a1d;
  static constexpr Tagged_t klatin1_b2_string = 0x3a2d;
  static constexpr Tagged_t klatin1_b3_string = 0x3a3d;
  static constexpr Tagged_t klatin1_b4_string = 0x3a4d;
  static constexpr Tagged_t klatin1_b5_string = 0x3a5d;
  static constexpr Tagged_t klatin1_b6_string = 0x3a6d;
  static constexpr Tagged_t klatin1_b7_string = 0x3a7d;
  static constexpr Tagged_t klatin1_b8_string = 0x3a8d;
  static constexpr Tagged_t klatin1_b9_string = 0x3a9d;
  static constexpr Tagged_t klatin1_ba_string = 0x3aad;
  static constexpr Tagged_t klatin1_bb_string = 0x3abd;
  static constexpr Tagged_t klatin1_bc_string = 0x3acd;
  static constexpr Tagged_t klatin1_bd_string = 0x3add;
  static constexpr Tagged_t klatin1_be_string = 0x3aed;
  static constexpr Tagged_t klatin1_bf_string = 0x3afd;
  static constexpr Tagged_t klatin1_c0_string = 0x3b0d;
  static constexpr Tagged_t klatin1_c1_string = 0x3b1d;
  static constexpr Tagged_t klatin1_c2_string = 0x3b2d;
  static constexpr Tagged_t klatin1_c3_string = 0x3b3d;
  static constexpr Tagged_t klatin1_c4_string = 0x3b4d;
  static constexpr Tagged_t klatin1_c5_string = 0x3b5d;
  static constexpr Tagged_t klatin1_c6_string = 0x3b6d;
  static constexpr Tagged_t klatin1_c7_string = 0x3b7d;
  static constexpr Tagged_t klatin1_c8_string = 0x3b8d;
  static constexpr Tagged_t klatin1_c9_string = 0x3b9d;
  static constexpr Tagged_t klatin1_ca_string = 0x3bad;
  static constexpr Tagged_t klatin1_cb_string = 0x3bbd;
  static constexpr Tagged_t klatin1_cc_string = 0x3bcd;
  static constexpr Tagged_t klatin1_cd_string = 0x3bdd;
  static constexpr Tagged_t klatin1_ce_string = 0x3bed;
  static constexpr Tagged_t klatin1_cf_string = 0x3bfd;
  static constexpr Tagged_t klatin1_d0_string = 0x3c0d;
  static constexpr Tagged_t klatin1_d1_string = 0x3c1d;
  static constexpr Tagged_t klatin1_d2_string = 0x3c2d;
  static constexpr Tagged_t klatin1_d3_string = 0x3c3d;
  static constexpr Tagged_t klatin1_d4_string = 0x3c4d;
  static constexpr Tagged_t klatin1_d5_string = 0x3c5d;
  static constexpr Tagged_t klatin1_d6_string = 0x3c6d;
  static constexpr Tagged_t klatin1_d7_string = 0x3c7d;
  static constexpr Tagged_t klatin1_d8_string = 0x3c8d;
  static constexpr Tagged_t klatin1_d9_string = 0x3c9d;
  static constexpr Tagged_t klatin1_da_string = 0x3cad;
  static constexpr Tagged_t klatin1_db_string = 0x3cbd;
  static constexpr Tagged_t klatin1_dc_string = 0x3ccd;
  static constexpr Tagged_t klatin1_dd_string = 0x3cdd;
  static constexpr Tagged_t klatin1_de_string = 0x3ced;
  static constexpr Tagged_t klatin1_df_string = 0x3cfd;
  static constexpr Tagged_t klatin1_e0_string = 0x3d0d;
  static constexpr Tagged_t klatin1_e1_string = 0x3d1d;
  static constexpr Tagged_t klatin1_e2_string = 0x3d2d;
  static constexpr Tagged_t klatin1_e3_string = 0x3d3d;
  static constexpr Tagged_t klatin1_e4_string = 0x3d4d;
  static constexpr Tagged_t klatin1_e5_string = 0x3d5d;
  static constexpr Tagged_t klatin1_e6_string = 0x3d6d;
  static constexpr Tagged_t klatin1_e7_string = 0x3d7d;
  static constexpr Tagged_t klatin1_e8_string = 0x3d8d;
  static constexpr Tagged_t klatin1_e9_string = 0x3d9d;
  static constexpr Tagged_t klatin1_ea_string = 0x3dad;
  static constexpr Tagged_t klatin1_eb_string = 0x3dbd;
  static constexpr Tagged_t klatin1_ec_string = 0x3dcd;
  static constexpr Tagged_t klatin1_ed_string = 0x3ddd;
  static constexpr Tagged_t klatin1_ee_string = 0x3ded;
  static constexpr Tagged_t klatin1_ef_string = 0x3dfd;
  static constexpr Tagged_t klatin1_f0_string = 0x3e0d;
  static constexpr Tagged_t klatin1_f1_string = 0x3e1d;
  static constexpr Tagged_t klatin1_f2_string = 0x3e2d;
  static constexpr Tagged_t klatin1_f3_string = 0x3e3d;
  static constexpr Tagged_t klatin1_f4_string = 0x3e4d;
  static constexpr Tagged_t klatin1_f5_string = 0x3e5d;
  static constexpr Tagged_t klatin1_f6_string = 0x3e6d;
  static constexpr Tagged_t klatin1_f7_string = 0x3e7d;
  static constexpr Tagged_t klatin1_f8_string = 0x3e8d;
  static constexpr Tagged_t klatin1_f9_string = 0x3e9d;
  static constexpr Tagged_t klatin1_fa_string = 0x3ead;
  static constexpr Tagged_t klatin1_fb_string = 0x3ebd;
  static constexpr Tagged_t klatin1_fc_string = 0x3ecd;
  static constexpr Tagged_t klatin1_fd_string = 0x3edd;
  static constexpr Tagged_t klatin1_fe_string = 0x3eed;
  static constexpr Tagged_t klatin1_ff_string = 0x3efd;
  static constexpr Tagged_t kadd_string = 0x3f0d;
  static constexpr Tagged_t kAggregateError_string = 0x3f1d;
  static constexpr Tagged_t kalphabet_string = 0x3f39;
  static constexpr Tagged_t kalways_string = 0x3f4d;
  static constexpr Tagged_t kanonymous_string = 0x3f61;
  static constexpr Tagged_t kapply_string = 0x3f79;
  static constexpr Tagged_t kArguments_string = 0x3f8d;
  static constexpr Tagged_t karguments_string = 0x3fa5;
  static constexpr Tagged_t karguments_to_string = 0x3fbd;
  static constexpr Tagged_t kArray_string = 0x3fdd;
  static constexpr Tagged_t karray_to_string = 0x3ff1;
  static constexpr Tagged_t kArrayBuffer_string = 0x400d;
  static constexpr Tagged_t kArrayIterator_string = 0x4025;
  static constexpr Tagged_t kas_string = 0x4041;
  static constexpr Tagged_t kassert_string = 0x4051;
  static constexpr Tagged_t kasync_string = 0x4065;
  static constexpr Tagged_t kAtomicsCondition_string = 0x4079;
  static constexpr Tagged_t kAtomicsMutex_string = 0x4099;
  static constexpr Tagged_t kauto_string = 0x40b5;
  static constexpr Tagged_t kBigInt64Array_string = 0x40c5;
  static constexpr Tagged_t kBigInt_string = 0x40e1;
  static constexpr Tagged_t kbigint_string = 0x40f5;
  static constexpr Tagged_t kBigUint64Array_string = 0x4109;
  static constexpr Tagged_t kbind_string = 0x4125;
  static constexpr Tagged_t kblank_string = 0x4135;
  static constexpr Tagged_t kBoolean_string = 0x4149;
  static constexpr Tagged_t kboolean_string = 0x415d;
  static constexpr Tagged_t kboolean_to_string = 0x4171;
  static constexpr Tagged_t kbound__string = 0x418d;
  static constexpr Tagged_t kbuffer_string = 0x41a1;
  static constexpr Tagged_t kbyte_length_string = 0x41b5;
  static constexpr Tagged_t kbyte_offset_string = 0x41cd;
  static constexpr Tagged_t kcalendar_string = 0x41e5;
  static constexpr Tagged_t kcalendarId_string = 0x41f9;
  static constexpr Tagged_t kcalendarName_string = 0x4211;
  static constexpr Tagged_t kcallee_string = 0x4229;
  static constexpr Tagged_t kcaller_string = 0x423d;
  static constexpr Tagged_t kcause_string = 0x4251;
  static constexpr Tagged_t kcharacter_string = 0x4265;
  static constexpr Tagged_t kcode_string = 0x427d;
  static constexpr Tagged_t kcolumn_string = 0x428d;
  static constexpr Tagged_t kCompileError_string = 0x42a1;
  static constexpr Tagged_t kcomputed_string = 0x42b9;
  static constexpr Tagged_t kconjunction_string = 0x42d1;
  static constexpr Tagged_t kconsole_string = 0x42e9;
  static constexpr Tagged_t kconstrain_string = 0x42fd;
  static constexpr Tagged_t kconstruct_string = 0x4315;
  static constexpr Tagged_t kcurrent_string = 0x432d;
  static constexpr Tagged_t kDate_string = 0x4341;
  static constexpr Tagged_t kdate_to_string = 0x4351;
  static constexpr Tagged_t kdateAdd_string = 0x436d;
  static constexpr Tagged_t kdateFromFields_string = 0x4381;
  static constexpr Tagged_t kdateUntil_string = 0x439d;
  static constexpr Tagged_t kday_string = 0x43b5;
  static constexpr Tagged_t kdayOfWeek_string = 0x43c5;
  static constexpr Tagged_t kdayOfYear_string = 0x43dd;
  static constexpr Tagged_t kdays_string = 0x43f5;
  static constexpr Tagged_t kdaysInMonth_string = 0x4405;
  static constexpr Tagged_t kdaysInWeek_string = 0x441d;
  static constexpr Tagged_t kdaysInYear_string = 0x4435;
  static constexpr Tagged_t kdefault_string = 0x444d;
  static constexpr Tagged_t kdefer_string = 0x4461;
  static constexpr Tagged_t kDeferred_Module_string = 0x4475;
  static constexpr Tagged_t kdefineProperty_string = 0x4491;
  static constexpr Tagged_t kdeleteProperty_string = 0x44ad;
  static constexpr Tagged_t kdetached_string = 0x44c9;
  static constexpr Tagged_t kdirection_string = 0x44dd;
  static constexpr Tagged_t kdisambiguation_string = 0x44f5;
  static constexpr Tagged_t kdisjunction_string = 0x4511;
  static constexpr Tagged_t kdisposed_string = 0x4529;
  static constexpr Tagged_t kdone_string = 0x453d;
  static constexpr Tagged_t kdot_brand_string = 0x454d;
  static constexpr Tagged_t kdot_catch_string = 0x4561;
  static constexpr Tagged_t kdot_default_string = 0x4575;
  static constexpr Tagged_t kdot_for_string = 0x4589;
  static constexpr Tagged_t kdot_generator_object_string = 0x4599;
  static constexpr Tagged_t kdot_home_object_string = 0x45b9;
  static constexpr Tagged_t kdot_new_target_string = 0x45d1;
  static constexpr Tagged_t kdot_repl_result_string = 0x45e9;
  static constexpr Tagged_t kdot_result_string = 0x4601;
  static constexpr Tagged_t kdot_static_home_object_string = 0x4615;
  static constexpr Tagged_t kdot_switch_tag_string = 0x4635;
  static constexpr Tagged_t kdot_this_function_string = 0x464d;
  static constexpr Tagged_t kdotAll_string = 0x4669;
  static constexpr Tagged_t kelement_string = 0x467d;
  static constexpr Tagged_t kepochMilliseconds_string = 0x4691;
  static constexpr Tagged_t kepochNanoseconds_string = 0x46b1;
  static constexpr Tagged_t kera_string = 0x46cd;
  static constexpr Tagged_t keraYear_string = 0x46dd;
  static constexpr Tagged_t kError_string = 0x46f1;
  static constexpr Tagged_t kerror_string = 0x4705;
  static constexpr Tagged_t kerror_to_string = 0x4719;
  static constexpr Tagged_t kerrors_string = 0x4735;
  static constexpr Tagged_t keval_string = 0x4749;
  static constexpr Tagged_t kEvalError_string = 0x4759;
  static constexpr Tagged_t kexception_string = 0x4771;
  static constexpr Tagged_t kexec_string = 0x4789;
  static constexpr Tagged_t kfalse_string = 0x4799;
  static constexpr Tagged_t kfields_string = 0x47ad;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x47c1;
  static constexpr Tagged_t kflags_string = 0x47e1;
  static constexpr Tagged_t kFloat16Array_string = 0x47f5;
  static constexpr Tagged_t kFloat32Array_string = 0x480d;
  static constexpr Tagged_t kFloat64Array_string = 0x4825;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x483d;
  static constexpr Tagged_t kfrom_string = 0x4861;
  static constexpr Tagged_t kfunction_native_code_string = 0x4871;
  static constexpr Tagged_t kFunction_prototype_apply_string = 0x489d;
  static constexpr Tagged_t kFunction_prototype_call_string = 0x48c1;
  static constexpr Tagged_t kFunction_string = 0x48e5;
  static constexpr Tagged_t kfunction_string = 0x48f9;
  static constexpr Tagged_t kfunction_to_string = 0x490d;
  static constexpr Tagged_t kGenerator_string = 0x492d;
  static constexpr Tagged_t kget_space_string = 0x4945;
  static constexpr Tagged_t kget_string = 0x4955;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4965;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4989;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x49ad;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x49d1;
  static constexpr Tagged_t kgetTimeZoneTransition_string = 0x49ed;
  static constexpr Tagged_t kglobal_string = 0x4a11;
  static constexpr Tagged_t kglobalThis_string = 0x4a25;
  static constexpr Tagged_t kgroups_string = 0x4a3d;
  static constexpr Tagged_t kgrowable_string = 0x4a51;
  static constexpr Tagged_t khas_string = 0x4a65;
  static constexpr Tagged_t khasIndices_string = 0x4a75;
  static constexpr Tagged_t khour_string = 0x4a8d;
  static constexpr Tagged_t khours_string = 0x4a9d;
  static constexpr Tagged_t khoursInDay_string = 0x4ab1;
  static constexpr Tagged_t kid_string = 0x4ac9;
  static constexpr Tagged_t kignoreCase_string = 0x4ad9;
  static constexpr Tagged_t killegal_access_string = 0x4af1;
  static constexpr Tagged_t killegal_argument_string = 0x4b0d;
  static constexpr Tagged_t kimmutable_string = 0x4b29;
  static constexpr Tagged_t kindex_string = 0x4b41;
  static constexpr Tagged_t kindices_string = 0x4b55;
  static constexpr Tagged_t kInfinity_string = 0x4b69;
  static constexpr Tagged_t kinfinity_string = 0x4b7d;
  static constexpr Tagged_t kinLeapYear_string = 0x4b91;
  static constexpr Tagged_t kinput_string = 0x4ba9;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4bbd;
  static constexpr Tagged_t kInt16Array_string = 0x4be9;
  static constexpr Tagged_t kInt32Array_string = 0x4c01;
  static constexpr Tagged_t kInt8Array_string = 0x4c19;
  static constexpr Tagged_t kisExtensible_string = 0x4c31;
  static constexpr Tagged_t kiso8601_string = 0x4c49;
  static constexpr Tagged_t kisoDay_string = 0x4c5d;
  static constexpr Tagged_t kisoHour_string = 0x4c71;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4c85;
  static constexpr Tagged_t kisoMillisecond_string = 0x4ca1;
  static constexpr Tagged_t kisoMinute_string = 0x4cbd;
  static constexpr Tagged_t kisoMonth_string = 0x4cd5;
  static constexpr Tagged_t kisoNanosecond_string = 0x4ce9;
  static constexpr Tagged_t kisoSecond_string = 0x4d05;
  static constexpr Tagged_t kisoYear_string = 0x4d1d;
  static constexpr Tagged_t kIterator_string = 0x4d31;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4d45;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4d61;
  static constexpr Tagged_t kkeys_string = 0x4d7d;
  static constexpr Tagged_t klargestUnit_string = 0x4d8d;
  static constexpr Tagged_t klast_chunk_handling_string = 0x4da5;
  static constexpr Tagged_t klastIndex_string = 0x4dc5;
  static constexpr Tagged_t klet_string = 0x4ddd;
  static constexpr Tagged_t kline_string = 0x4ded;
  static constexpr Tagged_t klinear_string = 0x4dfd;
  static constexpr Tagged_t kLinkError_string = 0x4e11;
  static constexpr Tagged_t klong_string = 0x4e29;
  static constexpr Tagged_t kMap_string = 0x4e39;
  static constexpr Tagged_t kMapIterator_string = 0x4e49;
  static constexpr Tagged_t kmax_byte_length_string = 0x4e61;
  static constexpr Tagged_t kmedium_string = 0x4e7d;
  static constexpr Tagged_t kmergeFields_string = 0x4e91;
  static constexpr Tagged_t kmessage_string = 0x4ea9;
  static constexpr Tagged_t kmeta_string = 0x4ebd;
  static constexpr Tagged_t kmicrosecond_string = 0x4ecd;
  static constexpr Tagged_t kmicroseconds_string = 0x4ee5;
  static constexpr Tagged_t kmillisecond_string = 0x4efd;
  static constexpr Tagged_t kmilliseconds_string = 0x4f15;
  static constexpr Tagged_t kminus_Infinity_string = 0x4f2d;
  static constexpr Tagged_t kminute_string = 0x4f45;
  static constexpr Tagged_t kminutes_string = 0x4f59;
  static constexpr Tagged_t kModule_string = 0x4f6d;
  static constexpr Tagged_t kmonth_string = 0x4f81;
  static constexpr Tagged_t kmonthCode_string = 0x4f95;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x4fad;
  static constexpr Tagged_t kmonths_string = 0x4fcd;
  static constexpr Tagged_t kmonthsInYear_string = 0x4fe1;
  static constexpr Tagged_t kmultiline_string = 0x4ff9;
  static constexpr Tagged_t kNaN_string = 0x5011;
  static constexpr Tagged_t knanosecond_string = 0x5021;
  static constexpr Tagged_t knanoseconds_string = 0x5039;
  static constexpr Tagged_t knarrow_string = 0x5051;
  static constexpr Tagged_t knative_string = 0x5065;
  static constexpr Tagged_t kNFC_string = 0x5079;
  static constexpr Tagged_t kNFD_string = 0x5089;
  static constexpr Tagged_t kNFKC_string = 0x5099;
  static constexpr Tagged_t kNFKD_string = 0x50a9;
  static constexpr Tagged_t knot_equal_string = 0x50b9;
  static constexpr Tagged_t knull_string = 0x50d1;
  static constexpr Tagged_t knull_to_string = 0x50e1;
  static constexpr Tagged_t kNumber_string = 0x50fd;
  static constexpr Tagged_t knumber_string = 0x5111;
  static constexpr Tagged_t knumber_to_string = 0x5125;
  static constexpr Tagged_t kObject_prototype_string = 0x5141;
  static constexpr Tagged_t kObject_string = 0x515d;
  static constexpr Tagged_t kobject_string = 0x5171;
  static constexpr Tagged_t kobject_to_string = 0x5185;
  static constexpr Tagged_t koffset_string = 0x51a1;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x51b5;
  static constexpr Tagged_t kok_string = 0x51d5;
  static constexpr Tagged_t kother_string = 0x51e5;
  static constexpr Tagged_t koverflow_string = 0x51f9;
  static constexpr Tagged_t kownKeys_string = 0x520d;
  static constexpr Tagged_t kpercent_string = 0x5221;
  static constexpr Tagged_t kplainDate_string = 0x5235;
  static constexpr Tagged_t kplainTime_string = 0x524d;
  static constexpr Tagged_t kposition_string = 0x5265;
  static constexpr Tagged_t kpreventExtensions_string = 0x5279;
  static constexpr Tagged_t kprivate_constructor_string = 0x5299;
  static constexpr Tagged_t kPromise_string = 0x52b1;
  static constexpr Tagged_t kpromise_string = 0x52c5;
  static constexpr Tagged_t kproto_string = 0x52d9;
  static constexpr Tagged_t kproxy_string = 0x52f1;
  static constexpr Tagged_t kProxy_string = 0x5305;
  static constexpr Tagged_t kquery_colon_string = 0x5319;
  static constexpr Tagged_t kRangeError_string = 0x5329;
  static constexpr Tagged_t kraw_json_string = 0x5341;
  static constexpr Tagged_t kraw_string = 0x5355;
  static constexpr Tagged_t kread_string = 0x5365;
  static constexpr Tagged_t kReferenceError_string = 0x5375;
  static constexpr Tagged_t kReflectGet_string = 0x5391;
  static constexpr Tagged_t kReflectHas_string = 0x53a9;
  static constexpr Tagged_t kRegExp_string = 0x53c1;
  static constexpr Tagged_t kregexp_to_string = 0x53d5;
  static constexpr Tagged_t kreject_string = 0x53f1;
  static constexpr Tagged_t krelativeTo_string = 0x5405;
  static constexpr Tagged_t kresizable_string = 0x541d;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5435;
  static constexpr Tagged_t kreturn_string = 0x5455;
  static constexpr Tagged_t krevoke_string = 0x5469;
  static constexpr Tagged_t kroundingIncrement_string = 0x547d;
  static constexpr Tagged_t kroundingMode_string = 0x549d;
  static constexpr Tagged_t kRuntimeError_string = 0x54b5;
  static constexpr Tagged_t kScript_string = 0x54cd;
  static constexpr Tagged_t kscript_string = 0x54e1;
  static constexpr Tagged_t ksecond_string = 0x54f5;
  static constexpr Tagged_t kseconds_string = 0x5509;
  static constexpr Tagged_t ksentence_string = 0x551d;
  static constexpr Tagged_t kset_space_string = 0x5531;
  static constexpr Tagged_t kSet_string = 0x5541;
  static constexpr Tagged_t kset_string = 0x5551;
  static constexpr Tagged_t kSetIterator_string = 0x5561;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x5579;
  static constexpr Tagged_t kShadowRealm_string = 0x5595;
  static constexpr Tagged_t kSharedArray_string = 0x55ad;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x55c5;
  static constexpr Tagged_t kSharedStruct_string = 0x55e5;
  static constexpr Tagged_t kshort_string = 0x55fd;
  static constexpr Tagged_t ksign_string = 0x5611;
  static constexpr Tagged_t ksize_string = 0x5621;
  static constexpr Tagged_t ksmallestUnit_string = 0x5631;
  static constexpr Tagged_t ksource_string = 0x5649;
  static constexpr Tagged_t ksourceText_string = 0x565d;
  static constexpr Tagged_t kstack_string = 0x5675;
  static constexpr Tagged_t kstackTraceLimit_string = 0x5689;
  static constexpr Tagged_t kstatic_initializer_string = 0x56a5;
  static constexpr Tagged_t ksticky_string = 0x56c5;
  static constexpr Tagged_t kString_string = 0x56d9;
  static constexpr Tagged_t kstring_string = 0x56ed;
  static constexpr Tagged_t kstring_to_string = 0x5701;
  static constexpr Tagged_t ksuppressed_string = 0x571d;
  static constexpr Tagged_t kSuppressedError_string = 0x5735;
  static constexpr Tagged_t kSuspendError_string = 0x5751;
  ...
  static constexpr Tagged_t ktimeZoneId_string = 0x58b1;
  static constexpr Tagged_t ktimeZoneName_string = 0x58c9;
  static constexpr Tagged_t ktoJSON_string = 0x58e1;
  static constexpr Tagged_t ktoString_string = 0x58f5;
  static constexpr Tagged_t ktotal_string = 0x5909;
  static constexpr Tagged_t ktrue_string = 0x591d;
  static constexpr Tagged_t kTypedArrayLength_string = 0x592d;
  static constexpr Tagged_t kTypeError_string = 0x5959;
  static constexpr Tagged_t kUint16Array_string = 0x5971;
  static constexpr Tagged_t kUint32Array_string = 0x5989;
  static constexpr Tagged_t kUint8Array_string = 0x59a1;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x59b9;
  static constexpr Tagged_t kundefined_string = 0x59d9;
  static constexpr Tagged_t kundefined_to_string = 0x59f1;
  static constexpr Tagged_t kunicode_string = 0x5a11;
  static constexpr Tagged_t kunicodeSets_string = 0x5a25;
  static constexpr Tagged_t kunit_string = 0x5a3d;
  static constexpr Tagged_t kURIError_string = 0x5a4d;
  static constexpr Tagged_t kUTC_string = 0x5a61;
  ...
  static constexpr Tagged_t kWebAssemblyException_string = 0x5aad;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x5ad1;
  static constexpr Tagged_t kweek_string = 0x5af1;
  static constexpr Tagged_t kweekOfYear_string = 0x5b01;
  static constexpr Tagged_t kweeks_string = 0x5b19;
  static constexpr Tagged_t kwith_string = 0x5b2d;
  static constexpr Tagged_t kword_string = 0x5b3d;
  static constexpr Tagged_t kwritten_string = 0x5b4d;
  static constexpr Tagged_t kyear_string = 0x5b61;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5b71;
  static constexpr Tagged_t kyearOfWeek_string = 0x5b91;
  static constexpr Tagged_t kyears_string = 0x5ba9;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5bbd;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5bcd;
  static constexpr Tagged_t kclass_fields_symbol = 0x5bdd;
  static constexpr Tagged_t kclass_positions_symbol = 0x5bed;
  static constexpr Tagged_t kdetached_symbol = 0x5bfd;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5c0d;
  static constexpr Tagged_t kerror_message_symbol = 0x5c1d;
  static constexpr Tagged_t kerror_script_symbol = 0x5c2d;
  static constexpr Tagged_t kerror_stack_symbol = 0x5c3d;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5c4d;
  static constexpr Tagged_t kfrozen_symbol = 0x5c5d;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5c6d;
  static constexpr Tagged_t knative_context_index_symbol = 0x5c7d;
  static constexpr Tagged_t knonextensible_symbol = 0x5c8d;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5c9d;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5cad;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5cbd;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5ccd;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5cdd;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5ced;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5cfd;
  static constexpr Tagged_t ksealed_symbol = 0x5d0d;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5d1d;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5d2d;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5d3d;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5d4d;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5d5d;
  static constexpr Tagged_t kwasm_asm_single_function_symbol = 0x5d6d;
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x5d7d;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5d8d;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5d9d;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5dad;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5dbd;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5dcd;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5ddd;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5e0d;
  static constexpr Tagged_t kmatch_symbol = 0x5e45;
  static constexpr Tagged_t ksearch_symbol = 0x5e6d;
  static constexpr Tagged_t kunscopables_symbol = 0x5e99;
  static constexpr Tagged_t kdispose_symbol = 0x5ec9;
  static constexpr Tagged_t kasync_dispose_symbol = 0x5ef5;
  static constexpr Tagged_t khas_instance_symbol = 0x5f25;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5f55;
  ...
  static constexpr Tagged_t kvalueOf_string = 0x6019;
  ...
  static constexpr Tagged_t kto_primitive_symbol = 0x607d;
  ...
  static constexpr Tagged_t kUndefinedContextCell = 0x60dd;
  ...
  static constexpr Tagged_t kNativeScopeInfo = 0x6171;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x6189;
  static constexpr Tagged_t kManyClosuresCell = 0x61a1;
  static constexpr Tagged_t kPreallocatedNumberStringTable = 0x61b1;
...
static constexpr std::array<Tagged_t, 1051> StaticReadOnlyRootsPointerTable = {
