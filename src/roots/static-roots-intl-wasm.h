...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kimmutable_string = 0x4abd;
  static constexpr Tagged_t kindex_string = 0x4ad5;
  static constexpr Tagged_t kindices_string = 0x4ae9;
  static constexpr Tagged_t kInfinity_string = 0x4afd;
  static constexpr Tagged_t kinfinity_string = 0x4b11;
  static constexpr Tagged_t kinLeapYear_string = 0x4b25;
  static constexpr Tagged_t kinput_string = 0x4b3d;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4b51;
  static constexpr Tagged_t kInt16Array_string = 0x4b7d;
  static constexpr Tagged_t kInt32Array_string = 0x4b95;
  static constexpr Tagged_t kInt8Array_string = 0x4bad;
  static constexpr Tagged_t kisExtensible_string = 0x4bc5;
  static constexpr Tagged_t kiso8601_string = 0x4bdd;
  static constexpr Tagged_t kisoDay_string = 0x4bf1;
  static constexpr Tagged_t kisoHour_string = 0x4c05;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4c19;
  static constexpr Tagged_t kisoMillisecond_string = 0x4c35;
  static constexpr Tagged_t kisoMinute_string = 0x4c51;
  static constexpr Tagged_t kisoMonth_string = 0x4c69;
  static constexpr Tagged_t kisoNanosecond_string = 0x4c7d;
  static constexpr Tagged_t kisoSecond_string = 0x4c99;
  static constexpr Tagged_t kisoYear_string = 0x4cb1;
  static constexpr Tagged_t kIterator_string = 0x4cc5;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4cd9;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4cf5;
  static constexpr Tagged_t kkeys_string = 0x4d11;
  static constexpr Tagged_t klargestUnit_string = 0x4d21;
  static constexpr Tagged_t klast_chunk_handling_string = 0x4d39;
  static constexpr Tagged_t klastIndex_string = 0x4d59;
  static constexpr Tagged_t klet_string = 0x4d71;
  static constexpr Tagged_t kline_string = 0x4d81;
  static constexpr Tagged_t klinear_string = 0x4d91;
  static constexpr Tagged_t kLinkError_string = 0x4da5;
  static constexpr Tagged_t klong_string = 0x4dbd;
  static constexpr Tagged_t kMap_string = 0x4dcd;
  static constexpr Tagged_t kMapIterator_string = 0x4ddd;
  static constexpr Tagged_t kmax_byte_length_string = 0x4df5;
  static constexpr Tagged_t kmedium_string = 0x4e11;
  static constexpr Tagged_t kmergeFields_string = 0x4e25;
  static constexpr Tagged_t kmessage_string = 0x4e3d;
  static constexpr Tagged_t kmeta_string = 0x4e51;
  ...
  static constexpr Tagged_t kminus_Infinity_string = 0x4ec1;
  static constexpr Tagged_t kminute_string = 0x4ed9;
  static constexpr Tagged_t kminutes_string = 0x4eed;
  static constexpr Tagged_t kModule_string = 0x4f01;
  static constexpr Tagged_t kmonth_string = 0x4f15;
  static constexpr Tagged_t kmonthCode_string = 0x4f29;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x4f41;
  static constexpr Tagged_t kmonths_string = 0x4f61;
  static constexpr Tagged_t kmonthsInYear_string = 0x4f75;
  static constexpr Tagged_t kmultiline_string = 0x4f8d;
  static constexpr Tagged_t kNaN_string = 0x4fa5;
  static constexpr Tagged_t knanosecond_string = 0x4fb5;
  static constexpr Tagged_t knanoseconds_string = 0x4fcd;
  static constexpr Tagged_t knarrow_string = 0x4fe5;
  static constexpr Tagged_t knative_string = 0x4ff9;
  static constexpr Tagged_t kNFC_string = 0x500d;
  static constexpr Tagged_t kNFD_string = 0x501d;
  static constexpr Tagged_t kNFKC_string = 0x502d;
  static constexpr Tagged_t kNFKD_string = 0x503d;
  static constexpr Tagged_t knot_equal_string = 0x504d;
  static constexpr Tagged_t knull_string = 0x5065;
  static constexpr Tagged_t knull_to_string = 0x5075;
  static constexpr Tagged_t kNumber_string = 0x5091;
  static constexpr Tagged_t knumber_string = 0x50a5;
  static constexpr Tagged_t knumber_to_string = 0x50b9;
  static constexpr Tagged_t kObject_prototype_string = 0x50d5;
  static constexpr Tagged_t kObject_string = 0x50f1;
  static constexpr Tagged_t kobject_string = 0x5105;
  static constexpr Tagged_t kobject_to_string = 0x5119;
  static constexpr Tagged_t koffset_string = 0x5135;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x5149;
  static constexpr Tagged_t kok_string = 0x5169;
  static constexpr Tagged_t kother_string = 0x5179;
  static constexpr Tagged_t koverflow_string = 0x518d;
  static constexpr Tagged_t kownKeys_string = 0x51a1;
  static constexpr Tagged_t kpercent_string = 0x51b5;
  static constexpr Tagged_t kplainDate_string = 0x51c9;
  static constexpr Tagged_t kplainTime_string = 0x51e1;
  static constexpr Tagged_t kposition_string = 0x51f9;
  static constexpr Tagged_t kpreventExtensions_string = 0x520d;
  static constexpr Tagged_t kprivate_constructor_string = 0x522d;
  static constexpr Tagged_t kPromise_string = 0x5245;
  static constexpr Tagged_t kpromise_string = 0x5259;
  static constexpr Tagged_t kproto_string = 0x526d;
  static constexpr Tagged_t kproxy_string = 0x5285;
  static constexpr Tagged_t kProxy_string = 0x5299;
  static constexpr Tagged_t kquery_colon_string = 0x52ad;
  static constexpr Tagged_t kRangeError_string = 0x52bd;
  static constexpr Tagged_t kraw_json_string = 0x52d5;
  static constexpr Tagged_t kraw_string = 0x52e9;
  static constexpr Tagged_t kread_string = 0x52f9;
  static constexpr Tagged_t kReferenceError_string = 0x5309;
  static constexpr Tagged_t kReflectGet_string = 0x5325;
  static constexpr Tagged_t kReflectHas_string = 0x533d;
  static constexpr Tagged_t kRegExp_string = 0x5355;
  static constexpr Tagged_t kregexp_to_string = 0x5369;
  static constexpr Tagged_t kreject_string = 0x5385;
  static constexpr Tagged_t krelativeTo_string = 0x5399;
  static constexpr Tagged_t kresizable_string = 0x53b1;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x53c9;
  static constexpr Tagged_t kreturn_string = 0x53e9;
  static constexpr Tagged_t krevoke_string = 0x53fd;
  static constexpr Tagged_t kroundingIncrement_string = 0x5411;
  static constexpr Tagged_t kroundingMode_string = 0x5431;
  static constexpr Tagged_t kRuntimeError_string = 0x5449;
  static constexpr Tagged_t kScript_string = 0x5461;
  static constexpr Tagged_t kscript_string = 0x5475;
  static constexpr Tagged_t ksecond_string = 0x5489;
  static constexpr Tagged_t kseconds_string = 0x549d;
  static constexpr Tagged_t ksentence_string = 0x54b1;
  static constexpr Tagged_t kset_space_string = 0x54c5;
  static constexpr Tagged_t kSet_string = 0x54d5;
  ...
  static constexpr Tagged_t ksign_string = 0x55a5;
  static constexpr Tagged_t ksize_string = 0x55b5;
  static constexpr Tagged_t ksmallestUnit_string = 0x55c5;
  static constexpr Tagged_t ksource_string = 0x55dd;
  static constexpr Tagged_t ksourceText_string = 0x55f1;
  static constexpr Tagged_t kstack_string = 0x5609;
  static constexpr Tagged_t kstackTraceLimit_string = 0x561d;
  static constexpr Tagged_t kstatic_initializer_string = 0x5639;
  static constexpr Tagged_t ksticky_string = 0x5659;
  static constexpr Tagged_t kString_string = 0x566d;
  static constexpr Tagged_t kstring_string = 0x5681;
  static constexpr Tagged_t kstring_to_string = 0x5695;
  static constexpr Tagged_t ksuppressed_string = 0x56b1;
  static constexpr Tagged_t kSuppressedError_string = 0x56c9;
  static constexpr Tagged_t kSuspendError_string = 0x56e5;
  static constexpr Tagged_t kSymbol_iterator_string = 0x56fd;
  static constexpr Tagged_t kSymbol_match_all_string = 0x5719;
  static constexpr Tagged_t kSymbol_replace_string = 0x5735;
  static constexpr Tagged_t ksymbol_species_string = 0x5751;
  static constexpr Tagged_t kSymbol_species_string = 0x576d;
  static constexpr Tagged_t kSymbol_split_string = 0x5789;
  static constexpr Tagged_t kSymbol_string = 0x57a1;
  static constexpr Tagged_t ksymbol_string = 0x57b5;
  static constexpr Tagged_t kSyntaxError_string = 0x57c9;
  static constexpr Tagged_t ktarget_string = 0x57e1;
  static constexpr Tagged_t kthis_string = 0x57f5;
  static constexpr Tagged_t kthrow_string = 0x5805;
  static constexpr Tagged_t ktimed_out_string = 0x5819;
  static constexpr Tagged_t ktimeZone_string = 0x5831;
  static constexpr Tagged_t ktimeZoneId_string = 0x5845;
  static constexpr Tagged_t ktimeZoneName_string = 0x585d;
  ...
  static constexpr Tagged_t kTypedArrayLength_string = 0x58c1;
  ...
  static constexpr Tagged_t kWeakMap_string = 0x5a05;
  static constexpr Tagged_t kWeakRef_string = 0x5a19;
  static constexpr Tagged_t kWeakSet_string = 0x5a2d;
  static constexpr Tagged_t kWebAssemblyException_string = 0x5a41;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x5a65;
  static constexpr Tagged_t kweek_string = 0x5a85;
  static constexpr Tagged_t kweekOfYear_string = 0x5a95;
  static constexpr Tagged_t kweeks_string = 0x5aad;
  static constexpr Tagged_t kwith_string = 0x5ac1;
  static constexpr Tagged_t kword_string = 0x5ad1;
  static constexpr Tagged_t kwritten_string = 0x5ae1;
  static constexpr Tagged_t kyear_string = 0x5af5;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5b05;
  static constexpr Tagged_t kyearOfWeek_string = 0x5b25;
  static constexpr Tagged_t kyears_string = 0x5b3d;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5b51;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5b61;
  static constexpr Tagged_t kclass_fields_symbol = 0x5b71;
  static constexpr Tagged_t kclass_positions_symbol = 0x5b81;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5b91;
  static constexpr Tagged_t kerror_message_symbol = 0x5ba1;
  static constexpr Tagged_t kerror_script_symbol = 0x5bb1;
  static constexpr Tagged_t kerror_stack_symbol = 0x5bc1;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5bd1;
  static constexpr Tagged_t kfrozen_symbol = 0x5be1;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5bf1;
  static constexpr Tagged_t knative_context_index_symbol = 0x5c01;
  static constexpr Tagged_t knonextensible_symbol = 0x5c11;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5c21;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5c31;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5c41;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5c51;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5c61;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5c71;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5c81;
  static constexpr Tagged_t ksealed_symbol = 0x5c91;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5ca1;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5cb1;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5cc1;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5cd1;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5ce1;
  static constexpr Tagged_t kwasm_asm_single_function_symbol = 0x5cf1;
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x5d01;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5d11;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5d21;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5d31;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5d41;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5d51;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5d61;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5d91;
  static constexpr Tagged_t kmatch_symbol = 0x5dc9;
  static constexpr Tagged_t ksearch_symbol = 0x5df1;
  static constexpr Tagged_t kunscopables_symbol = 0x5e1d;
  static constexpr Tagged_t kdispose_symbol = 0x5e4d;
  static constexpr Tagged_t kasync_dispose_symbol = 0x5e79;
  static constexpr Tagged_t khas_instance_symbol = 0x5ea9;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5ed9;
  static constexpr Tagged_t kconstructor_string = 0x5f51;
  static constexpr Tagged_t knext_string = 0x5f69;
  static constexpr Tagged_t kresolve_string = 0x5f79;
  static constexpr Tagged_t kthen_string = 0x5f8d;
  static constexpr Tagged_t kvalueOf_string = 0x5f9d;
  static constexpr Tagged_t kiterator_symbol = 0x5fb1;
  static constexpr Tagged_t kmatch_all_symbol = 0x5fc1;
  static constexpr Tagged_t kreplace_symbol = 0x5fd1;
  static constexpr Tagged_t kspecies_symbol = 0x5fe1;
  static constexpr Tagged_t ksplit_symbol = 0x5ff1;
  static constexpr Tagged_t kto_primitive_symbol = 0x6001;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x6011;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x6021;
  static constexpr Tagged_t kEmptySymbolTable = 0x6045;
  static constexpr Tagged_t kUndefinedContextCell = 0x6061;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x6079;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x608d;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x60a1;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x60ad;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x60cd;
  static constexpr Tagged_t kNativeScopeInfo = 0x60f5;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x610d;
  static constexpr Tagged_t kManyClosuresCell = 0x6125;
  static constexpr Tagged_t kPreallocatedNumberStringTable = 0x6135;
