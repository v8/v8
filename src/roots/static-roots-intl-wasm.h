...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kadoptText_string = 0x21f1;
  static constexpr Tagged_t kapproximatelySign_string = 0x2209;
  static constexpr Tagged_t kbaseName_string = 0x2229;
  static constexpr Tagged_t kaccounting_string = 0x223d;
  static constexpr Tagged_t kbreakType_string = 0x2255;
  static constexpr Tagged_t kcalendars_string = 0x226d;
  static constexpr Tagged_t kcardinal_string = 0x2285;
  static constexpr Tagged_t kcaseFirst_string = 0x2299;
  static constexpr Tagged_t kceil_string = 0x22b1;
  static constexpr Tagged_t kcompare_string = 0x22c1;
  static constexpr Tagged_t kcollation_string = 0x22d5;
  static constexpr Tagged_t kcollations_string = 0x22ed;
  static constexpr Tagged_t kcompact_string = 0x2305;
  static constexpr Tagged_t kcompactDisplay_string = 0x2319;
  static constexpr Tagged_t kcurrency_string = 0x2335;
  static constexpr Tagged_t kcurrencyDisplay_string = 0x2349;
  static constexpr Tagged_t kcurrencySign_string = 0x2365;
  static constexpr Tagged_t kdateStyle_string = 0x237d;
  static constexpr Tagged_t kdateTimeField_string = 0x2395;
  static constexpr Tagged_t kdayPeriod_string = 0x23b1;
  static constexpr Tagged_t kdaysDisplay_string = 0x23c9;
  static constexpr Tagged_t kdecimal_string = 0x23e1;
  static constexpr Tagged_t kdialect_string = 0x23f5;
  static constexpr Tagged_t kdigital_string = 0x2409;
  ...
  static constexpr Tagged_t ktimeZoneName_string = 0x57fd;
  static constexpr Tagged_t ktoJSON_string = 0x5815;
  static constexpr Tagged_t ktoString_string = 0x5829;
  static constexpr Tagged_t ktrue_string = 0x583d;
  static constexpr Tagged_t ktotal_string = 0x584d;
  static constexpr Tagged_t kTypedArrayLength_string = 0x5861;
  static constexpr Tagged_t kTypeError_string = 0x588d;
  static constexpr Tagged_t kUint16Array_string = 0x58a5;
  static constexpr Tagged_t kUint32Array_string = 0x58bd;
  static constexpr Tagged_t kUint8Array_string = 0x58d5;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x58ed;
  static constexpr Tagged_t kundefined_string = 0x590d;
  static constexpr Tagged_t kundefined_to_string = 0x5925;
  static constexpr Tagged_t kunicode_string = 0x5945;
  static constexpr Tagged_t kunicodeSets_string = 0x5959;
  static constexpr Tagged_t kunit_string = 0x5971;
  static constexpr Tagged_t kURIError_string = 0x5981;
  static constexpr Tagged_t kUTC_string = 0x5995;
  static constexpr Tagged_t kWeakMap_string = 0x59a5;
  static constexpr Tagged_t kWeakRef_string = 0x59b9;
  static constexpr Tagged_t kWeakSet_string = 0x59cd;
  static constexpr Tagged_t kweek_string = 0x59e1;
  static constexpr Tagged_t kweeks_string = 0x59f1;
  static constexpr Tagged_t kweekOfYear_string = 0x5a05;
  static constexpr Tagged_t kwith_string = 0x5a1d;
  static constexpr Tagged_t kword_string = 0x5a2d;
  static constexpr Tagged_t kwritten_string = 0x5a3d;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5a51;
  static constexpr Tagged_t kyear_string = 0x5a71;
  static constexpr Tagged_t kyears_string = 0x5a81;
  static constexpr Tagged_t kyearOfWeek_string = 0x5a95;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5aad;
  static constexpr Tagged_t kHashTableHoleValue = 0x5ab9;
  static constexpr Tagged_t kPromiseHoleValue = 0x5ac5;
  static constexpr Tagged_t kUninitializedValue = 0x5ad1;
  static constexpr Tagged_t kArgumentsMarker = 0x5add;
  static constexpr Tagged_t kTerminationException = 0x5ae9;
  static constexpr Tagged_t kException = 0x5af5;
  static constexpr Tagged_t kOptimizedOut = 0x5b01;
  static constexpr Tagged_t kStaleRegister = 0x5b0d;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5b19;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5b25;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5b31;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5b41;
  static constexpr Tagged_t kclass_fields_symbol = 0x5b51;
  static constexpr Tagged_t kclass_positions_symbol = 0x5b61;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5b71;
  static constexpr Tagged_t kerror_message_symbol = 0x5b81;
  static constexpr Tagged_t kerror_script_symbol = 0x5b91;
  static constexpr Tagged_t kerror_stack_symbol = 0x5ba1;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5bb1;
  static constexpr Tagged_t kfrozen_symbol = 0x5bc1;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5bd1;
  static constexpr Tagged_t knative_context_index_symbol = 0x5be1;
  static constexpr Tagged_t knonextensible_symbol = 0x5bf1;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5c01;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5c11;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5c21;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5c31;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5c41;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5c51;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5c61;
  static constexpr Tagged_t ksealed_symbol = 0x5c71;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5c81;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5c91;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5ca1;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5cb1;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5cc1;
  static constexpr Tagged_t kwasm_asm_single_function_symbol = 0x5cd1;
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x5ce1;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5cf1;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5d01;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5d11;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5d21;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5d31;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5d41;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5d71;
  static constexpr Tagged_t kmatch_symbol = 0x5da9;
  static constexpr Tagged_t ksearch_symbol = 0x5dd1;
  static constexpr Tagged_t kunscopables_symbol = 0x5dfd;
  static constexpr Tagged_t kdispose_symbol = 0x5e2d;
  static constexpr Tagged_t kasync_dispose_symbol = 0x5e59;
  static constexpr Tagged_t khas_instance_symbol = 0x5e89;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5eb9;
  static constexpr Tagged_t kconstructor_string = 0x5f31;
  static constexpr Tagged_t knext_string = 0x5f49;
  static constexpr Tagged_t kresolve_string = 0x5f59;
  static constexpr Tagged_t kthen_string = 0x5f6d;
  static constexpr Tagged_t kvalueOf_string = 0x5f7d;
  static constexpr Tagged_t kiterator_symbol = 0x5f91;
  static constexpr Tagged_t kmatch_all_symbol = 0x5fa1;
  static constexpr Tagged_t kreplace_symbol = 0x5fb1;
  static constexpr Tagged_t kspecies_symbol = 0x5fc1;
  static constexpr Tagged_t ksplit_symbol = 0x5fd1;
  static constexpr Tagged_t kto_primitive_symbol = 0x5fe1;
  ...
  static constexpr Tagged_t kUndefinedContextCell = 0x6041;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x6059;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x606d;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x6081;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x608d;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x60ad;
  static constexpr Tagged_t kNativeScopeInfo = 0x60d1;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x60e9;
  static constexpr Tagged_t kManyClosuresCell = 0x6101;
  static constexpr Tagged_t kPreallocatedNumberStringTable = 0x6111;
  static constexpr Tagged_t kWasmNullPadding = 0x6849;
