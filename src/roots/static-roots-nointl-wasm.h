...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t ktoJSON_string = 0x4b49;
  static constexpr Tagged_t ktoString_string = 0x4b5d;
  static constexpr Tagged_t ktrue_string = 0x4b71;
  static constexpr Tagged_t ktotal_string = 0x4b81;
  static constexpr Tagged_t kTypedArrayLength_string = 0x4b95;
  static constexpr Tagged_t kTypeError_string = 0x4bc1;
  static constexpr Tagged_t kUint16Array_string = 0x4bd9;
  static constexpr Tagged_t kUint32Array_string = 0x4bf1;
  static constexpr Tagged_t kUint8Array_string = 0x4c09;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x4c21;
  static constexpr Tagged_t kundefined_string = 0x4c41;
  static constexpr Tagged_t kundefined_to_string = 0x4c59;
  static constexpr Tagged_t kunicode_string = 0x4c79;
  static constexpr Tagged_t kunicodeSets_string = 0x4c8d;
  static constexpr Tagged_t kunit_string = 0x4ca5;
  static constexpr Tagged_t kURIError_string = 0x4cb5;
  static constexpr Tagged_t kUTC_string = 0x4cc9;
  static constexpr Tagged_t kWeakMap_string = 0x4cd9;
  static constexpr Tagged_t kWeakRef_string = 0x4ced;
  static constexpr Tagged_t kWeakSet_string = 0x4d01;
  static constexpr Tagged_t kweek_string = 0x4d15;
  static constexpr Tagged_t kweeks_string = 0x4d25;
  static constexpr Tagged_t kweekOfYear_string = 0x4d39;
  static constexpr Tagged_t kwith_string = 0x4d51;
  static constexpr Tagged_t kword_string = 0x4d61;
  static constexpr Tagged_t kwritten_string = 0x4d71;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x4d85;
  static constexpr Tagged_t kyear_string = 0x4da5;
  static constexpr Tagged_t kyears_string = 0x4db5;
  static constexpr Tagged_t kyearOfWeek_string = 0x4dc9;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x4de1;
  static constexpr Tagged_t kHashTableHoleValue = 0x4ded;
  static constexpr Tagged_t kPromiseHoleValue = 0x4df9;
  static constexpr Tagged_t kUninitializedValue = 0x4e05;
  static constexpr Tagged_t kArgumentsMarker = 0x4e11;
  static constexpr Tagged_t kTerminationException = 0x4e1d;
  static constexpr Tagged_t kException = 0x4e29;
  static constexpr Tagged_t kOptimizedOut = 0x4e35;
  static constexpr Tagged_t kStaleRegister = 0x4e41;
  static constexpr Tagged_t kSelfReferenceMarker = 0x4e4d;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x4e59;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x4e65;
  static constexpr Tagged_t kcall_site_info_symbol = 0x4e75;
  static constexpr Tagged_t kclass_fields_symbol = 0x4e85;
  static constexpr Tagged_t kclass_positions_symbol = 0x4e95;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x4ea5;
  static constexpr Tagged_t kerror_message_symbol = 0x4eb5;
  static constexpr Tagged_t kerror_script_symbol = 0x4ec5;
  static constexpr Tagged_t kerror_stack_symbol = 0x4ed5;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x4ee5;
  static constexpr Tagged_t kfrozen_symbol = 0x4ef5;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x4f05;
  static constexpr Tagged_t knative_context_index_symbol = 0x4f15;
  static constexpr Tagged_t knonextensible_symbol = 0x4f25;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x4f35;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x4f45;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x4f55;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x4f65;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x4f75;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x4f85;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x4f95;
  static constexpr Tagged_t ksealed_symbol = 0x4fa5;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x4fb5;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x4fc5;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x4fd5;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x4fe5;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x4ff5;
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x5005;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5015;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5025;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5035;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5045;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5055;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5065;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5095;
  static constexpr Tagged_t kmatch_symbol = 0x50cd;
  static constexpr Tagged_t ksearch_symbol = 0x50f5;
  static constexpr Tagged_t kunscopables_symbol = 0x5121;
  static constexpr Tagged_t kdispose_symbol = 0x5151;
  static constexpr Tagged_t kasync_dispose_symbol = 0x517d;
  static constexpr Tagged_t khas_instance_symbol = 0x51ad;
  static constexpr Tagged_t kto_string_tag_symbol = 0x51dd;
  static constexpr Tagged_t kconstructor_string = 0x5255;
  static constexpr Tagged_t knext_string = 0x526d;
  static constexpr Tagged_t kresolve_string = 0x527d;
  static constexpr Tagged_t kthen_string = 0x5291;
  static constexpr Tagged_t kvalueOf_string = 0x52a1;
  static constexpr Tagged_t kiterator_symbol = 0x52b5;
  static constexpr Tagged_t kmatch_all_symbol = 0x52c5;
  static constexpr Tagged_t kreplace_symbol = 0x52d5;
  static constexpr Tagged_t kspecies_symbol = 0x52e5;
  static constexpr Tagged_t ksplit_symbol = 0x52f5;
  static constexpr Tagged_t kto_primitive_symbol = 0x5305;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x5315;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x5325;
  static constexpr Tagged_t kEmptySymbolTable = 0x5349;
  static constexpr Tagged_t kUndefinedContextCell = 0x5365;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x537d;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x5391;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x53a5;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x53b1;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x53d1;
  static constexpr Tagged_t kNativeScopeInfo = 0x53f5;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x540d;
  static constexpr Tagged_t kManyClosuresCell = 0x5425;
  static constexpr Tagged_t kPreallocatedNumberStringTable = 0x5435;
  static constexpr Tagged_t kWasmNullPadding = 0x5b6d;
