...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kproto_string = 0x5345;
  static constexpr Tagged_t kproxy_string = 0x535d;
  static constexpr Tagged_t kProxy_string = 0x5371;
  static constexpr Tagged_t kquery_colon_string = 0x5385;
  static constexpr Tagged_t kRangeError_string = 0x5395;
  static constexpr Tagged_t kraw_json_string = 0x53ad;
  static constexpr Tagged_t kraw_string = 0x53c1;
  static constexpr Tagged_t kReferenceError_string = 0x53d1;
  static constexpr Tagged_t kReflectGet_string = 0x53ed;
  static constexpr Tagged_t kReflectHas_string = 0x5405;
  static constexpr Tagged_t kRegExp_string = 0x541d;
  static constexpr Tagged_t kregexp_to_string = 0x5431;
  static constexpr Tagged_t kreject_string = 0x544d;
  static constexpr Tagged_t krelativeTo_string = 0x5461;
  static constexpr Tagged_t kresizable_string = 0x5479;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5491;
  static constexpr Tagged_t kreturn_string = 0x54b1;
  static constexpr Tagged_t krevoke_string = 0x54c5;
  static constexpr Tagged_t kroundingIncrement_string = 0x54d9;
  static constexpr Tagged_t kRuntimeError_string = 0x54f9;
  static constexpr Tagged_t kWebAssemblyException_string = 0x5511;
  static constexpr Tagged_t kScript_string = 0x5535;
  static constexpr Tagged_t kscript_string = 0x5549;
  static constexpr Tagged_t ksecond_string = 0x555d;
  static constexpr Tagged_t kseconds_string = 0x5571;
  static constexpr Tagged_t kshort_string = 0x5585;
  static constexpr Tagged_t kSet_string = 0x5599;
  static constexpr Tagged_t ksentence_string = 0x55a9;
  static constexpr Tagged_t kset_space_string = 0x55bd;
  static constexpr Tagged_t kset_string = 0x55cd;
  static constexpr Tagged_t kSetIterator_string = 0x55dd;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x55f5;
  static constexpr Tagged_t kShadowRealm_string = 0x5611;
  static constexpr Tagged_t kSharedArray_string = 0x5629;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x5641;
  static constexpr Tagged_t kSharedStruct_string = 0x5661;
  static constexpr Tagged_t ksign_string = 0x5679;
  static constexpr Tagged_t ksmallestUnit_string = 0x5689;
  static constexpr Tagged_t ksource_string = 0x56a1;
  static constexpr Tagged_t ksourceText_string = 0x56b5;
  static constexpr Tagged_t kstack_string = 0x56cd;
  static constexpr Tagged_t kstackTraceLimit_string = 0x56e1;
  static constexpr Tagged_t ksticky_string = 0x56fd;
  static constexpr Tagged_t kString_string = 0x5711;
  static constexpr Tagged_t kstring_string = 0x5725;
  static constexpr Tagged_t kstring_to_string = 0x5739;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5755;
  static constexpr Tagged_t kSymbol_replace_string = 0x5771;
  static constexpr Tagged_t ksymbol_species_string = 0x578d;
  static constexpr Tagged_t kSymbol_species_string = 0x57a9;
  static constexpr Tagged_t kSymbol_string = 0x57c5;
  static constexpr Tagged_t ksymbol_string = 0x57d9;
  static constexpr Tagged_t kSyntaxError_string = 0x57ed;
  static constexpr Tagged_t ktarget_string = 0x5805;
  static constexpr Tagged_t kthis_function_string = 0x5819;
  static constexpr Tagged_t kthis_string = 0x5835;
  static constexpr Tagged_t kthrow_string = 0x5845;
  static constexpr Tagged_t ktimed_out_string = 0x5859;
  static constexpr Tagged_t ktimeZone_string = 0x5871;
  static constexpr Tagged_t ktoJSON_string = 0x5885;
  static constexpr Tagged_t ktoString_string = 0x5899;
  static constexpr Tagged_t ktrue_string = 0x58ad;
  static constexpr Tagged_t ktotal_string = 0x58bd;
  static constexpr Tagged_t kTypeError_string = 0x58d1;
  static constexpr Tagged_t kUint16Array_string = 0x58e9;
  static constexpr Tagged_t kUint32Array_string = 0x5901;
  static constexpr Tagged_t kUint8Array_string = 0x5919;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5931;
  static constexpr Tagged_t kundefined_string = 0x5951;
  static constexpr Tagged_t kundefined_to_string = 0x5969;
  static constexpr Tagged_t kunicode_string = 0x5989;
  static constexpr Tagged_t kunicodeSets_string = 0x599d;
  static constexpr Tagged_t kunit_string = 0x59b5;
  static constexpr Tagged_t kURIError_string = 0x59c5;
  static constexpr Tagged_t kUTC_string = 0x59d9;
  static constexpr Tagged_t kvalueOf_string = 0x59e9;
  static constexpr Tagged_t kWeakMap_string = 0x59fd;
  static constexpr Tagged_t kWeakRef_string = 0x5a11;
  static constexpr Tagged_t kWeakSet_string = 0x5a25;
  static constexpr Tagged_t kweek_string = 0x5a39;
  static constexpr Tagged_t kweeks_string = 0x5a49;
  static constexpr Tagged_t kweekOfYear_string = 0x5a5d;
  static constexpr Tagged_t kword_string = 0x5a75;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5a85;
  static constexpr Tagged_t kyear_string = 0x5aa5;
  static constexpr Tagged_t kyears_string = 0x5ab5;
  static constexpr Tagged_t kUninitializedValue = 0x5ad9;
  static constexpr Tagged_t kArgumentsMarker = 0x5b11;
  static constexpr Tagged_t kTerminationException = 0x5b49;
  static constexpr Tagged_t kException = 0x5b89;
  static constexpr Tagged_t kOptimizedOut = 0x5ba5;
  static constexpr Tagged_t kStaleRegister = 0x5bdd;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5c15;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5c55;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5c99;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5ca9;
  static constexpr Tagged_t kconsole_context_id_symbol = 0x5cb9;
  static constexpr Tagged_t kconsole_context_name_symbol = 0x5cc9;
  static constexpr Tagged_t kclass_fields_symbol = 0x5cd9;
  static constexpr Tagged_t kclass_positions_symbol = 0x5ce9;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5cf9;
  static constexpr Tagged_t kerror_script_symbol = 0x5d09;
  static constexpr Tagged_t kerror_stack_symbol = 0x5d19;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5d29;
  static constexpr Tagged_t kfrozen_symbol = 0x5d39;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5d49;
  static constexpr Tagged_t knative_context_index_symbol = 0x5d59;
  static constexpr Tagged_t knonextensible_symbol = 0x5d69;
  static constexpr Tagged_t kpromise_debug_marker_symbol = 0x5d79;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5d89;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5d99;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5da9;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5db9;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5dc9;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5dd9;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5de9;
  static constexpr Tagged_t ksealed_symbol = 0x5df9;
  ...
  static constexpr Tagged_t kmatch_all_symbol = 0x5f01;
  static constexpr Tagged_t kmatch_symbol = 0x5f2d;
  static constexpr Tagged_t ksearch_symbol = 0x5f55;
  static constexpr Tagged_t ksplit_symbol = 0x5f81;
  static constexpr Tagged_t kto_primitive_symbol = 0x5fa9;
  static constexpr Tagged_t kunscopables_symbol = 0x5fd9;
  static constexpr Tagged_t khas_instance_symbol = 0x6009;
  static constexpr Tagged_t kto_string_tag_symbol = 0x6039;
  static constexpr Tagged_t kconstructor_string = 0x6091;
  static constexpr Tagged_t knext_string = 0x60a9;
  static constexpr Tagged_t kresolve_string = 0x60b9;
  static constexpr Tagged_t kthen_string = 0x60cd;
  static constexpr Tagged_t kiterator_symbol = 0x60dd;
  static constexpr Tagged_t kreplace_symbol = 0x60ed;
  static constexpr Tagged_t kspecies_symbol = 0x60fd;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x610d;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x611d;
  static constexpr Tagged_t kEmptySymbolTable = 0x6141;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x615d;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6171;
