...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kerror_string = 0x4885;
  static constexpr Tagged_t kerrors_string = 0x4899;
  static constexpr Tagged_t kerror_to_string = 0x48ad;
  static constexpr Tagged_t keval_string = 0x48c9;
  static constexpr Tagged_t kexception_string = 0x48d9;
  static constexpr Tagged_t kexec_string = 0x48f1;
  static constexpr Tagged_t kfalse_string = 0x4901;
  static constexpr Tagged_t kfields_string = 0x4915;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x4929;
  static constexpr Tagged_t kflags_string = 0x4949;
  static constexpr Tagged_t kFloat32Array_string = 0x495d;
  static constexpr Tagged_t kFloat64Array_string = 0x4975;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x498d;
  static constexpr Tagged_t kfrom_string = 0x49b1;
  static constexpr Tagged_t kFunction_string = 0x49c1;
  static constexpr Tagged_t kfunction_native_code_string = 0x49d5;
  static constexpr Tagged_t kfunction_string = 0x4a01;
  static constexpr Tagged_t kfunction_to_string = 0x4a15;
  static constexpr Tagged_t kGenerator_string = 0x4a35;
  static constexpr Tagged_t kget_space_string = 0x4a4d;
  static constexpr Tagged_t kget_string = 0x4a5d;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4a6d;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4a91;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4ab5;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4ad9;
  static constexpr Tagged_t kglobal_string = 0x4af5;
  static constexpr Tagged_t kglobalThis_string = 0x4b09;
  static constexpr Tagged_t kgroups_string = 0x4b21;
  static constexpr Tagged_t kgrowable_string = 0x4b35;
  static constexpr Tagged_t khas_string = 0x4b49;
  static constexpr Tagged_t khasIndices_string = 0x4b59;
  static constexpr Tagged_t khour_string = 0x4b71;
  static constexpr Tagged_t khours_string = 0x4b81;
  static constexpr Tagged_t khoursInDay_string = 0x4b95;
  static constexpr Tagged_t kignoreCase_string = 0x4bad;
  static constexpr Tagged_t kid_string = 0x4bc5;
  static constexpr Tagged_t killegal_access_string = 0x4bd5;
  static constexpr Tagged_t killegal_argument_string = 0x4bf1;
  static constexpr Tagged_t kinLeapYear_string = 0x4c0d;
  static constexpr Tagged_t kindex_string = 0x4c25;
  static constexpr Tagged_t kindices_string = 0x4c39;
  static constexpr Tagged_t kInfinity_string = 0x4c4d;
  static constexpr Tagged_t kinfinity_string = 0x4c61;
  static constexpr Tagged_t kinput_string = 0x4c75;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4c89;
  static constexpr Tagged_t kInt16Array_string = 0x4cb5;
  static constexpr Tagged_t kInt32Array_string = 0x4ccd;
  static constexpr Tagged_t kInt8Array_string = 0x4ce5;
  static constexpr Tagged_t kisExtensible_string = 0x4cfd;
  static constexpr Tagged_t kiso8601_string = 0x4d15;
  static constexpr Tagged_t kisoDay_string = 0x4d29;
  static constexpr Tagged_t kisoHour_string = 0x4d3d;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4d51;
  static constexpr Tagged_t kisoMillisecond_string = 0x4d6d;
  static constexpr Tagged_t kisoMinute_string = 0x4d89;
  static constexpr Tagged_t kisoMonth_string = 0x4da1;
  static constexpr Tagged_t kisoNanosecond_string = 0x4db5;
  static constexpr Tagged_t kisoSecond_string = 0x4dd1;
  static constexpr Tagged_t kisoYear_string = 0x4de9;
  static constexpr Tagged_t kIterator_string = 0x4dfd;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4e11;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4e2d;
  static constexpr Tagged_t kkeys_string = 0x4e49;
  static constexpr Tagged_t klargestUnit_string = 0x4e59;
  static constexpr Tagged_t klastIndex_string = 0x4e71;
  static constexpr Tagged_t klet_string = 0x4e89;
  static constexpr Tagged_t kline_string = 0x4e99;
  static constexpr Tagged_t klinear_string = 0x4ea9;
  static constexpr Tagged_t kLinkError_string = 0x4ebd;
  static constexpr Tagged_t klong_string = 0x4ed5;
  static constexpr Tagged_t kMap_string = 0x4ee5;
  static constexpr Tagged_t kMapIterator_string = 0x4ef5;
  static constexpr Tagged_t kmax_byte_length_string = 0x4f0d;
  static constexpr Tagged_t kmedium_string = 0x4f29;
  static constexpr Tagged_t kmergeFields_string = 0x4f3d;
  static constexpr Tagged_t kmessage_string = 0x4f55;
  static constexpr Tagged_t kmeta_string = 0x4f69;
  static constexpr Tagged_t kminus_Infinity_string = 0x4f79;
  static constexpr Tagged_t kmicrosecond_string = 0x4f91;
  static constexpr Tagged_t kmicroseconds_string = 0x4fa9;
  static constexpr Tagged_t kmillisecond_string = 0x4fc1;
  static constexpr Tagged_t kmilliseconds_string = 0x4fd9;
  static constexpr Tagged_t kminute_string = 0x4ff1;
  static constexpr Tagged_t kminutes_string = 0x5005;
  static constexpr Tagged_t kModule_string = 0x5019;
  static constexpr Tagged_t kmonth_string = 0x502d;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x5041;
  static constexpr Tagged_t kmonths_string = 0x5061;
  static constexpr Tagged_t kmonthsInYear_string = 0x5075;
  static constexpr Tagged_t kmonthCode_string = 0x508d;
  static constexpr Tagged_t kmultiline_string = 0x50a5;
  static constexpr Tagged_t kNaN_string = 0x50bd;
  static constexpr Tagged_t knanosecond_string = 0x50cd;
  static constexpr Tagged_t knanoseconds_string = 0x50e5;
  static constexpr Tagged_t knarrow_string = 0x50fd;
  static constexpr Tagged_t knative_string = 0x5111;
  static constexpr Tagged_t kNFC_string = 0x5125;
  static constexpr Tagged_t kNFD_string = 0x5135;
  static constexpr Tagged_t kNFKC_string = 0x5145;
  static constexpr Tagged_t kNFKD_string = 0x5155;
  static constexpr Tagged_t knot_equal_string = 0x5165;
  static constexpr Tagged_t knull_string = 0x517d;
  static constexpr Tagged_t knull_to_string = 0x518d;
  static constexpr Tagged_t kNumber_string = 0x51a9;
  static constexpr Tagged_t knumber_string = 0x51bd;
  static constexpr Tagged_t knumber_to_string = 0x51d1;
  static constexpr Tagged_t kObject_string = 0x51ed;
  static constexpr Tagged_t kobject_string = 0x5201;
  static constexpr Tagged_t kobject_to_string = 0x5215;
  static constexpr Tagged_t kObject_prototype_string = 0x5231;
  static constexpr Tagged_t kof_string = 0x524d;
  static constexpr Tagged_t koffset_string = 0x525d;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x5271;
  static constexpr Tagged_t kok_string = 0x5291;
  static constexpr Tagged_t kother_string = 0x52a1;
  static constexpr Tagged_t koverflow_string = 0x52b5;
  static constexpr Tagged_t kownKeys_string = 0x52c9;
  static constexpr Tagged_t kpercent_string = 0x52dd;
  static constexpr Tagged_t kplainDate_string = 0x52f1;
  static constexpr Tagged_t kplainTime_string = 0x5309;
  static constexpr Tagged_t kposition_string = 0x5321;
  static constexpr Tagged_t kpreventExtensions_string = 0x5335;
  static constexpr Tagged_t kprivate_constructor_string = 0x5355;
  static constexpr Tagged_t kPromise_string = 0x536d;
  static constexpr Tagged_t kpromise_string = 0x5381;
  static constexpr Tagged_t kproto_string = 0x5395;
  static constexpr Tagged_t kproxy_string = 0x53ad;
  static constexpr Tagged_t kProxy_string = 0x53c1;
  static constexpr Tagged_t kquery_colon_string = 0x53d5;
  static constexpr Tagged_t kRangeError_string = 0x53e5;
  static constexpr Tagged_t kraw_json_string = 0x53fd;
  static constexpr Tagged_t kraw_string = 0x5411;
  static constexpr Tagged_t kReferenceError_string = 0x5421;
  static constexpr Tagged_t kReflectGet_string = 0x543d;
  static constexpr Tagged_t kReflectHas_string = 0x5455;
  static constexpr Tagged_t kRegExp_string = 0x546d;
  static constexpr Tagged_t kregexp_to_string = 0x5481;
  static constexpr Tagged_t kreject_string = 0x549d;
  static constexpr Tagged_t krelativeTo_string = 0x54b1;
  static constexpr Tagged_t kresizable_string = 0x54c9;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x54e1;
  static constexpr Tagged_t kreturn_string = 0x5501;
  static constexpr Tagged_t krevoke_string = 0x5515;
  static constexpr Tagged_t kroundingIncrement_string = 0x5529;
  static constexpr Tagged_t kRuntimeError_string = 0x5549;
  static constexpr Tagged_t kWebAssemblyException_string = 0x5561;
  static constexpr Tagged_t kScript_string = 0x5585;
  static constexpr Tagged_t kscript_string = 0x5599;
  static constexpr Tagged_t ksecond_string = 0x55ad;
  static constexpr Tagged_t kseconds_string = 0x55c1;
  static constexpr Tagged_t kshort_string = 0x55d5;
  static constexpr Tagged_t kSet_string = 0x55e9;
  static constexpr Tagged_t ksentence_string = 0x55f9;
  static constexpr Tagged_t kset_space_string = 0x560d;
  static constexpr Tagged_t kset_string = 0x561d;
  static constexpr Tagged_t kSetIterator_string = 0x562d;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x5645;
  static constexpr Tagged_t kShadowRealm_string = 0x5661;
  static constexpr Tagged_t kSharedArray_string = 0x5679;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x5691;
  static constexpr Tagged_t kSharedStruct_string = 0x56b1;
  static constexpr Tagged_t ksign_string = 0x56c9;
  static constexpr Tagged_t ksize_string = 0x56d9;
  static constexpr Tagged_t ksmallestUnit_string = 0x56e9;
  static constexpr Tagged_t ksource_string = 0x5701;
  static constexpr Tagged_t ksourceText_string = 0x5715;
  static constexpr Tagged_t kstack_string = 0x572d;
  static constexpr Tagged_t kstackTraceLimit_string = 0x5741;
  static constexpr Tagged_t kstatic_initializer_string = 0x575d;
  static constexpr Tagged_t ksticky_string = 0x577d;
  static constexpr Tagged_t kString_string = 0x5791;
  static constexpr Tagged_t kstring_string = 0x57a5;
  static constexpr Tagged_t kstring_to_string = 0x57b9;
  static constexpr Tagged_t ksuppressed_string = 0x57d5;
  static constexpr Tagged_t kSuppressedError_string = 0x57ed;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5809;
  static constexpr Tagged_t kSymbol_match_all_string = 0x5825;
  static constexpr Tagged_t kSymbol_replace_string = 0x5841;
  static constexpr Tagged_t ksymbol_species_string = 0x585d;
  static constexpr Tagged_t kSymbol_species_string = 0x5879;
  static constexpr Tagged_t kSymbol_split_string = 0x5895;
  static constexpr Tagged_t kSymbol_string = 0x58ad;
  static constexpr Tagged_t ksymbol_string = 0x58c1;
  static constexpr Tagged_t kSyntaxError_string = 0x58d5;
  static constexpr Tagged_t ktarget_string = 0x58ed;
  static constexpr Tagged_t kthis_function_string = 0x5901;
  static constexpr Tagged_t kthis_string = 0x591d;
  static constexpr Tagged_t kthrow_string = 0x592d;
  static constexpr Tagged_t ktimed_out_string = 0x5941;
  static constexpr Tagged_t ktimeZone_string = 0x5959;
  static constexpr Tagged_t ktoJSON_string = 0x596d;
  static constexpr Tagged_t ktoString_string = 0x5981;
  static constexpr Tagged_t ktrue_string = 0x5995;
  static constexpr Tagged_t ktotal_string = 0x59a5;
  static constexpr Tagged_t kTypeError_string = 0x59b9;
  static constexpr Tagged_t kUint16Array_string = 0x59d1;
  static constexpr Tagged_t kUint32Array_string = 0x59e9;
  static constexpr Tagged_t kUint8Array_string = 0x5a01;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5a19;
  static constexpr Tagged_t kundefined_string = 0x5a39;
  static constexpr Tagged_t kundefined_to_string = 0x5a51;
  static constexpr Tagged_t kunicode_string = 0x5a71;
  static constexpr Tagged_t kunicodeSets_string = 0x5a85;
  static constexpr Tagged_t kunit_string = 0x5a9d;
  static constexpr Tagged_t kURIError_string = 0x5aad;
  static constexpr Tagged_t kUTC_string = 0x5ac1;
  static constexpr Tagged_t kvalueOf_string = 0x5ad1;
  static constexpr Tagged_t kWeakMap_string = 0x5ae5;
  static constexpr Tagged_t kWeakRef_string = 0x5af9;
  static constexpr Tagged_t kWeakSet_string = 0x5b0d;
  static constexpr Tagged_t kweek_string = 0x5b21;
  static constexpr Tagged_t kweeks_string = 0x5b31;
  static constexpr Tagged_t kweekOfYear_string = 0x5b45;
  static constexpr Tagged_t kwith_string = 0x5b5d;
  static constexpr Tagged_t kword_string = 0x5b6d;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5b7d;
  static constexpr Tagged_t kyear_string = 0x5b9d;
  static constexpr Tagged_t kyears_string = 0x5bad;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5bc1;
  static constexpr Tagged_t kHashTableHoleValue = 0x5bcd;
  static constexpr Tagged_t kPromiseHoleValue = 0x5bd9;
  static constexpr Tagged_t kUninitializedValue = 0x5be5;
  static constexpr Tagged_t kArgumentsMarker = 0x5bf1;
  static constexpr Tagged_t kTerminationException = 0x5bfd;
  static constexpr Tagged_t kException = 0x5c09;
  static constexpr Tagged_t kOptimizedOut = 0x5c15;
  static constexpr Tagged_t kStaleRegister = 0x5c21;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5c2d;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5c39;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5c45;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5c55;
  static constexpr Tagged_t kconsole_context_id_symbol = 0x5c65;
  static constexpr Tagged_t kconsole_context_name_symbol = 0x5c75;
  static constexpr Tagged_t kclass_fields_symbol = 0x5c85;
  static constexpr Tagged_t kclass_positions_symbol = 0x5c95;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5ca5;
  static constexpr Tagged_t kerror_script_symbol = 0x5cb5;
  static constexpr Tagged_t kerror_stack_symbol = 0x5cc5;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5cd5;
  static constexpr Tagged_t kfrozen_symbol = 0x5ce5;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5cf5;
  static constexpr Tagged_t knative_context_index_symbol = 0x5d05;
  static constexpr Tagged_t knonextensible_symbol = 0x5d15;
  static constexpr Tagged_t kpromise_debug_marker_symbol = 0x5d25;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5d35;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5d45;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5d55;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5d65;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5d75;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5d85;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5d95;
  static constexpr Tagged_t ksealed_symbol = 0x5da5;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5db5;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5dc5;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5dd5;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5de5;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5df5;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5e05;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5e15;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5e25;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5e35;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5e45;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5e55;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5e65;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5e95;
  static constexpr Tagged_t kmatch_symbol = 0x5ecd;
  static constexpr Tagged_t ksearch_symbol = 0x5ef5;
  static constexpr Tagged_t kto_primitive_symbol = 0x5f21;
  static constexpr Tagged_t kunscopables_symbol = 0x5f51;
  static constexpr Tagged_t khas_instance_symbol = 0x5f81;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5fb1;
  static constexpr Tagged_t kconstructor_string = 0x6009;
  static constexpr Tagged_t knext_string = 0x6021;
  static constexpr Tagged_t kresolve_string = 0x6031;
  static constexpr Tagged_t kthen_string = 0x6045;
  static constexpr Tagged_t kiterator_symbol = 0x6055;
  static constexpr Tagged_t kmatch_all_symbol = 0x6065;
  static constexpr Tagged_t kreplace_symbol = 0x6075;
  static constexpr Tagged_t kspecies_symbol = 0x6085;
  static constexpr Tagged_t ksplit_symbol = 0x6095;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x60a5;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x60b5;
  static constexpr Tagged_t kEmptySymbolTable = 0x60d9;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x60f5;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6109;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x611d;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x6129;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x6149;
  static constexpr Tagged_t kNativeScopeInfo = 0x616d;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x6185;
  static constexpr Tagged_t kEmptyExternalPointerArray = 0x619d;
  static constexpr Tagged_t kWasmNullPadding = 0x61a5;
