...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kScript_string = 0x56fd;
  static constexpr Tagged_t kscript_string = 0x5711;
  static constexpr Tagged_t ksecond_string = 0x5725;
  static constexpr Tagged_t kseconds_string = 0x5739;
  static constexpr Tagged_t kshort_string = 0x574d;
  static constexpr Tagged_t kSet_string = 0x5761;
  static constexpr Tagged_t ksentence_string = 0x5771;
  static constexpr Tagged_t kset_space_string = 0x5785;
  static constexpr Tagged_t kset_string = 0x5795;
  static constexpr Tagged_t kSetIterator_string = 0x57a5;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x57bd;
  static constexpr Tagged_t kShadowRealm_string = 0x57d9;
  static constexpr Tagged_t kSharedArray_string = 0x57f1;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x5809;
  static constexpr Tagged_t kSharedStruct_string = 0x5829;
  static constexpr Tagged_t ksign_string = 0x5841;
  static constexpr Tagged_t ksize_string = 0x5851;
  static constexpr Tagged_t ksmallestUnit_string = 0x5861;
  static constexpr Tagged_t ksource_string = 0x5879;
  static constexpr Tagged_t ksourceText_string = 0x588d;
  static constexpr Tagged_t kstack_string = 0x58a5;
  static constexpr Tagged_t kstackTraceLimit_string = 0x58b9;
  static constexpr Tagged_t kstatic_initializer_string = 0x58d5;
  static constexpr Tagged_t ksticky_string = 0x58f5;
  static constexpr Tagged_t kString_string = 0x5909;
  static constexpr Tagged_t kstring_string = 0x591d;
  static constexpr Tagged_t kstring_to_string = 0x5931;
  static constexpr Tagged_t ksuppressed_string = 0x594d;
  static constexpr Tagged_t kSuppressedError_string = 0x5965;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5981;
  static constexpr Tagged_t kSymbol_match_all_string = 0x599d;
  static constexpr Tagged_t kSymbol_replace_string = 0x59b9;
  static constexpr Tagged_t ksymbol_species_string = 0x59d5;
  static constexpr Tagged_t kSymbol_species_string = 0x59f1;
  static constexpr Tagged_t kSymbol_split_string = 0x5a0d;
  static constexpr Tagged_t kSymbol_string = 0x5a25;
  static constexpr Tagged_t ksymbol_string = 0x5a39;
  static constexpr Tagged_t kSyntaxError_string = 0x5a4d;
  static constexpr Tagged_t ktarget_string = 0x5a65;
  static constexpr Tagged_t kthis_function_string = 0x5a79;
  static constexpr Tagged_t kthis_string = 0x5a95;
  static constexpr Tagged_t kthrow_string = 0x5aa5;
  static constexpr Tagged_t ktimed_out_string = 0x5ab9;
  static constexpr Tagged_t ktimeZone_string = 0x5ad1;
  static constexpr Tagged_t ktoJSON_string = 0x5ae5;
  static constexpr Tagged_t ktoString_string = 0x5af9;
  static constexpr Tagged_t ktrue_string = 0x5b0d;
  static constexpr Tagged_t ktotal_string = 0x5b1d;
  static constexpr Tagged_t kTypeError_string = 0x5b31;
  static constexpr Tagged_t kUint16Array_string = 0x5b49;
  static constexpr Tagged_t kUint32Array_string = 0x5b61;
  static constexpr Tagged_t kUint8Array_string = 0x5b79;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5b91;
  static constexpr Tagged_t kundefined_string = 0x5bb1;
  static constexpr Tagged_t kundefined_to_string = 0x5bc9;
  static constexpr Tagged_t kunicode_string = 0x5be9;
  static constexpr Tagged_t kunicodeSets_string = 0x5bfd;
  static constexpr Tagged_t kunit_string = 0x5c15;
  static constexpr Tagged_t kURIError_string = 0x5c25;
  static constexpr Tagged_t kUTC_string = 0x5c39;
  static constexpr Tagged_t kWeakMap_string = 0x5c49;
  static constexpr Tagged_t kWeakRef_string = 0x5c5d;
  static constexpr Tagged_t kWeakSet_string = 0x5c71;
  static constexpr Tagged_t kweek_string = 0x5c85;
  static constexpr Tagged_t kweeks_string = 0x5c95;
  static constexpr Tagged_t kweekOfYear_string = 0x5ca9;
  static constexpr Tagged_t kwith_string = 0x5cc1;
  static constexpr Tagged_t kword_string = 0x5cd1;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5ce1;
  static constexpr Tagged_t kyear_string = 0x5d01;
  static constexpr Tagged_t kyears_string = 0x5d11;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5d25;
  static constexpr Tagged_t kHashTableHoleValue = 0x5d31;
  static constexpr Tagged_t kPromiseHoleValue = 0x5d3d;
  static constexpr Tagged_t kUninitializedValue = 0x5d49;
  static constexpr Tagged_t kArgumentsMarker = 0x5d55;
  static constexpr Tagged_t kTerminationException = 0x5d61;
  static constexpr Tagged_t kException = 0x5d6d;
  static constexpr Tagged_t kOptimizedOut = 0x5d79;
  static constexpr Tagged_t kStaleRegister = 0x5d85;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5d91;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5d9d;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5da9;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5db9;
  static constexpr Tagged_t kclass_fields_symbol = 0x5dc9;
  static constexpr Tagged_t kclass_positions_symbol = 0x5dd9;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5de9;
  static constexpr Tagged_t kerror_message_symbol = 0x5df9;
  static constexpr Tagged_t kerror_script_symbol = 0x5e09;
  static constexpr Tagged_t kerror_stack_symbol = 0x5e19;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5e29;
  static constexpr Tagged_t kfrozen_symbol = 0x5e39;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5e49;
  static constexpr Tagged_t knative_context_index_symbol = 0x5e59;
  static constexpr Tagged_t knonextensible_symbol = 0x5e69;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5e79;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5e89;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5e99;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5ea9;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5eb9;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5ec9;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5ed9;
  static constexpr Tagged_t ksealed_symbol = 0x5ee9;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5ef9;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5f09;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5f19;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5f29;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5f39;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5f49;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5f59;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5f69;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5f79;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5f89;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5f99;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5fa9;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5fd9;
  static constexpr Tagged_t kmatch_symbol = 0x6011;
  static constexpr Tagged_t ksearch_symbol = 0x6039;
  static constexpr Tagged_t kunscopables_symbol = 0x6065;
  static constexpr Tagged_t kdispose_symbol = 0x6095;
  static constexpr Tagged_t kasync_dispose_symbol = 0x60c1;
  static constexpr Tagged_t khas_instance_symbol = 0x60f1;
  static constexpr Tagged_t kto_string_tag_symbol = 0x6121;
  static constexpr Tagged_t kconstructor_string = 0x6199;
  static constexpr Tagged_t knext_string = 0x61b1;
  static constexpr Tagged_t kresolve_string = 0x61c1;
  static constexpr Tagged_t kthen_string = 0x61d5;
  static constexpr Tagged_t kvalueOf_string = 0x61e5;
  static constexpr Tagged_t kiterator_symbol = 0x61f9;
  static constexpr Tagged_t kmatch_all_symbol = 0x6209;
  static constexpr Tagged_t kreplace_symbol = 0x6219;
  static constexpr Tagged_t kspecies_symbol = 0x6229;
  static constexpr Tagged_t ksplit_symbol = 0x6239;
  static constexpr Tagged_t kto_primitive_symbol = 0x6249;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x6259;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x6269;
  static constexpr Tagged_t kEmptySymbolTable = 0x628d;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x62a9;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x62bd;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x62d1;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x62dd;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x62fd;
  static constexpr Tagged_t kNativeScopeInfo = 0x6321;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x6339;
  static constexpr Tagged_t kEmptyExternalPointerArray = 0x6351;
  static constexpr Tagged_t kWasmNullPadding = 0x6359;
