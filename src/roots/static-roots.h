...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kWasmIndirectFunctionTableMap = 0x150d;
  static constexpr Tagged_t kAllocationSiteWithWeakNextMap = 0x1535;
  static constexpr Tagged_t kAllocationSiteWithoutWeakNextMap = 0x155d;
  static constexpr Tagged_t kLoadHandler1Map = 0x1585;
  static constexpr Tagged_t kLoadHandler2Map = 0x15ad;
  static constexpr Tagged_t kLoadHandler3Map = 0x15d5;
  static constexpr Tagged_t kStoreHandler0Map = 0x15fd;
  static constexpr Tagged_t kStoreHandler1Map = 0x1625;
  static constexpr Tagged_t kStoreHandler2Map = 0x164d;
  static constexpr Tagged_t kStoreHandler3Map = 0x1675;
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataMap = 0x169d;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataMap = 0x16c5;
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataWithJobMap =
      0x16ed;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataAndJobMap = 0x1715;
  static constexpr Tagged_t kOnHeapBasicBlockProfilerDataMap = 0x173d;
  static constexpr Tagged_t kTurbofanBitsetTypeMap = 0x1765;
  static constexpr Tagged_t kTurbofanUnionTypeMap = 0x178d;
  static constexpr Tagged_t kTurbofanRangeTypeMap = 0x17b5;
  static constexpr Tagged_t kTurbofanHeapConstantTypeMap = 0x17dd;
  static constexpr Tagged_t kTurbofanOtherNumberConstantTypeMap = 0x1805;
  static constexpr Tagged_t kTurboshaftWord32TypeMap = 0x182d;
  static constexpr Tagged_t kTurboshaftWord32RangeTypeMap = 0x1855;
  static constexpr Tagged_t kTurboshaftWord64TypeMap = 0x187d;
  static constexpr Tagged_t kTurboshaftWord64RangeTypeMap = 0x18a5;
  static constexpr Tagged_t kTurboshaftFloat64TypeMap = 0x18cd;
  static constexpr Tagged_t kTurboshaftFloat64RangeTypeMap = 0x18f5;
  static constexpr Tagged_t kInternalClassMap = 0x191d;
  static constexpr Tagged_t kSmiPairMap = 0x1945;
  static constexpr Tagged_t kSmiBoxMap = 0x196d;
  static constexpr Tagged_t kExportedSubClassBaseMap = 0x1995;
  static constexpr Tagged_t kExportedSubClassMap = 0x19bd;
  static constexpr Tagged_t kAbstractInternalClassSubclass1Map = 0x19e5;
  static constexpr Tagged_t kAbstractInternalClassSubclass2Map = 0x1a0d;
  static constexpr Tagged_t kExportedSubClass2Map = 0x1a35;
  static constexpr Tagged_t kSortStateMap = 0x1a5d;
  static constexpr Tagged_t kWasmStringViewIterMap = 0x1a85;
  static constexpr Tagged_t kSloppyArgumentsElementsMap = 0x1aad;
  static constexpr Tagged_t kStrongDescriptorArrayMap = 0x1ad5;
  static constexpr Tagged_t kTurboshaftWord32SetTypeMap = 0x1afd;
  static constexpr Tagged_t kTurboshaftWord64SetTypeMap = 0x1b25;
  static constexpr Tagged_t kTurboshaftFloat64SetTypeMap = 0x1b4d;
  static constexpr Tagged_t kInternalClassWithStructElementsMap = 0x1b75;
  static constexpr Tagged_t kOrderedHashMapMap = 0x1b9d;
  static constexpr Tagged_t kOrderedHashSetMap = 0x1bc5;
  static constexpr Tagged_t kSimpleNumberDictionaryMap = 0x1bed;
  static constexpr Tagged_t kNameToIndexHashTableMap = 0x1c15;
  static constexpr Tagged_t kEmbedderDataArrayMap = 0x1c3d;
  static constexpr Tagged_t kEphemeronHashTableMap = 0x1c65;
  static constexpr Tagged_t kScriptContextTableMap = 0x1c8d;
  static constexpr Tagged_t kObjectBoilerplateDescriptionMap = 0x1cb5;
  static constexpr Tagged_t kCoverageInfoMap = 0x1cdd;
  static constexpr Tagged_t kRegExpMatchInfoMap = 0x1d05;
  static constexpr Tagged_t kSideEffectCallHandlerInfoMap = 0x1d2d;
  static constexpr Tagged_t kSideEffectFreeCallHandlerInfoMap = 0x1d55;
  static constexpr Tagged_t kSourceTextModuleMap = 0x1d7d;
  static constexpr Tagged_t kSyntheticModuleMap = 0x1da5;
