...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kdone_string = 0x47d1;
  static constexpr Tagged_t kdot_brand_string = 0x47e1;
  static constexpr Tagged_t kdot_catch_string = 0x47f5;
  static constexpr Tagged_t kdot_default_string = 0x4809;
  static constexpr Tagged_t kdot_for_string = 0x481d;
  static constexpr Tagged_t kdot_generator_object_string = 0x482d;
  static constexpr Tagged_t kdot_home_object_string = 0x484d;
  static constexpr Tagged_t kdot_new_target_string = 0x4865;
  static constexpr Tagged_t knew_target_string = 0x4865;
  static constexpr Tagged_t kdot_result_string = 0x487d;
  static constexpr Tagged_t kdot_repl_result_string = 0x4891;
  static constexpr Tagged_t kdot_static_home_object_string = 0x48a9;
  static constexpr Tagged_t kdot_switch_tag_string = 0x48c9;
  static constexpr Tagged_t kdotAll_string = 0x48e1;
  static constexpr Tagged_t kError_string = 0x48f5;
  static constexpr Tagged_t kEvalError_string = 0x4909;
  static constexpr Tagged_t kelement_string = 0x4921;
  static constexpr Tagged_t kepochMicroseconds_string = 0x4935;
  static constexpr Tagged_t kepochMilliseconds_string = 0x4955;
  static constexpr Tagged_t kepochNanoseconds_string = 0x4975;
  static constexpr Tagged_t kepochSeconds_string = 0x4991;
  static constexpr Tagged_t kera_string = 0x49a9;
  static constexpr Tagged_t keraYear_string = 0x49b9;
  static constexpr Tagged_t kerror_string = 0x49cd;
  static constexpr Tagged_t kerrors_string = 0x49e1;
  static constexpr Tagged_t kerror_to_string = 0x49f5;
  static constexpr Tagged_t keval_string = 0x4a11;
  static constexpr Tagged_t kexception_string = 0x4a21;
  static constexpr Tagged_t kexec_string = 0x4a39;
  static constexpr Tagged_t kfalse_string = 0x4a49;
  static constexpr Tagged_t kfields_string = 0x4a5d;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x4a71;
  static constexpr Tagged_t kflags_string = 0x4a91;
  static constexpr Tagged_t kFloat16Array_string = 0x4aa5;
  static constexpr Tagged_t kFloat32Array_string = 0x4abd;
  static constexpr Tagged_t kFloat64Array_string = 0x4ad5;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x4aed;
  static constexpr Tagged_t kfrom_string = 0x4b11;
  static constexpr Tagged_t kFunction_string = 0x4b21;
  static constexpr Tagged_t kfunction_native_code_string = 0x4b35;
  static constexpr Tagged_t kfunction_string = 0x4b61;
  static constexpr Tagged_t kfunction_to_string = 0x4b75;
  static constexpr Tagged_t kGenerator_string = 0x4b95;
  static constexpr Tagged_t kget_space_string = 0x4bad;
  static constexpr Tagged_t kget_string = 0x4bbd;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4bcd;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4bf1;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4c15;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4c39;
  static constexpr Tagged_t kglobal_string = 0x4c55;
  static constexpr Tagged_t kglobalThis_string = 0x4c69;
  static constexpr Tagged_t kgroups_string = 0x4c81;
  static constexpr Tagged_t kgrowable_string = 0x4c95;
  static constexpr Tagged_t khas_string = 0x4ca9;
  static constexpr Tagged_t khasIndices_string = 0x4cb9;
  static constexpr Tagged_t khour_string = 0x4cd1;
  static constexpr Tagged_t khours_string = 0x4ce1;
  static constexpr Tagged_t khoursInDay_string = 0x4cf5;
  static constexpr Tagged_t kignoreCase_string = 0x4d0d;
  static constexpr Tagged_t kid_string = 0x4d25;
  static constexpr Tagged_t killegal_access_string = 0x4d35;
  static constexpr Tagged_t killegal_argument_string = 0x4d51;
  static constexpr Tagged_t kinLeapYear_string = 0x4d6d;
  static constexpr Tagged_t kindex_string = 0x4d85;
  static constexpr Tagged_t kindices_string = 0x4d99;
  static constexpr Tagged_t kInfinity_string = 0x4dad;
  static constexpr Tagged_t kinfinity_string = 0x4dc1;
  static constexpr Tagged_t kinput_string = 0x4dd5;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4de9;
  static constexpr Tagged_t kInt16Array_string = 0x4e15;
  static constexpr Tagged_t kInt32Array_string = 0x4e2d;
  static constexpr Tagged_t kInt8Array_string = 0x4e45;
  static constexpr Tagged_t kisExtensible_string = 0x4e5d;
  static constexpr Tagged_t kiso8601_string = 0x4e75;
  static constexpr Tagged_t kisoDay_string = 0x4e89;
  static constexpr Tagged_t kisoHour_string = 0x4e9d;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4eb1;
  static constexpr Tagged_t kisoMillisecond_string = 0x4ecd;
  static constexpr Tagged_t kisoMinute_string = 0x4ee9;
  static constexpr Tagged_t kisoMonth_string = 0x4f01;
  static constexpr Tagged_t kisoNanosecond_string = 0x4f15;
  static constexpr Tagged_t kisoSecond_string = 0x4f31;
  static constexpr Tagged_t kisoYear_string = 0x4f49;
  static constexpr Tagged_t kIterator_string = 0x4f5d;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4f71;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4f8d;
  static constexpr Tagged_t kkeys_string = 0x4fa9;
  static constexpr Tagged_t klargestUnit_string = 0x4fb9;
  static constexpr Tagged_t klastIndex_string = 0x4fd1;
  static constexpr Tagged_t klet_string = 0x4fe9;
  static constexpr Tagged_t kline_string = 0x4ff9;
  static constexpr Tagged_t klinear_string = 0x5009;
  static constexpr Tagged_t kLinkError_string = 0x501d;
  static constexpr Tagged_t klong_string = 0x5035;
  static constexpr Tagged_t kMap_string = 0x5045;
  static constexpr Tagged_t kMapIterator_string = 0x5055;
  static constexpr Tagged_t kmax_byte_length_string = 0x506d;
  static constexpr Tagged_t kmedium_string = 0x5089;
  static constexpr Tagged_t kmergeFields_string = 0x509d;
  static constexpr Tagged_t kmessage_string = 0x50b5;
  static constexpr Tagged_t kmeta_string = 0x50c9;
  static constexpr Tagged_t kminus_Infinity_string = 0x50d9;
  static constexpr Tagged_t kmicrosecond_string = 0x50f1;
  static constexpr Tagged_t kmicroseconds_string = 0x5109;
  static constexpr Tagged_t kmillisecond_string = 0x5121;
  static constexpr Tagged_t kmilliseconds_string = 0x5139;
  static constexpr Tagged_t kminute_string = 0x5151;
  static constexpr Tagged_t kminutes_string = 0x5165;
  static constexpr Tagged_t kModule_string = 0x5179;
  static constexpr Tagged_t kmonth_string = 0x518d;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x51a1;
  static constexpr Tagged_t kmonths_string = 0x51c1;
  static constexpr Tagged_t kmonthsInYear_string = 0x51d5;
  static constexpr Tagged_t kmonthCode_string = 0x51ed;
  static constexpr Tagged_t kmultiline_string = 0x5205;
  static constexpr Tagged_t kNaN_string = 0x521d;
  static constexpr Tagged_t knanosecond_string = 0x522d;
  static constexpr Tagged_t knanoseconds_string = 0x5245;
  static constexpr Tagged_t knarrow_string = 0x525d;
  static constexpr Tagged_t knative_string = 0x5271;
  static constexpr Tagged_t kNFC_string = 0x5285;
  static constexpr Tagged_t kNFD_string = 0x5295;
  static constexpr Tagged_t kNFKC_string = 0x52a5;
  static constexpr Tagged_t kNFKD_string = 0x52b5;
  static constexpr Tagged_t knot_equal_string = 0x52c5;
  static constexpr Tagged_t knull_string = 0x52dd;
  static constexpr Tagged_t knull_to_string = 0x52ed;
  static constexpr Tagged_t kNumber_string = 0x5309;
  static constexpr Tagged_t knumber_string = 0x531d;
  static constexpr Tagged_t knumber_to_string = 0x5331;
  static constexpr Tagged_t kObject_string = 0x534d;
  static constexpr Tagged_t kobject_string = 0x5361;
  static constexpr Tagged_t kobject_to_string = 0x5375;
  static constexpr Tagged_t kObject_prototype_string = 0x5391;
  static constexpr Tagged_t koffset_string = 0x53ad;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x53c1;
  static constexpr Tagged_t kok_string = 0x53e1;
  static constexpr Tagged_t kother_string = 0x53f1;
  static constexpr Tagged_t koverflow_string = 0x5405;
  static constexpr Tagged_t kownKeys_string = 0x5419;
  static constexpr Tagged_t kpercent_string = 0x542d;
  static constexpr Tagged_t kplainDate_string = 0x5441;
  static constexpr Tagged_t kplainTime_string = 0x5459;
  static constexpr Tagged_t kposition_string = 0x5471;
  static constexpr Tagged_t kpreventExtensions_string = 0x5485;
  static constexpr Tagged_t kprivate_constructor_string = 0x54a5;
  static constexpr Tagged_t kPromise_string = 0x54bd;
  static constexpr Tagged_t kpromise_string = 0x54d1;
  static constexpr Tagged_t kproto_string = 0x54e5;
  static constexpr Tagged_t kproxy_string = 0x54fd;
  static constexpr Tagged_t kProxy_string = 0x5511;
  static constexpr Tagged_t kquery_colon_string = 0x5525;
  static constexpr Tagged_t kRangeError_string = 0x5535;
  static constexpr Tagged_t kraw_json_string = 0x554d;
  static constexpr Tagged_t kraw_string = 0x5561;
  static constexpr Tagged_t kReferenceError_string = 0x5571;
  static constexpr Tagged_t kReflectGet_string = 0x558d;
  static constexpr Tagged_t kReflectHas_string = 0x55a5;
  static constexpr Tagged_t kRegExp_string = 0x55bd;
  static constexpr Tagged_t kregexp_to_string = 0x55d1;
  static constexpr Tagged_t kreject_string = 0x55ed;
  static constexpr Tagged_t krelativeTo_string = 0x5601;
  static constexpr Tagged_t kresizable_string = 0x5619;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5631;
  static constexpr Tagged_t kreturn_string = 0x5651;
  static constexpr Tagged_t krevoke_string = 0x5665;
  static constexpr Tagged_t kroundingIncrement_string = 0x5679;
  static constexpr Tagged_t kRuntimeError_string = 0x5699;
  static constexpr Tagged_t kWebAssemblyException_string = 0x56b1;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x56d5;
  ...
  static constexpr Tagged_t kWasmNullPadding = 0x6349;
