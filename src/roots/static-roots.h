...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kto_primitive_symbol = 0x5f81;
  static constexpr Tagged_t kunscopables_symbol = 0x5fb1;
  static constexpr Tagged_t khas_instance_symbol = 0x5fe1;
  static constexpr Tagged_t kto_string_tag_symbol = 0x6011;
  static constexpr Tagged_t kconstructor_string = 0x6069;
  static constexpr Tagged_t knext_string = 0x6081;
  static constexpr Tagged_t kresolve_string = 0x6091;
  static constexpr Tagged_t kthen_string = 0x60a5;
  ...
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x6105;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x6115;
  static constexpr Tagged_t kEmptySymbolTable = 0x6139;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x6155;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6169;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x617d;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x6189;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x61a9;
  static constexpr Tagged_t kNativeScopeInfo = 0x61cd;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x61e5;
  static constexpr Tagged_t kEmptyExternalPointerArray = 0x61fd;
  static constexpr Tagged_t kWasmNullPadding = 0x6205;
