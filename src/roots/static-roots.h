...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kSymbol_iterator_string = 0x5985;
  static constexpr Tagged_t kSymbol_match_all_string = 0x59a1;
  static constexpr Tagged_t kSymbol_replace_string = 0x59bd;
  static constexpr Tagged_t ksymbol_species_string = 0x59d9;
  static constexpr Tagged_t kSymbol_species_string = 0x59f5;
  static constexpr Tagged_t kSymbol_split_string = 0x5a11;
  static constexpr Tagged_t kSymbol_string = 0x5a29;
  static constexpr Tagged_t ksymbol_string = 0x5a3d;
  static constexpr Tagged_t kSyntaxError_string = 0x5a51;
  static constexpr Tagged_t ktarget_string = 0x5a69;
  static constexpr Tagged_t kthis_function_string = 0x5a7d;
  static constexpr Tagged_t kthis_string = 0x5a99;
  static constexpr Tagged_t kthrow_string = 0x5aa9;
  static constexpr Tagged_t ktimed_out_string = 0x5abd;
  static constexpr Tagged_t ktimeZone_string = 0x5ad5;
  static constexpr Tagged_t ktoJSON_string = 0x5ae9;
  static constexpr Tagged_t ktoString_string = 0x5afd;
  static constexpr Tagged_t ktrue_string = 0x5b11;
  static constexpr Tagged_t ktotal_string = 0x5b21;
  static constexpr Tagged_t kTypeError_string = 0x5b35;
  static constexpr Tagged_t kUint16Array_string = 0x5b4d;
  static constexpr Tagged_t kUint32Array_string = 0x5b65;
  static constexpr Tagged_t kUint8Array_string = 0x5b7d;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5b95;
  static constexpr Tagged_t kundefined_string = 0x5bb5;
  static constexpr Tagged_t kundefined_to_string = 0x5bcd;
  static constexpr Tagged_t kunicode_string = 0x5bed;
  static constexpr Tagged_t kunicodeSets_string = 0x5c01;
  static constexpr Tagged_t kunit_string = 0x5c19;
  static constexpr Tagged_t kURIError_string = 0x5c29;
  static constexpr Tagged_t kUTC_string = 0x5c3d;
  static constexpr Tagged_t kWeakMap_string = 0x5c4d;
  static constexpr Tagged_t kWeakRef_string = 0x5c61;
  static constexpr Tagged_t kWeakSet_string = 0x5c75;
  static constexpr Tagged_t kweek_string = 0x5c89;
  static constexpr Tagged_t kweeks_string = 0x5c99;
  static constexpr Tagged_t kweekOfYear_string = 0x5cad;
  static constexpr Tagged_t kwith_string = 0x5cc5;
  static constexpr Tagged_t kword_string = 0x5cd5;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5ce5;
  static constexpr Tagged_t kyear_string = 0x5d05;
  static constexpr Tagged_t kyears_string = 0x5d15;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5d29;
  static constexpr Tagged_t kHashTableHoleValue = 0x5d35;
  static constexpr Tagged_t kPromiseHoleValue = 0x5d41;
  static constexpr Tagged_t kUninitializedValue = 0x5d4d;
  static constexpr Tagged_t kArgumentsMarker = 0x5d59;
  static constexpr Tagged_t kTerminationException = 0x5d65;
  static constexpr Tagged_t kException = 0x5d71;
  static constexpr Tagged_t kOptimizedOut = 0x5d7d;
  static constexpr Tagged_t kStaleRegister = 0x5d89;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5d95;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5da1;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5dad;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5dbd;
  ...
  static constexpr Tagged_t kerror_message_symbol = 0x5dfd;
  static constexpr Tagged_t kerror_script_symbol = 0x5e0d;
  static constexpr Tagged_t kerror_stack_symbol = 0x5e1d;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5e2d;
  static constexpr Tagged_t kfrozen_symbol = 0x5e3d;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5e4d;
  static constexpr Tagged_t knative_context_index_symbol = 0x5e5d;
  static constexpr Tagged_t knonextensible_symbol = 0x5e6d;
  ...
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5efd;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5f0d;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5f1d;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5f2d;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5f3d;
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x5f4d;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5f5d;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5f6d;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5f7d;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5f8d;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5f9d;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5fad;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5fdd;
  static constexpr Tagged_t kmatch_symbol = 0x6015;
  static constexpr Tagged_t ksearch_symbol = 0x603d;
  static constexpr Tagged_t kunscopables_symbol = 0x6069;
  static constexpr Tagged_t kdispose_symbol = 0x6099;
  static constexpr Tagged_t kasync_dispose_symbol = 0x60c5;
  static constexpr Tagged_t khas_instance_symbol = 0x60f5;
  static constexpr Tagged_t kto_string_tag_symbol = 0x6125;
  static constexpr Tagged_t kconstructor_string = 0x619d;
  static constexpr Tagged_t knext_string = 0x61b5;
  static constexpr Tagged_t kresolve_string = 0x61c5;
  static constexpr Tagged_t kthen_string = 0x61d9;
  static constexpr Tagged_t kvalueOf_string = 0x61e9;
  static constexpr Tagged_t kiterator_symbol = 0x61fd;
  static constexpr Tagged_t kmatch_all_symbol = 0x620d;
  static constexpr Tagged_t kreplace_symbol = 0x621d;
  static constexpr Tagged_t kspecies_symbol = 0x622d;
  static constexpr Tagged_t ksplit_symbol = 0x623d;
  static constexpr Tagged_t kto_primitive_symbol = 0x624d;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x625d;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x626d;
  static constexpr Tagged_t kEmptySymbolTable = 0x6291;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x62ad;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x62c1;
  ...
  static constexpr Tagged_t kWasmNullPadding = 0x6355;
...
static constexpr std::array<Tagged_t, 768> StaticReadOnlyRootsPointerTable = {
