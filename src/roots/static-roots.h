...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kStackTraceInfoMap = 0x14a5;
  static constexpr Tagged_t kTemplateObjectDescriptionMap = 0x14cd;
  static constexpr Tagged_t kTuple2Map = 0x14f5;
  static constexpr Tagged_t kWasmExceptionTagMap = 0x151d;
  static constexpr Tagged_t kAllocationSiteWithWeakNextMap = 0x1545;
  static constexpr Tagged_t kAllocationSiteWithoutWeakNextMap = 0x156d;
  static constexpr Tagged_t kLoadHandler1Map = 0x1595;
  static constexpr Tagged_t kLoadHandler2Map = 0x15bd;
  static constexpr Tagged_t kLoadHandler3Map = 0x15e5;
  static constexpr Tagged_t kStoreHandler0Map = 0x160d;
  static constexpr Tagged_t kStoreHandler1Map = 0x1635;
  static constexpr Tagged_t kStoreHandler2Map = 0x165d;
  static constexpr Tagged_t kStoreHandler3Map = 0x1685;
  static constexpr Tagged_t kFunctionTemplateInfoMap = 0x16ad;
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataMap = 0x16d5;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataMap = 0x16fd;
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataWithJobMap =
      0x1725;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataAndJobMap = 0x174d;
  static constexpr Tagged_t kOnHeapBasicBlockProfilerDataMap = 0x1775;
  static constexpr Tagged_t kObjectTemplateInfoMap = 0x179d;
  static constexpr Tagged_t kTurbofanBitsetTypeMap = 0x17c5;
  static constexpr Tagged_t kTurbofanUnionTypeMap = 0x17ed;
  static constexpr Tagged_t kTurbofanRangeTypeMap = 0x1815;
  static constexpr Tagged_t kTurbofanHeapConstantTypeMap = 0x183d;
  static constexpr Tagged_t kTurbofanOtherNumberConstantTypeMap = 0x1865;
  static constexpr Tagged_t kTurboshaftWord32TypeMap = 0x188d;
  static constexpr Tagged_t kTurboshaftWord32RangeTypeMap = 0x18b5;
  static constexpr Tagged_t kTurboshaftWord64TypeMap = 0x18dd;
  static constexpr Tagged_t kTurboshaftWord64RangeTypeMap = 0x1905;
  static constexpr Tagged_t kTurboshaftFloat64TypeMap = 0x192d;
  static constexpr Tagged_t kTurboshaftFloat64RangeTypeMap = 0x1955;
  static constexpr Tagged_t kInternalClassMap = 0x197d;
  static constexpr Tagged_t kSmiPairMap = 0x19a5;
  static constexpr Tagged_t kSmiBoxMap = 0x19cd;
  static constexpr Tagged_t kExportedSubClassBaseMap = 0x19f5;
  static constexpr Tagged_t kExportedSubClassMap = 0x1a1d;
  static constexpr Tagged_t kAbstractInternalClassSubclass1Map = 0x1a45;
  static constexpr Tagged_t kAbstractInternalClassSubclass2Map = 0x1a6d;
  static constexpr Tagged_t kExportedSubClass2Map = 0x1a95;
  static constexpr Tagged_t kSortStateMap = 0x1abd;
  static constexpr Tagged_t kWasmFastApiCallDataMap = 0x1ae5;
  static constexpr Tagged_t kWasmStringViewIterMap = 0x1b0d;
  static constexpr Tagged_t kSloppyArgumentsElementsMap = 0x1b35;
  static constexpr Tagged_t kStrongDescriptorArrayMap = 0x1b5d;
  static constexpr Tagged_t kTurboshaftWord32SetTypeMap = 0x1b85;
  static constexpr Tagged_t kTurboshaftWord64SetTypeMap = 0x1bad;
  static constexpr Tagged_t kTurboshaftFloat64SetTypeMap = 0x1bd5;
  static constexpr Tagged_t kInternalClassWithStructElementsMap = 0x1bfd;
  static constexpr Tagged_t kOrderedHashMapMap = 0x1c25;
  static constexpr Tagged_t kOrderedHashSetMap = 0x1c4d;
  static constexpr Tagged_t kSimpleNumberDictionaryMap = 0x1c75;
  static constexpr Tagged_t kNameToIndexHashTableMap = 0x1c9d;
  static constexpr Tagged_t kEmbedderDataArrayMap = 0x1cc5;
  static constexpr Tagged_t kEphemeronHashTableMap = 0x1ced;
  static constexpr Tagged_t kScriptContextTableMap = 0x1d15;
  static constexpr Tagged_t kObjectBoilerplateDescriptionMap = 0x1d3d;
  static constexpr Tagged_t kCoverageInfoMap = 0x1d65;
  static constexpr Tagged_t kRegExpMatchInfoMap = 0x1d8d;
  static constexpr Tagged_t kRegExpDataMap = 0x1db5;
  static constexpr Tagged_t kAtomRegExpDataMap = 0x1ddd;
  static constexpr Tagged_t kIrRegExpDataMap = 0x1e05;
  static constexpr Tagged_t kSourceTextModuleMap = 0x1e2d;
  static constexpr Tagged_t kSyntheticModuleMap = 0x1e55;
  static constexpr Tagged_t kGlobalContextSidePropertyCellMap = 0x1e7d;
  static constexpr Tagged_t kWasmImportDataMap = 0x1ea5;
  static constexpr Tagged_t kWasmCapiFunctionDataMap = 0x1ecd;
  static constexpr Tagged_t kWasmExportedFunctionDataMap = 0x1ef5;
  static constexpr Tagged_t kWasmInternalFunctionMap = 0x1f1d;
  static constexpr Tagged_t kWasmFuncRefMap = 0x1f45;
  static constexpr Tagged_t kWasmJSFunctionDataMap = 0x1f6d;
  static constexpr Tagged_t kWasmResumeDataMap = 0x1f95;
  static constexpr Tagged_t kWasmSuspenderObjectMap = 0x1fbd;
  static constexpr Tagged_t kWasmTypeInfoMap = 0x1fe5;
  static constexpr Tagged_t kWasmContinuationObjectMap = 0x200d;
  static constexpr Tagged_t kWasmNullMap = 0x2035;
  static constexpr Tagged_t kWasmTrustedInstanceDataMap = 0x205d;
  static constexpr Tagged_t kWasmDispatchTableMap = 0x2085;
  static constexpr Tagged_t kWeakCellMap = 0x20ad;
  ...
  static constexpr Tagged_t kdisposed_string = 0x47f9;
  static constexpr Tagged_t kdone_string = 0x480d;
  static constexpr Tagged_t kdot_brand_string = 0x481d;
  static constexpr Tagged_t kdot_catch_string = 0x4831;
  static constexpr Tagged_t kdot_default_string = 0x4845;
  static constexpr Tagged_t kdot_for_string = 0x4859;
  static constexpr Tagged_t kdot_generator_object_string = 0x4869;
  static constexpr Tagged_t kdot_home_object_string = 0x4889;
  static constexpr Tagged_t kdot_new_target_string = 0x48a1;
  static constexpr Tagged_t knew_target_string = 0x48a1;
  static constexpr Tagged_t kdot_result_string = 0x48b9;
  static constexpr Tagged_t kdot_repl_result_string = 0x48cd;
  static constexpr Tagged_t kdot_static_home_object_string = 0x48e5;
  static constexpr Tagged_t kdot_switch_tag_string = 0x4905;
  static constexpr Tagged_t kdotAll_string = 0x491d;
  static constexpr Tagged_t kError_string = 0x4931;
  static constexpr Tagged_t kEvalError_string = 0x4945;
  static constexpr Tagged_t kelement_string = 0x495d;
  static constexpr Tagged_t kepochMicroseconds_string = 0x4971;
  static constexpr Tagged_t kepochMilliseconds_string = 0x4991;
  static constexpr Tagged_t kepochNanoseconds_string = 0x49b1;
  static constexpr Tagged_t kepochSeconds_string = 0x49cd;
  static constexpr Tagged_t kera_string = 0x49e5;
  static constexpr Tagged_t keraYear_string = 0x49f5;
  static constexpr Tagged_t kerror_string = 0x4a09;
  static constexpr Tagged_t kerrors_string = 0x4a1d;
  static constexpr Tagged_t kerror_to_string = 0x4a31;
  static constexpr Tagged_t keval_string = 0x4a4d;
  static constexpr Tagged_t kexception_string = 0x4a5d;
  static constexpr Tagged_t kexec_string = 0x4a75;
  static constexpr Tagged_t kfalse_string = 0x4a85;
  static constexpr Tagged_t kfields_string = 0x4a99;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x4aad;
  static constexpr Tagged_t kflags_string = 0x4acd;
  static constexpr Tagged_t kFloat16Array_string = 0x4ae1;
  static constexpr Tagged_t kFloat32Array_string = 0x4af9;
  static constexpr Tagged_t kFloat64Array_string = 0x4b11;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x4b29;
  static constexpr Tagged_t kfrom_string = 0x4b4d;
  static constexpr Tagged_t kFunction_string = 0x4b5d;
  static constexpr Tagged_t kfunction_native_code_string = 0x4b71;
  static constexpr Tagged_t kfunction_string = 0x4b9d;
  static constexpr Tagged_t kfunction_to_string = 0x4bb1;
  static constexpr Tagged_t kGenerator_string = 0x4bd1;
  static constexpr Tagged_t kget_space_string = 0x4be9;
  static constexpr Tagged_t kget_string = 0x4bf9;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4c09;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4c2d;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4c51;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4c75;
  static constexpr Tagged_t kglobal_string = 0x4c91;
  static constexpr Tagged_t kglobalThis_string = 0x4ca5;
  static constexpr Tagged_t kgroups_string = 0x4cbd;
  static constexpr Tagged_t kgrowable_string = 0x4cd1;
  static constexpr Tagged_t khas_string = 0x4ce5;
  static constexpr Tagged_t khasIndices_string = 0x4cf5;
  static constexpr Tagged_t khour_string = 0x4d0d;
  static constexpr Tagged_t khours_string = 0x4d1d;
  static constexpr Tagged_t khoursInDay_string = 0x4d31;
  static constexpr Tagged_t kignoreCase_string = 0x4d49;
  static constexpr Tagged_t kid_string = 0x4d61;
  static constexpr Tagged_t killegal_access_string = 0x4d71;
  static constexpr Tagged_t killegal_argument_string = 0x4d8d;
  static constexpr Tagged_t kinLeapYear_string = 0x4da9;
  static constexpr Tagged_t kindex_string = 0x4dc1;
  static constexpr Tagged_t kindices_string = 0x4dd5;
  static constexpr Tagged_t kInfinity_string = 0x4de9;
  static constexpr Tagged_t kinfinity_string = 0x4dfd;
  static constexpr Tagged_t kinput_string = 0x4e11;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4e25;
  static constexpr Tagged_t kInt16Array_string = 0x4e51;
  static constexpr Tagged_t kInt32Array_string = 0x4e69;
  static constexpr Tagged_t kInt8Array_string = 0x4e81;
  static constexpr Tagged_t kisExtensible_string = 0x4e99;
  static constexpr Tagged_t kiso8601_string = 0x4eb1;
  static constexpr Tagged_t kisoDay_string = 0x4ec5;
  static constexpr Tagged_t kisoHour_string = 0x4ed9;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4eed;
  static constexpr Tagged_t kisoMillisecond_string = 0x4f09;
  static constexpr Tagged_t kisoMinute_string = 0x4f25;
  static constexpr Tagged_t kisoMonth_string = 0x4f3d;
  static constexpr Tagged_t kisoNanosecond_string = 0x4f51;
  static constexpr Tagged_t kisoSecond_string = 0x4f6d;
  static constexpr Tagged_t kisoYear_string = 0x4f85;
  static constexpr Tagged_t kIterator_string = 0x4f99;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4fad;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4fc9;
  static constexpr Tagged_t kkeys_string = 0x4fe5;
  static constexpr Tagged_t klargestUnit_string = 0x4ff5;
  static constexpr Tagged_t klastIndex_string = 0x500d;
  static constexpr Tagged_t klet_string = 0x5025;
  static constexpr Tagged_t kline_string = 0x5035;
  static constexpr Tagged_t klinear_string = 0x5045;
  static constexpr Tagged_t kLinkError_string = 0x5059;
  static constexpr Tagged_t klong_string = 0x5071;
  static constexpr Tagged_t kMap_string = 0x5081;
  static constexpr Tagged_t kMapIterator_string = 0x5091;
  static constexpr Tagged_t kmax_byte_length_string = 0x50a9;
  static constexpr Tagged_t kmedium_string = 0x50c5;
  static constexpr Tagged_t kmergeFields_string = 0x50d9;
  static constexpr Tagged_t kmessage_string = 0x50f1;
  static constexpr Tagged_t kmeta_string = 0x5105;
  static constexpr Tagged_t kminus_Infinity_string = 0x5115;
  static constexpr Tagged_t kmicrosecond_string = 0x512d;
  static constexpr Tagged_t kmicroseconds_string = 0x5145;
  static constexpr Tagged_t kmillisecond_string = 0x515d;
  static constexpr Tagged_t kmilliseconds_string = 0x5175;
  static constexpr Tagged_t kminute_string = 0x518d;
  static constexpr Tagged_t kminutes_string = 0x51a1;
  static constexpr Tagged_t kModule_string = 0x51b5;
  static constexpr Tagged_t kmonth_string = 0x51c9;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x51dd;
  static constexpr Tagged_t kmonths_string = 0x51fd;
  static constexpr Tagged_t kmonthsInYear_string = 0x5211;
  static constexpr Tagged_t kmonthCode_string = 0x5229;
  static constexpr Tagged_t kmultiline_string = 0x5241;
  static constexpr Tagged_t kNaN_string = 0x5259;
  static constexpr Tagged_t knanosecond_string = 0x5269;
  static constexpr Tagged_t knanoseconds_string = 0x5281;
  static constexpr Tagged_t knarrow_string = 0x5299;
  static constexpr Tagged_t knative_string = 0x52ad;
  static constexpr Tagged_t kNFC_string = 0x52c1;
  static constexpr Tagged_t kNFD_string = 0x52d1;
  static constexpr Tagged_t kNFKC_string = 0x52e1;
  static constexpr Tagged_t kNFKD_string = 0x52f1;
  static constexpr Tagged_t knot_equal_string = 0x5301;
  static constexpr Tagged_t knull_string = 0x5319;
  static constexpr Tagged_t knull_to_string = 0x5329;
  static constexpr Tagged_t kNumber_string = 0x5345;
  static constexpr Tagged_t knumber_string = 0x5359;
  static constexpr Tagged_t knumber_to_string = 0x536d;
  static constexpr Tagged_t kObject_string = 0x5389;
  static constexpr Tagged_t kobject_string = 0x539d;
  static constexpr Tagged_t kobject_to_string = 0x53b1;
  static constexpr Tagged_t kObject_prototype_string = 0x53cd;
  static constexpr Tagged_t koffset_string = 0x53e9;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x53fd;
  static constexpr Tagged_t kok_string = 0x541d;
  static constexpr Tagged_t kother_string = 0x542d;
  static constexpr Tagged_t koverflow_string = 0x5441;
  static constexpr Tagged_t kownKeys_string = 0x5455;
  static constexpr Tagged_t kpercent_string = 0x5469;
  static constexpr Tagged_t kplainDate_string = 0x547d;
  static constexpr Tagged_t kplainTime_string = 0x5495;
  static constexpr Tagged_t kposition_string = 0x54ad;
  static constexpr Tagged_t kpreventExtensions_string = 0x54c1;
  static constexpr Tagged_t kprivate_constructor_string = 0x54e1;
  static constexpr Tagged_t kPromise_string = 0x54f9;
  static constexpr Tagged_t kpromise_string = 0x550d;
  static constexpr Tagged_t kproto_string = 0x5521;
  static constexpr Tagged_t kproxy_string = 0x5539;
  static constexpr Tagged_t kProxy_string = 0x554d;
  static constexpr Tagged_t kquery_colon_string = 0x5561;
  static constexpr Tagged_t kRangeError_string = 0x5571;
  static constexpr Tagged_t kraw_json_string = 0x5589;
  static constexpr Tagged_t kraw_string = 0x559d;
  static constexpr Tagged_t kReferenceError_string = 0x55ad;
  static constexpr Tagged_t kReflectGet_string = 0x55c9;
  static constexpr Tagged_t kReflectHas_string = 0x55e1;
  static constexpr Tagged_t kRegExp_string = 0x55f9;
  static constexpr Tagged_t kregexp_to_string = 0x560d;
  static constexpr Tagged_t kreject_string = 0x5629;
  static constexpr Tagged_t krelativeTo_string = 0x563d;
  static constexpr Tagged_t kresizable_string = 0x5655;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x566d;
  static constexpr Tagged_t kreturn_string = 0x568d;
  static constexpr Tagged_t krevoke_string = 0x56a1;
  static constexpr Tagged_t kroundingIncrement_string = 0x56b5;
  static constexpr Tagged_t kRuntimeError_string = 0x56d5;
  static constexpr Tagged_t kWebAssemblyException_string = 0x56ed;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x5711;
  static constexpr Tagged_t kScript_string = 0x5731;
  static constexpr Tagged_t kscript_string = 0x5745;
  static constexpr Tagged_t ksecond_string = 0x5759;
  static constexpr Tagged_t kseconds_string = 0x576d;
  static constexpr Tagged_t kshort_string = 0x5781;
  static constexpr Tagged_t kSet_string = 0x5795;
  static constexpr Tagged_t ksentence_string = 0x57a5;
  static constexpr Tagged_t kset_space_string = 0x57b9;
  static constexpr Tagged_t kset_string = 0x57c9;
  static constexpr Tagged_t kSetIterator_string = 0x57d9;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x57f1;
  static constexpr Tagged_t kShadowRealm_string = 0x580d;
  static constexpr Tagged_t kSharedArray_string = 0x5825;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x583d;
  static constexpr Tagged_t kSharedStruct_string = 0x585d;
  static constexpr Tagged_t ksign_string = 0x5875;
  static constexpr Tagged_t ksize_string = 0x5885;
  static constexpr Tagged_t ksmallestUnit_string = 0x5895;
  static constexpr Tagged_t ksource_string = 0x58ad;
  static constexpr Tagged_t ksourceText_string = 0x58c1;
  static constexpr Tagged_t kstack_string = 0x58d9;
  static constexpr Tagged_t kstackTraceLimit_string = 0x58ed;
  static constexpr Tagged_t kstatic_initializer_string = 0x5909;
  static constexpr Tagged_t ksticky_string = 0x5929;
  static constexpr Tagged_t kString_string = 0x593d;
  static constexpr Tagged_t kstring_string = 0x5951;
  static constexpr Tagged_t kstring_to_string = 0x5965;
  static constexpr Tagged_t ksuppressed_string = 0x5981;
  static constexpr Tagged_t kSuppressedError_string = 0x5999;
  static constexpr Tagged_t kSymbol_iterator_string = 0x59b5;
  static constexpr Tagged_t kSymbol_match_all_string = 0x59d1;
  static constexpr Tagged_t kSymbol_replace_string = 0x59ed;
  static constexpr Tagged_t ksymbol_species_string = 0x5a09;
  static constexpr Tagged_t kSymbol_species_string = 0x5a25;
  static constexpr Tagged_t kSymbol_split_string = 0x5a41;
  static constexpr Tagged_t kSymbol_string = 0x5a59;
  static constexpr Tagged_t ksymbol_string = 0x5a6d;
  static constexpr Tagged_t kSyntaxError_string = 0x5a81;
  static constexpr Tagged_t ktarget_string = 0x5a99;
  static constexpr Tagged_t kthis_function_string = 0x5aad;
  static constexpr Tagged_t kthis_string = 0x5ac9;
  static constexpr Tagged_t kthrow_string = 0x5ad9;
  static constexpr Tagged_t ktimed_out_string = 0x5aed;
  static constexpr Tagged_t ktimeZone_string = 0x5b05;
  static constexpr Tagged_t ktoJSON_string = 0x5b19;
  static constexpr Tagged_t ktoString_string = 0x5b2d;
  static constexpr Tagged_t ktrue_string = 0x5b41;
  static constexpr Tagged_t ktotal_string = 0x5b51;
  static constexpr Tagged_t kTypeError_string = 0x5b65;
  static constexpr Tagged_t kUint16Array_string = 0x5b7d;
  static constexpr Tagged_t kUint32Array_string = 0x5b95;
  static constexpr Tagged_t kUint8Array_string = 0x5bad;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5bc5;
  static constexpr Tagged_t kundefined_string = 0x5be5;
  static constexpr Tagged_t kundefined_to_string = 0x5bfd;
  static constexpr Tagged_t kunicode_string = 0x5c1d;
  static constexpr Tagged_t kunicodeSets_string = 0x5c31;
  static constexpr Tagged_t kunit_string = 0x5c49;
  static constexpr Tagged_t kURIError_string = 0x5c59;
  static constexpr Tagged_t kUTC_string = 0x5c6d;
  static constexpr Tagged_t kWeakMap_string = 0x5c7d;
  static constexpr Tagged_t kWeakRef_string = 0x5c91;
  static constexpr Tagged_t kWeakSet_string = 0x5ca5;
  static constexpr Tagged_t kweek_string = 0x5cb9;
  static constexpr Tagged_t kweeks_string = 0x5cc9;
  static constexpr Tagged_t kweekOfYear_string = 0x5cdd;
  static constexpr Tagged_t kwith_string = 0x5cf5;
  static constexpr Tagged_t kword_string = 0x5d05;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5d15;
  static constexpr Tagged_t kyear_string = 0x5d35;
  static constexpr Tagged_t kyears_string = 0x5d45;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5d59;
  static constexpr Tagged_t kHashTableHoleValue = 0x5d65;
  static constexpr Tagged_t kPromiseHoleValue = 0x5d71;
  static constexpr Tagged_t kUninitializedValue = 0x5d7d;
  static constexpr Tagged_t kArgumentsMarker = 0x5d89;
  static constexpr Tagged_t kTerminationException = 0x5d95;
  static constexpr Tagged_t kException = 0x5da1;
  static constexpr Tagged_t kOptimizedOut = 0x5dad;
  static constexpr Tagged_t kStaleRegister = 0x5db9;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5dc5;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5dd1;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5ddd;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5ded;
  static constexpr Tagged_t kclass_fields_symbol = 0x5dfd;
  static constexpr Tagged_t kclass_positions_symbol = 0x5e0d;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5e1d;
  static constexpr Tagged_t kerror_message_symbol = 0x5e2d;
  static constexpr Tagged_t kerror_script_symbol = 0x5e3d;
  static constexpr Tagged_t kerror_stack_symbol = 0x5e4d;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5e5d;
  static constexpr Tagged_t kfrozen_symbol = 0x5e6d;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5e7d;
  static constexpr Tagged_t knative_context_index_symbol = 0x5e8d;
  static constexpr Tagged_t knonextensible_symbol = 0x5e9d;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5ead;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5ebd;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5ecd;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5edd;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5eed;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5efd;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5f0d;
  static constexpr Tagged_t ksealed_symbol = 0x5f1d;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5f2d;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5f3d;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5f4d;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5f5d;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5f6d;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5f7d;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5f8d;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5f9d;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5fad;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5fbd;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5fcd;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5fdd;
  static constexpr Tagged_t kintl_fallback_symbol = 0x600d;
  static constexpr Tagged_t kmatch_symbol = 0x6045;
  static constexpr Tagged_t ksearch_symbol = 0x606d;
  static constexpr Tagged_t kunscopables_symbol = 0x6099;
  static constexpr Tagged_t kdispose_symbol = 0x60c9;
  static constexpr Tagged_t kasync_dispose_symbol = 0x60f5;
  static constexpr Tagged_t khas_instance_symbol = 0x6125;
  static constexpr Tagged_t kto_string_tag_symbol = 0x6155;
  static constexpr Tagged_t kconstructor_string = 0x61cd;
  static constexpr Tagged_t knext_string = 0x61e5;
  static constexpr Tagged_t kresolve_string = 0x61f5;
  static constexpr Tagged_t kthen_string = 0x6209;
  static constexpr Tagged_t kvalueOf_string = 0x6219;
  static constexpr Tagged_t kiterator_symbol = 0x622d;
  static constexpr Tagged_t kmatch_all_symbol = 0x623d;
  static constexpr Tagged_t kreplace_symbol = 0x624d;
  static constexpr Tagged_t kspecies_symbol = 0x625d;
  static constexpr Tagged_t ksplit_symbol = 0x626d;
  static constexpr Tagged_t kto_primitive_symbol = 0x627d;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x628d;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x629d;
  static constexpr Tagged_t kEmptySymbolTable = 0x62c1;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x62dd;
