...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kGlobalConstTrackingLetCellMap = 0x1dcd;
  static constexpr Tagged_t kWasmApiFunctionRefMap = 0x1df5;
  static constexpr Tagged_t kWasmCapiFunctionDataMap = 0x1e1d;
  static constexpr Tagged_t kWasmExportedFunctionDataMap = 0x1e45;
  static constexpr Tagged_t kWasmInternalFunctionMap = 0x1e6d;
  static constexpr Tagged_t kWasmJSFunctionDataMap = 0x1e95;
  static constexpr Tagged_t kWasmResumeDataMap = 0x1ebd;
  static constexpr Tagged_t kWasmTypeInfoMap = 0x1ee5;
  static constexpr Tagged_t kWasmContinuationObjectMap = 0x1f0d;
  static constexpr Tagged_t kWasmNullMap = 0x1f35;
  static constexpr Tagged_t kWasmTrustedInstanceDataMap = 0x1f5d;
  static constexpr Tagged_t kWasmDispatchTableMap = 0x1f85;
  static constexpr Tagged_t kWeakCellMap = 0x1fad;
  static constexpr Tagged_t kExternalPointerArrayMap = 0x1fd5;
  static constexpr Tagged_t kInterpreterDataMap = 0x1ffd;
  static constexpr Tagged_t kDictionaryTemplateInfoMap = 0x2025;
  static constexpr Tagged_t kNoOpInterceptorInfo = 0x204d;
  static constexpr Tagged_t kEmptyArrayList = 0x2075;
  static constexpr Tagged_t kEmptyObjectBoilerplateDescription = 0x2081;
  static constexpr Tagged_t kEmptyArrayBoilerplateDescription = 0x2091;
  static constexpr Tagged_t kEmptyClosureFeedbackCellArray = 0x209d;
  static constexpr Tagged_t kEmptySwissPropertyDictionary = 0x20b1;
  static constexpr Tagged_t kSingleCharacterStringTable = 0x20d1;
  static constexpr Tagged_t kdot_string = 0x27b9;
  static constexpr Tagged_t kzero_string = 0x27d9;
  static constexpr Tagged_t kone_string = 0x27e9;
  static constexpr Tagged_t kadoptText_string = 0x34d9;
  static constexpr Tagged_t kapproximatelySign_string = 0x34f1;
  static constexpr Tagged_t kbaseName_string = 0x3511;
  static constexpr Tagged_t kaccounting_string = 0x3525;
  static constexpr Tagged_t kbreakType_string = 0x353d;
  static constexpr Tagged_t kcalendars_string = 0x3555;
  static constexpr Tagged_t kcardinal_string = 0x356d;
  static constexpr Tagged_t kcaseFirst_string = 0x3581;
  static constexpr Tagged_t kceil_string = 0x3599;
  static constexpr Tagged_t kcompare_string = 0x35a9;
  static constexpr Tagged_t kcollation_string = 0x35bd;
  static constexpr Tagged_t kcollations_string = 0x35d5;
  static constexpr Tagged_t kcompact_string = 0x35ed;
  static constexpr Tagged_t kcompactDisplay_string = 0x3601;
  static constexpr Tagged_t kcurrency_string = 0x361d;
  static constexpr Tagged_t kcurrencyDisplay_string = 0x3631;
  static constexpr Tagged_t kcurrencySign_string = 0x364d;
  static constexpr Tagged_t kdateStyle_string = 0x3665;
  static constexpr Tagged_t kdateTimeField_string = 0x367d;
  static constexpr Tagged_t kdayPeriod_string = 0x3699;
  static constexpr Tagged_t kdaysDisplay_string = 0x36b1;
  static constexpr Tagged_t kdecimal_string = 0x36c9;
  static constexpr Tagged_t kdialect_string = 0x36dd;
  static constexpr Tagged_t kdigital_string = 0x36f1;
  static constexpr Tagged_t kdirection_string = 0x3705;
  static constexpr Tagged_t kendRange_string = 0x371d;
  static constexpr Tagged_t kengineering_string = 0x3731;
  static constexpr Tagged_t kexceptZero_string = 0x3749;
  static constexpr Tagged_t kexpand_string = 0x3761;
  static constexpr Tagged_t kexponentInteger_string = 0x3775;
  static constexpr Tagged_t kexponentMinusSign_string = 0x3791;
  static constexpr Tagged_t kexponentSeparator_string = 0x37b1;
  static constexpr Tagged_t kfallback_string = 0x37d1;
  static constexpr Tagged_t kfirst_string = 0x37e5;
  static constexpr Tagged_t kfirstDay_string = 0x37f9;
  static constexpr Tagged_t kfloor_string = 0x380d;
  static constexpr Tagged_t kformat_string = 0x3821;
  static constexpr Tagged_t kfraction_string = 0x3835;
  static constexpr Tagged_t kfractionalDigits_string = 0x3849;
  static constexpr Tagged_t kfractionalSecond_string = 0x3865;
  static constexpr Tagged_t kfull_string = 0x3881;
  static constexpr Tagged_t kgranularity_string = 0x3891;
  static constexpr Tagged_t kgrapheme_string = 0x38a9;
  static constexpr Tagged_t kgroup_string = 0x38bd;
  static constexpr Tagged_t kh11_string = 0x38d1;
  static constexpr Tagged_t kh12_string = 0x38e1;
  static constexpr Tagged_t kh23_string = 0x38f1;
  static constexpr Tagged_t kh24_string = 0x3901;
  static constexpr Tagged_t khalfCeil_string = 0x3911;
  static constexpr Tagged_t khalfEven_string = 0x3925;
  static constexpr Tagged_t khalfExpand_string = 0x3939;
  static constexpr Tagged_t khalfFloor_string = 0x3951;
  static constexpr Tagged_t khalfTrunc_string = 0x3969;
  static constexpr Tagged_t khour12_string = 0x3981;
  static constexpr Tagged_t khourCycle_string = 0x3995;
  static constexpr Tagged_t khourCycles_string = 0x39ad;
  static constexpr Tagged_t khoursDisplay_string = 0x39c5;
  static constexpr Tagged_t kideo_string = 0x39dd;
  static constexpr Tagged_t kignorePunctuation_string = 0x39ed;
  static constexpr Tagged_t kInvalid_Date_string = 0x3a0d;
  static constexpr Tagged_t kinteger_string = 0x3a25;
  static constexpr Tagged_t kisWordLike_string = 0x3a39;
  static constexpr Tagged_t kkana_string = 0x3a51;
  static constexpr Tagged_t klanguage_string = 0x3a61;
  static constexpr Tagged_t klanguageDisplay_string = 0x3a75;
  static constexpr Tagged_t klessPrecision_string = 0x3a91;
  static constexpr Tagged_t kletter_string = 0x3aad;
  static constexpr Tagged_t klist_string = 0x3ac1;
  static constexpr Tagged_t kliteral_string = 0x3ad1;
  static constexpr Tagged_t klocale_string = 0x3ae5;
  static constexpr Tagged_t kloose_string = 0x3af9;
  static constexpr Tagged_t klower_string = 0x3b0d;
  static constexpr Tagged_t kltr_string = 0x3b21;
  static constexpr Tagged_t kmaximumFractionDigits_string = 0x3b31;
  static constexpr Tagged_t kmaximumSignificantDigits_string = 0x3b55;
  static constexpr Tagged_t kmicrosecondsDisplay_string = 0x3b79;
  static constexpr Tagged_t kmillisecondsDisplay_string = 0x3b99;
  static constexpr Tagged_t kmin2_string = 0x3bb9;
  static constexpr Tagged_t kminimalDays_string = 0x3bc9;
  static constexpr Tagged_t kminimumFractionDigits_string = 0x3be1;
  static constexpr Tagged_t kminimumIntegerDigits_string = 0x3c05;
  static constexpr Tagged_t kminimumSignificantDigits_string = 0x3c25;
  static constexpr Tagged_t kminus_0 = 0x3c49;
  static constexpr Tagged_t kminusSign_string = 0x3c59;
  static constexpr Tagged_t kminutesDisplay_string = 0x3c71;
  static constexpr Tagged_t kmonthsDisplay_string = 0x3c8d;
  static constexpr Tagged_t kmorePrecision_string = 0x3ca9;
  static constexpr Tagged_t knan_string = 0x3cc5;
  static constexpr Tagged_t knanosecondsDisplay_string = 0x3cd5;
  static constexpr Tagged_t knarrowSymbol_string = 0x3cf5;
  static constexpr Tagged_t knegative_string = 0x3d0d;
  static constexpr Tagged_t knever_string = 0x3d21;
  static constexpr Tagged_t knone_string = 0x3d35;
  static constexpr Tagged_t knotation_string = 0x3d45;
  static constexpr Tagged_t knormal_string = 0x3d59;
  static constexpr Tagged_t knumberingSystem_string = 0x3d6d;
  static constexpr Tagged_t knumberingSystems_string = 0x3d89;
  static constexpr Tagged_t knumeric_string = 0x3da5;
  static constexpr Tagged_t kordinal_string = 0x3db9;
  static constexpr Tagged_t kpercentSign_string = 0x3dcd;
  static constexpr Tagged_t kplusSign_string = 0x3de5;
  static constexpr Tagged_t kquarter_string = 0x3df9;
  static constexpr Tagged_t kregion_string = 0x3e0d;
  static constexpr Tagged_t krelatedYear_string = 0x3e21;
  static constexpr Tagged_t kroundingMode_string = 0x3e39;
  static constexpr Tagged_t kroundingPriority_string = 0x3e51;
  static constexpr Tagged_t krtl_string = 0x3e6d;
  static constexpr Tagged_t kscientific_string = 0x3e7d;
  static constexpr Tagged_t ksecondsDisplay_string = 0x3e95;
  static constexpr Tagged_t ksegment_string = 0x3eb1;
  static constexpr Tagged_t kSegmentIterator_string = 0x3ec5;
  static constexpr Tagged_t kSegments_string = 0x3ee1;
  static constexpr Tagged_t ksensitivity_string = 0x3ef5;
  static constexpr Tagged_t ksep_string = 0x3f0d;
  static constexpr Tagged_t kshared_string = 0x3f1d;
  static constexpr Tagged_t ksignDisplay_string = 0x3f31;
  static constexpr Tagged_t kstandard_string = 0x3f49;
  static constexpr Tagged_t kstartRange_string = 0x3f5d;
  static constexpr Tagged_t kstrict_string = 0x3f75;
  static constexpr Tagged_t kstripIfInteger_string = 0x3f89;
  static constexpr Tagged_t kstyle_string = 0x3fa5;
  static constexpr Tagged_t kterm_string = 0x3fb9;
  static constexpr Tagged_t ktextInfo_string = 0x3fc9;
  static constexpr Tagged_t ktimeStyle_string = 0x3fdd;
  static constexpr Tagged_t ktimeZones_string = 0x3ff5;
  static constexpr Tagged_t ktimeZoneName_string = 0x400d;
  static constexpr Tagged_t ktrailingZeroDisplay_string = 0x4025;
  static constexpr Tagged_t ktrunc_string = 0x4045;
  static constexpr Tagged_t ktwo_digit_string = 0x4059;
  static constexpr Tagged_t ktype_string = 0x406d;
  static constexpr Tagged_t kunknown_string = 0x407d;
  static constexpr Tagged_t kupper_string = 0x4091;
  static constexpr Tagged_t kusage_string = 0x40a5;
  static constexpr Tagged_t kuseGrouping_string = 0x40b9;
  static constexpr Tagged_t kunitDisplay_string = 0x40d1;
  static constexpr Tagged_t kweekday_string = 0x40e9;
  static constexpr Tagged_t kweekend_string = 0x40fd;
  static constexpr Tagged_t kweeksDisplay_string = 0x4111;
  static constexpr Tagged_t kweekInfo_string = 0x4129;
  static constexpr Tagged_t kyearName_string = 0x413d;
  static constexpr Tagged_t kyearsDisplay_string = 0x4151;
  static constexpr Tagged_t kadd_string = 0x4169;
  static constexpr Tagged_t kAggregateError_string = 0x4179;
  static constexpr Tagged_t kalways_string = 0x4195;
  static constexpr Tagged_t kanonymous_function_string = 0x41a9;
  ...
  static constexpr Tagged_t kawait_string = 0x432d;
  static constexpr Tagged_t kBigInt_string = 0x4341;
  static constexpr Tagged_t kbigint_string = 0x4355;
  static constexpr Tagged_t kBigInt64Array_string = 0x4369;
  static constexpr Tagged_t kBigUint64Array_string = 0x4385;
  static constexpr Tagged_t kbind_string = 0x43a1;
  static constexpr Tagged_t kblank_string = 0x43b1;
  static constexpr Tagged_t kBoolean_string = 0x43c5;
  static constexpr Tagged_t kboolean_string = 0x43d9;
  static constexpr Tagged_t kboolean_to_string = 0x43ed;
  static constexpr Tagged_t kbound__string = 0x4409;
  static constexpr Tagged_t kbuffer_string = 0x441d;
  static constexpr Tagged_t kbyte_length_string = 0x4431;
  static constexpr Tagged_t kbyte_offset_string = 0x4449;
  static constexpr Tagged_t kCompileError_string = 0x4461;
  static constexpr Tagged_t kcalendar_string = 0x4479;
  static constexpr Tagged_t kcallee_string = 0x448d;
  static constexpr Tagged_t kcaller_string = 0x44a1;
  static constexpr Tagged_t kcause_string = 0x44b5;
  static constexpr Tagged_t kcharacter_string = 0x44c9;
  static constexpr Tagged_t kcode_string = 0x44e1;
  static constexpr Tagged_t kcolumn_string = 0x44f1;
  static constexpr Tagged_t kcomputed_string = 0x4505;
  static constexpr Tagged_t kconjunction_string = 0x451d;
  static constexpr Tagged_t kconsole_string = 0x4535;
  static constexpr Tagged_t kconstrain_string = 0x4549;
  static constexpr Tagged_t kconstruct_string = 0x4561;
  static constexpr Tagged_t kcurrent_string = 0x4579;
  static constexpr Tagged_t kDate_string = 0x458d;
  static constexpr Tagged_t kdate_to_string = 0x459d;
  static constexpr Tagged_t kdateAdd_string = 0x45b9;
  static constexpr Tagged_t kdateFromFields_string = 0x45cd;
  static constexpr Tagged_t kdateUntil_string = 0x45e9;
  static constexpr Tagged_t kday_string = 0x4601;
  static constexpr Tagged_t kdayOfWeek_string = 0x4611;
  static constexpr Tagged_t kdayOfYear_string = 0x4629;
  static constexpr Tagged_t kdays_string = 0x4641;
  static constexpr Tagged_t kdaysInMonth_string = 0x4651;
  static constexpr Tagged_t kdaysInWeek_string = 0x4669;
  static constexpr Tagged_t kdaysInYear_string = 0x4681;
  static constexpr Tagged_t kdefault_string = 0x4699;
  static constexpr Tagged_t kdefineProperty_string = 0x46ad;
  static constexpr Tagged_t kdeleteProperty_string = 0x46c9;
  static constexpr Tagged_t kdetached_string = 0x46e5;
  static constexpr Tagged_t kdisjunction_string = 0x46f9;
  static constexpr Tagged_t kdone_string = 0x4711;
  static constexpr Tagged_t kdot_brand_string = 0x4721;
  static constexpr Tagged_t kdot_catch_string = 0x4735;
  static constexpr Tagged_t kdot_default_string = 0x4749;
  static constexpr Tagged_t kdot_for_string = 0x475d;
  static constexpr Tagged_t kdot_generator_object_string = 0x476d;
  static constexpr Tagged_t kdot_home_object_string = 0x478d;
  static constexpr Tagged_t kdot_new_target_string = 0x47a5;
  static constexpr Tagged_t knew_target_string = 0x47a5;
  static constexpr Tagged_t kdot_result_string = 0x47bd;
  static constexpr Tagged_t kdot_repl_result_string = 0x47d1;
  static constexpr Tagged_t kdot_static_home_object_string = 0x47e9;
  static constexpr Tagged_t kdot_switch_tag_string = 0x4809;
  static constexpr Tagged_t kdotAll_string = 0x4821;
  static constexpr Tagged_t kError_string = 0x4835;
  static constexpr Tagged_t kEvalError_string = 0x4849;
  static constexpr Tagged_t kelement_string = 0x4861;
  static constexpr Tagged_t kepochMicroseconds_string = 0x4875;
  static constexpr Tagged_t kepochMilliseconds_string = 0x4895;
  static constexpr Tagged_t kepochNanoseconds_string = 0x48b5;
  static constexpr Tagged_t kepochSeconds_string = 0x48d1;
  static constexpr Tagged_t kera_string = 0x48e9;
  static constexpr Tagged_t keraYear_string = 0x48f9;
  static constexpr Tagged_t kerror_string = 0x490d;
  static constexpr Tagged_t kerrors_string = 0x4921;
  static constexpr Tagged_t kerror_to_string = 0x4935;
  static constexpr Tagged_t keval_string = 0x4951;
  static constexpr Tagged_t kexception_string = 0x4961;
  static constexpr Tagged_t kexec_string = 0x4979;
  static constexpr Tagged_t kfalse_string = 0x4989;
  static constexpr Tagged_t kfields_string = 0x499d;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x49b1;
  static constexpr Tagged_t kflags_string = 0x49d1;
  static constexpr Tagged_t kFloat32Array_string = 0x49e5;
  static constexpr Tagged_t kFloat64Array_string = 0x49fd;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x4a15;
  static constexpr Tagged_t kfrom_string = 0x4a39;
  static constexpr Tagged_t kFunction_string = 0x4a49;
  static constexpr Tagged_t kfunction_native_code_string = 0x4a5d;
  static constexpr Tagged_t kfunction_string = 0x4a89;
  static constexpr Tagged_t kfunction_to_string = 0x4a9d;
  static constexpr Tagged_t kGenerator_string = 0x4abd;
  static constexpr Tagged_t kget_space_string = 0x4ad5;
  static constexpr Tagged_t kget_string = 0x4ae5;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4af5;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4b19;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4b3d;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4b61;
  static constexpr Tagged_t kglobal_string = 0x4b7d;
  static constexpr Tagged_t kglobalThis_string = 0x4b91;
  static constexpr Tagged_t kgroups_string = 0x4ba9;
  static constexpr Tagged_t kgrowable_string = 0x4bbd;
  static constexpr Tagged_t khas_string = 0x4bd1;
  static constexpr Tagged_t khasIndices_string = 0x4be1;
  static constexpr Tagged_t khour_string = 0x4bf9;
  static constexpr Tagged_t khours_string = 0x4c09;
  static constexpr Tagged_t khoursInDay_string = 0x4c1d;
  static constexpr Tagged_t kignoreCase_string = 0x4c35;
  static constexpr Tagged_t kid_string = 0x4c4d;
  static constexpr Tagged_t killegal_access_string = 0x4c5d;
  static constexpr Tagged_t killegal_argument_string = 0x4c79;
  static constexpr Tagged_t kinLeapYear_string = 0x4c95;
  static constexpr Tagged_t kindex_string = 0x4cad;
  static constexpr Tagged_t kindices_string = 0x4cc1;
  static constexpr Tagged_t kInfinity_string = 0x4cd5;
  static constexpr Tagged_t kinfinity_string = 0x4ce9;
  static constexpr Tagged_t kinput_string = 0x4cfd;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4d11;
  static constexpr Tagged_t kInt16Array_string = 0x4d3d;
  static constexpr Tagged_t kInt32Array_string = 0x4d55;
  static constexpr Tagged_t kInt8Array_string = 0x4d6d;
  static constexpr Tagged_t kisExtensible_string = 0x4d85;
  static constexpr Tagged_t kiso8601_string = 0x4d9d;
  static constexpr Tagged_t kisoDay_string = 0x4db1;
  static constexpr Tagged_t kisoHour_string = 0x4dc5;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4dd9;
  static constexpr Tagged_t kisoMillisecond_string = 0x4df5;
  static constexpr Tagged_t kisoMinute_string = 0x4e11;
  static constexpr Tagged_t kisoMonth_string = 0x4e29;
  static constexpr Tagged_t kisoNanosecond_string = 0x4e3d;
  static constexpr Tagged_t kisoSecond_string = 0x4e59;
  static constexpr Tagged_t kisoYear_string = 0x4e71;
  static constexpr Tagged_t kIterator_string = 0x4e85;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4e99;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4eb5;
  static constexpr Tagged_t kkeys_string = 0x4ed1;
  static constexpr Tagged_t klargestUnit_string = 0x4ee1;
  static constexpr Tagged_t klastIndex_string = 0x4ef9;
  static constexpr Tagged_t klet_string = 0x4f11;
  static constexpr Tagged_t kline_string = 0x4f21;
  static constexpr Tagged_t klinear_string = 0x4f31;
  static constexpr Tagged_t kLinkError_string = 0x4f45;
  static constexpr Tagged_t klong_string = 0x4f5d;
  static constexpr Tagged_t kMap_string = 0x4f6d;
  static constexpr Tagged_t kMapIterator_string = 0x4f7d;
  static constexpr Tagged_t kmax_byte_length_string = 0x4f95;
  static constexpr Tagged_t kmedium_string = 0x4fb1;
  static constexpr Tagged_t kmergeFields_string = 0x4fc5;
  static constexpr Tagged_t kmessage_string = 0x4fdd;
  static constexpr Tagged_t kmeta_string = 0x4ff1;
  static constexpr Tagged_t kminus_Infinity_string = 0x5001;
  static constexpr Tagged_t kmicrosecond_string = 0x5019;
  static constexpr Tagged_t kmicroseconds_string = 0x5031;
  static constexpr Tagged_t kmillisecond_string = 0x5049;
  static constexpr Tagged_t kmilliseconds_string = 0x5061;
  static constexpr Tagged_t kminute_string = 0x5079;
  static constexpr Tagged_t kminutes_string = 0x508d;
  static constexpr Tagged_t kModule_string = 0x50a1;
  static constexpr Tagged_t kmonth_string = 0x50b5;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x50c9;
  static constexpr Tagged_t kmonths_string = 0x50e9;
  static constexpr Tagged_t kmonthsInYear_string = 0x50fd;
  static constexpr Tagged_t kmonthCode_string = 0x5115;
  static constexpr Tagged_t kmultiline_string = 0x512d;
  static constexpr Tagged_t kNaN_string = 0x5145;
  static constexpr Tagged_t knanosecond_string = 0x5155;
  static constexpr Tagged_t knanoseconds_string = 0x516d;
  static constexpr Tagged_t knarrow_string = 0x5185;
  static constexpr Tagged_t knative_string = 0x5199;
  static constexpr Tagged_t kNFC_string = 0x51ad;
  static constexpr Tagged_t kNFD_string = 0x51bd;
  static constexpr Tagged_t kNFKC_string = 0x51cd;
  static constexpr Tagged_t kNFKD_string = 0x51dd;
  static constexpr Tagged_t knot_equal_string = 0x51ed;
  static constexpr Tagged_t knull_string = 0x5205;
  static constexpr Tagged_t knull_to_string = 0x5215;
  static constexpr Tagged_t kNumber_string = 0x5231;
  static constexpr Tagged_t knumber_string = 0x5245;
  static constexpr Tagged_t knumber_to_string = 0x5259;
  static constexpr Tagged_t kObject_string = 0x5275;
  static constexpr Tagged_t kobject_string = 0x5289;
  static constexpr Tagged_t kobject_to_string = 0x529d;
  static constexpr Tagged_t kObject_prototype_string = 0x52b9;
  static constexpr Tagged_t kof_string = 0x52d5;
  static constexpr Tagged_t koffset_string = 0x52e5;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x52f9;
  static constexpr Tagged_t kok_string = 0x5319;
  static constexpr Tagged_t kother_string = 0x5329;
  static constexpr Tagged_t koverflow_string = 0x533d;
  static constexpr Tagged_t kownKeys_string = 0x5351;
  static constexpr Tagged_t kpercent_string = 0x5365;
  static constexpr Tagged_t kplainDate_string = 0x5379;
  static constexpr Tagged_t kplainTime_string = 0x5391;
  static constexpr Tagged_t kposition_string = 0x53a9;
  static constexpr Tagged_t kpreventExtensions_string = 0x53bd;
  static constexpr Tagged_t kprivate_constructor_string = 0x53dd;
  static constexpr Tagged_t kPromise_string = 0x53f5;
  static constexpr Tagged_t kpromise_string = 0x5409;
  static constexpr Tagged_t kproto_string = 0x541d;
  static constexpr Tagged_t kproxy_string = 0x5435;
  static constexpr Tagged_t kProxy_string = 0x5449;
  static constexpr Tagged_t kquery_colon_string = 0x545d;
  static constexpr Tagged_t kRangeError_string = 0x546d;
  static constexpr Tagged_t kraw_json_string = 0x5485;
  static constexpr Tagged_t kraw_string = 0x5499;
  static constexpr Tagged_t kReferenceError_string = 0x54a9;
  static constexpr Tagged_t kReflectGet_string = 0x54c5;
  static constexpr Tagged_t kReflectHas_string = 0x54dd;
  static constexpr Tagged_t kRegExp_string = 0x54f5;
  static constexpr Tagged_t kregexp_to_string = 0x5509;
  static constexpr Tagged_t kreject_string = 0x5525;
  static constexpr Tagged_t krelativeTo_string = 0x5539;
  static constexpr Tagged_t kresizable_string = 0x5551;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5569;
  static constexpr Tagged_t kreturn_string = 0x5589;
  static constexpr Tagged_t krevoke_string = 0x559d;
  static constexpr Tagged_t kroundingIncrement_string = 0x55b1;
  static constexpr Tagged_t kRuntimeError_string = 0x55d1;
  static constexpr Tagged_t kWebAssemblyException_string = 0x55e9;
  static constexpr Tagged_t kScript_string = 0x560d;
  static constexpr Tagged_t kscript_string = 0x5621;
  static constexpr Tagged_t ksecond_string = 0x5635;
  static constexpr Tagged_t kseconds_string = 0x5649;
  static constexpr Tagged_t kshort_string = 0x565d;
  static constexpr Tagged_t kSet_string = 0x5671;
  static constexpr Tagged_t ksentence_string = 0x5681;
  static constexpr Tagged_t kset_space_string = 0x5695;
  static constexpr Tagged_t kset_string = 0x56a5;
  static constexpr Tagged_t kSetIterator_string = 0x56b5;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x56cd;
  static constexpr Tagged_t kShadowRealm_string = 0x56e9;
  static constexpr Tagged_t kSharedArray_string = 0x5701;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x5719;
  static constexpr Tagged_t kSharedStruct_string = 0x5739;
  static constexpr Tagged_t ksign_string = 0x5751;
  static constexpr Tagged_t ksize_string = 0x5761;
  static constexpr Tagged_t ksmallestUnit_string = 0x5771;
  static constexpr Tagged_t ksource_string = 0x5789;
  static constexpr Tagged_t ksourceText_string = 0x579d;
  static constexpr Tagged_t kstack_string = 0x57b5;
  static constexpr Tagged_t kstackTraceLimit_string = 0x57c9;
  static constexpr Tagged_t kstatic_initializer_string = 0x57e5;
  static constexpr Tagged_t ksticky_string = 0x5805;
  static constexpr Tagged_t kString_string = 0x5819;
  static constexpr Tagged_t kstring_string = 0x582d;
  static constexpr Tagged_t kstring_to_string = 0x5841;
  static constexpr Tagged_t ksuppressed_string = 0x585d;
  static constexpr Tagged_t kSuppressedError_string = 0x5875;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5891;
  static constexpr Tagged_t kSymbol_match_all_string = 0x58ad;
  static constexpr Tagged_t kSymbol_replace_string = 0x58c9;
  static constexpr Tagged_t ksymbol_species_string = 0x58e5;
  static constexpr Tagged_t kSymbol_species_string = 0x5901;
  static constexpr Tagged_t kSymbol_split_string = 0x591d;
  static constexpr Tagged_t kSymbol_string = 0x5935;
  static constexpr Tagged_t ksymbol_string = 0x5949;
  static constexpr Tagged_t kSyntaxError_string = 0x595d;
  static constexpr Tagged_t ktarget_string = 0x5975;
  static constexpr Tagged_t kthis_function_string = 0x5989;
  static constexpr Tagged_t kthis_string = 0x59a5;
  static constexpr Tagged_t kthrow_string = 0x59b5;
  static constexpr Tagged_t ktimed_out_string = 0x59c9;
  static constexpr Tagged_t ktimeZone_string = 0x59e1;
  static constexpr Tagged_t ktoJSON_string = 0x59f5;
  static constexpr Tagged_t ktoString_string = 0x5a09;
  static constexpr Tagged_t ktrue_string = 0x5a1d;
  static constexpr Tagged_t ktotal_string = 0x5a2d;
  static constexpr Tagged_t kTypeError_string = 0x5a41;
  static constexpr Tagged_t kUint16Array_string = 0x5a59;
  static constexpr Tagged_t kUint32Array_string = 0x5a71;
  static constexpr Tagged_t kUint8Array_string = 0x5a89;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5aa1;
  static constexpr Tagged_t kundefined_string = 0x5ac1;
  static constexpr Tagged_t kundefined_to_string = 0x5ad9;
  static constexpr Tagged_t kunicode_string = 0x5af9;
  static constexpr Tagged_t kunicodeSets_string = 0x5b0d;
  static constexpr Tagged_t kunit_string = 0x5b25;
  static constexpr Tagged_t kURIError_string = 0x5b35;
  static constexpr Tagged_t kUTC_string = 0x5b49;
  static constexpr Tagged_t kvalueOf_string = 0x5b59;
  static constexpr Tagged_t kWeakMap_string = 0x5b6d;
  static constexpr Tagged_t kWeakRef_string = 0x5b81;
  static constexpr Tagged_t kWeakSet_string = 0x5b95;
  static constexpr Tagged_t kweek_string = 0x5ba9;
  static constexpr Tagged_t kweeks_string = 0x5bb9;
  static constexpr Tagged_t kweekOfYear_string = 0x5bcd;
  static constexpr Tagged_t kwith_string = 0x5be5;
  static constexpr Tagged_t kword_string = 0x5bf5;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5c05;
  static constexpr Tagged_t kyear_string = 0x5c25;
  static constexpr Tagged_t kyears_string = 0x5c35;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5c49;
  static constexpr Tagged_t kHashTableHoleValue = 0x5c55;
  static constexpr Tagged_t kPromiseHoleValue = 0x5c61;
  static constexpr Tagged_t kUninitializedValue = 0x5c6d;
  static constexpr Tagged_t kArgumentsMarker = 0x5c79;
  static constexpr Tagged_t kTerminationException = 0x5c85;
  static constexpr Tagged_t kException = 0x5c91;
  static constexpr Tagged_t kOptimizedOut = 0x5c9d;
  static constexpr Tagged_t kStaleRegister = 0x5ca9;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5cb5;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5cc1;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5ccd;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5cdd;
  static constexpr Tagged_t kconsole_context_id_symbol = 0x5ced;
  static constexpr Tagged_t kconsole_context_name_symbol = 0x5cfd;
  static constexpr Tagged_t kclass_fields_symbol = 0x5d0d;
  static constexpr Tagged_t kclass_positions_symbol = 0x5d1d;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5d2d;
  static constexpr Tagged_t kerror_script_symbol = 0x5d3d;
  static constexpr Tagged_t kerror_stack_symbol = 0x5d4d;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5d5d;
  static constexpr Tagged_t kfrozen_symbol = 0x5d6d;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5d7d;
  static constexpr Tagged_t knative_context_index_symbol = 0x5d8d;
  static constexpr Tagged_t knonextensible_symbol = 0x5d9d;
  ...
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5e2d;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5e3d;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5e4d;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5e5d;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5e6d;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5e7d;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5e8d;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5e9d;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5ead;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5ebd;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5ecd;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5edd;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5f0d;
  static constexpr Tagged_t kmatch_symbol = 0x5f45;
  static constexpr Tagged_t ksearch_symbol = 0x5f6d;
  static constexpr Tagged_t kto_primitive_symbol = 0x5f99;
  static constexpr Tagged_t kunscopables_symbol = 0x5fc9;
  static constexpr Tagged_t khas_instance_symbol = 0x5ff9;
  static constexpr Tagged_t kto_string_tag_symbol = 0x6029;
  ...
  static constexpr Tagged_t kiterator_symbol = 0x60cd;
  static constexpr Tagged_t kmatch_all_symbol = 0x60dd;
  static constexpr Tagged_t kreplace_symbol = 0x60ed;
  static constexpr Tagged_t kspecies_symbol = 0x60fd;
  static constexpr Tagged_t ksplit_symbol = 0x610d;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x611d;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x612d;
  static constexpr Tagged_t kEmptySymbolTable = 0x6151;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x616d;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6181;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x6195;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x61a1;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x61c1;
  static constexpr Tagged_t kNativeScopeInfo = 0x61e5;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x61fd;
  static constexpr Tagged_t kEmptyExternalPointerArray = 0x6215;
  static constexpr Tagged_t kWasmNullPadding = 0x621d;
