...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kobject_clone_transition_symbol = 0xe95;
  static constexpr Tagged_t kmega_dom_symbol = 0xea5;
  static constexpr Tagged_t kEmptyPropertyDictionary = 0xeb5;
  static constexpr Tagged_t kEmptyOrderedPropertyDictionary = 0xee1;
  static constexpr Tagged_t kEmptyByteArray = 0xef9;
  static constexpr Tagged_t kEmptyScopeInfo = 0xf01;
  static constexpr Tagged_t kEmptyPropertyArray = 0xf19;
  static constexpr Tagged_t kMinusZeroValue = 0xf21;
  static constexpr Tagged_t kNanValue = 0xf2d;
  static constexpr Tagged_t kHoleNanValue = 0xf39;
  static constexpr Tagged_t kInfinityValue = 0xf45;
  static constexpr Tagged_t kMinusInfinityValue = 0xf51;
  static constexpr Tagged_t kMaxSafeInteger = 0xf5d;
  static constexpr Tagged_t kMaxUInt32 = 0xf69;
  static constexpr Tagged_t kSmiMinValue = 0xf75;
  static constexpr Tagged_t kSmiMaxValuePlusOne = 0xf81;
  static constexpr Tagged_t kPromiseFulfillReactionJobTaskMap = 0xf8d;
  static constexpr Tagged_t kPromiseRejectReactionJobTaskMap = 0xfb5;
  static constexpr Tagged_t kCallableTaskMap = 0xfdd;
  static constexpr Tagged_t kCallbackTaskMap = 0x1005;
  static constexpr Tagged_t kPromiseResolveThenableJobTaskMap = 0x102d;
  static constexpr Tagged_t kAccessCheckInfoMap = 0x1055;
  static constexpr Tagged_t kAccessorPairMap = 0x107d;
  static constexpr Tagged_t kAliasedArgumentsEntryMap = 0x10a5;
  static constexpr Tagged_t kAllocationMementoMap = 0x10cd;
  static constexpr Tagged_t kArrayBoilerplateDescriptionMap = 0x10f5;
  static constexpr Tagged_t kAsmWasmDataMap = 0x111d;
  static constexpr Tagged_t kAsyncGeneratorRequestMap = 0x1145;
  static constexpr Tagged_t kBreakPointMap = 0x116d;
  static constexpr Tagged_t kBreakPointInfoMap = 0x1195;
  static constexpr Tagged_t kBytecodeWrapperMap = 0x11bd;
  static constexpr Tagged_t kClassBoilerplateMap = 0x11e5;
  static constexpr Tagged_t kClassPositionsMap = 0x120d;
  static constexpr Tagged_t kCodeWrapperMap = 0x1235;
  static constexpr Tagged_t kDebugInfoMap = 0x125d;
  static constexpr Tagged_t kErrorStackDataMap = 0x1285;
  static constexpr Tagged_t kFunctionTemplateRareDataMap = 0x12ad;
  static constexpr Tagged_t kInterceptorInfoMap = 0x12d5;
  static constexpr Tagged_t kModuleRequestMap = 0x12fd;
  static constexpr Tagged_t kPromiseCapabilityMap = 0x1325;
  static constexpr Tagged_t kPromiseReactionMap = 0x134d;
  static constexpr Tagged_t kPropertyDescriptorObjectMap = 0x1375;
  static constexpr Tagged_t kPrototypeInfoMap = 0x139d;
  static constexpr Tagged_t kRegExpBoilerplateDescriptionMap = 0x13c5;
  static constexpr Tagged_t kScriptMap = 0x13ed;
  static constexpr Tagged_t kScriptOrModuleMap = 0x1415;
  static constexpr Tagged_t kSourceTextModuleInfoEntryMap = 0x143d;
  static constexpr Tagged_t kStackFrameInfoMap = 0x1465;
  ...
  static constexpr Tagged_t kSourceTextModuleMap = 0x1d75;
  static constexpr Tagged_t kSyntheticModuleMap = 0x1d9d;
  static constexpr Tagged_t kGlobalConstTrackingLetCellMap = 0x1dc5;
  static constexpr Tagged_t kWasmApiFunctionRefMap = 0x1ded;
  static constexpr Tagged_t kWasmCapiFunctionDataMap = 0x1e15;
  static constexpr Tagged_t kWasmExportedFunctionDataMap = 0x1e3d;
  static constexpr Tagged_t kWasmInternalFunctionMap = 0x1e65;
  static constexpr Tagged_t kWasmFuncRefMap = 0x1e8d;
  static constexpr Tagged_t kWasmJSFunctionDataMap = 0x1eb5;
  static constexpr Tagged_t kWasmResumeDataMap = 0x1edd;
  static constexpr Tagged_t kWasmTypeInfoMap = 0x1f05;
  static constexpr Tagged_t kWasmContinuationObjectMap = 0x1f2d;
  static constexpr Tagged_t kWasmNullMap = 0x1f55;
  static constexpr Tagged_t kWasmTrustedInstanceDataMap = 0x1f7d;
  static constexpr Tagged_t kWasmDispatchTableMap = 0x1fa5;
  static constexpr Tagged_t kWeakCellMap = 0x1fcd;
  static constexpr Tagged_t kExternalPointerArrayMap = 0x1ff5;
  static constexpr Tagged_t kInterpreterDataMap = 0x201d;
  static constexpr Tagged_t kSharedFunctionInfoWrapperMap = 0x2045;
  static constexpr Tagged_t kDictionaryTemplateInfoMap = 0x206d;
  static constexpr Tagged_t kNoOpInterceptorInfo = 0x2095;
  static constexpr Tagged_t kEmptyArrayList = 0x20bd;
  static constexpr Tagged_t kEmptyObjectBoilerplateDescription = 0x20c9;
  static constexpr Tagged_t kEmptyArrayBoilerplateDescription = 0x20d9;
  static constexpr Tagged_t kEmptyClosureFeedbackCellArray = 0x20e5;
  static constexpr Tagged_t kEmptySwissPropertyDictionary = 0x20f9;
  static constexpr Tagged_t kSingleCharacterStringTable = 0x2119;
  static constexpr Tagged_t kdot_string = 0x2801;
  static constexpr Tagged_t kzero_string = 0x2821;
  static constexpr Tagged_t kone_string = 0x2831;
  static constexpr Tagged_t kadoptText_string = 0x3521;
  static constexpr Tagged_t kapproximatelySign_string = 0x3539;
  static constexpr Tagged_t kbaseName_string = 0x3559;
  static constexpr Tagged_t kaccounting_string = 0x356d;
  static constexpr Tagged_t kbreakType_string = 0x3585;
  static constexpr Tagged_t kcalendars_string = 0x359d;
  static constexpr Tagged_t kcardinal_string = 0x35b5;
  static constexpr Tagged_t kcaseFirst_string = 0x35c9;
  static constexpr Tagged_t kceil_string = 0x35e1;
  static constexpr Tagged_t kcompare_string = 0x35f1;
  static constexpr Tagged_t kcollation_string = 0x3605;
  static constexpr Tagged_t kcollations_string = 0x361d;
  static constexpr Tagged_t kcompact_string = 0x3635;
  static constexpr Tagged_t kcompactDisplay_string = 0x3649;
  static constexpr Tagged_t kcurrency_string = 0x3665;
  static constexpr Tagged_t kcurrencyDisplay_string = 0x3679;
  static constexpr Tagged_t kcurrencySign_string = 0x3695;
  static constexpr Tagged_t kdateStyle_string = 0x36ad;
  static constexpr Tagged_t kdateTimeField_string = 0x36c5;
  static constexpr Tagged_t kdayPeriod_string = 0x36e1;
  static constexpr Tagged_t kdaysDisplay_string = 0x36f9;
  static constexpr Tagged_t kdecimal_string = 0x3711;
  static constexpr Tagged_t kdialect_string = 0x3725;
  static constexpr Tagged_t kdigital_string = 0x3739;
  static constexpr Tagged_t kdirection_string = 0x374d;
  static constexpr Tagged_t kendRange_string = 0x3765;
  static constexpr Tagged_t kengineering_string = 0x3779;
  static constexpr Tagged_t kexceptZero_string = 0x3791;
  static constexpr Tagged_t kexpand_string = 0x37a9;
  static constexpr Tagged_t kexponentInteger_string = 0x37bd;
  static constexpr Tagged_t kexponentMinusSign_string = 0x37d9;
  static constexpr Tagged_t kexponentSeparator_string = 0x37f9;
  static constexpr Tagged_t kfallback_string = 0x3819;
  static constexpr Tagged_t kfirst_string = 0x382d;
  static constexpr Tagged_t kfirstDay_string = 0x3841;
  static constexpr Tagged_t kfloor_string = 0x3855;
  static constexpr Tagged_t kformat_string = 0x3869;
  static constexpr Tagged_t kfraction_string = 0x387d;
  static constexpr Tagged_t kfractionalDigits_string = 0x3891;
  static constexpr Tagged_t kfractionalSecond_string = 0x38ad;
  static constexpr Tagged_t kfull_string = 0x38c9;
  static constexpr Tagged_t kgranularity_string = 0x38d9;
  static constexpr Tagged_t kgrapheme_string = 0x38f1;
  static constexpr Tagged_t kgroup_string = 0x3905;
  static constexpr Tagged_t kh11_string = 0x3919;
  static constexpr Tagged_t kh12_string = 0x3929;
  static constexpr Tagged_t kh23_string = 0x3939;
  static constexpr Tagged_t kh24_string = 0x3949;
  static constexpr Tagged_t khalfCeil_string = 0x3959;
  static constexpr Tagged_t khalfEven_string = 0x396d;
  static constexpr Tagged_t khalfExpand_string = 0x3981;
  static constexpr Tagged_t khalfFloor_string = 0x3999;
  static constexpr Tagged_t khalfTrunc_string = 0x39b1;
  static constexpr Tagged_t khour12_string = 0x39c9;
  static constexpr Tagged_t khourCycle_string = 0x39dd;
  static constexpr Tagged_t khourCycles_string = 0x39f5;
  static constexpr Tagged_t khoursDisplay_string = 0x3a0d;
  static constexpr Tagged_t kideo_string = 0x3a25;
  static constexpr Tagged_t kignorePunctuation_string = 0x3a35;
  static constexpr Tagged_t kInvalid_Date_string = 0x3a55;
  static constexpr Tagged_t kinteger_string = 0x3a6d;
  static constexpr Tagged_t kisWordLike_string = 0x3a81;
  static constexpr Tagged_t kkana_string = 0x3a99;
  static constexpr Tagged_t klanguage_string = 0x3aa9;
  static constexpr Tagged_t klanguageDisplay_string = 0x3abd;
  static constexpr Tagged_t klessPrecision_string = 0x3ad9;
  static constexpr Tagged_t kletter_string = 0x3af5;
  static constexpr Tagged_t klist_string = 0x3b09;
  static constexpr Tagged_t kliteral_string = 0x3b19;
  static constexpr Tagged_t klocale_string = 0x3b2d;
  static constexpr Tagged_t kloose_string = 0x3b41;
  static constexpr Tagged_t klower_string = 0x3b55;
  static constexpr Tagged_t kltr_string = 0x3b69;
  static constexpr Tagged_t kmaximumFractionDigits_string = 0x3b79;
  static constexpr Tagged_t kmaximumSignificantDigits_string = 0x3b9d;
  static constexpr Tagged_t kmicrosecondsDisplay_string = 0x3bc1;
  static constexpr Tagged_t kmillisecondsDisplay_string = 0x3be1;
  static constexpr Tagged_t kmin2_string = 0x3c01;
  static constexpr Tagged_t kminimalDays_string = 0x3c11;
  static constexpr Tagged_t kminimumFractionDigits_string = 0x3c29;
  static constexpr Tagged_t kminimumIntegerDigits_string = 0x3c4d;
  static constexpr Tagged_t kminimumSignificantDigits_string = 0x3c6d;
  static constexpr Tagged_t kminus_0 = 0x3c91;
  static constexpr Tagged_t kminusSign_string = 0x3ca1;
  static constexpr Tagged_t kminutesDisplay_string = 0x3cb9;
  static constexpr Tagged_t kmonthsDisplay_string = 0x3cd5;
  static constexpr Tagged_t kmorePrecision_string = 0x3cf1;
  static constexpr Tagged_t knan_string = 0x3d0d;
  static constexpr Tagged_t knanosecondsDisplay_string = 0x3d1d;
  static constexpr Tagged_t knarrowSymbol_string = 0x3d3d;
  static constexpr Tagged_t knegative_string = 0x3d55;
  static constexpr Tagged_t knever_string = 0x3d69;
  static constexpr Tagged_t knone_string = 0x3d7d;
  static constexpr Tagged_t knotation_string = 0x3d8d;
  static constexpr Tagged_t knormal_string = 0x3da1;
  static constexpr Tagged_t knumberingSystem_string = 0x3db5;
  static constexpr Tagged_t knumberingSystems_string = 0x3dd1;
  static constexpr Tagged_t knumeric_string = 0x3ded;
  static constexpr Tagged_t kordinal_string = 0x3e01;
  static constexpr Tagged_t kpercentSign_string = 0x3e15;
  static constexpr Tagged_t kplusSign_string = 0x3e2d;
  static constexpr Tagged_t kquarter_string = 0x3e41;
  static constexpr Tagged_t kregion_string = 0x3e55;
  static constexpr Tagged_t krelatedYear_string = 0x3e69;
  static constexpr Tagged_t kroundingMode_string = 0x3e81;
  static constexpr Tagged_t kroundingPriority_string = 0x3e99;
  static constexpr Tagged_t krtl_string = 0x3eb5;
  static constexpr Tagged_t kscientific_string = 0x3ec5;
  static constexpr Tagged_t ksecondsDisplay_string = 0x3edd;
  static constexpr Tagged_t ksegment_string = 0x3ef9;
  static constexpr Tagged_t kSegmentIterator_string = 0x3f0d;
  static constexpr Tagged_t kSegments_string = 0x3f29;
  static constexpr Tagged_t ksensitivity_string = 0x3f3d;
  static constexpr Tagged_t ksep_string = 0x3f55;
  static constexpr Tagged_t kshared_string = 0x3f65;
  static constexpr Tagged_t ksignDisplay_string = 0x3f79;
  static constexpr Tagged_t kstandard_string = 0x3f91;
  static constexpr Tagged_t kstartRange_string = 0x3fa5;
  static constexpr Tagged_t kstrict_string = 0x3fbd;
  static constexpr Tagged_t kstripIfInteger_string = 0x3fd1;
  static constexpr Tagged_t kstyle_string = 0x3fed;
  static constexpr Tagged_t kterm_string = 0x4001;
  static constexpr Tagged_t ktextInfo_string = 0x4011;
  static constexpr Tagged_t ktimeStyle_string = 0x4025;
  static constexpr Tagged_t ktimeZones_string = 0x403d;
  static constexpr Tagged_t ktimeZoneName_string = 0x4055;
  static constexpr Tagged_t ktrailingZeroDisplay_string = 0x406d;
  static constexpr Tagged_t ktrunc_string = 0x408d;
  static constexpr Tagged_t ktwo_digit_string = 0x40a1;
  static constexpr Tagged_t ktype_string = 0x40b5;
  static constexpr Tagged_t kunknown_string = 0x40c5;
  static constexpr Tagged_t kupper_string = 0x40d9;
  static constexpr Tagged_t kusage_string = 0x40ed;
  static constexpr Tagged_t kuseGrouping_string = 0x4101;
  static constexpr Tagged_t kunitDisplay_string = 0x4119;
  static constexpr Tagged_t kweekday_string = 0x4131;
  static constexpr Tagged_t kweekend_string = 0x4145;
  static constexpr Tagged_t kweeksDisplay_string = 0x4159;
  static constexpr Tagged_t kweekInfo_string = 0x4171;
  static constexpr Tagged_t kyearName_string = 0x4185;
  static constexpr Tagged_t kyearsDisplay_string = 0x4199;
  static constexpr Tagged_t kadd_string = 0x41b1;
  static constexpr Tagged_t kAggregateError_string = 0x41c1;
  static constexpr Tagged_t kalways_string = 0x41dd;
  static constexpr Tagged_t kanonymous_string = 0x41f1;
  static constexpr Tagged_t kapply_string = 0x4209;
  static constexpr Tagged_t kArguments_string = 0x421d;
  static constexpr Tagged_t karguments_string = 0x4235;
  static constexpr Tagged_t karguments_to_string = 0x424d;
  static constexpr Tagged_t kArray_string = 0x426d;
  static constexpr Tagged_t karray_to_string = 0x4281;
  static constexpr Tagged_t kArrayBuffer_string = 0x429d;
  static constexpr Tagged_t kArrayIterator_string = 0x42b5;
  static constexpr Tagged_t kas_string = 0x42d1;
  static constexpr Tagged_t kassert_string = 0x42e1;
  static constexpr Tagged_t kasync_string = 0x42f5;
  static constexpr Tagged_t kAtomicsCondition_string = 0x4309;
  static constexpr Tagged_t kAtomicsMutex_string = 0x4329;
  static constexpr Tagged_t kauto_string = 0x4345;
  static constexpr Tagged_t kBigInt_string = 0x4355;
  static constexpr Tagged_t kbigint_string = 0x4369;
  static constexpr Tagged_t kBigInt64Array_string = 0x437d;
  static constexpr Tagged_t kBigUint64Array_string = 0x4399;
  static constexpr Tagged_t kbind_string = 0x43b5;
  static constexpr Tagged_t kblank_string = 0x43c5;
  static constexpr Tagged_t kBoolean_string = 0x43d9;
  static constexpr Tagged_t kboolean_string = 0x43ed;
  static constexpr Tagged_t kboolean_to_string = 0x4401;
  static constexpr Tagged_t kbound__string = 0x441d;
  static constexpr Tagged_t kbuffer_string = 0x4431;
  static constexpr Tagged_t kbyte_length_string = 0x4445;
  static constexpr Tagged_t kbyte_offset_string = 0x445d;
  static constexpr Tagged_t kCompileError_string = 0x4475;
  static constexpr Tagged_t kcalendar_string = 0x448d;
  static constexpr Tagged_t kcallee_string = 0x44a1;
  static constexpr Tagged_t kcaller_string = 0x44b5;
  static constexpr Tagged_t kcause_string = 0x44c9;
  static constexpr Tagged_t kcharacter_string = 0x44dd;
  static constexpr Tagged_t kcode_string = 0x44f5;
  static constexpr Tagged_t kcolumn_string = 0x4505;
  static constexpr Tagged_t kcomputed_string = 0x4519;
  static constexpr Tagged_t kconjunction_string = 0x4531;
  static constexpr Tagged_t kconsole_string = 0x4549;
  static constexpr Tagged_t kconstrain_string = 0x455d;
  static constexpr Tagged_t kconstruct_string = 0x4575;
  static constexpr Tagged_t kcurrent_string = 0x458d;
  static constexpr Tagged_t kDate_string = 0x45a1;
  static constexpr Tagged_t kdate_to_string = 0x45b1;
  static constexpr Tagged_t kdateAdd_string = 0x45cd;
  static constexpr Tagged_t kdateFromFields_string = 0x45e1;
  static constexpr Tagged_t kdateUntil_string = 0x45fd;
  static constexpr Tagged_t kday_string = 0x4615;
  static constexpr Tagged_t kdayOfWeek_string = 0x4625;
  static constexpr Tagged_t kdayOfYear_string = 0x463d;
  static constexpr Tagged_t kdays_string = 0x4655;
  static constexpr Tagged_t kdaysInMonth_string = 0x4665;
  static constexpr Tagged_t kdaysInWeek_string = 0x467d;
  static constexpr Tagged_t kdaysInYear_string = 0x4695;
  static constexpr Tagged_t kdefault_string = 0x46ad;
  static constexpr Tagged_t kdefineProperty_string = 0x46c1;
  static constexpr Tagged_t kdeleteProperty_string = 0x46dd;
  static constexpr Tagged_t kdetached_string = 0x46f9;
  static constexpr Tagged_t kdisjunction_string = 0x470d;
  static constexpr Tagged_t kdone_string = 0x4725;
  static constexpr Tagged_t kdot_brand_string = 0x4735;
  static constexpr Tagged_t kdot_catch_string = 0x4749;
  static constexpr Tagged_t kdot_default_string = 0x475d;
  static constexpr Tagged_t kdot_for_string = 0x4771;
  static constexpr Tagged_t kdot_generator_object_string = 0x4781;
  static constexpr Tagged_t kdot_home_object_string = 0x47a1;
  static constexpr Tagged_t kdot_new_target_string = 0x47b9;
  static constexpr Tagged_t knew_target_string = 0x47b9;
  static constexpr Tagged_t kdot_result_string = 0x47d1;
  static constexpr Tagged_t kdot_repl_result_string = 0x47e5;
  static constexpr Tagged_t kdot_static_home_object_string = 0x47fd;
  static constexpr Tagged_t kdot_switch_tag_string = 0x481d;
  static constexpr Tagged_t kdotAll_string = 0x4835;
  static constexpr Tagged_t kError_string = 0x4849;
  static constexpr Tagged_t kEvalError_string = 0x485d;
  static constexpr Tagged_t kelement_string = 0x4875;
  static constexpr Tagged_t kepochMicroseconds_string = 0x4889;
  static constexpr Tagged_t kepochMilliseconds_string = 0x48a9;
  static constexpr Tagged_t kepochNanoseconds_string = 0x48c9;
  static constexpr Tagged_t kepochSeconds_string = 0x48e5;
  static constexpr Tagged_t kera_string = 0x48fd;
  static constexpr Tagged_t keraYear_string = 0x490d;
  static constexpr Tagged_t kerror_string = 0x4921;
  static constexpr Tagged_t kerrors_string = 0x4935;
  static constexpr Tagged_t kerror_to_string = 0x4949;
  static constexpr Tagged_t keval_string = 0x4965;
  static constexpr Tagged_t kexception_string = 0x4975;
  static constexpr Tagged_t kexec_string = 0x498d;
  static constexpr Tagged_t kfalse_string = 0x499d;
  static constexpr Tagged_t kfields_string = 0x49b1;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x49c5;
  static constexpr Tagged_t kflags_string = 0x49e5;
  static constexpr Tagged_t kFloat16Array_string = 0x49f9;
  static constexpr Tagged_t kFloat32Array_string = 0x4a11;
  static constexpr Tagged_t kFloat64Array_string = 0x4a29;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x4a41;
  static constexpr Tagged_t kfrom_string = 0x4a65;
  static constexpr Tagged_t kFunction_string = 0x4a75;
  static constexpr Tagged_t kfunction_native_code_string = 0x4a89;
  static constexpr Tagged_t kfunction_string = 0x4ab5;
  static constexpr Tagged_t kfunction_to_string = 0x4ac9;
  static constexpr Tagged_t kGenerator_string = 0x4ae9;
  static constexpr Tagged_t kget_space_string = 0x4b01;
  static constexpr Tagged_t kget_string = 0x4b11;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4b21;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4b45;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4b69;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4b8d;
  static constexpr Tagged_t kglobal_string = 0x4ba9;
  static constexpr Tagged_t kglobalThis_string = 0x4bbd;
  static constexpr Tagged_t kgroups_string = 0x4bd5;
  static constexpr Tagged_t kgrowable_string = 0x4be9;
  static constexpr Tagged_t khas_string = 0x4bfd;
  static constexpr Tagged_t khasIndices_string = 0x4c0d;
  static constexpr Tagged_t khour_string = 0x4c25;
  static constexpr Tagged_t khours_string = 0x4c35;
  static constexpr Tagged_t khoursInDay_string = 0x4c49;
  static constexpr Tagged_t kignoreCase_string = 0x4c61;
  static constexpr Tagged_t kid_string = 0x4c79;
  static constexpr Tagged_t killegal_access_string = 0x4c89;
  static constexpr Tagged_t killegal_argument_string = 0x4ca5;
  static constexpr Tagged_t kinLeapYear_string = 0x4cc1;
  static constexpr Tagged_t kindex_string = 0x4cd9;
  static constexpr Tagged_t kindices_string = 0x4ced;
  static constexpr Tagged_t kInfinity_string = 0x4d01;
  static constexpr Tagged_t kinfinity_string = 0x4d15;
  static constexpr Tagged_t kinput_string = 0x4d29;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4d3d;
  static constexpr Tagged_t kInt16Array_string = 0x4d69;
  static constexpr Tagged_t kInt32Array_string = 0x4d81;
  static constexpr Tagged_t kInt8Array_string = 0x4d99;
  static constexpr Tagged_t kisExtensible_string = 0x4db1;
  static constexpr Tagged_t kiso8601_string = 0x4dc9;
  static constexpr Tagged_t kisoDay_string = 0x4ddd;
  static constexpr Tagged_t kisoHour_string = 0x4df1;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4e05;
  static constexpr Tagged_t kisoMillisecond_string = 0x4e21;
  static constexpr Tagged_t kisoMinute_string = 0x4e3d;
  static constexpr Tagged_t kisoMonth_string = 0x4e55;
  static constexpr Tagged_t kisoNanosecond_string = 0x4e69;
  static constexpr Tagged_t kisoSecond_string = 0x4e85;
  static constexpr Tagged_t kisoYear_string = 0x4e9d;
  static constexpr Tagged_t kIterator_string = 0x4eb1;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4ec5;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4ee1;
  static constexpr Tagged_t kkeys_string = 0x4efd;
  static constexpr Tagged_t klargestUnit_string = 0x4f0d;
  static constexpr Tagged_t klastIndex_string = 0x4f25;
  static constexpr Tagged_t klet_string = 0x4f3d;
  static constexpr Tagged_t kline_string = 0x4f4d;
  static constexpr Tagged_t klinear_string = 0x4f5d;
  static constexpr Tagged_t kLinkError_string = 0x4f71;
  static constexpr Tagged_t klong_string = 0x4f89;
  static constexpr Tagged_t kMap_string = 0x4f99;
  static constexpr Tagged_t kMapIterator_string = 0x4fa9;
  static constexpr Tagged_t kmax_byte_length_string = 0x4fc1;
  static constexpr Tagged_t kmedium_string = 0x4fdd;
  static constexpr Tagged_t kmergeFields_string = 0x4ff1;
  static constexpr Tagged_t kmessage_string = 0x5009;
  static constexpr Tagged_t kmeta_string = 0x501d;
  static constexpr Tagged_t kminus_Infinity_string = 0x502d;
  static constexpr Tagged_t kmicrosecond_string = 0x5045;
  static constexpr Tagged_t kmicroseconds_string = 0x505d;
  static constexpr Tagged_t kmillisecond_string = 0x5075;
  static constexpr Tagged_t kmilliseconds_string = 0x508d;
  static constexpr Tagged_t kminute_string = 0x50a5;
  static constexpr Tagged_t kminutes_string = 0x50b9;
  static constexpr Tagged_t kModule_string = 0x50cd;
  static constexpr Tagged_t kmonth_string = 0x50e1;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x50f5;
  static constexpr Tagged_t kmonths_string = 0x5115;
  static constexpr Tagged_t kmonthsInYear_string = 0x5129;
  static constexpr Tagged_t kmonthCode_string = 0x5141;
  static constexpr Tagged_t kmultiline_string = 0x5159;
  static constexpr Tagged_t kNaN_string = 0x5171;
  static constexpr Tagged_t knanosecond_string = 0x5181;
  static constexpr Tagged_t knanoseconds_string = 0x5199;
  static constexpr Tagged_t knarrow_string = 0x51b1;
  static constexpr Tagged_t knative_string = 0x51c5;
  static constexpr Tagged_t kNFC_string = 0x51d9;
  static constexpr Tagged_t kNFD_string = 0x51e9;
  static constexpr Tagged_t kNFKC_string = 0x51f9;
  static constexpr Tagged_t kNFKD_string = 0x5209;
  static constexpr Tagged_t knot_equal_string = 0x5219;
  static constexpr Tagged_t knull_string = 0x5231;
  static constexpr Tagged_t knull_to_string = 0x5241;
  static constexpr Tagged_t kNumber_string = 0x525d;
  static constexpr Tagged_t knumber_string = 0x5271;
  static constexpr Tagged_t knumber_to_string = 0x5285;
  static constexpr Tagged_t kObject_string = 0x52a1;
  static constexpr Tagged_t kobject_string = 0x52b5;
  static constexpr Tagged_t kobject_to_string = 0x52c9;
  static constexpr Tagged_t kObject_prototype_string = 0x52e5;
  static constexpr Tagged_t koffset_string = 0x5301;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x5315;
  static constexpr Tagged_t kok_string = 0x5335;
  static constexpr Tagged_t kother_string = 0x5345;
  static constexpr Tagged_t koverflow_string = 0x5359;
  static constexpr Tagged_t kownKeys_string = 0x536d;
  static constexpr Tagged_t kpercent_string = 0x5381;
  static constexpr Tagged_t kplainDate_string = 0x5395;
  static constexpr Tagged_t kplainTime_string = 0x53ad;
  static constexpr Tagged_t kposition_string = 0x53c5;
  static constexpr Tagged_t kpreventExtensions_string = 0x53d9;
  static constexpr Tagged_t kprivate_constructor_string = 0x53f9;
  static constexpr Tagged_t kPromise_string = 0x5411;
  static constexpr Tagged_t kpromise_string = 0x5425;
  static constexpr Tagged_t kproto_string = 0x5439;
  static constexpr Tagged_t kproxy_string = 0x5451;
  static constexpr Tagged_t kProxy_string = 0x5465;
  static constexpr Tagged_t kquery_colon_string = 0x5479;
  static constexpr Tagged_t kRangeError_string = 0x5489;
  static constexpr Tagged_t kraw_json_string = 0x54a1;
  static constexpr Tagged_t kraw_string = 0x54b5;
  static constexpr Tagged_t kReferenceError_string = 0x54c5;
  static constexpr Tagged_t kReflectGet_string = 0x54e1;
  static constexpr Tagged_t kReflectHas_string = 0x54f9;
  static constexpr Tagged_t kRegExp_string = 0x5511;
  static constexpr Tagged_t kregexp_to_string = 0x5525;
  static constexpr Tagged_t kreject_string = 0x5541;
  static constexpr Tagged_t krelativeTo_string = 0x5555;
  static constexpr Tagged_t kresizable_string = 0x556d;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5585;
  static constexpr Tagged_t kreturn_string = 0x55a5;
  static constexpr Tagged_t krevoke_string = 0x55b9;
  static constexpr Tagged_t kroundingIncrement_string = 0x55cd;
  static constexpr Tagged_t kRuntimeError_string = 0x55ed;
  static constexpr Tagged_t kWebAssemblyException_string = 0x5605;
  static constexpr Tagged_t kScript_string = 0x5629;
  static constexpr Tagged_t kscript_string = 0x563d;
  static constexpr Tagged_t ksecond_string = 0x5651;
  static constexpr Tagged_t kseconds_string = 0x5665;
  static constexpr Tagged_t kshort_string = 0x5679;
  static constexpr Tagged_t kSet_string = 0x568d;
  static constexpr Tagged_t ksentence_string = 0x569d;
  static constexpr Tagged_t kset_space_string = 0x56b1;
  static constexpr Tagged_t kset_string = 0x56c1;
  static constexpr Tagged_t kSetIterator_string = 0x56d1;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x56e9;
  static constexpr Tagged_t kShadowRealm_string = 0x5705;
  static constexpr Tagged_t kSharedArray_string = 0x571d;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x5735;
  static constexpr Tagged_t kSharedStruct_string = 0x5755;
  static constexpr Tagged_t ksign_string = 0x576d;
  static constexpr Tagged_t ksize_string = 0x577d;
  static constexpr Tagged_t ksmallestUnit_string = 0x578d;
  static constexpr Tagged_t ksource_string = 0x57a5;
  static constexpr Tagged_t ksourceText_string = 0x57b9;
  static constexpr Tagged_t kstack_string = 0x57d1;
  static constexpr Tagged_t kstackTraceLimit_string = 0x57e5;
  static constexpr Tagged_t kstatic_initializer_string = 0x5801;
  static constexpr Tagged_t ksticky_string = 0x5821;
  static constexpr Tagged_t kString_string = 0x5835;
  static constexpr Tagged_t kstring_string = 0x5849;
  static constexpr Tagged_t kstring_to_string = 0x585d;
  static constexpr Tagged_t ksuppressed_string = 0x5879;
  static constexpr Tagged_t kSuppressedError_string = 0x5891;
  static constexpr Tagged_t kSymbol_iterator_string = 0x58ad;
  static constexpr Tagged_t kSymbol_match_all_string = 0x58c9;
  static constexpr Tagged_t kSymbol_replace_string = 0x58e5;
  static constexpr Tagged_t ksymbol_species_string = 0x5901;
  static constexpr Tagged_t kSymbol_species_string = 0x591d;
  static constexpr Tagged_t kSymbol_split_string = 0x5939;
  static constexpr Tagged_t kSymbol_string = 0x5951;
  static constexpr Tagged_t ksymbol_string = 0x5965;
  static constexpr Tagged_t kSyntaxError_string = 0x5979;
  static constexpr Tagged_t ktarget_string = 0x5991;
  static constexpr Tagged_t kthis_function_string = 0x59a5;
  static constexpr Tagged_t kthis_string = 0x59c1;
  static constexpr Tagged_t kthrow_string = 0x59d1;
  static constexpr Tagged_t ktimed_out_string = 0x59e5;
  static constexpr Tagged_t ktimeZone_string = 0x59fd;
  static constexpr Tagged_t ktoJSON_string = 0x5a11;
  static constexpr Tagged_t ktoString_string = 0x5a25;
  static constexpr Tagged_t ktrue_string = 0x5a39;
  static constexpr Tagged_t ktotal_string = 0x5a49;
  static constexpr Tagged_t kTypeError_string = 0x5a5d;
  static constexpr Tagged_t kUint16Array_string = 0x5a75;
  static constexpr Tagged_t kUint32Array_string = 0x5a8d;
  static constexpr Tagged_t kUint8Array_string = 0x5aa5;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5abd;
  static constexpr Tagged_t kundefined_string = 0x5add;
  static constexpr Tagged_t kundefined_to_string = 0x5af5;
  static constexpr Tagged_t kunicode_string = 0x5b15;
  static constexpr Tagged_t kunicodeSets_string = 0x5b29;
  static constexpr Tagged_t kunit_string = 0x5b41;
  static constexpr Tagged_t kURIError_string = 0x5b51;
  static constexpr Tagged_t kUTC_string = 0x5b65;
  static constexpr Tagged_t kWeakMap_string = 0x5b75;
  static constexpr Tagged_t kWeakRef_string = 0x5b89;
  static constexpr Tagged_t kWeakSet_string = 0x5b9d;
  static constexpr Tagged_t kweek_string = 0x5bb1;
  static constexpr Tagged_t kweeks_string = 0x5bc1;
  static constexpr Tagged_t kweekOfYear_string = 0x5bd5;
  static constexpr Tagged_t kwith_string = 0x5bed;
  static constexpr Tagged_t kword_string = 0x5bfd;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5c0d;
  static constexpr Tagged_t kyear_string = 0x5c2d;
  static constexpr Tagged_t kyears_string = 0x5c3d;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5c51;
  static constexpr Tagged_t kHashTableHoleValue = 0x5c5d;
  static constexpr Tagged_t kPromiseHoleValue = 0x5c69;
  static constexpr Tagged_t kUninitializedValue = 0x5c75;
  static constexpr Tagged_t kArgumentsMarker = 0x5c81;
  static constexpr Tagged_t kTerminationException = 0x5c8d;
  static constexpr Tagged_t kException = 0x5c99;
  static constexpr Tagged_t kOptimizedOut = 0x5ca5;
  static constexpr Tagged_t kStaleRegister = 0x5cb1;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5cbd;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5cc9;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5cd5;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5ce5;
  static constexpr Tagged_t kconsole_context_id_symbol = 0x5cf5;
  static constexpr Tagged_t kconsole_context_name_symbol = 0x5d05;
  static constexpr Tagged_t kclass_fields_symbol = 0x5d15;
  static constexpr Tagged_t kclass_positions_symbol = 0x5d25;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5d35;
  static constexpr Tagged_t kerror_message_symbol = 0x5d45;
  static constexpr Tagged_t kerror_script_symbol = 0x5d55;
  static constexpr Tagged_t kerror_stack_symbol = 0x5d65;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5d75;
  static constexpr Tagged_t kfrozen_symbol = 0x5d85;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5d95;
  static constexpr Tagged_t knative_context_index_symbol = 0x5da5;
  static constexpr Tagged_t knonextensible_symbol = 0x5db5;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5dc5;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5dd5;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5de5;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5df5;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5e05;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5e15;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5e25;
  static constexpr Tagged_t ksealed_symbol = 0x5e35;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5e45;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5e55;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5e65;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5e75;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5e85;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5e95;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5ea5;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5eb5;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5ec5;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5ed5;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5ee5;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5ef5;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5f25;
  static constexpr Tagged_t kmatch_symbol = 0x5f5d;
  static constexpr Tagged_t ksearch_symbol = 0x5f85;
  static constexpr Tagged_t kunscopables_symbol = 0x5fb1;
  static constexpr Tagged_t kdispose_symbol = 0x5fe1;
  static constexpr Tagged_t kasync_dispose_symbol = 0x600d;
  static constexpr Tagged_t khas_instance_symbol = 0x603d;
  static constexpr Tagged_t kto_string_tag_symbol = 0x606d;
  static constexpr Tagged_t kconstructor_string = 0x60e5;
  static constexpr Tagged_t knext_string = 0x60fd;
  static constexpr Tagged_t kresolve_string = 0x610d;
  static constexpr Tagged_t kthen_string = 0x6121;
  static constexpr Tagged_t kvalueOf_string = 0x6131;
  static constexpr Tagged_t kiterator_symbol = 0x6145;
  static constexpr Tagged_t kmatch_all_symbol = 0x6155;
  static constexpr Tagged_t kreplace_symbol = 0x6165;
  static constexpr Tagged_t kspecies_symbol = 0x6175;
  static constexpr Tagged_t ksplit_symbol = 0x6185;
  static constexpr Tagged_t kto_primitive_symbol = 0x6195;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x61a5;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x61b5;
  static constexpr Tagged_t kEmptySymbolTable = 0x61d9;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x61f5;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6209;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x621d;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x6229;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x6249;
  static constexpr Tagged_t kNativeScopeInfo = 0x626d;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x6285;
  static constexpr Tagged_t kEmptyExternalPointerArray = 0x629d;
  static constexpr Tagged_t kWasmNullPadding = 0x62a5;
