...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kWasmApiFunctionRefMap = 0x1e7d;
  ...
  static constexpr Tagged_t kWasmTypeInfoMap = 0x1f95;
  static constexpr Tagged_t kWasmContinuationObjectMap = 0x1fbd;
  static constexpr Tagged_t kWasmNullMap = 0x1fe5;
  static constexpr Tagged_t kWasmTrustedInstanceDataMap = 0x200d;
  static constexpr Tagged_t kWasmDispatchTableMap = 0x2035;
  static constexpr Tagged_t kWeakCellMap = 0x205d;
  static constexpr Tagged_t kExternalPointerArrayMap = 0x2085;
  ...
  static constexpr Tagged_t kScript_string = 0x56d5;
  static constexpr Tagged_t kscript_string = 0x56e9;
  static constexpr Tagged_t ksecond_string = 0x56fd;
  static constexpr Tagged_t kseconds_string = 0x5711;
  static constexpr Tagged_t kshort_string = 0x5725;
  static constexpr Tagged_t kSet_string = 0x5739;
  static constexpr Tagged_t ksentence_string = 0x5749;
  static constexpr Tagged_t kset_space_string = 0x575d;
  static constexpr Tagged_t kset_string = 0x576d;
  static constexpr Tagged_t kSetIterator_string = 0x577d;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x5795;
  static constexpr Tagged_t kShadowRealm_string = 0x57b1;
  static constexpr Tagged_t kSharedArray_string = 0x57c9;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x57e1;
  static constexpr Tagged_t kSharedStruct_string = 0x5801;
  static constexpr Tagged_t ksign_string = 0x5819;
  static constexpr Tagged_t ksize_string = 0x5829;
  static constexpr Tagged_t ksmallestUnit_string = 0x5839;
  static constexpr Tagged_t ksource_string = 0x5851;
  static constexpr Tagged_t ksourceText_string = 0x5865;
  static constexpr Tagged_t kstack_string = 0x587d;
  static constexpr Tagged_t kstackTraceLimit_string = 0x5891;
  static constexpr Tagged_t kstatic_initializer_string = 0x58ad;
  static constexpr Tagged_t ksticky_string = 0x58cd;
  static constexpr Tagged_t kString_string = 0x58e1;
  static constexpr Tagged_t kstring_string = 0x58f5;
  static constexpr Tagged_t kstring_to_string = 0x5909;
  static constexpr Tagged_t ksuppressed_string = 0x5925;
  static constexpr Tagged_t kSuppressedError_string = 0x593d;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5959;
  static constexpr Tagged_t kSymbol_match_all_string = 0x5975;
  static constexpr Tagged_t kSymbol_replace_string = 0x5991;
  static constexpr Tagged_t ksymbol_species_string = 0x59ad;
  static constexpr Tagged_t kSymbol_species_string = 0x59c9;
  static constexpr Tagged_t kSymbol_split_string = 0x59e5;
  static constexpr Tagged_t kSymbol_string = 0x59fd;
  static constexpr Tagged_t ksymbol_string = 0x5a11;
  static constexpr Tagged_t kSyntaxError_string = 0x5a25;
  static constexpr Tagged_t ktarget_string = 0x5a3d;
  static constexpr Tagged_t kthis_function_string = 0x5a51;
  static constexpr Tagged_t kthis_string = 0x5a6d;
  static constexpr Tagged_t kthrow_string = 0x5a7d;
  static constexpr Tagged_t ktimed_out_string = 0x5a91;
  static constexpr Tagged_t ktimeZone_string = 0x5aa9;
  static constexpr Tagged_t ktoJSON_string = 0x5abd;
  static constexpr Tagged_t ktoString_string = 0x5ad1;
  static constexpr Tagged_t ktrue_string = 0x5ae5;
  static constexpr Tagged_t ktotal_string = 0x5af5;
  static constexpr Tagged_t kTypeError_string = 0x5b09;
  static constexpr Tagged_t kUint16Array_string = 0x5b21;
  static constexpr Tagged_t kUint32Array_string = 0x5b39;
  static constexpr Tagged_t kUint8Array_string = 0x5b51;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5b69;
  static constexpr Tagged_t kundefined_string = 0x5b89;
  static constexpr Tagged_t kundefined_to_string = 0x5ba1;
  static constexpr Tagged_t kunicode_string = 0x5bc1;
  static constexpr Tagged_t kunicodeSets_string = 0x5bd5;
  static constexpr Tagged_t kunit_string = 0x5bed;
  static constexpr Tagged_t kURIError_string = 0x5bfd;
  static constexpr Tagged_t kUTC_string = 0x5c11;
  static constexpr Tagged_t kWeakMap_string = 0x5c21;
  static constexpr Tagged_t kWeakRef_string = 0x5c35;
  static constexpr Tagged_t kWeakSet_string = 0x5c49;
  static constexpr Tagged_t kweek_string = 0x5c5d;
  static constexpr Tagged_t kweeks_string = 0x5c6d;
  static constexpr Tagged_t kweekOfYear_string = 0x5c81;
  static constexpr Tagged_t kwith_string = 0x5c99;
  static constexpr Tagged_t kword_string = 0x5ca9;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5cb9;
  static constexpr Tagged_t kyear_string = 0x5cd9;
  static constexpr Tagged_t kyears_string = 0x5ce9;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5cfd;
  static constexpr Tagged_t kHashTableHoleValue = 0x5d09;
  static constexpr Tagged_t kPromiseHoleValue = 0x5d15;
  static constexpr Tagged_t kUninitializedValue = 0x5d21;
  static constexpr Tagged_t kArgumentsMarker = 0x5d2d;
  static constexpr Tagged_t kTerminationException = 0x5d39;
  static constexpr Tagged_t kException = 0x5d45;
  static constexpr Tagged_t kOptimizedOut = 0x5d51;
  static constexpr Tagged_t kStaleRegister = 0x5d5d;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5d69;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5d75;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5d81;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5d91;
  ...
  static constexpr Tagged_t kerror_message_symbol = 0x5dd1;
  static constexpr Tagged_t kerror_script_symbol = 0x5de1;
  static constexpr Tagged_t kerror_stack_symbol = 0x5df1;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5e01;
  static constexpr Tagged_t kfrozen_symbol = 0x5e11;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5e21;
  static constexpr Tagged_t knative_context_index_symbol = 0x5e31;
  static constexpr Tagged_t knonextensible_symbol = 0x5e41;
  ...
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5ed1;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5ee1;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5ef1;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5f01;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5f11;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5f21;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5f31;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5f41;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5f51;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5f61;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5f71;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5f81;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5fb1;
  static constexpr Tagged_t kmatch_symbol = 0x5fe9;
  static constexpr Tagged_t ksearch_symbol = 0x6011;
  static constexpr Tagged_t kunscopables_symbol = 0x603d;
  static constexpr Tagged_t kdispose_symbol = 0x606d;
  static constexpr Tagged_t kasync_dispose_symbol = 0x6099;
  static constexpr Tagged_t khas_instance_symbol = 0x60c9;
  static constexpr Tagged_t kto_string_tag_symbol = 0x60f9;
  ...
  static constexpr Tagged_t kvalueOf_string = 0x61bd;
  static constexpr Tagged_t kiterator_symbol = 0x61d1;
  static constexpr Tagged_t kmatch_all_symbol = 0x61e1;
  static constexpr Tagged_t kreplace_symbol = 0x61f1;
  static constexpr Tagged_t kspecies_symbol = 0x6201;
  static constexpr Tagged_t ksplit_symbol = 0x6211;
  static constexpr Tagged_t kto_primitive_symbol = 0x6221;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x6231;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x6241;
  static constexpr Tagged_t kEmptySymbolTable = 0x6265;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x6281;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6295;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x62a9;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x62b5;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x62d5;
  static constexpr Tagged_t kNativeScopeInfo = 0x62f9;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x6311;
  static constexpr Tagged_t kEmptyExternalPointerArray = 0x6329;
  static constexpr Tagged_t kWasmNullPadding = 0x6331;
