...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kBytecodeArrayMap = 0x8c9;
  static constexpr Tagged_t kFreeSpaceMap = 0x8f1;
  static constexpr Tagged_t kPropertyArrayMap = 0x919;
  static constexpr Tagged_t kSmallOrderedHashMapMap = 0x941;
  static constexpr Tagged_t kSmallOrderedHashSetMap = 0x969;
  static constexpr Tagged_t kSmallOrderedNameDictionaryMap = 0x991;
  static constexpr Tagged_t kInstructionStreamMap = 0x9b9;
  static constexpr Tagged_t kCellMap = 0x9e1;
  static constexpr Tagged_t kInvalidPrototypeValidityCell = 0xa09;
  static constexpr Tagged_t kGlobalPropertyCellMap = 0xa11;
  static constexpr Tagged_t kOnePointerFillerMap = 0xa39;
  static constexpr Tagged_t kTwoPointerFillerMap = 0xa61;
  static constexpr Tagged_t kNoClosuresCellMap = 0xa89;
  static constexpr Tagged_t kOneClosureCellMap = 0xab1;
  static constexpr Tagged_t kManyClosuresCellMap = 0xad9;
  static constexpr Tagged_t kTransitionArrayMap = 0xb01;
  static constexpr Tagged_t kHashTableMap = 0xb29;
  static constexpr Tagged_t kOrderedNameDictionaryMap = 0xb51;
  static constexpr Tagged_t kNameDictionaryMap = 0xb79;
  static constexpr Tagged_t kSwissNameDictionaryMap = 0xba1;
  static constexpr Tagged_t kGlobalDictionaryMap = 0xbc9;
  static constexpr Tagged_t kNumberDictionaryMap = 0xbf1;
  static constexpr Tagged_t kRegisteredSymbolTableMap = 0xc19;
  static constexpr Tagged_t kArrayListMap = 0xc41;
  static constexpr Tagged_t kAccessorInfoMap = 0xc69;
  static constexpr Tagged_t kPreparseDataMap = 0xc91;
  static constexpr Tagged_t kSharedFunctionInfoMap = 0xcb9;
  static constexpr Tagged_t kCodeMap = 0xce1;
  static constexpr Tagged_t kHashSeed = 0xd09;
  static constexpr Tagged_t klength_string = 0xd19;
  static constexpr Tagged_t kprototype_string = 0xd2d;
  static constexpr Tagged_t kname_string = 0xd45;
  static constexpr Tagged_t kenumerable_string = 0xd55;
  static constexpr Tagged_t kconfigurable_string = 0xd6d;
  static constexpr Tagged_t kvalue_string = 0xd85;
  static constexpr Tagged_t kwritable_string = 0xd99;
  static constexpr Tagged_t knot_mapped_symbol = 0xdad;
  static constexpr Tagged_t kuninitialized_symbol = 0xdbd;
  static constexpr Tagged_t kmegamorphic_symbol = 0xdcd;
  static constexpr Tagged_t kelements_transition_symbol = 0xddd;
  static constexpr Tagged_t kmega_dom_symbol = 0xded;
  static constexpr Tagged_t kEmptyPropertyDictionary = 0xdfd;
  static constexpr Tagged_t kEmptyOrderedPropertyDictionary = 0xe29;
  static constexpr Tagged_t kEmptyByteArray = 0xe41;
  static constexpr Tagged_t kEmptyScopeInfo = 0xe49;
  static constexpr Tagged_t kEmptyPropertyArray = 0xe59;
  static constexpr Tagged_t kMinusZeroValue = 0xe61;
  static constexpr Tagged_t kNanValue = 0xe6d;
  static constexpr Tagged_t kHoleNanValue = 0xe79;
  static constexpr Tagged_t kInfinityValue = 0xe85;
  static constexpr Tagged_t kMinusInfinityValue = 0xe91;
  static constexpr Tagged_t kMaxSafeInteger = 0xe9d;
  static constexpr Tagged_t kMaxUInt32 = 0xea9;
  static constexpr Tagged_t kSmiMinValue = 0xeb5;
  static constexpr Tagged_t kSmiMaxValuePlusOne = 0xec1;
  static constexpr Tagged_t kPromiseFulfillReactionJobTaskMap = 0xecd;
  static constexpr Tagged_t kPromiseRejectReactionJobTaskMap = 0xef5;
  static constexpr Tagged_t kCallableTaskMap = 0xf1d;
  static constexpr Tagged_t kCallbackTaskMap = 0xf45;
  static constexpr Tagged_t kPromiseResolveThenableJobTaskMap = 0xf6d;
  static constexpr Tagged_t kFunctionTemplateInfoMap = 0xf95;
  static constexpr Tagged_t kObjectTemplateInfoMap = 0xfbd;
  ...
  static constexpr Tagged_t kWasmIndirectFunctionTableMap = 0x14bd;
  ...
  static constexpr Tagged_t kWasmStringViewIterMap = 0x1a35;
  static constexpr Tagged_t kSloppyArgumentsElementsMap = 0x1a5d;
  static constexpr Tagged_t kStrongDescriptorArrayMap = 0x1a85;
  static constexpr Tagged_t kTurboshaftWord32SetTypeMap = 0x1aad;
  static constexpr Tagged_t kTurboshaftWord64SetTypeMap = 0x1ad5;
  static constexpr Tagged_t kTurboshaftFloat64SetTypeMap = 0x1afd;
  static constexpr Tagged_t kInternalClassWithStructElementsMap = 0x1b25;
  static constexpr Tagged_t kOrderedHashMapMap = 0x1b4d;
  static constexpr Tagged_t kOrderedHashSetMap = 0x1b75;
  static constexpr Tagged_t kSimpleNumberDictionaryMap = 0x1b9d;
  static constexpr Tagged_t kNameToIndexHashTableMap = 0x1bc5;
  static constexpr Tagged_t kEmbedderDataArrayMap = 0x1bed;
  static constexpr Tagged_t kEphemeronHashTableMap = 0x1c15;
  static constexpr Tagged_t kScriptContextTableMap = 0x1c3d;
  static constexpr Tagged_t kObjectBoilerplateDescriptionMap = 0x1c65;
  static constexpr Tagged_t kCoverageInfoMap = 0x1c8d;
  static constexpr Tagged_t kRegExpMatchInfoMap = 0x1cb5;
  static constexpr Tagged_t kSideEffectCallHandlerInfoMap = 0x1cdd;
  static constexpr Tagged_t kSideEffectFreeCallHandlerInfoMap = 0x1d05;
  static constexpr Tagged_t kSourceTextModuleMap = 0x1d2d;
  static constexpr Tagged_t kSyntheticModuleMap = 0x1d55;
  static constexpr Tagged_t kWasmApiFunctionRefMap = 0x1d7d;
  static constexpr Tagged_t kWasmCapiFunctionDataMap = 0x1da5;
  static constexpr Tagged_t kWasmExportedFunctionDataMap = 0x1dcd;
  static constexpr Tagged_t kWasmInternalFunctionMap = 0x1df5;
  static constexpr Tagged_t kWasmJSFunctionDataMap = 0x1e1d;
  static constexpr Tagged_t kWasmResumeDataMap = 0x1e45;
  static constexpr Tagged_t kWasmTypeInfoMap = 0x1e6d;
  static constexpr Tagged_t kWasmContinuationObjectMap = 0x1e95;
  static constexpr Tagged_t kWasmNullMap = 0x1ebd;
  static constexpr Tagged_t kWeakCellMap = 0x1ee5;
  static constexpr Tagged_t kExternalPointerArrayMap = 0x1f0d;
  static constexpr Tagged_t kInterpreterDataMap = 0x1f35;
  static constexpr Tagged_t kNoOpInterceptorInfo = 0x1f5d;
  static constexpr Tagged_t kEmptyArrayList = 0x1f85;
  static constexpr Tagged_t kEmptyObjectBoilerplateDescription = 0x1f91;
  static constexpr Tagged_t kEmptyArrayBoilerplateDescription = 0x1fa1;
  static constexpr Tagged_t kEmptyClosureFeedbackCellArray = 0x1fad;
  static constexpr Tagged_t kEmptySwissPropertyDictionary = 0x1fc1;
  static constexpr Tagged_t kSingleCharacterStringTable = 0x1fe1;
  static constexpr Tagged_t kdot_string = 0x26c9;
  static constexpr Tagged_t kzero_string = 0x26e9;
  static constexpr Tagged_t kone_string = 0x26f9;
  static constexpr Tagged_t kadoptText_string = 0x33e9;
  static constexpr Tagged_t kapproximatelySign_string = 0x3401;
  static constexpr Tagged_t kbaseName_string = 0x3421;
  static constexpr Tagged_t kaccounting_string = 0x3435;
  static constexpr Tagged_t kbreakType_string = 0x344d;
  static constexpr Tagged_t kcalendars_string = 0x3465;
  static constexpr Tagged_t kcardinal_string = 0x347d;
  static constexpr Tagged_t kcaseFirst_string = 0x3491;
  static constexpr Tagged_t kceil_string = 0x34a9;
  static constexpr Tagged_t kcompare_string = 0x34b9;
  static constexpr Tagged_t kcollation_string = 0x34cd;
  static constexpr Tagged_t kcollations_string = 0x34e5;
  static constexpr Tagged_t kcompact_string = 0x34fd;
  static constexpr Tagged_t kcompactDisplay_string = 0x3511;
  static constexpr Tagged_t kcurrency_string = 0x352d;
  static constexpr Tagged_t kcurrencyDisplay_string = 0x3541;
  static constexpr Tagged_t kcurrencySign_string = 0x355d;
  static constexpr Tagged_t kdateStyle_string = 0x3575;
  static constexpr Tagged_t kdateTimeField_string = 0x358d;
  static constexpr Tagged_t kdayPeriod_string = 0x35a9;
  static constexpr Tagged_t kdaysDisplay_string = 0x35c1;
  static constexpr Tagged_t kdecimal_string = 0x35d9;
  static constexpr Tagged_t kdialect_string = 0x35ed;
  static constexpr Tagged_t kdigital_string = 0x3601;
  static constexpr Tagged_t kdirection_string = 0x3615;
  static constexpr Tagged_t kendRange_string = 0x362d;
  static constexpr Tagged_t kengineering_string = 0x3641;
  static constexpr Tagged_t kexceptZero_string = 0x3659;
  static constexpr Tagged_t kexpand_string = 0x3671;
  static constexpr Tagged_t kexponentInteger_string = 0x3685;
  static constexpr Tagged_t kexponentMinusSign_string = 0x36a1;
  static constexpr Tagged_t kexponentSeparator_string = 0x36c1;
  static constexpr Tagged_t kfallback_string = 0x36e1;
  static constexpr Tagged_t kfirst_string = 0x36f5;
  static constexpr Tagged_t kfirstDay_string = 0x3709;
  static constexpr Tagged_t kfloor_string = 0x371d;
  static constexpr Tagged_t kformat_string = 0x3731;
  static constexpr Tagged_t kfraction_string = 0x3745;
  static constexpr Tagged_t kfractionalDigits_string = 0x3759;
  static constexpr Tagged_t kfractionalSecond_string = 0x3775;
  static constexpr Tagged_t kfull_string = 0x3791;
  static constexpr Tagged_t kgranularity_string = 0x37a1;
  static constexpr Tagged_t kgrapheme_string = 0x37b9;
  static constexpr Tagged_t kgroup_string = 0x37cd;
  static constexpr Tagged_t kh11_string = 0x37e1;
  static constexpr Tagged_t kh12_string = 0x37f1;
  static constexpr Tagged_t kh23_string = 0x3801;
  static constexpr Tagged_t kh24_string = 0x3811;
  static constexpr Tagged_t khalfCeil_string = 0x3821;
  static constexpr Tagged_t khalfEven_string = 0x3835;
  static constexpr Tagged_t khalfExpand_string = 0x3849;
  static constexpr Tagged_t khalfFloor_string = 0x3861;
  static constexpr Tagged_t khalfTrunc_string = 0x3879;
  static constexpr Tagged_t khour12_string = 0x3891;
  static constexpr Tagged_t khourCycle_string = 0x38a5;
  static constexpr Tagged_t khourCycles_string = 0x38bd;
  static constexpr Tagged_t khoursDisplay_string = 0x38d5;
  static constexpr Tagged_t kideo_string = 0x38ed;
  static constexpr Tagged_t kignorePunctuation_string = 0x38fd;
  static constexpr Tagged_t kInvalid_Date_string = 0x391d;
  static constexpr Tagged_t kinteger_string = 0x3935;
  static constexpr Tagged_t kisWordLike_string = 0x3949;
  static constexpr Tagged_t kkana_string = 0x3961;
  static constexpr Tagged_t klanguage_string = 0x3971;
  static constexpr Tagged_t klanguageDisplay_string = 0x3985;
  static constexpr Tagged_t klessPrecision_string = 0x39a1;
  static constexpr Tagged_t kletter_string = 0x39bd;
  static constexpr Tagged_t klist_string = 0x39d1;
  static constexpr Tagged_t kliteral_string = 0x39e1;
  static constexpr Tagged_t klocale_string = 0x39f5;
  static constexpr Tagged_t kloose_string = 0x3a09;
  static constexpr Tagged_t klower_string = 0x3a1d;
  static constexpr Tagged_t kltr_string = 0x3a31;
  static constexpr Tagged_t kmaximumFractionDigits_string = 0x3a41;
  static constexpr Tagged_t kmaximumSignificantDigits_string = 0x3a65;
  static constexpr Tagged_t kmicrosecondsDisplay_string = 0x3a89;
  static constexpr Tagged_t kmillisecondsDisplay_string = 0x3aa9;
  static constexpr Tagged_t kmin2_string = 0x3ac9;
  static constexpr Tagged_t kminimalDays_string = 0x3ad9;
  static constexpr Tagged_t kminimumFractionDigits_string = 0x3af1;
  static constexpr Tagged_t kminimumIntegerDigits_string = 0x3b15;
  static constexpr Tagged_t kminimumSignificantDigits_string = 0x3b35;
  static constexpr Tagged_t kminus_0 = 0x3b59;
  static constexpr Tagged_t kminusSign_string = 0x3b69;
  static constexpr Tagged_t kminutesDisplay_string = 0x3b81;
  static constexpr Tagged_t kmonthsDisplay_string = 0x3b9d;
  static constexpr Tagged_t kmorePrecision_string = 0x3bb9;
  static constexpr Tagged_t knan_string = 0x3bd5;
  static constexpr Tagged_t knanosecondsDisplay_string = 0x3be5;
  static constexpr Tagged_t knarrowSymbol_string = 0x3c05;
  static constexpr Tagged_t knegative_string = 0x3c1d;
  static constexpr Tagged_t knever_string = 0x3c31;
  static constexpr Tagged_t knone_string = 0x3c45;
  static constexpr Tagged_t knotation_string = 0x3c55;
  static constexpr Tagged_t knormal_string = 0x3c69;
  static constexpr Tagged_t knumberingSystem_string = 0x3c7d;
  static constexpr Tagged_t knumberingSystems_string = 0x3c99;
  static constexpr Tagged_t knumeric_string = 0x3cb5;
  static constexpr Tagged_t kordinal_string = 0x3cc9;
  static constexpr Tagged_t kpercentSign_string = 0x3cdd;
  static constexpr Tagged_t kplusSign_string = 0x3cf5;
  static constexpr Tagged_t kquarter_string = 0x3d09;
  static constexpr Tagged_t kregion_string = 0x3d1d;
  static constexpr Tagged_t krelatedYear_string = 0x3d31;
  static constexpr Tagged_t kroundingMode_string = 0x3d49;
  static constexpr Tagged_t kroundingPriority_string = 0x3d61;
  static constexpr Tagged_t krtl_string = 0x3d7d;
  static constexpr Tagged_t kscientific_string = 0x3d8d;
  static constexpr Tagged_t ksecondsDisplay_string = 0x3da5;
  static constexpr Tagged_t ksegment_string = 0x3dc1;
  static constexpr Tagged_t kSegmentIterator_string = 0x3dd5;
  static constexpr Tagged_t kSegments_string = 0x3df1;
  static constexpr Tagged_t ksensitivity_string = 0x3e05;
  static constexpr Tagged_t ksep_string = 0x3e1d;
  static constexpr Tagged_t kshared_string = 0x3e2d;
  static constexpr Tagged_t ksignDisplay_string = 0x3e41;
  static constexpr Tagged_t kstandard_string = 0x3e59;
  static constexpr Tagged_t kstartRange_string = 0x3e6d;
  static constexpr Tagged_t kstrict_string = 0x3e85;
  static constexpr Tagged_t kstripIfInteger_string = 0x3e99;
  static constexpr Tagged_t kstyle_string = 0x3eb5;
  static constexpr Tagged_t kterm_string = 0x3ec9;
  static constexpr Tagged_t ktextInfo_string = 0x3ed9;
  static constexpr Tagged_t ktimeStyle_string = 0x3eed;
  static constexpr Tagged_t ktimeZones_string = 0x3f05;
  static constexpr Tagged_t ktimeZoneName_string = 0x3f1d;
  static constexpr Tagged_t ktrailingZeroDisplay_string = 0x3f35;
  static constexpr Tagged_t ktrunc_string = 0x3f55;
  static constexpr Tagged_t ktwo_digit_string = 0x3f69;
  static constexpr Tagged_t ktype_string = 0x3f7d;
  static constexpr Tagged_t kunknown_string = 0x3f8d;
  static constexpr Tagged_t kupper_string = 0x3fa1;
  static constexpr Tagged_t kusage_string = 0x3fb5;
  static constexpr Tagged_t kuseGrouping_string = 0x3fc9;
  static constexpr Tagged_t kunitDisplay_string = 0x3fe1;
  static constexpr Tagged_t kweekday_string = 0x3ff9;
  static constexpr Tagged_t kweekend_string = 0x400d;
  static constexpr Tagged_t kweeksDisplay_string = 0x4021;
  static constexpr Tagged_t kweekInfo_string = 0x4039;
  static constexpr Tagged_t kyearName_string = 0x404d;
  static constexpr Tagged_t kyearsDisplay_string = 0x4061;
  static constexpr Tagged_t kadd_string = 0x4079;
  static constexpr Tagged_t kAggregateError_string = 0x4089;
  static constexpr Tagged_t kalways_string = 0x40a5;
  static constexpr Tagged_t kanonymous_function_string = 0x40b9;
  static constexpr Tagged_t kanonymous_string = 0x40d9;
  static constexpr Tagged_t kapply_string = 0x40f1;
  static constexpr Tagged_t kArguments_string = 0x4105;
  static constexpr Tagged_t karguments_string = 0x411d;
  static constexpr Tagged_t karguments_to_string = 0x4135;
  static constexpr Tagged_t kArray_string = 0x4155;
  static constexpr Tagged_t karray_to_string = 0x4169;
  static constexpr Tagged_t kArrayBuffer_string = 0x4185;
  static constexpr Tagged_t kArrayIterator_string = 0x419d;
  static constexpr Tagged_t kas_string = 0x41b9;
  static constexpr Tagged_t kassert_string = 0x41c9;
  static constexpr Tagged_t kasync_string = 0x41dd;
  static constexpr Tagged_t kAtomicsCondition_string = 0x41f1;
  static constexpr Tagged_t kAtomicsMutex_string = 0x4211;
  static constexpr Tagged_t kauto_string = 0x422d;
  static constexpr Tagged_t kawait_string = 0x423d;
  static constexpr Tagged_t kBigInt_string = 0x4251;
  static constexpr Tagged_t kbigint_string = 0x4265;
  static constexpr Tagged_t kBigInt64Array_string = 0x4279;
  static constexpr Tagged_t kBigUint64Array_string = 0x4295;
  static constexpr Tagged_t kbind_string = 0x42b1;
  static constexpr Tagged_t kblank_string = 0x42c1;
  static constexpr Tagged_t kBoolean_string = 0x42d5;
  static constexpr Tagged_t kboolean_string = 0x42e9;
  static constexpr Tagged_t kboolean_to_string = 0x42fd;
  static constexpr Tagged_t kbound__string = 0x4319;
  static constexpr Tagged_t kbuffer_string = 0x432d;
  static constexpr Tagged_t kbyte_length_string = 0x4341;
  static constexpr Tagged_t kbyte_offset_string = 0x4359;
  static constexpr Tagged_t kCompileError_string = 0x4371;
  static constexpr Tagged_t kcalendar_string = 0x4389;
  static constexpr Tagged_t kcallee_string = 0x439d;
  static constexpr Tagged_t kcaller_string = 0x43b1;
  static constexpr Tagged_t kcause_string = 0x43c5;
  static constexpr Tagged_t kcharacter_string = 0x43d9;
  static constexpr Tagged_t kclosure_string = 0x43f1;
  static constexpr Tagged_t kcode_string = 0x4409;
  static constexpr Tagged_t kcolumn_string = 0x4419;
  static constexpr Tagged_t kcomputed_string = 0x442d;
  static constexpr Tagged_t kconjunction_string = 0x4445;
  static constexpr Tagged_t kconsole_string = 0x445d;
  static constexpr Tagged_t kconstrain_string = 0x4471;
  static constexpr Tagged_t kconstruct_string = 0x4489;
  static constexpr Tagged_t kcurrent_string = 0x44a1;
  static constexpr Tagged_t kDate_string = 0x44b5;
  static constexpr Tagged_t kdate_to_string = 0x44c5;
  static constexpr Tagged_t kdateAdd_string = 0x44e1;
  static constexpr Tagged_t kdateFromFields_string = 0x44f5;
  static constexpr Tagged_t kdateUntil_string = 0x4511;
  static constexpr Tagged_t kday_string = 0x4529;
  static constexpr Tagged_t kdayOfWeek_string = 0x4539;
  static constexpr Tagged_t kdayOfYear_string = 0x4551;
  static constexpr Tagged_t kdays_string = 0x4569;
  static constexpr Tagged_t kdaysInMonth_string = 0x4579;
  static constexpr Tagged_t kdaysInWeek_string = 0x4591;
  static constexpr Tagged_t kdaysInYear_string = 0x45a9;
  static constexpr Tagged_t kdefault_string = 0x45c1;
  static constexpr Tagged_t kdefineProperty_string = 0x45d5;
  static constexpr Tagged_t kdeleteProperty_string = 0x45f1;
  static constexpr Tagged_t kdetached_string = 0x460d;
  static constexpr Tagged_t kdisjunction_string = 0x4621;
  static constexpr Tagged_t kdone_string = 0x4639;
  static constexpr Tagged_t kdot_brand_string = 0x4649;
  static constexpr Tagged_t kdot_catch_string = 0x465d;
  static constexpr Tagged_t kdot_default_string = 0x4671;
  static constexpr Tagged_t kdot_for_string = 0x4685;
  static constexpr Tagged_t kdot_generator_object_string = 0x4695;
  static constexpr Tagged_t kdot_home_object_string = 0x46b5;
  static constexpr Tagged_t kdot_new_target_string = 0x46cd;
  static constexpr Tagged_t knew_target_string = 0x46cd;
  static constexpr Tagged_t kdot_result_string = 0x46e5;
  static constexpr Tagged_t kdot_repl_result_string = 0x46f9;
  static constexpr Tagged_t kdot_static_home_object_string = 0x4711;
  static constexpr Tagged_t kdot_switch_tag_string = 0x4731;
  static constexpr Tagged_t kdotAll_string = 0x4749;
  static constexpr Tagged_t kError_string = 0x475d;
  static constexpr Tagged_t kEvalError_string = 0x4771;
  static constexpr Tagged_t kelement_string = 0x4789;
  static constexpr Tagged_t kepochMicroseconds_string = 0x479d;
  static constexpr Tagged_t kepochMilliseconds_string = 0x47bd;
  static constexpr Tagged_t kepochNanoseconds_string = 0x47dd;
  static constexpr Tagged_t kepochSeconds_string = 0x47f9;
  static constexpr Tagged_t kera_string = 0x4811;
  static constexpr Tagged_t keraYear_string = 0x4821;
  static constexpr Tagged_t kerror_string = 0x4835;
  static constexpr Tagged_t kerrors_string = 0x4849;
  static constexpr Tagged_t kerror_to_string = 0x485d;
  static constexpr Tagged_t keval_string = 0x4879;
  static constexpr Tagged_t kexception_string = 0x4889;
  static constexpr Tagged_t kexec_string = 0x48a1;
  static constexpr Tagged_t kfalse_string = 0x48b1;
  static constexpr Tagged_t kfields_string = 0x48c5;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x48d9;
  static constexpr Tagged_t kflags_string = 0x48f9;
  static constexpr Tagged_t kFloat32Array_string = 0x490d;
  static constexpr Tagged_t kFloat64Array_string = 0x4925;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x493d;
  static constexpr Tagged_t kfrom_string = 0x4961;
  static constexpr Tagged_t kFunction_string = 0x4971;
  static constexpr Tagged_t kfunction_native_code_string = 0x4985;
  static constexpr Tagged_t kfunction_string = 0x49b1;
  static constexpr Tagged_t kfunction_to_string = 0x49c5;
  static constexpr Tagged_t kGenerator_string = 0x49e5;
  static constexpr Tagged_t kget_space_string = 0x49fd;
  static constexpr Tagged_t kget_string = 0x4a0d;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4a1d;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4a41;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4a65;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4a89;
  static constexpr Tagged_t kglobal_string = 0x4aa5;
  static constexpr Tagged_t kglobalThis_string = 0x4ab9;
  static constexpr Tagged_t kgroups_string = 0x4ad1;
  static constexpr Tagged_t kgrowable_string = 0x4ae5;
  static constexpr Tagged_t khas_string = 0x4af9;
  static constexpr Tagged_t khasIndices_string = 0x4b09;
  static constexpr Tagged_t khour_string = 0x4b21;
  static constexpr Tagged_t khours_string = 0x4b31;
  static constexpr Tagged_t khoursInDay_string = 0x4b45;
  static constexpr Tagged_t kignoreCase_string = 0x4b5d;
  static constexpr Tagged_t kid_string = 0x4b75;
  static constexpr Tagged_t killegal_access_string = 0x4b85;
  static constexpr Tagged_t killegal_argument_string = 0x4ba1;
  static constexpr Tagged_t kinLeapYear_string = 0x4bbd;
  static constexpr Tagged_t kindex_string = 0x4bd5;
  static constexpr Tagged_t kindices_string = 0x4be9;
  static constexpr Tagged_t kInfinity_string = 0x4bfd;
  static constexpr Tagged_t kinfinity_string = 0x4c11;
  static constexpr Tagged_t kinput_string = 0x4c25;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4c39;
  static constexpr Tagged_t kInt16Array_string = 0x4c65;
  static constexpr Tagged_t kInt32Array_string = 0x4c7d;
  static constexpr Tagged_t kInt8Array_string = 0x4c95;
  static constexpr Tagged_t kisExtensible_string = 0x4cad;
  static constexpr Tagged_t kiso8601_string = 0x4cc5;
  static constexpr Tagged_t kisoDay_string = 0x4cd9;
  static constexpr Tagged_t kisoHour_string = 0x4ced;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4d01;
  static constexpr Tagged_t kisoMillisecond_string = 0x4d1d;
  static constexpr Tagged_t kisoMinute_string = 0x4d39;
  static constexpr Tagged_t kisoMonth_string = 0x4d51;
  static constexpr Tagged_t kisoNanosecond_string = 0x4d65;
  static constexpr Tagged_t kisoSecond_string = 0x4d81;
  static constexpr Tagged_t kisoYear_string = 0x4d99;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4dad;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4dc9;
  static constexpr Tagged_t kkeys_string = 0x4de5;
  static constexpr Tagged_t klargestUnit_string = 0x4df5;
  static constexpr Tagged_t klastIndex_string = 0x4e0d;
  static constexpr Tagged_t klet_string = 0x4e25;
  static constexpr Tagged_t kline_string = 0x4e35;
  static constexpr Tagged_t klinear_string = 0x4e45;
  static constexpr Tagged_t kLinkError_string = 0x4e59;
  static constexpr Tagged_t klong_string = 0x4e71;
  static constexpr Tagged_t kMap_string = 0x4e81;
  static constexpr Tagged_t kMapIterator_string = 0x4e91;
  static constexpr Tagged_t kmax_byte_length_string = 0x4ea9;
  static constexpr Tagged_t kmedium_string = 0x4ec5;
  static constexpr Tagged_t kmergeFields_string = 0x4ed9;
  static constexpr Tagged_t kmessage_string = 0x4ef1;
  static constexpr Tagged_t kmeta_string = 0x4f05;
  static constexpr Tagged_t kminus_Infinity_string = 0x4f15;
  static constexpr Tagged_t kmicrosecond_string = 0x4f2d;
  static constexpr Tagged_t kmicroseconds_string = 0x4f45;
  static constexpr Tagged_t kmillisecond_string = 0x4f5d;
  static constexpr Tagged_t kmilliseconds_string = 0x4f75;
  static constexpr Tagged_t kminute_string = 0x4f8d;
  static constexpr Tagged_t kminutes_string = 0x4fa1;
  static constexpr Tagged_t kModule_string = 0x4fb5;
  static constexpr Tagged_t kmonth_string = 0x4fc9;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x4fdd;
  static constexpr Tagged_t kmonths_string = 0x4ffd;
  static constexpr Tagged_t kmonthsInYear_string = 0x5011;
  static constexpr Tagged_t kmonthCode_string = 0x5029;
  static constexpr Tagged_t kmultiline_string = 0x5041;
  static constexpr Tagged_t kNaN_string = 0x5059;
  static constexpr Tagged_t knanosecond_string = 0x5069;
  static constexpr Tagged_t knanoseconds_string = 0x5081;
  static constexpr Tagged_t knarrow_string = 0x5099;
  static constexpr Tagged_t knative_string = 0x50ad;
  static constexpr Tagged_t kNFC_string = 0x50c1;
  static constexpr Tagged_t kNFD_string = 0x50d1;
  static constexpr Tagged_t kNFKC_string = 0x50e1;
  static constexpr Tagged_t kNFKD_string = 0x50f1;
  static constexpr Tagged_t knot_equal_string = 0x5101;
  static constexpr Tagged_t knull_string = 0x5119;
  static constexpr Tagged_t knull_to_string = 0x5129;
  static constexpr Tagged_t kNumber_string = 0x5145;
  static constexpr Tagged_t knumber_string = 0x5159;
  static constexpr Tagged_t knumber_to_string = 0x516d;
  static constexpr Tagged_t kObject_string = 0x5189;
  static constexpr Tagged_t kobject_string = 0x519d;
  static constexpr Tagged_t kobject_to_string = 0x51b1;
  static constexpr Tagged_t kObject_prototype_string = 0x51cd;
  ...
  static constexpr Tagged_t kpromise_string = 0x531d;
  static constexpr Tagged_t kproto_string = 0x5331;
  static constexpr Tagged_t kproxy_string = 0x5349;
  static constexpr Tagged_t kProxy_string = 0x535d;
  static constexpr Tagged_t kquery_colon_string = 0x5371;
  static constexpr Tagged_t kRangeError_string = 0x5381;
  static constexpr Tagged_t kraw_json_string = 0x5399;
  static constexpr Tagged_t kraw_string = 0x53ad;
  static constexpr Tagged_t kReferenceError_string = 0x53bd;
  static constexpr Tagged_t kReflectGet_string = 0x53d9;
  static constexpr Tagged_t kReflectHas_string = 0x53f1;
  static constexpr Tagged_t kRegExp_string = 0x5409;
  static constexpr Tagged_t kregexp_to_string = 0x541d;
  static constexpr Tagged_t kreject_string = 0x5439;
  static constexpr Tagged_t krelativeTo_string = 0x544d;
  static constexpr Tagged_t kresizable_string = 0x5465;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x547d;
  static constexpr Tagged_t kreturn_string = 0x549d;
  static constexpr Tagged_t krevoke_string = 0x54b1;
  static constexpr Tagged_t kroundingIncrement_string = 0x54c5;
  static constexpr Tagged_t kRuntimeError_string = 0x54e5;
  static constexpr Tagged_t kWebAssemblyException_string = 0x54fd;
  static constexpr Tagged_t kScript_string = 0x5521;
  static constexpr Tagged_t kscript_string = 0x5535;
  static constexpr Tagged_t ksecond_string = 0x5549;
  static constexpr Tagged_t kseconds_string = 0x555d;
  static constexpr Tagged_t kshort_string = 0x5571;
  static constexpr Tagged_t kSet_string = 0x5585;
  static constexpr Tagged_t ksentence_string = 0x5595;
  static constexpr Tagged_t kset_space_string = 0x55a9;
  static constexpr Tagged_t kset_string = 0x55b9;
  static constexpr Tagged_t kSetIterator_string = 0x55c9;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x55e1;
  static constexpr Tagged_t kShadowRealm_string = 0x55fd;
  static constexpr Tagged_t kSharedArray_string = 0x5615;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x562d;
  static constexpr Tagged_t kSharedStruct_string = 0x564d;
  static constexpr Tagged_t ksign_string = 0x5665;
  static constexpr Tagged_t ksize_string = 0x5675;
  static constexpr Tagged_t ksmallestUnit_string = 0x5685;
  static constexpr Tagged_t ksource_string = 0x569d;
  static constexpr Tagged_t ksourceText_string = 0x56b1;
  static constexpr Tagged_t kstack_string = 0x56c9;
  static constexpr Tagged_t kstackTraceLimit_string = 0x56dd;
  static constexpr Tagged_t kstatic_initializer_string = 0x56f9;
  ...
  static constexpr Tagged_t ksuppressed_string = 0x5771;
  static constexpr Tagged_t kSuppressedError_string = 0x5789;
  static constexpr Tagged_t kSymbol_iterator_string = 0x57a5;
  static constexpr Tagged_t kSymbol_match_all_string = 0x57c1;
  static constexpr Tagged_t kSymbol_replace_string = 0x57dd;
  static constexpr Tagged_t ksymbol_species_string = 0x57f9;
  static constexpr Tagged_t kSymbol_species_string = 0x5815;
  static constexpr Tagged_t kSymbol_split_string = 0x5831;
  static constexpr Tagged_t kSymbol_string = 0x5849;
  static constexpr Tagged_t ksymbol_string = 0x585d;
  static constexpr Tagged_t kSyntaxError_string = 0x5871;
  static constexpr Tagged_t ktarget_string = 0x5889;
  static constexpr Tagged_t kthis_function_string = 0x589d;
  static constexpr Tagged_t kthis_string = 0x58b9;
  static constexpr Tagged_t kthrow_string = 0x58c9;
  static constexpr Tagged_t ktimed_out_string = 0x58dd;
  static constexpr Tagged_t ktimeZone_string = 0x58f5;
  static constexpr Tagged_t ktoJSON_string = 0x5909;
  static constexpr Tagged_t ktoString_string = 0x591d;
  static constexpr Tagged_t ktrue_string = 0x5931;
  static constexpr Tagged_t ktotal_string = 0x5941;
  static constexpr Tagged_t kTypeError_string = 0x5955;
  static constexpr Tagged_t kUint16Array_string = 0x596d;
  static constexpr Tagged_t kUint32Array_string = 0x5985;
  static constexpr Tagged_t kUint8Array_string = 0x599d;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x59b5;
  static constexpr Tagged_t kundefined_string = 0x59d5;
  static constexpr Tagged_t kundefined_to_string = 0x59ed;
  static constexpr Tagged_t kunicode_string = 0x5a0d;
  static constexpr Tagged_t kunicodeSets_string = 0x5a21;
  static constexpr Tagged_t kunit_string = 0x5a39;
  static constexpr Tagged_t kURIError_string = 0x5a49;
  static constexpr Tagged_t kUTC_string = 0x5a5d;
  static constexpr Tagged_t kvalueOf_string = 0x5a6d;
  static constexpr Tagged_t kWeakMap_string = 0x5a81;
  static constexpr Tagged_t kWeakRef_string = 0x5a95;
  static constexpr Tagged_t kWeakSet_string = 0x5aa9;
  static constexpr Tagged_t kweek_string = 0x5abd;
  static constexpr Tagged_t kweeks_string = 0x5acd;
  static constexpr Tagged_t kweekOfYear_string = 0x5ae1;
  static constexpr Tagged_t kwith_string = 0x5af9;
  static constexpr Tagged_t kword_string = 0x5b09;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5b19;
  static constexpr Tagged_t kyear_string = 0x5b39;
  static constexpr Tagged_t kyears_string = 0x5b49;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5b5d;
  static constexpr Tagged_t kHashTableHoleValue = 0x5b69;
  static constexpr Tagged_t kPromiseHoleValue = 0x5b75;
  static constexpr Tagged_t kUninitializedValue = 0x5b81;
  static constexpr Tagged_t kArgumentsMarker = 0x5b8d;
  static constexpr Tagged_t kTerminationException = 0x5b99;
  static constexpr Tagged_t kException = 0x5ba5;
  static constexpr Tagged_t kOptimizedOut = 0x5bb1;
  static constexpr Tagged_t kStaleRegister = 0x5bbd;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5bc9;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5bd5;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5be1;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5bf1;
  static constexpr Tagged_t kconsole_context_id_symbol = 0x5c01;
  static constexpr Tagged_t kconsole_context_name_symbol = 0x5c11;
  static constexpr Tagged_t kclass_fields_symbol = 0x5c21;
  static constexpr Tagged_t kclass_positions_symbol = 0x5c31;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5c41;
  static constexpr Tagged_t kerror_script_symbol = 0x5c51;
  static constexpr Tagged_t kerror_stack_symbol = 0x5c61;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5c71;
  static constexpr Tagged_t kfrozen_symbol = 0x5c81;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5c91;
  static constexpr Tagged_t knative_context_index_symbol = 0x5ca1;
  static constexpr Tagged_t knonextensible_symbol = 0x5cb1;
  static constexpr Tagged_t kpromise_debug_marker_symbol = 0x5cc1;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5cd1;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5ce1;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5cf1;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5d01;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5d11;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5d21;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5d31;
  static constexpr Tagged_t ksealed_symbol = 0x5d41;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5d51;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5d61;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5d71;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5d81;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5d91;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5da1;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5db1;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5dc1;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5dd1;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5de1;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5df1;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5e01;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5e31;
  static constexpr Tagged_t kmatch_symbol = 0x5e69;
  static constexpr Tagged_t ksearch_symbol = 0x5e91;
  static constexpr Tagged_t kto_primitive_symbol = 0x5ebd;
  static constexpr Tagged_t kunscopables_symbol = 0x5eed;
  static constexpr Tagged_t khas_instance_symbol = 0x5f1d;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5f4d;
  static constexpr Tagged_t kconstructor_string = 0x5fa5;
  static constexpr Tagged_t knext_string = 0x5fbd;
  static constexpr Tagged_t kresolve_string = 0x5fcd;
  static constexpr Tagged_t kthen_string = 0x5fe1;
  static constexpr Tagged_t kiterator_symbol = 0x5ff1;
  static constexpr Tagged_t kmatch_all_symbol = 0x6001;
  static constexpr Tagged_t kreplace_symbol = 0x6011;
  static constexpr Tagged_t kspecies_symbol = 0x6021;
  static constexpr Tagged_t ksplit_symbol = 0x6031;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x6041;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x6051;
  static constexpr Tagged_t kEmptySymbolTable = 0x6075;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x6091;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x60a5;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x60b9;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x60c5;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x60e5;
  static constexpr Tagged_t kNativeScopeInfo = 0x6109;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x6121;
  static constexpr Tagged_t kEmptyExternalPointerArray = 0x6139;
  static constexpr Tagged_t kWasmNullPadding = 0x6141;
...
static constexpr std::array<Tagged_t, 755> StaticReadOnlyRootsPointerTable = {
