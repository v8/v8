...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kAsyncGeneratorRequestMap = 0x112d;
  static constexpr Tagged_t kBreakPointMap = 0x1155;
  static constexpr Tagged_t kBreakPointInfoMap = 0x117d;
  static constexpr Tagged_t kBytecodeWrapperMap = 0x11a5;
  static constexpr Tagged_t kClassBoilerplateMap = 0x11cd;
  static constexpr Tagged_t kClassPositionsMap = 0x11f5;
  static constexpr Tagged_t kCodeWrapperMap = 0x121d;
  static constexpr Tagged_t kDebugInfoMap = 0x1245;
  static constexpr Tagged_t kErrorStackDataMap = 0x126d;
  static constexpr Tagged_t kFunctionTemplateRareDataMap = 0x1295;
  ...
  static constexpr Tagged_t kRegExpDataWrapperMap = 0x13ad;
  static constexpr Tagged_t kScriptMap = 0x13d5;
  static constexpr Tagged_t kScriptOrModuleMap = 0x13fd;
  static constexpr Tagged_t kSourceTextModuleInfoEntryMap = 0x1425;
  static constexpr Tagged_t kStackFrameInfoMap = 0x144d;
  static constexpr Tagged_t kStackTraceInfoMap = 0x1475;
  ...
  static constexpr Tagged_t kOnHeapBasicBlockProfilerDataMap = 0x167d;
  static constexpr Tagged_t kObjectTemplateInfoMap = 0x16a5;
  static constexpr Tagged_t kTurbofanBitsetTypeMap = 0x16cd;
  static constexpr Tagged_t kTurbofanUnionTypeMap = 0x16f5;
  static constexpr Tagged_t kTurbofanRangeTypeMap = 0x171d;
  static constexpr Tagged_t kTurbofanHeapConstantTypeMap = 0x1745;
  static constexpr Tagged_t kTurbofanOtherNumberConstantTypeMap = 0x176d;
  static constexpr Tagged_t kTurboshaftWord32TypeMap = 0x1795;
  static constexpr Tagged_t kTurboshaftWord32RangeTypeMap = 0x17bd;
  static constexpr Tagged_t kTurboshaftWord64TypeMap = 0x17e5;
  static constexpr Tagged_t kTurboshaftWord64RangeTypeMap = 0x180d;
  static constexpr Tagged_t kTurboshaftFloat64TypeMap = 0x1835;
  static constexpr Tagged_t kTurboshaftFloat64RangeTypeMap = 0x185d;
  static constexpr Tagged_t kInternalClassMap = 0x1885;
  static constexpr Tagged_t kSmiPairMap = 0x18ad;
  static constexpr Tagged_t kSmiBoxMap = 0x18d5;
  static constexpr Tagged_t kExportedSubClassBaseMap = 0x18fd;
  static constexpr Tagged_t kExportedSubClassMap = 0x1925;
  static constexpr Tagged_t kAbstractInternalClassSubclass1Map = 0x194d;
  static constexpr Tagged_t kAbstractInternalClassSubclass2Map = 0x1975;
  static constexpr Tagged_t kExportedSubClass2Map = 0x199d;
  static constexpr Tagged_t kSortStateMap = 0x19c5;
  static constexpr Tagged_t kSloppyArgumentsElementsMap = 0x19ed;
  static constexpr Tagged_t kStrongDescriptorArrayMap = 0x1a15;
  static constexpr Tagged_t kTurboshaftWord32SetTypeMap = 0x1a3d;
  static constexpr Tagged_t kTurboshaftWord64SetTypeMap = 0x1a65;
  static constexpr Tagged_t kTurboshaftFloat64SetTypeMap = 0x1a8d;
  static constexpr Tagged_t kInternalClassWithStructElementsMap = 0x1ab5;
  static constexpr Tagged_t kOrderedHashMapMap = 0x1add;
  static constexpr Tagged_t kOrderedHashSetMap = 0x1b05;
  static constexpr Tagged_t kSimpleNumberDictionaryMap = 0x1b2d;
  static constexpr Tagged_t kSimpleNameDictionaryMap = 0x1b55;
  static constexpr Tagged_t kNameToIndexHashTableMap = 0x1b7d;
  static constexpr Tagged_t kDoubleStringCacheMap = 0x1ba5;
  static constexpr Tagged_t kEmbedderDataArrayMap = 0x1bcd;
  static constexpr Tagged_t kEphemeronHashTableMap = 0x1bf5;
  static constexpr Tagged_t kScriptContextTableMap = 0x1c1d;
  static constexpr Tagged_t kObjectBoilerplateDescriptionMap = 0x1c45;
  static constexpr Tagged_t kCoverageInfoMap = 0x1c6d;
  static constexpr Tagged_t kRegExpMatchInfoMap = 0x1c95;
  static constexpr Tagged_t kRegExpDataMap = 0x1cbd;
  static constexpr Tagged_t kAtomRegExpDataMap = 0x1ce5;
  static constexpr Tagged_t kIrRegExpDataMap = 0x1d0d;
  static constexpr Tagged_t kSourceTextModuleMap = 0x1d35;
  static constexpr Tagged_t kSyntheticModuleMap = 0x1d5d;
  static constexpr Tagged_t kContextCellMap = 0x1d85;
  static constexpr Tagged_t kWeakCellMap = 0x1dad;
  static constexpr Tagged_t kInterpreterDataMap = 0x1dd5;
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataMap = 0x1dfd;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataMap = 0x1e25;
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataWithJobMap =
      0x1e4d;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataAndJobMap = 0x1e75;
  static constexpr Tagged_t kSharedFunctionInfoWrapperMap = 0x1e9d;
  static constexpr Tagged_t kDictionaryTemplateInfoMap = 0x1ec5;
  static constexpr Tagged_t kEmptyArrayList = 0x1eed;
  static constexpr Tagged_t kEmptyObjectBoilerplateDescription = 0x1ef9;
  static constexpr Tagged_t kEmptyArrayBoilerplateDescription = 0x1f09;
  static constexpr Tagged_t kEmptyClosureFeedbackCellArray = 0x1f15;
  static constexpr Tagged_t kEmptySwissPropertyDictionary = 0x1f29;
  static constexpr Tagged_t kadoptText_string = 0x1f49;
  static constexpr Tagged_t kapproximatelySign_string = 0x1f61;
  static constexpr Tagged_t kbaseName_string = 0x1f81;
  static constexpr Tagged_t kaccounting_string = 0x1f95;
  static constexpr Tagged_t kbreakType_string = 0x1fad;
  static constexpr Tagged_t kcalendars_string = 0x1fc5;
  static constexpr Tagged_t kcardinal_string = 0x1fdd;
  static constexpr Tagged_t kcaseFirst_string = 0x1ff1;
  static constexpr Tagged_t kceil_string = 0x2009;
  static constexpr Tagged_t kcompare_string = 0x2019;
  static constexpr Tagged_t kcollation_string = 0x202d;
  static constexpr Tagged_t kcollations_string = 0x2045;
  static constexpr Tagged_t kcompact_string = 0x205d;
  static constexpr Tagged_t kcompactDisplay_string = 0x2071;
  static constexpr Tagged_t kcurrency_string = 0x208d;
  static constexpr Tagged_t kcurrencyDisplay_string = 0x20a1;
  static constexpr Tagged_t kcurrencySign_string = 0x20bd;
  static constexpr Tagged_t kdateStyle_string = 0x20d5;
  static constexpr Tagged_t kdateTimeField_string = 0x20ed;
  static constexpr Tagged_t kdayPeriod_string = 0x2109;
  static constexpr Tagged_t kdaysDisplay_string = 0x2121;
  static constexpr Tagged_t kdecimal_string = 0x2139;
  static constexpr Tagged_t kdialect_string = 0x214d;
  static constexpr Tagged_t kdigital_string = 0x2161;
  static constexpr Tagged_t kendRange_string = 0x2175;
  static constexpr Tagged_t kengineering_string = 0x2189;
  static constexpr Tagged_t kexceptZero_string = 0x21a1;
  static constexpr Tagged_t kexpand_string = 0x21b9;
  static constexpr Tagged_t kexponentInteger_string = 0x21cd;
  static constexpr Tagged_t kexponentMinusSign_string = 0x21e9;
  static constexpr Tagged_t kexponentSeparator_string = 0x2209;
  static constexpr Tagged_t kfallback_string = 0x2229;
  static constexpr Tagged_t kfirst_string = 0x223d;
  static constexpr Tagged_t kfirstDay_string = 0x2251;
  static constexpr Tagged_t kfirstDayOfWeek_string = 0x2265;
  static constexpr Tagged_t kfloor_string = 0x2281;
  static constexpr Tagged_t kformat_string = 0x2295;
  static constexpr Tagged_t kformatMatcher_string = 0x22a9;
  static constexpr Tagged_t kfraction_string = 0x22c5;
  static constexpr Tagged_t kfractionalDigits_string = 0x22d9;
  static constexpr Tagged_t kfractionalSecond_string = 0x22f5;
  static constexpr Tagged_t kfull_string = 0x2311;
  static constexpr Tagged_t kgranularity_string = 0x2321;
  static constexpr Tagged_t kgrapheme_string = 0x2339;
  static constexpr Tagged_t kgroup_string = 0x234d;
  static constexpr Tagged_t kh11_string = 0x2361;
  static constexpr Tagged_t kh12_string = 0x2371;
  static constexpr Tagged_t kh23_string = 0x2381;
  static constexpr Tagged_t kh24_string = 0x2391;
  static constexpr Tagged_t khalfCeil_string = 0x23a1;
  static constexpr Tagged_t khalfEven_string = 0x23b5;
  static constexpr Tagged_t khalfExpand_string = 0x23c9;
  static constexpr Tagged_t khalfFloor_string = 0x23e1;
  static constexpr Tagged_t khalfTrunc_string = 0x23f9;
  static constexpr Tagged_t khour12_string = 0x2411;
  static constexpr Tagged_t khourCycle_string = 0x2425;
  static constexpr Tagged_t khourCycles_string = 0x243d;
  static constexpr Tagged_t khoursDisplay_string = 0x2455;
  static constexpr Tagged_t kideo_string = 0x246d;
  static constexpr Tagged_t kignorePunctuation_string = 0x247d;
  static constexpr Tagged_t kInvalid_Date_string = 0x249d;
  static constexpr Tagged_t kinteger_string = 0x24b5;
  static constexpr Tagged_t kisWordLike_string = 0x24c9;
  static constexpr Tagged_t kkana_string = 0x24e1;
  static constexpr Tagged_t klanguage_string = 0x24f1;
  static constexpr Tagged_t klanguageDisplay_string = 0x2505;
  static constexpr Tagged_t klessPrecision_string = 0x2521;
  static constexpr Tagged_t kletter_string = 0x253d;
  static constexpr Tagged_t klist_string = 0x2551;
  static constexpr Tagged_t kliteral_string = 0x2561;
  static constexpr Tagged_t klocale_string = 0x2575;
  static constexpr Tagged_t klocaleMatcher_string = 0x2589;
  static constexpr Tagged_t kloose_string = 0x25a5;
  static constexpr Tagged_t klower_string = 0x25b9;
  static constexpr Tagged_t kltr_string = 0x25cd;
  static constexpr Tagged_t kmaximumFractionDigits_string = 0x25dd;
  static constexpr Tagged_t kmaximumSignificantDigits_string = 0x2601;
  static constexpr Tagged_t kmicrosecondsDisplay_string = 0x2625;
  static constexpr Tagged_t kmillisecondsDisplay_string = 0x2645;
  static constexpr Tagged_t kmin2_string = 0x2665;
  static constexpr Tagged_t kminimalDays_string = 0x2675;
  static constexpr Tagged_t kminimumFractionDigits_string = 0x268d;
  static constexpr Tagged_t kminimumIntegerDigits_string = 0x26b1;
  static constexpr Tagged_t kminimumSignificantDigits_string = 0x26d1;
  static constexpr Tagged_t kminus_0 = 0x26f5;
  static constexpr Tagged_t kminusSign_string = 0x2705;
  static constexpr Tagged_t kminutesDisplay_string = 0x271d;
  static constexpr Tagged_t kmonthsDisplay_string = 0x2739;
  static constexpr Tagged_t kmorePrecision_string = 0x2755;
  static constexpr Tagged_t knan_string = 0x2771;
  static constexpr Tagged_t knanosecondsDisplay_string = 0x2781;
  static constexpr Tagged_t knarrowSymbol_string = 0x27a1;
  static constexpr Tagged_t knegative_string = 0x27b9;
  static constexpr Tagged_t knever_string = 0x27cd;
  static constexpr Tagged_t knone_string = 0x27e1;
  static constexpr Tagged_t knotation_string = 0x27f1;
  static constexpr Tagged_t knormal_string = 0x2805;
  static constexpr Tagged_t knumberingSystem_string = 0x2819;
  static constexpr Tagged_t knumberingSystems_string = 0x2835;
  static constexpr Tagged_t knumeric_string = 0x2851;
  static constexpr Tagged_t kordinal_string = 0x2865;
  static constexpr Tagged_t kpercentSign_string = 0x2879;
  static constexpr Tagged_t kplusSign_string = 0x2891;
  static constexpr Tagged_t kquarter_string = 0x28a5;
  static constexpr Tagged_t kregion_string = 0x28b9;
  static constexpr Tagged_t krelatedYear_string = 0x28cd;
  static constexpr Tagged_t kroundingPriority_string = 0x28e5;
  static constexpr Tagged_t krtl_string = 0x2901;
  static constexpr Tagged_t kscientific_string = 0x2911;
  static constexpr Tagged_t ksecondsDisplay_string = 0x2929;
  static constexpr Tagged_t ksegment_string = 0x2945;
  static constexpr Tagged_t kSegmentIterator_string = 0x2959;
  static constexpr Tagged_t kSegments_string = 0x2975;
  static constexpr Tagged_t ksensitivity_string = 0x2989;
  static constexpr Tagged_t ksep_string = 0x29a1;
  static constexpr Tagged_t kshared_string = 0x29b1;
  static constexpr Tagged_t ksignDisplay_string = 0x29c5;
  static constexpr Tagged_t kstandard_string = 0x29dd;
  static constexpr Tagged_t kstartRange_string = 0x29f1;
  static constexpr Tagged_t kstrict_string = 0x2a09;
  static constexpr Tagged_t kstripIfInteger_string = 0x2a1d;
  static constexpr Tagged_t kstyle_string = 0x2a39;
  static constexpr Tagged_t kterm_string = 0x2a4d;
  static constexpr Tagged_t ktextInfo_string = 0x2a5d;
  static constexpr Tagged_t ktimeStyle_string = 0x2a71;
  static constexpr Tagged_t ktimeZones_string = 0x2a89;
  ...
  static constexpr Tagged_t ktimeZoneName_string = 0x5555;
  static constexpr Tagged_t ktoJSON_string = 0x556d;
  static constexpr Tagged_t ktoString_string = 0x5581;
  static constexpr Tagged_t ktrue_string = 0x5595;
  static constexpr Tagged_t ktotal_string = 0x55a5;
  static constexpr Tagged_t kTypedArrayLength_string = 0x55b9;
  static constexpr Tagged_t kTypeError_string = 0x55e5;
  static constexpr Tagged_t kUint16Array_string = 0x55fd;
  static constexpr Tagged_t kUint32Array_string = 0x5615;
  static constexpr Tagged_t kUint8Array_string = 0x562d;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5645;
  static constexpr Tagged_t kundefined_string = 0x5665;
  static constexpr Tagged_t kundefined_to_string = 0x567d;
  static constexpr Tagged_t kunicode_string = 0x569d;
  static constexpr Tagged_t kunicodeSets_string = 0x56b1;
  static constexpr Tagged_t kunit_string = 0x56c9;
  static constexpr Tagged_t kURIError_string = 0x56d9;
  static constexpr Tagged_t kUTC_string = 0x56ed;
  static constexpr Tagged_t kWeakMap_string = 0x56fd;
  static constexpr Tagged_t kWeakRef_string = 0x5711;
  static constexpr Tagged_t kWeakSet_string = 0x5725;
  static constexpr Tagged_t kweek_string = 0x5739;
  static constexpr Tagged_t kweeks_string = 0x5749;
  static constexpr Tagged_t kweekOfYear_string = 0x575d;
  static constexpr Tagged_t kwith_string = 0x5775;
  static constexpr Tagged_t kword_string = 0x5785;
  static constexpr Tagged_t kwritten_string = 0x5795;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x57a9;
  static constexpr Tagged_t kyear_string = 0x57c9;
  static constexpr Tagged_t kyears_string = 0x57d9;
  static constexpr Tagged_t kyearOfWeek_string = 0x57ed;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5805;
  static constexpr Tagged_t kHashTableHoleValue = 0x5811;
  static constexpr Tagged_t kPromiseHoleValue = 0x581d;
  static constexpr Tagged_t kUninitializedValue = 0x5829;
  static constexpr Tagged_t kArgumentsMarker = 0x5835;
  static constexpr Tagged_t kTerminationException = 0x5841;
  static constexpr Tagged_t kException = 0x584d;
  static constexpr Tagged_t kOptimizedOut = 0x5859;
  static constexpr Tagged_t kStaleRegister = 0x5865;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5871;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x587d;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5889;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5899;
  static constexpr Tagged_t kclass_fields_symbol = 0x58a9;
  static constexpr Tagged_t kclass_positions_symbol = 0x58b9;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x58c9;
  static constexpr Tagged_t kerror_message_symbol = 0x58d9;
  static constexpr Tagged_t kerror_script_symbol = 0x58e9;
  static constexpr Tagged_t kerror_stack_symbol = 0x58f9;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5909;
  static constexpr Tagged_t kfrozen_symbol = 0x5919;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5929;
  static constexpr Tagged_t knative_context_index_symbol = 0x5939;
  static constexpr Tagged_t knonextensible_symbol = 0x5949;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5959;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5969;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5979;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5989;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5999;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x59a9;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x59b9;
  static constexpr Tagged_t ksealed_symbol = 0x59c9;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x59d9;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x59e9;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x59f9;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5a09;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5a19;
  static constexpr Tagged_t kwasm_asm_single_function_symbol = 0x5a29;
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x5a39;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5a49;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5a59;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5a69;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5a79;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5a89;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5a99;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5ac9;
  static constexpr Tagged_t kmatch_symbol = 0x5b01;
  static constexpr Tagged_t ksearch_symbol = 0x5b29;
  static constexpr Tagged_t kunscopables_symbol = 0x5b55;
  static constexpr Tagged_t kdispose_symbol = 0x5b85;
  static constexpr Tagged_t kasync_dispose_symbol = 0x5bb1;
  static constexpr Tagged_t khas_instance_symbol = 0x5be1;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5c11;
  static constexpr Tagged_t kconstructor_string = 0x5c89;
  static constexpr Tagged_t knext_string = 0x5ca1;
  static constexpr Tagged_t kresolve_string = 0x5cb1;
  static constexpr Tagged_t kthen_string = 0x5cc5;
  static constexpr Tagged_t kvalueOf_string = 0x5cd5;
  static constexpr Tagged_t kiterator_symbol = 0x5ce9;
  static constexpr Tagged_t kmatch_all_symbol = 0x5cf9;
  static constexpr Tagged_t kreplace_symbol = 0x5d09;
  static constexpr Tagged_t kspecies_symbol = 0x5d19;
  static constexpr Tagged_t ksplit_symbol = 0x5d29;
  static constexpr Tagged_t kto_primitive_symbol = 0x5d39;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x5d49;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x5d59;
  static constexpr Tagged_t kEmptySymbolTable = 0x5d7d;
  static constexpr Tagged_t kUndefinedContextCell = 0x5d99;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x5db1;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x5dc5;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x5dd9;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x5de5;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x5e05;
  static constexpr Tagged_t kNativeScopeInfo = 0x5e29;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x5e41;
  static constexpr Tagged_t kManyClosuresCell = 0x5e59;
  static constexpr Tagged_t kPreallocatedNumberStringTable = 0x5e69;
  static constexpr Tagged_t kJSMessageObjectMap = 0x65a1;
  static constexpr Tagged_t kExternalMap = 0x65c9;
  static constexpr Tagged_t kCppHeapExternalMap = 0x65f1;
  static constexpr Tagged_t kJSSharedArrayMap = 0x6619;
  static constexpr Tagged_t kJSAtomicsMutexMap = 0x6661;
  static constexpr Tagged_t kJSAtomicsConditionMap = 0x6689;
  static constexpr Tagged_t kNoOpInterceptorInfo = 0x66b1;

  static constexpr Tagged_t kFirstAllocatedRoot = 0x11;
  static constexpr Tagged_t kLastAllocatedRoot = 0x66b1;
};
