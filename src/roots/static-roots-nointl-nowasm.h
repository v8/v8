...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kDeferred_Module_string = 0x34cd;
  static constexpr Tagged_t kdefineProperty_string = 0x34e9;
  static constexpr Tagged_t kdeleteProperty_string = 0x3505;
  static constexpr Tagged_t kdetached_string = 0x3521;
  static constexpr Tagged_t kdirection_string = 0x3535;
  static constexpr Tagged_t kdisambiguation_string = 0x354d;
  static constexpr Tagged_t kdisjunction_string = 0x3569;
  static constexpr Tagged_t kdisposed_string = 0x3581;
  static constexpr Tagged_t kdone_string = 0x3595;
  static constexpr Tagged_t kdot_brand_string = 0x35a5;
  static constexpr Tagged_t kdot_catch_string = 0x35b9;
  static constexpr Tagged_t kdot_default_string = 0x35cd;
  static constexpr Tagged_t kdot_for_string = 0x35e1;
  static constexpr Tagged_t kdot_generator_object_string = 0x35f1;
  static constexpr Tagged_t kdot_home_object_string = 0x3611;
  static constexpr Tagged_t kdot_new_target_string = 0x3629;
  static constexpr Tagged_t kdot_repl_result_string = 0x3641;
  static constexpr Tagged_t kdot_result_string = 0x3659;
  static constexpr Tagged_t kdot_static_home_object_string = 0x366d;
  static constexpr Tagged_t kdot_switch_tag_string = 0x368d;
  static constexpr Tagged_t kdot_this_function_string = 0x36a5;
  static constexpr Tagged_t kdotAll_string = 0x36c1;
  static constexpr Tagged_t kelement_string = 0x36d5;
  static constexpr Tagged_t kepochMilliseconds_string = 0x36e9;
  static constexpr Tagged_t kepochNanoseconds_string = 0x3709;
  static constexpr Tagged_t kera_string = 0x3725;
  static constexpr Tagged_t keraYear_string = 0x3735;
  static constexpr Tagged_t kError_string = 0x3749;
  static constexpr Tagged_t kerror_string = 0x375d;
  static constexpr Tagged_t kerror_to_string = 0x3771;
  static constexpr Tagged_t kerrors_string = 0x378d;
  static constexpr Tagged_t keval_string = 0x37a1;
  static constexpr Tagged_t kEvalError_string = 0x37b1;
  static constexpr Tagged_t kexception_string = 0x37c9;
  static constexpr Tagged_t kexec_string = 0x37e1;
  static constexpr Tagged_t kfalse_string = 0x37f1;
  static constexpr Tagged_t kfields_string = 0x3805;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x3819;
  static constexpr Tagged_t kflags_string = 0x3839;
  static constexpr Tagged_t kFloat16Array_string = 0x384d;
  static constexpr Tagged_t kFloat32Array_string = 0x3865;
  static constexpr Tagged_t kFloat64Array_string = 0x387d;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x3895;
  static constexpr Tagged_t kfrom_string = 0x38b9;
  static constexpr Tagged_t kfunction_native_code_string = 0x38c9;
  static constexpr Tagged_t kFunction_prototype_apply_string = 0x38f5;
  static constexpr Tagged_t kFunction_prototype_call_string = 0x3919;
  static constexpr Tagged_t kFunction_string = 0x393d;
  static constexpr Tagged_t kfunction_string = 0x3951;
  static constexpr Tagged_t kfunction_to_string = 0x3965;
  static constexpr Tagged_t kGenerator_string = 0x3985;
  static constexpr Tagged_t kget_space_string = 0x399d;
  static constexpr Tagged_t kget_string = 0x39ad;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x39bd;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x39e1;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x3a05;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x3a29;
  static constexpr Tagged_t kgetTimeZoneTransition_string = 0x3a45;
  static constexpr Tagged_t kglobal_string = 0x3a69;
  static constexpr Tagged_t kglobalThis_string = 0x3a7d;
  static constexpr Tagged_t kgroups_string = 0x3a95;
  static constexpr Tagged_t kgrowable_string = 0x3aa9;
  static constexpr Tagged_t khas_string = 0x3abd;
  static constexpr Tagged_t khasIndices_string = 0x3acd;
  static constexpr Tagged_t khour_string = 0x3ae5;
  static constexpr Tagged_t khours_string = 0x3af5;
  static constexpr Tagged_t khoursInDay_string = 0x3b09;
  static constexpr Tagged_t kid_string = 0x3b21;
  static constexpr Tagged_t kignoreCase_string = 0x3b31;
  static constexpr Tagged_t killegal_access_string = 0x3b49;
  static constexpr Tagged_t killegal_argument_string = 0x3b65;
  static constexpr Tagged_t kimmutable_string = 0x3b81;
  static constexpr Tagged_t kindex_string = 0x3b99;
  static constexpr Tagged_t kindices_string = 0x3bad;
  static constexpr Tagged_t kInfinity_string = 0x3bc1;
  static constexpr Tagged_t kinfinity_string = 0x3bd5;
  static constexpr Tagged_t kinLeapYear_string = 0x3be9;
  static constexpr Tagged_t kinput_string = 0x3c01;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x3c15;
  static constexpr Tagged_t kInt16Array_string = 0x3c41;
  static constexpr Tagged_t kInt32Array_string = 0x3c59;
  static constexpr Tagged_t kInt8Array_string = 0x3c71;
  static constexpr Tagged_t kisExtensible_string = 0x3c89;
  static constexpr Tagged_t kiso8601_string = 0x3ca1;
  static constexpr Tagged_t kisoDay_string = 0x3cb5;
  static constexpr Tagged_t kisoHour_string = 0x3cc9;
  static constexpr Tagged_t kisoMicrosecond_string = 0x3cdd;
  static constexpr Tagged_t kisoMillisecond_string = 0x3cf9;
  static constexpr Tagged_t kisoMinute_string = 0x3d15;
  static constexpr Tagged_t kisoMonth_string = 0x3d2d;
  static constexpr Tagged_t kisoNanosecond_string = 0x3d41;
  static constexpr Tagged_t kisoSecond_string = 0x3d5d;
  static constexpr Tagged_t kisoYear_string = 0x3d75;
  static constexpr Tagged_t kIterator_string = 0x3d89;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x3d9d;
  static constexpr Tagged_t kjsMemoryRange_string = 0x3db9;
  static constexpr Tagged_t kkeys_string = 0x3dd5;
  static constexpr Tagged_t klargestUnit_string = 0x3de5;
  static constexpr Tagged_t klast_chunk_handling_string = 0x3dfd;
  static constexpr Tagged_t klastIndex_string = 0x3e1d;
  static constexpr Tagged_t klet_string = 0x3e35;
  static constexpr Tagged_t kline_string = 0x3e45;
  static constexpr Tagged_t klinear_string = 0x3e55;
  static constexpr Tagged_t kLinkError_string = 0x3e69;
  static constexpr Tagged_t klong_string = 0x3e81;
  static constexpr Tagged_t kMap_string = 0x3e91;
  static constexpr Tagged_t kMapIterator_string = 0x3ea1;
  static constexpr Tagged_t kmax_byte_length_string = 0x3eb9;
  static constexpr Tagged_t kmedium_string = 0x3ed5;
  static constexpr Tagged_t kmergeFields_string = 0x3ee9;
  static constexpr Tagged_t kmessage_string = 0x3f01;
  static constexpr Tagged_t kmeta_string = 0x3f15;
  static constexpr Tagged_t kmicrosecond_string = 0x3f25;
  static constexpr Tagged_t kmicroseconds_string = 0x3f3d;
  static constexpr Tagged_t kmillisecond_string = 0x3f55;
  static constexpr Tagged_t kmilliseconds_string = 0x3f6d;
  static constexpr Tagged_t kminus_Infinity_string = 0x3f85;
  static constexpr Tagged_t kminute_string = 0x3f9d;
  static constexpr Tagged_t kminutes_string = 0x3fb1;
  static constexpr Tagged_t kModule_string = 0x3fc5;
  static constexpr Tagged_t kmonth_string = 0x3fd9;
  static constexpr Tagged_t kmonthCode_string = 0x3fed;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x4005;
  static constexpr Tagged_t kmonths_string = 0x4025;
  static constexpr Tagged_t kmonthsInYear_string = 0x4039;
  static constexpr Tagged_t kmultiline_string = 0x4051;
  static constexpr Tagged_t kNaN_string = 0x4069;
  static constexpr Tagged_t knanosecond_string = 0x4079;
  static constexpr Tagged_t knanoseconds_string = 0x4091;
  static constexpr Tagged_t knarrow_string = 0x40a9;
  static constexpr Tagged_t knative_string = 0x40bd;
  static constexpr Tagged_t kNFC_string = 0x40d1;
  static constexpr Tagged_t kNFD_string = 0x40e1;
  static constexpr Tagged_t kNFKC_string = 0x40f1;
  static constexpr Tagged_t kNFKD_string = 0x4101;
  static constexpr Tagged_t knot_equal_string = 0x4111;
  static constexpr Tagged_t knull_string = 0x4129;
  static constexpr Tagged_t knull_to_string = 0x4139;
  static constexpr Tagged_t kNumber_string = 0x4155;
  static constexpr Tagged_t knumber_string = 0x4169;
  static constexpr Tagged_t knumber_to_string = 0x417d;
  static constexpr Tagged_t kObject_prototype_string = 0x4199;
  static constexpr Tagged_t kObject_string = 0x41b5;
  static constexpr Tagged_t kobject_string = 0x41c9;
  static constexpr Tagged_t kobject_to_string = 0x41dd;
  static constexpr Tagged_t koffset_string = 0x41f9;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x420d;
  static constexpr Tagged_t kok_string = 0x422d;
  static constexpr Tagged_t kother_string = 0x423d;
  static constexpr Tagged_t koverflow_string = 0x4251;
  static constexpr Tagged_t kownKeys_string = 0x4265;
  static constexpr Tagged_t kpercent_string = 0x4279;
  static constexpr Tagged_t kplainDate_string = 0x428d;
  static constexpr Tagged_t kplainTime_string = 0x42a5;
  static constexpr Tagged_t kposition_string = 0x42bd;
  static constexpr Tagged_t kpreventExtensions_string = 0x42d1;
  static constexpr Tagged_t kprivate_constructor_string = 0x42f1;
  static constexpr Tagged_t kPromise_string = 0x4309;
  static constexpr Tagged_t kpromise_string = 0x431d;
  static constexpr Tagged_t kproto_string = 0x4331;
  static constexpr Tagged_t kproxy_string = 0x4349;
  static constexpr Tagged_t kProxy_string = 0x435d;
  static constexpr Tagged_t kquery_colon_string = 0x4371;
  static constexpr Tagged_t kRangeError_string = 0x4381;
  static constexpr Tagged_t kraw_json_string = 0x4399;
  static constexpr Tagged_t kraw_string = 0x43ad;
  static constexpr Tagged_t kread_string = 0x43bd;
  static constexpr Tagged_t kReferenceError_string = 0x43cd;
  static constexpr Tagged_t kReflectGet_string = 0x43e9;
  static constexpr Tagged_t kReflectHas_string = 0x4401;
  static constexpr Tagged_t kRegExp_string = 0x4419;
  static constexpr Tagged_t kregexp_to_string = 0x442d;
  static constexpr Tagged_t kreject_string = 0x4449;
  static constexpr Tagged_t krelativeTo_string = 0x445d;
  static constexpr Tagged_t kresizable_string = 0x4475;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x448d;
  static constexpr Tagged_t kreturn_string = 0x44ad;
  static constexpr Tagged_t krevoke_string = 0x44c1;
  static constexpr Tagged_t kroundingIncrement_string = 0x44d5;
  static constexpr Tagged_t kroundingMode_string = 0x44f5;
  static constexpr Tagged_t kRuntimeError_string = 0x450d;
  static constexpr Tagged_t kScript_string = 0x4525;
  static constexpr Tagged_t kscript_string = 0x4539;
  static constexpr Tagged_t ksecond_string = 0x454d;
  static constexpr Tagged_t kseconds_string = 0x4561;
  static constexpr Tagged_t ksentence_string = 0x4575;
  static constexpr Tagged_t kset_space_string = 0x4589;
  static constexpr Tagged_t kSet_string = 0x4599;
  static constexpr Tagged_t kset_string = 0x45a9;
  static constexpr Tagged_t kSetIterator_string = 0x45b9;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x45d1;
  static constexpr Tagged_t kShadowRealm_string = 0x45ed;
  static constexpr Tagged_t kSharedArray_string = 0x4605;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x461d;
  static constexpr Tagged_t kSharedStruct_string = 0x463d;
  static constexpr Tagged_t kshort_string = 0x4655;
  static constexpr Tagged_t ksign_string = 0x4669;
  static constexpr Tagged_t ksize_string = 0x4679;
  static constexpr Tagged_t ksmallestUnit_string = 0x4689;
  static constexpr Tagged_t ksource_string = 0x46a1;
  static constexpr Tagged_t ksourceText_string = 0x46b5;
  static constexpr Tagged_t kstack_string = 0x46cd;
  static constexpr Tagged_t kstackTraceLimit_string = 0x46e1;
  static constexpr Tagged_t kstatic_initializer_string = 0x46fd;
  static constexpr Tagged_t ksticky_string = 0x471d;
  static constexpr Tagged_t kString_string = 0x4731;
  static constexpr Tagged_t kstring_string = 0x4745;
  static constexpr Tagged_t kstring_to_string = 0x4759;
  static constexpr Tagged_t ksuppressed_string = 0x4775;
  static constexpr Tagged_t kSuppressedError_string = 0x478d;
  static constexpr Tagged_t kSuspendError_string = 0x47a9;
  static constexpr Tagged_t kSymbol_iterator_string = 0x47c1;
  static constexpr Tagged_t kSymbol_match_all_string = 0x47dd;
  static constexpr Tagged_t kSymbol_replace_string = 0x47f9;
  static constexpr Tagged_t ksymbol_species_string = 0x4815;
  static constexpr Tagged_t kSymbol_species_string = 0x4831;
  static constexpr Tagged_t kSymbol_split_string = 0x484d;
  static constexpr Tagged_t kSymbol_string = 0x4865;
  static constexpr Tagged_t ksymbol_string = 0x4879;
  static constexpr Tagged_t kSyntaxError_string = 0x488d;
  static constexpr Tagged_t ktarget_string = 0x48a5;
  static constexpr Tagged_t kthis_string = 0x48b9;
  static constexpr Tagged_t kthrow_string = 0x48c9;
  static constexpr Tagged_t ktimed_out_string = 0x48dd;
  static constexpr Tagged_t ktimeZone_string = 0x48f5;
  static constexpr Tagged_t ktimeZoneId_string = 0x4909;
  static constexpr Tagged_t ktimeZoneName_string = 0x4921;
  static constexpr Tagged_t ktoJSON_string = 0x4939;
  static constexpr Tagged_t ktoString_string = 0x494d;
  static constexpr Tagged_t ktotal_string = 0x4961;
  static constexpr Tagged_t ktrue_string = 0x4975;
  static constexpr Tagged_t kTypedArrayLength_string = 0x4985;
  static constexpr Tagged_t kTypeError_string = 0x49b1;
  static constexpr Tagged_t kUint16Array_string = 0x49c9;
  static constexpr Tagged_t kUint32Array_string = 0x49e1;
  static constexpr Tagged_t kUint8Array_string = 0x49f9;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x4a11;
  static constexpr Tagged_t kundefined_string = 0x4a31;
  static constexpr Tagged_t kundefined_to_string = 0x4a49;
  static constexpr Tagged_t kunicode_string = 0x4a69;
  static constexpr Tagged_t kunicodeSets_string = 0x4a7d;
  static constexpr Tagged_t kunit_string = 0x4a95;
  static constexpr Tagged_t kURIError_string = 0x4aa5;
  static constexpr Tagged_t kUTC_string = 0x4ab9;
  static constexpr Tagged_t kWeakMap_string = 0x4ac9;
  static constexpr Tagged_t kWeakRef_string = 0x4add;
  static constexpr Tagged_t kWeakSet_string = 0x4af1;
  static constexpr Tagged_t kWebAssemblyException_string = 0x4b05;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x4b29;
  static constexpr Tagged_t kweek_string = 0x4b49;
  static constexpr Tagged_t kweekOfYear_string = 0x4b59;
  static constexpr Tagged_t kweeks_string = 0x4b71;
  static constexpr Tagged_t kwith_string = 0x4b85;
  static constexpr Tagged_t kword_string = 0x4b95;
  static constexpr Tagged_t kwritten_string = 0x4ba5;
  static constexpr Tagged_t kyear_string = 0x4bb9;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x4bc9;
  static constexpr Tagged_t kyearOfWeek_string = 0x4be9;
  static constexpr Tagged_t kyears_string = 0x4c01;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x4c15;
  static constexpr Tagged_t kcall_site_info_symbol = 0x4c25;
  static constexpr Tagged_t kclass_fields_symbol = 0x4c35;
  static constexpr Tagged_t kclass_positions_symbol = 0x4c45;
  static constexpr Tagged_t kdetached_symbol = 0x4c55;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x4c65;
  static constexpr Tagged_t kerror_message_symbol = 0x4c75;
  static constexpr Tagged_t kerror_script_symbol = 0x4c85;
  static constexpr Tagged_t kerror_stack_symbol = 0x4c95;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x4ca5;
  static constexpr Tagged_t kfrozen_symbol = 0x4cb5;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x4cc5;
  static constexpr Tagged_t knative_context_index_symbol = 0x4cd5;
  static constexpr Tagged_t knonextensible_symbol = 0x4ce5;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x4cf5;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x4d05;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x4d15;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x4d25;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x4d35;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x4d45;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x4d55;
  static constexpr Tagged_t ksealed_symbol = 0x4d65;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x4d75;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x4d85;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x4d95;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x4da5;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x4db5;
  static constexpr Tagged_t kwasm_asm_single_function_symbol = 0x4dc5;
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x4dd5;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x4de5;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x4df5;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x4e05;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x4e15;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x4e25;
  static constexpr Tagged_t kasync_iterator_symbol = 0x4e35;
  static constexpr Tagged_t kintl_fallback_symbol = 0x4e65;
  static constexpr Tagged_t kmatch_symbol = 0x4e9d;
  static constexpr Tagged_t ksearch_symbol = 0x4ec5;
  static constexpr Tagged_t kunscopables_symbol = 0x4ef1;
  static constexpr Tagged_t kdispose_symbol = 0x4f21;
  static constexpr Tagged_t kasync_dispose_symbol = 0x4f4d;
  static constexpr Tagged_t khas_instance_symbol = 0x4f7d;
  static constexpr Tagged_t kto_string_tag_symbol = 0x4fad;
  static constexpr Tagged_t kconstructor_string = 0x5025;
  static constexpr Tagged_t knext_string = 0x503d;
  static constexpr Tagged_t kresolve_string = 0x504d;
  static constexpr Tagged_t kthen_string = 0x5061;
  static constexpr Tagged_t kvalueOf_string = 0x5071;
  static constexpr Tagged_t kiterator_symbol = 0x5085;
  static constexpr Tagged_t kmatch_all_symbol = 0x5095;
  static constexpr Tagged_t kreplace_symbol = 0x50a5;
  static constexpr Tagged_t kspecies_symbol = 0x50b5;
  static constexpr Tagged_t ksplit_symbol = 0x50c5;
  static constexpr Tagged_t kto_primitive_symbol = 0x50d5;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x50e5;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x50f5;
  static constexpr Tagged_t kEmptySymbolTable = 0x5119;
  static constexpr Tagged_t kUndefinedContextCell = 0x5135;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x514d;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x5161;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x5175;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x5181;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x51a1;
  static constexpr Tagged_t kNativeScopeInfo = 0x51c9;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x51e1;
  static constexpr Tagged_t kManyClosuresCell = 0x51f9;
  static constexpr Tagged_t kPreallocatedNumberStringTable = 0x5209;
