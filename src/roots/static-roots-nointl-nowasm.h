...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kimmutable_string = 0x3b59;
  static constexpr Tagged_t kindex_string = 0x3b71;
  static constexpr Tagged_t kindices_string = 0x3b85;
  static constexpr Tagged_t kInfinity_string = 0x3b99;
  static constexpr Tagged_t kinfinity_string = 0x3bad;
  static constexpr Tagged_t kinLeapYear_string = 0x3bc1;
  static constexpr Tagged_t kinput_string = 0x3bd9;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x3bed;
  static constexpr Tagged_t kInt16Array_string = 0x3c19;
  static constexpr Tagged_t kInt32Array_string = 0x3c31;
  static constexpr Tagged_t kInt8Array_string = 0x3c49;
  static constexpr Tagged_t kisExtensible_string = 0x3c61;
  static constexpr Tagged_t kiso8601_string = 0x3c79;
  static constexpr Tagged_t kisoDay_string = 0x3c8d;
  static constexpr Tagged_t kisoHour_string = 0x3ca1;
  static constexpr Tagged_t kisoMicrosecond_string = 0x3cb5;
  static constexpr Tagged_t kisoMillisecond_string = 0x3cd1;
  static constexpr Tagged_t kisoMinute_string = 0x3ced;
  static constexpr Tagged_t kisoMonth_string = 0x3d05;
  static constexpr Tagged_t kisoNanosecond_string = 0x3d19;
  static constexpr Tagged_t kisoSecond_string = 0x3d35;
  static constexpr Tagged_t kisoYear_string = 0x3d4d;
  static constexpr Tagged_t kIterator_string = 0x3d61;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x3d75;
  static constexpr Tagged_t kjsMemoryRange_string = 0x3d91;
  static constexpr Tagged_t kkeys_string = 0x3dad;
  static constexpr Tagged_t klargestUnit_string = 0x3dbd;
  static constexpr Tagged_t klast_chunk_handling_string = 0x3dd5;
  static constexpr Tagged_t klastIndex_string = 0x3df5;
  static constexpr Tagged_t klet_string = 0x3e0d;
  static constexpr Tagged_t kline_string = 0x3e1d;
  static constexpr Tagged_t klinear_string = 0x3e2d;
  static constexpr Tagged_t kLinkError_string = 0x3e41;
  static constexpr Tagged_t klong_string = 0x3e59;
  static constexpr Tagged_t kMap_string = 0x3e69;
  static constexpr Tagged_t kMapIterator_string = 0x3e79;
  static constexpr Tagged_t kmax_byte_length_string = 0x3e91;
  static constexpr Tagged_t kmedium_string = 0x3ead;
  static constexpr Tagged_t kmergeFields_string = 0x3ec1;
  static constexpr Tagged_t kmessage_string = 0x3ed9;
  static constexpr Tagged_t kmeta_string = 0x3eed;
  static constexpr Tagged_t kmicrosecond_string = 0x3efd;
  static constexpr Tagged_t kmicroseconds_string = 0x3f15;
  static constexpr Tagged_t kmillisecond_string = 0x3f2d;
  static constexpr Tagged_t kmilliseconds_string = 0x3f45;
  static constexpr Tagged_t kminus_Infinity_string = 0x3f5d;
  static constexpr Tagged_t kminute_string = 0x3f75;
  static constexpr Tagged_t kminutes_string = 0x3f89;
  static constexpr Tagged_t kModule_string = 0x3f9d;
  static constexpr Tagged_t kmonth_string = 0x3fb1;
  static constexpr Tagged_t kmonthCode_string = 0x3fc5;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x3fdd;
  static constexpr Tagged_t kmonths_string = 0x3ffd;
  static constexpr Tagged_t kmonthsInYear_string = 0x4011;
  static constexpr Tagged_t kmultiline_string = 0x4029;
  static constexpr Tagged_t kNaN_string = 0x4041;
  static constexpr Tagged_t knanosecond_string = 0x4051;
  static constexpr Tagged_t knanoseconds_string = 0x4069;
  static constexpr Tagged_t knarrow_string = 0x4081;
  static constexpr Tagged_t knative_string = 0x4095;
  static constexpr Tagged_t kNFC_string = 0x40a9;
  static constexpr Tagged_t kNFD_string = 0x40b9;
  static constexpr Tagged_t kNFKC_string = 0x40c9;
  static constexpr Tagged_t kNFKD_string = 0x40d9;
  static constexpr Tagged_t knot_equal_string = 0x40e9;
  static constexpr Tagged_t knull_string = 0x4101;
  static constexpr Tagged_t knull_to_string = 0x4111;
  static constexpr Tagged_t kNumber_string = 0x412d;
  static constexpr Tagged_t knumber_string = 0x4141;
  static constexpr Tagged_t knumber_to_string = 0x4155;
  static constexpr Tagged_t kObject_prototype_string = 0x4171;
  static constexpr Tagged_t kObject_string = 0x418d;
  static constexpr Tagged_t kobject_string = 0x41a1;
  static constexpr Tagged_t kobject_to_string = 0x41b5;
  static constexpr Tagged_t koffset_string = 0x41d1;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x41e5;
  static constexpr Tagged_t kok_string = 0x4205;
  static constexpr Tagged_t kother_string = 0x4215;
  static constexpr Tagged_t koverflow_string = 0x4229;
  static constexpr Tagged_t kownKeys_string = 0x423d;
  static constexpr Tagged_t kpercent_string = 0x4251;
  static constexpr Tagged_t kplainDate_string = 0x4265;
  static constexpr Tagged_t kplainTime_string = 0x427d;
  static constexpr Tagged_t kposition_string = 0x4295;
  static constexpr Tagged_t kpreventExtensions_string = 0x42a9;
  static constexpr Tagged_t kprivate_constructor_string = 0x42c9;
  static constexpr Tagged_t kPromise_string = 0x42e1;
  static constexpr Tagged_t kpromise_string = 0x42f5;
  static constexpr Tagged_t kproto_string = 0x4309;
  static constexpr Tagged_t kproxy_string = 0x4321;
  static constexpr Tagged_t kProxy_string = 0x4335;
  static constexpr Tagged_t kquery_colon_string = 0x4349;
  static constexpr Tagged_t kRangeError_string = 0x4359;
  static constexpr Tagged_t kraw_json_string = 0x4371;
  static constexpr Tagged_t kraw_string = 0x4385;
  static constexpr Tagged_t kread_string = 0x4395;
  static constexpr Tagged_t kReferenceError_string = 0x43a5;
  static constexpr Tagged_t kReflectGet_string = 0x43c1;
  static constexpr Tagged_t kReflectHas_string = 0x43d9;
  static constexpr Tagged_t kRegExp_string = 0x43f1;
  static constexpr Tagged_t kregexp_to_string = 0x4405;
  static constexpr Tagged_t kreject_string = 0x4421;
  static constexpr Tagged_t krelativeTo_string = 0x4435;
  static constexpr Tagged_t kresizable_string = 0x444d;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x4465;
  static constexpr Tagged_t kreturn_string = 0x4485;
  static constexpr Tagged_t krevoke_string = 0x4499;
  static constexpr Tagged_t kroundingIncrement_string = 0x44ad;
  static constexpr Tagged_t kroundingMode_string = 0x44cd;
  static constexpr Tagged_t kRuntimeError_string = 0x44e5;
  static constexpr Tagged_t kScript_string = 0x44fd;
  static constexpr Tagged_t kscript_string = 0x4511;
  static constexpr Tagged_t ksecond_string = 0x4525;
  static constexpr Tagged_t kseconds_string = 0x4539;
  static constexpr Tagged_t ksentence_string = 0x454d;
  static constexpr Tagged_t kset_space_string = 0x4561;
  static constexpr Tagged_t kSet_string = 0x4571;
  static constexpr Tagged_t kset_string = 0x4581;
  static constexpr Tagged_t kSetIterator_string = 0x4591;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x45a9;
  static constexpr Tagged_t kShadowRealm_string = 0x45c5;
  static constexpr Tagged_t kSharedArray_string = 0x45dd;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x45f5;
  static constexpr Tagged_t kSharedStruct_string = 0x4615;
  static constexpr Tagged_t kshort_string = 0x462d;
  static constexpr Tagged_t ksign_string = 0x4641;
  static constexpr Tagged_t ksize_string = 0x4651;
  static constexpr Tagged_t ksmallestUnit_string = 0x4661;
  static constexpr Tagged_t ksource_string = 0x4679;
  static constexpr Tagged_t ksourceText_string = 0x468d;
  static constexpr Tagged_t kstack_string = 0x46a5;
  static constexpr Tagged_t kstackTraceLimit_string = 0x46b9;
  static constexpr Tagged_t kstatic_initializer_string = 0x46d5;
  static constexpr Tagged_t ksticky_string = 0x46f5;
  static constexpr Tagged_t kString_string = 0x4709;
  static constexpr Tagged_t kstring_string = 0x471d;
  static constexpr Tagged_t kstring_to_string = 0x4731;
  static constexpr Tagged_t ksuppressed_string = 0x474d;
  static constexpr Tagged_t kSuppressedError_string = 0x4765;
  static constexpr Tagged_t kSuspendError_string = 0x4781;
  static constexpr Tagged_t kSymbol_iterator_string = 0x4799;
  static constexpr Tagged_t kSymbol_match_all_string = 0x47b5;
  static constexpr Tagged_t kSymbol_replace_string = 0x47d1;
  static constexpr Tagged_t ksymbol_species_string = 0x47ed;
  static constexpr Tagged_t kSymbol_species_string = 0x4809;
  static constexpr Tagged_t kSymbol_split_string = 0x4825;
  static constexpr Tagged_t kSymbol_string = 0x483d;
  static constexpr Tagged_t ksymbol_string = 0x4851;
  static constexpr Tagged_t kSyntaxError_string = 0x4865;
  static constexpr Tagged_t ktarget_string = 0x487d;
  static constexpr Tagged_t kthis_string = 0x4891;
  static constexpr Tagged_t kthrow_string = 0x48a1;
  static constexpr Tagged_t ktimed_out_string = 0x48b5;
  static constexpr Tagged_t ktimeZone_string = 0x48cd;
  static constexpr Tagged_t ktimeZoneId_string = 0x48e1;
  static constexpr Tagged_t ktimeZoneName_string = 0x48f9;
  static constexpr Tagged_t ktoJSON_string = 0x4911;
  static constexpr Tagged_t ktoString_string = 0x4925;
  static constexpr Tagged_t ktotal_string = 0x4939;
  static constexpr Tagged_t ktrue_string = 0x494d;
  static constexpr Tagged_t kTypedArrayLength_string = 0x495d;
  static constexpr Tagged_t kTypeError_string = 0x4989;
  static constexpr Tagged_t kUint16Array_string = 0x49a1;
  static constexpr Tagged_t kUint32Array_string = 0x49b9;
  static constexpr Tagged_t kUint8Array_string = 0x49d1;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x49e9;
  static constexpr Tagged_t kundefined_string = 0x4a09;
  static constexpr Tagged_t kundefined_to_string = 0x4a21;
  static constexpr Tagged_t kunicode_string = 0x4a41;
  static constexpr Tagged_t kunicodeSets_string = 0x4a55;
  static constexpr Tagged_t kunit_string = 0x4a6d;
  static constexpr Tagged_t kURIError_string = 0x4a7d;
  static constexpr Tagged_t kUTC_string = 0x4a91;
  static constexpr Tagged_t kWeakMap_string = 0x4aa1;
  static constexpr Tagged_t kWeakRef_string = 0x4ab5;
  static constexpr Tagged_t kWeakSet_string = 0x4ac9;
  static constexpr Tagged_t kWebAssemblyException_string = 0x4add;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x4b01;
  static constexpr Tagged_t kweek_string = 0x4b21;
  static constexpr Tagged_t kweekOfYear_string = 0x4b31;
  static constexpr Tagged_t kweeks_string = 0x4b49;
  static constexpr Tagged_t kwith_string = 0x4b5d;
  static constexpr Tagged_t kword_string = 0x4b6d;
  static constexpr Tagged_t kwritten_string = 0x4b7d;
  static constexpr Tagged_t kyear_string = 0x4b91;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x4ba1;
  static constexpr Tagged_t kyearOfWeek_string = 0x4bc1;
  static constexpr Tagged_t kyears_string = 0x4bd9;
  ...
  static constexpr Tagged_t kdetached_symbol = 0x4c2d;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x4c3d;
  static constexpr Tagged_t kerror_message_symbol = 0x4c4d;
  static constexpr Tagged_t kerror_script_symbol = 0x4c5d;
  static constexpr Tagged_t kerror_stack_symbol = 0x4c6d;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x4c7d;
  static constexpr Tagged_t kfrozen_symbol = 0x4c8d;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x4c9d;
  static constexpr Tagged_t knative_context_index_symbol = 0x4cad;
  static constexpr Tagged_t knonextensible_symbol = 0x4cbd;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x4ccd;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x4cdd;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x4ced;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x4cfd;
