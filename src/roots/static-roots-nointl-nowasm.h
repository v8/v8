...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t ktimeZoneName_string = 0x48a1;
  static constexpr Tagged_t ktoJSON_string = 0x48b9;
  static constexpr Tagged_t ktoString_string = 0x48cd;
  static constexpr Tagged_t ktrue_string = 0x48e1;
  static constexpr Tagged_t ktotal_string = 0x48f1;
  static constexpr Tagged_t kTypedArrayLength_string = 0x4905;
  static constexpr Tagged_t kTypeError_string = 0x4931;
  static constexpr Tagged_t kUint16Array_string = 0x4949;
  static constexpr Tagged_t kUint32Array_string = 0x4961;
  static constexpr Tagged_t kUint8Array_string = 0x4979;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x4991;
  static constexpr Tagged_t kundefined_string = 0x49b1;
  static constexpr Tagged_t kundefined_to_string = 0x49c9;
  static constexpr Tagged_t kunicode_string = 0x49e9;
  static constexpr Tagged_t kunicodeSets_string = 0x49fd;
  static constexpr Tagged_t kunit_string = 0x4a15;
  static constexpr Tagged_t kURIError_string = 0x4a25;
  static constexpr Tagged_t kUTC_string = 0x4a39;
  static constexpr Tagged_t kWeakMap_string = 0x4a49;
  static constexpr Tagged_t kWeakRef_string = 0x4a5d;
  static constexpr Tagged_t kWeakSet_string = 0x4a71;
  static constexpr Tagged_t kweek_string = 0x4a85;
  static constexpr Tagged_t kweeks_string = 0x4a95;
  static constexpr Tagged_t kweekOfYear_string = 0x4aa9;
  static constexpr Tagged_t kwith_string = 0x4ac1;
  static constexpr Tagged_t kword_string = 0x4ad1;
  static constexpr Tagged_t kwritten_string = 0x4ae1;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x4af5;
  static constexpr Tagged_t kyear_string = 0x4b15;
  static constexpr Tagged_t kyears_string = 0x4b25;
  static constexpr Tagged_t kyearOfWeek_string = 0x4b39;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x4b51;
  static constexpr Tagged_t kHashTableHoleValue = 0x4b5d;
  static constexpr Tagged_t kPromiseHoleValue = 0x4b69;
  static constexpr Tagged_t kUninitializedValue = 0x4b75;
  static constexpr Tagged_t kArgumentsMarker = 0x4b81;
  static constexpr Tagged_t kTerminationException = 0x4b8d;
  static constexpr Tagged_t kException = 0x4b99;
  static constexpr Tagged_t kOptimizedOut = 0x4ba5;
  static constexpr Tagged_t kStaleRegister = 0x4bb1;
  static constexpr Tagged_t kSelfReferenceMarker = 0x4bbd;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x4bc9;
  ...
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x4d75;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x4d85;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x4d95;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x4da5;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x4db5;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x4dc5;
  static constexpr Tagged_t kasync_iterator_symbol = 0x4dd5;
  static constexpr Tagged_t kintl_fallback_symbol = 0x4e05;
  static constexpr Tagged_t kmatch_symbol = 0x4e3d;
  static constexpr Tagged_t ksearch_symbol = 0x4e65;
  static constexpr Tagged_t kunscopables_symbol = 0x4e91;
  static constexpr Tagged_t kdispose_symbol = 0x4ec1;
  static constexpr Tagged_t kasync_dispose_symbol = 0x4eed;
  static constexpr Tagged_t khas_instance_symbol = 0x4f1d;
  static constexpr Tagged_t kto_string_tag_symbol = 0x4f4d;
  static constexpr Tagged_t kconstructor_string = 0x4fc5;
  static constexpr Tagged_t knext_string = 0x4fdd;
  static constexpr Tagged_t kresolve_string = 0x4fed;
  static constexpr Tagged_t kthen_string = 0x5001;
  static constexpr Tagged_t kvalueOf_string = 0x5011;
  static constexpr Tagged_t kiterator_symbol = 0x5025;
  static constexpr Tagged_t kmatch_all_symbol = 0x5035;
  static constexpr Tagged_t kreplace_symbol = 0x5045;
  static constexpr Tagged_t kspecies_symbol = 0x5055;
  static constexpr Tagged_t ksplit_symbol = 0x5065;
  static constexpr Tagged_t kto_primitive_symbol = 0x5075;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x5085;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x5095;
  static constexpr Tagged_t kEmptySymbolTable = 0x50b9;
  static constexpr Tagged_t kUndefinedContextCell = 0x50d5;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x50ed;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x5101;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x5115;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x5121;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x5141;
  static constexpr Tagged_t kNativeScopeInfo = 0x5165;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x517d;
  static constexpr Tagged_t kManyClosuresCell = 0x5195;
  static constexpr Tagged_t kPreallocatedNumberStringTable = 0x51a5;
  static constexpr Tagged_t kJSMessageObjectMap = 0x58dd;
  static constexpr Tagged_t kExternalMap = 0x5905;
  static constexpr Tagged_t kCppHeapExternalMap = 0x592d;
  static constexpr Tagged_t kJSSharedArrayMap = 0x5955;
  static constexpr Tagged_t kJSAtomicsMutexMap = 0x599d;
  static constexpr Tagged_t kJSAtomicsConditionMap = 0x59c5;
  static constexpr Tagged_t kNoOpInterceptorInfo = 0x59ed;

  static constexpr Tagged_t kFirstAllocatedRoot = 0x11;
  static constexpr Tagged_t kLastAllocatedRoot = 0x59ed;
};
