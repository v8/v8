...
Local<Script> UnboundScript::BindToCurrentContext() {
  ...
  DCHECK(!i::InReadOnlySpace(*function_info));
...
MaybeLocal<UnboundScript> ScriptCompiler::CompileUnboundInternal(
  ...
  DCHECK_IMPLIES(!has_exception, !i::InReadOnlySpace(*result));
...
ScriptCompiler::CachedData* ScriptCompiler::CreateCodeCache(
  ...
  // TODO(jgruber): Remove this DCHECK once Function::GetUnboundScript is gone.
  DCHECK(!i::InReadOnlySpace(*shared));
...
Local<String> v8::Object::GetConstructorName() {
  ...
  auto self = Utils::OpenHandle(this);
  i::Isolate* i_isolate;
  if (i::InWritableSharedSpace(*self)) {
    i_isolate = i::Isolate::Current();
  } else {
...
bool v8::String::MakeExternal(v8::String::ExternalStringResource* resource) {
  ...
  i::Isolate* i_isolate;
  if (i::InWritableSharedSpace(obj)) {
    i_isolate = i::Isolate::Current();
  } else {
