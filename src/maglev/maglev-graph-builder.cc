...
void MaglevGraphBuilder::MaglevSubGraphBuilder::
  ...
  builder_->current_interpreter_frame_.set_virtual_objects(
      variable_frame_.virtual_objects());
  variable_frame_.set_virtual_objects(VirtualObjectList());
}
