...
// V8_USE_PERFETTO_SDK must imply V8_USE_PERFETTO.
#if defined(V8_USE_PERFETTO_SDK) && !defined(V8_USE_PERFETTO)
#error Inconsistent build configuration: To build the V8 with Perfetto SDK, \
set V8_USE_PERFETTO as well.
#endif
