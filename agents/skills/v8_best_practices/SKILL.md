...
-   **Update documentation when necessary:** If you make changes to a component that make some part of the internal documentation in `docs/` outdated, you must verify and update the documentation accordingly. Important: do not try to update docs/security/triaging.md, we must maintain that manually.
