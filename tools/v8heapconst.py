...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x042f1): "BoundFunctionNameAccessor",
  ("old_space", 0x04331): "ErrorStackAccessor",
  ("old_space", 0x04371): "FunctionArgumentsAccessor",
  ("old_space", 0x043b1): "FunctionCallerAccessor",
  ("old_space", 0x043f1): "FunctionNameAccessor",
  ("old_space", 0x04431): "FunctionLengthAccessor",
  ("old_space", 0x04471): "FunctionPrototypeAccessor",
  ("old_space", 0x044b1): "StringLengthAccessor",
  ("old_space", 0x044f1): "WrappedFunctionLengthAccessor",
  ("old_space", 0x04531): "WrappedFunctionNameAccessor",
  ("old_space", 0x04571): "InvalidPrototypeValidityCell",
  ("old_space", 0x04579): "EmptyScript",
  ("old_space", 0x045bd): "ManyClosuresCell",
  ("old_space", 0x045c9): "ArrayConstructorProtector",
  ("old_space", 0x045dd): "NoElementsProtector",
  ("old_space", 0x045f1): "MegaDOMProtector",
  ("old_space", 0x04605): "IsConcatSpreadableProtector",
  ("old_space", 0x04619): "ArraySpeciesProtector",
  ("old_space", 0x0462d): "TypedArraySpeciesProtector",
  ("old_space", 0x04641): "PromiseSpeciesProtector",
  ("old_space", 0x04655): "RegExpSpeciesProtector",
  ("old_space", 0x04669): "StringLengthProtector",
  ("old_space", 0x0467d): "ArrayIteratorProtector",
  ("old_space", 0x04691): "ArrayBufferDetachingProtector",
  ("old_space", 0x046a5): "PromiseHookProtector",
  ("old_space", 0x046b9): "PromiseResolveProtector",
  ("old_space", 0x046cd): "MapIteratorProtector",
  ("old_space", 0x046e1): "PromiseThenProtector",
  ("old_space", 0x046f5): "SetIteratorProtector",
  ("old_space", 0x04709): "StringIteratorProtector",
  ("old_space", 0x0471d): "StringSplitCache",
  ("old_space", 0x04b25): "RegExpMultipleCache",
  ("old_space", 0x04f2d): "SingleCharacterStringTable",
  ("old_space", 0x05335): "BuiltinsConstantsTable",
  ("old_space", 0x0576d): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05791): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x057b5): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x057d9): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x057fd): "AsyncGeneratorYieldResolveSharedFun",
  ("old_space", 0x05821): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05845): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05869): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x0588d): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x058b1): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x058d5): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x058f9): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0591d): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05941): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05965): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05989): "PromiseCatchFinallySharedFun",
  ("old_space", 0x059ad): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x059d1): "PromiseThenFinallySharedFun",
  ("old_space", 0x059f5): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05a19): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05a3d): "ProxyRevokeSharedFun",
  ("old_space", 0x05a61): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05a85): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05aa9): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
