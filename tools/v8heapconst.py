...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x0a171): (158, "AllocationSiteMap"),
  ("RO_SPACE", 0x0a1d9): (159, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x0a241): (160, "DebugInfoMap"),
  ("RO_SPACE", 0x0a2a9): (161, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x0a311): (163, "InterpreterDataMap"),
  ("RO_SPACE", 0x0a379): (164, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x0a3e1): (165, "ModuleMap"),
  ("RO_SPACE", 0x0a449): (166, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x0a4b1): (167, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x0a519): (168, "PromiseReactionMap"),
  ("RO_SPACE", 0x0a581): (169, "PrototypeInfoMap"),
  ("RO_SPACE", 0x0a5e9): (171, "StackFrameInfoMap"),
  ("RO_SPACE", 0x0a651): (173, "Tuple3Map"),
  ("RO_SPACE", 0x0a6b9): (174, "WasmCompiledModuleMap"),
  ("RO_SPACE", 0x0a721): (175, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x0a789): (176, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x0a7f1): (177, "WasmSharedModuleDataMap"),
  ("RO_SPACE", 0x0a859): (178, "CallableTaskMap"),
  ("RO_SPACE", 0x0a8c1): (179, "CallbackTaskMap"),
  ("RO_SPACE", 0x0a929): (180, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x0a991): (181, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x0a9f9): (182, "PromiseResolveThenableJobTaskMap"),
