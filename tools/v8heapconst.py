...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x04e81): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x04ed1): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x04f21): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x04f71): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x04fc1): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x05011): (158, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x05061): (159, "DebugInfoMap"),
  ("RO_SPACE", 0x050b1): (160, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x05101): (162, "InterpreterDataMap"),
  ("RO_SPACE", 0x05151): (163, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x051a1): (164, "ModuleMap"),
  ("RO_SPACE", 0x051f1): (165, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x05241): (166, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x05291): (167, "PromiseReactionMap"),
  ("RO_SPACE", 0x052e1): (168, "PrototypeInfoMap"),
  ("RO_SPACE", 0x05331): (169, "ScriptMap"),
  ("RO_SPACE", 0x05381): (170, "StackFrameInfoMap"),
  ("RO_SPACE", 0x053d1): (172, "Tuple3Map"),
  ("RO_SPACE", 0x05421): (174, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x05471): (175, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x054c1): (176, "CallableTaskMap"),
  ("RO_SPACE", 0x05511): (177, "CallbackTaskMap"),
  ("RO_SPACE", 0x05561): (178, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x055b1): (179, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x05601): (180, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x05651): (181, "MicrotaskQueueMap"),
  ("RO_SPACE", 0x056a1): (182, "AllocationSiteWithWeakNextMap"),
  ("RO_SPACE", 0x056f1): (182, "AllocationSiteWithoutWeakNextMap"),
  ("RO_SPACE", 0x05741): (214, "LoadHandler1Map"),
  ("RO_SPACE", 0x05791): (214, "LoadHandler2Map"),
  ("RO_SPACE", 0x057e1): (214, "LoadHandler3Map"),
  ("RO_SPACE", 0x05831): (221, "StoreHandler0Map"),
  ("RO_SPACE", 0x05881): (221, "StoreHandler1Map"),
  ("RO_SPACE", 0x058d1): (221, "StoreHandler2Map"),
  ("RO_SPACE", 0x05921): (221, "StoreHandler3Map"),
