...
KNOWN_MAPS = {
    ...
    ("old_space", 0x043c5): (2124, "ExternalMap"),
    ("old_space", 0x043ed): (2128, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x053dd): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05401): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05425): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05449): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x0546d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05491): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x054b5): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x054d9): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x054fd): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05521): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05545): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05569): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0558d): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x055b1): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x055d5): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x055f9): "PromiseCatchFinallySharedFun",
  ("old_space", 0x0561d): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05641): "PromiseThenFinallySharedFun",
  ("old_space", 0x05665): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05689): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x056ad): "ProxyRevokeSharedFun",
  ("old_space", 0x056d1): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x056f5): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05719): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
