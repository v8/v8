...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x03219): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x03241): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x03269): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x03291): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x032b9): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x032e1): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x03309): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x03331): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x03359): "ErrorStackGetterSharedFun",
  ("old_space", 0x033a5): "ErrorStackSetterSharedFun",
  ("old_space", 0x033f1): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x03419): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x03441): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x03469): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x03491): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x034b9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x034e1): "PromiseCatchFinallySharedFun",
  ("old_space", 0x03509): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x03531): "PromiseThenFinallySharedFun",
  ("old_space", 0x03559): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x03581): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x035a9): "ProxyRevokeSharedFun",
  ("old_space", 0x035d1): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x035f9): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x03621): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
