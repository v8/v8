...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x05ae9): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05b0d): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05b31): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b55): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05b79): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05b9d): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05bc1): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05be5): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05c09): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c2d): "ErrorStackGetterSharedFun",
  ("old_space", 0x05c75): "ErrorStackSetterSharedFun",
  ("old_space", 0x05cbd): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05ce1): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05d05): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d29): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05d4d): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05d71): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05d95): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05db9): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05ddd): "PromiseThenFinallySharedFun",
  ("old_space", 0x05e01): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05e25): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05e49): "ProxyRevokeSharedFun",
  ("old_space", 0x05e6d): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05e91): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05eb5): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
