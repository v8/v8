...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x05049): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x05099): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x050e9): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x05139): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x05189): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x051d9): (158, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x05229): (159, "DebugInfoMap"),
  ("RO_SPACE", 0x05279): (160, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x052c9): (162, "InterpreterDataMap"),
  ("RO_SPACE", 0x05319): (163, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x05369): (164, "ModuleMap"),
  ("RO_SPACE", 0x053b9): (165, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x05409): (166, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x05459): (167, "PromiseReactionMap"),
  ("RO_SPACE", 0x054a9): (168, "PrototypeInfoMap"),
  ("RO_SPACE", 0x054f9): (169, "ScriptMap"),
  ("RO_SPACE", 0x05549): (170, "StackFrameInfoMap"),
  ("RO_SPACE", 0x05599): (172, "Tuple3Map"),
  ("RO_SPACE", 0x055e9): (174, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x05639): (175, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x05689): (176, "CallableTaskMap"),
  ("RO_SPACE", 0x056d9): (177, "CallbackTaskMap"),
  ("RO_SPACE", 0x05729): (178, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x05779): (179, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x057c9): (180, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x05819): (181, "MicrotaskQueueMap"),
  ("RO_SPACE", 0x05869): (182, "AllocationSiteWithWeakNextMap"),
  ("RO_SPACE", 0x058b9): (182, "AllocationSiteWithoutWeakNextMap"),
  ("RO_SPACE", 0x05909): (214, "LoadHandler1Map"),
  ("RO_SPACE", 0x05959): (214, "LoadHandler2Map"),
  ("RO_SPACE", 0x059a9): (214, "LoadHandler3Map"),
  ("RO_SPACE", 0x059f9): (221, "StoreHandler0Map"),
  ("RO_SPACE", 0x05a49): (221, "StoreHandler1Map"),
  ("RO_SPACE", 0x05a99): (221, "StoreHandler2Map"),
  ("RO_SPACE", 0x05ae9): (221, "StoreHandler3Map"),
