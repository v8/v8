...
INSTANCE_TYPES = {
  ...
  171: "LOAD_HANDLER_TYPE",
  172: "STORE_HANDLER_TYPE",
  173: "FIXED_ARRAY_TYPE",
  174: "HASH_TABLE_TYPE",
  175: "DESCRIPTOR_ARRAY_TYPE",
  176: "TRANSITION_ARRAY_TYPE",
  177: "FEEDBACK_VECTOR_TYPE",
  178: "PROPERTY_ARRAY_TYPE",
  179: "SHARED_FUNCTION_INFO_TYPE",
  180: "CELL_TYPE",
  181: "WEAK_CELL_TYPE",
  182: "PROPERTY_CELL_TYPE",
  183: "SMALL_ORDERED_HASH_MAP_TYPE",
  184: "SMALL_ORDERED_HASH_SET_TYPE",
  185: "CODE_DATA_CONTAINER_TYPE",
  186: "JS_PROXY_TYPE",
  187: "JS_GLOBAL_OBJECT_TYPE",
  188: "JS_GLOBAL_PROXY_TYPE",
  189: "JS_MODULE_NAMESPACE_TYPE",
  190: "JS_SPECIAL_API_OBJECT_TYPE",
  191: "JS_VALUE_TYPE",
  192: "JS_MESSAGE_OBJECT_TYPE",
  193: "JS_DATE_TYPE",
  194: "JS_API_OBJECT_TYPE",
  195: "JS_OBJECT_TYPE",
  196: "JS_ARGUMENTS_TYPE",
  197: "JS_CONTEXT_EXTENSION_OBJECT_TYPE",
  198: "JS_GENERATOR_OBJECT_TYPE",
  199: "JS_ASYNC_GENERATOR_OBJECT_TYPE",
  200: "JS_ARRAY_TYPE",
  201: "JS_ARRAY_BUFFER_TYPE",
  202: "JS_TYPED_ARRAY_TYPE",
  203: "JS_DATA_VIEW_TYPE",
  204: "JS_SET_TYPE",
  205: "JS_MAP_TYPE",
  206: "JS_SET_KEY_VALUE_ITERATOR_TYPE",
  207: "JS_SET_VALUE_ITERATOR_TYPE",
  208: "JS_MAP_KEY_ITERATOR_TYPE",
  209: "JS_MAP_KEY_VALUE_ITERATOR_TYPE",
  210: "JS_MAP_VALUE_ITERATOR_TYPE",
  211: "JS_WEAK_MAP_TYPE",
  212: "JS_WEAK_SET_TYPE",
  213: "JS_PROMISE_TYPE",
  214: "JS_REGEXP_TYPE",
  215: "JS_ERROR_TYPE",
  216: "JS_ASYNC_FROM_SYNC_ITERATOR_TYPE",
  217: "JS_STRING_ITERATOR_TYPE",
  218: "JS_TYPED_ARRAY_KEY_ITERATOR_TYPE",
  219: "JS_FAST_ARRAY_KEY_ITERATOR_TYPE",
  220: "JS_GENERIC_ARRAY_KEY_ITERATOR_TYPE",
  221: "JS_UINT8_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  222: "JS_INT8_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  223: "JS_UINT16_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  224: "JS_INT16_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  225: "JS_UINT32_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  226: "JS_INT32_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  227: "JS_FLOAT32_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  228: "JS_FLOAT64_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  229: "JS_UINT8_CLAMPED_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  230: "JS_FAST_SMI_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  231: "JS_FAST_HOLEY_SMI_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  232: "JS_FAST_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  233: "JS_FAST_HOLEY_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  234: "JS_FAST_DOUBLE_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  235: "JS_FAST_HOLEY_DOUBLE_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  236: "JS_GENERIC_ARRAY_KEY_VALUE_ITERATOR_TYPE",
  237: "JS_UINT8_ARRAY_VALUE_ITERATOR_TYPE",
  238: "JS_INT8_ARRAY_VALUE_ITERATOR_TYPE",
  239: "JS_UINT16_ARRAY_VALUE_ITERATOR_TYPE",
  240: "JS_INT16_ARRAY_VALUE_ITERATOR_TYPE",
  241: "JS_UINT32_ARRAY_VALUE_ITERATOR_TYPE",
  242: "JS_INT32_ARRAY_VALUE_ITERATOR_TYPE",
  243: "JS_FLOAT32_ARRAY_VALUE_ITERATOR_TYPE",
  244: "JS_FLOAT64_ARRAY_VALUE_ITERATOR_TYPE",
  245: "JS_UINT8_CLAMPED_ARRAY_VALUE_ITERATOR_TYPE",
  246: "JS_FAST_SMI_ARRAY_VALUE_ITERATOR_TYPE",
  247: "JS_FAST_HOLEY_SMI_ARRAY_VALUE_ITERATOR_TYPE",
  248: "JS_FAST_ARRAY_VALUE_ITERATOR_TYPE",
  249: "JS_FAST_HOLEY_ARRAY_VALUE_ITERATOR_TYPE",
  250: "JS_FAST_DOUBLE_ARRAY_VALUE_ITERATOR_TYPE",
  251: "JS_FAST_HOLEY_DOUBLE_ARRAY_VALUE_ITERATOR_TYPE",
  252: "JS_GENERIC_ARRAY_VALUE_ITERATOR_TYPE",
  253: "WASM_INSTANCE_TYPE",
  254: "WASM_MEMORY_TYPE",
  255: "WASM_MODULE_TYPE",
  256: "WASM_TABLE_TYPE",
...
KNOWN_MAPS = {
  ...
  0x02251: (132, "MetaMap"),
  0x022a1: (131, "NullMap"),
  0x022f1: (175, "DescriptorArrayMap"),
  0x02341: (173, "FixedArrayMap"),
  ...
  0x02661: (173, "FixedCOWArrayMap"),
  0x026b1: (174, "HashTableMap"),
  0x02701: (128, "SymbolMap"),
  0x02751: (72, "OneByteStringMap"),
  0x027a1: (173, "ScopeInfoMap"),
  0x027f1: (179, "SharedFunctionInfoMap"),
  0x02841: (133, "CodeMap"),
  0x02891: (173, "FunctionContextMap"),
  0x028e1: (180, "CellMap"),
  0x02931: (181, "WeakCellMap"),
  0x02981: (182, "GlobalPropertyCellMap"),
  0x029d1: (135, "ForeignMap"),
  0x02a21: (176, "TransitionArrayMap"),
  ...
  0x02c51: (173, "NativeContextMap"),
  0x02ca1: (173, "ModuleContextMap"),
  0x02cf1: (173, "EvalContextMap"),
  0x02d41: (173, "ScriptContextMap"),
  0x02d91: (173, "BlockContextMap"),
  0x02de1: (173, "CatchContextMap"),
  0x02e31: (173, "WithContextMap"),
  0x02e81: (173, "DebugEvaluateContextMap"),
  0x02ed1: (173, "ScriptContextTableMap"),
  0x02f21: (148, "FixedDoubleArrayMap"),
  0x02f71: (134, "MutableHeapNumberMap"),
  0x02fc1: (174, "OrderedHashMapMap"),
  0x03011: (174, "OrderedHashSetMap"),
  0x03061: (174, "NameDictionaryMap"),
  0x030b1: (174, "GlobalDictionaryMap"),
  0x03101: (174, "NumberDictionaryMap"),
  0x03151: (174, "StringTableMap"),
  0x031a1: (174, "WeakHashTableMap"),
  0x031f1: (173, "SloppyArgumentsElementsMap"),
  0x03241: (183, "SmallOrderedHashMapMap"),
  0x03291: (184, "SmallOrderedHashSetMap"),
  0x032e1: (185, "CodeDataContainerMap"),
  0x03331: (192, "JSMessageObjectMap"),
  0x03381: (195, "ExternalMap"),
  0x033d1: (137, "BytecodeArrayMap"),
  0x03421: (173, "ModuleInfoMap"),
  0x03471: (180, "NoClosuresCellMap"),
  0x034c1: (180, "OneClosureCellMap"),
  0x03511: (180, "ManyClosuresCellMap"),
  0x03561: (178, "PropertyArrayMap"),
