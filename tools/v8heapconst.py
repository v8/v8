...
KNOWN_MAPS = {
    ...
    ("read_only_space", 0x073f9): (132, "PromiseFulfillReactionJobTaskMap"),
    ("read_only_space", 0x07421): (133, "PromiseRejectReactionJobTaskMap"),
    ("read_only_space", 0x07449): (134, "CallableTaskMap"),
    ("read_only_space", 0x07471): (135, "CallbackTaskMap"),
    ("read_only_space", 0x07499): (136, "PromiseResolveThenableJobTaskMap"),
    ("read_only_space", 0x074c1): (139, "FunctionTemplateInfoMap"),
    ("read_only_space", 0x074e9): (140, "ObjectTemplateInfoMap"),
    ("read_only_space", 0x07511): (141, "AccessCheckInfoMap"),
    ("read_only_space", 0x07539): (142, "AccessorPairMap"),
    ("read_only_space", 0x07561): (143, "AliasedArgumentsEntryMap"),
    ("read_only_space", 0x07589): (144, "AllocationMementoMap"),
    ("read_only_space", 0x075b1): (147, "AsmWasmDataMap"),
    ("read_only_space", 0x075d9): (148, "AsyncGeneratorRequestMap"),
    ("read_only_space", 0x07601): (149, "BreakPointMap"),
    ("read_only_space", 0x07629): (150, "BreakPointInfoMap"),
    ("read_only_space", 0x07651): (151, "CachedTemplateObjectMap"),
    ("read_only_space", 0x07679): (152, "CallSiteInfoMap"),
    ("read_only_space", 0x076a1): (153, "ClassPositionsMap"),
    ("read_only_space", 0x076c9): (154, "DebugInfoMap"),
    ("read_only_space", 0x076f1): (156, "ErrorStackDataMap"),
    ("read_only_space", 0x07719): (158, "FunctionTemplateRareDataMap"),
    ("read_only_space", 0x07741): (160, "InterpreterDataMap"),
    ("read_only_space", 0x07769): (161, "ModuleRequestMap"),
    ("read_only_space", 0x07791): (162, "PromiseCapabilityMap"),
    ("read_only_space", 0x077b9): (163, "PromiseOnStackMap"),
    ("read_only_space", 0x077e1): (164, "PromiseReactionMap"),
    ("read_only_space", 0x07809): (165, "PropertyDescriptorObjectMap"),
    ("read_only_space", 0x07831): (166, "PrototypeInfoMap"),
    ("read_only_space", 0x07859): (167, "RegExpBoilerplateDescriptionMap"),
    ("read_only_space", 0x07881): (168, "ScriptMap"),
    ("read_only_space", 0x078a9): (169, "ScriptOrModuleMap"),
    ("read_only_space", 0x078d1): (170, "SourceTextModuleInfoEntryMap"),
    ("read_only_space", 0x078f9): (171, "StackFrameInfoMap"),
    ("read_only_space", 0x07921): (172, "TemplateObjectDescriptionMap"),
    ("read_only_space", 0x07949): (173, "Tuple2Map"),
    ("read_only_space", 0x07971): (174, "WasmExceptionTagMap"),
    ("read_only_space", 0x07999): (175, "WasmIndirectFunctionTableMap"),
    ("read_only_space", 0x079c1): (195, "SloppyArgumentsElementsMap"),
    ("read_only_space", 0x079e9): (228, "DescriptorArrayMap"),
    ("read_only_space", 0x07a11): (217, "UncompiledDataWithoutPreparseDataMap"),
    ("read_only_space", 0x07a39): (215, "UncompiledDataWithPreparseDataMap"),
    ("read_only_space", 0x07a61): (218, "UncompiledDataWithoutPreparseDataWithJobMap"),
    ("read_only_space", 0x07a89): (216, "UncompiledDataWithPreparseDataAndJobMap"),
    ("read_only_space", 0x07ab1): (249, "OnHeapBasicBlockProfilerDataMap"),
    ("read_only_space", 0x07ad9): (196, "TurbofanBitsetTypeMap"),
    ("read_only_space", 0x07b01): (200, "TurbofanUnionTypeMap"),
    ("read_only_space", 0x07b29): (199, "TurbofanRangeTypeMap"),
    ("read_only_space", 0x07b51): (197, "TurbofanHeapConstantTypeMap"),
    ("read_only_space", 0x07b79): (198, "TurbofanOtherNumberConstantTypeMap"),
    ("read_only_space", 0x07ba1): (245, "InternalClassMap"),
    ("read_only_space", 0x07bc9): (256, "SmiPairMap"),
    ("read_only_space", 0x07bf1): (255, "SmiBoxMap"),
    ("read_only_space", 0x07c19): (201, "ExportedSubClassBaseMap"),
    ("read_only_space", 0x07c41): (202, "ExportedSubClassMap"),
    ("read_only_space", 0x07c69): (226, "AbstractInternalClassSubclass1Map"),
    ("read_only_space", 0x07c91): (227, "AbstractInternalClassSubclass2Map"),
    ("read_only_space", 0x07cb9): (194, "InternalClassWithSmiElementsMap"),
    ("read_only_space", 0x07ce1): (246, "InternalClassWithStructElementsMap"),
    ("read_only_space", 0x07d09): (203, "ExportedSubClass2Map"),
    ("read_only_space", 0x07d31): (257, "SortStateMap"),
    ("read_only_space", 0x07d59): (263, "WasmStringViewIterMap"),
    ("read_only_space", 0x07d81): (145, "AllocationSiteWithWeakNextMap"),
    ("read_only_space", 0x07da9): (145, "AllocationSiteWithoutWeakNextMap"),
    ("read_only_space", 0x07e75): (137, "LoadHandler1Map"),
    ("read_only_space", 0x07e9d): (137, "LoadHandler2Map"),
    ("read_only_space", 0x07ec5): (137, "LoadHandler3Map"),
    ("read_only_space", 0x07eed): (138, "StoreHandler0Map"),
    ("read_only_space", 0x07f15): (138, "StoreHandler1Map"),
    ("read_only_space", 0x07f3d): (138, "StoreHandler2Map"),
    ("read_only_space", 0x07f65): (138, "StoreHandler3Map"),
