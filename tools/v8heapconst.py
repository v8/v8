...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x03245): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x03271): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x0329d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x032c9): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x032f5): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x03321): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x0334d): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x03379): "ErrorStackGetterSharedFun",
  ("old_space", 0x033c5): "ErrorStackSetterSharedFun",
  ("old_space", 0x03411): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x0343d): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x03469): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x03495): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x034c1): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x034ed): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x03519): "PromiseCatchFinallySharedFun",
  ("old_space", 0x03545): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x03571): "PromiseThenFinallySharedFun",
  ("old_space", 0x0359d): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x035c9): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x035f5): "ProxyRevokeSharedFun",
  ("old_space", 0x03621): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x0364d): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x03679): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
