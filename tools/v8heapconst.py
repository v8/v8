...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x053c1): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x053e5): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05409): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0542d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05451): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05475): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05499): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x054bd): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x054e1): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05505): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05529): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0554d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05571): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05595): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x055b9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x055dd): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05601): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05625): "PromiseThenFinallySharedFun",
  ("old_space", 0x05649): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x0566d): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05691): "ProxyRevokeSharedFun",
  ("old_space", 0x056b5): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x056d9): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x056fd): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
