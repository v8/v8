...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x09df1): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x09e59): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x09ec1): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x09f29): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x09f91): (158, "AllocationSiteMap"),
  ("RO_SPACE", 0x09ff9): (159, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x0a061): (160, "DebugInfoMap"),
  ("RO_SPACE", 0x0a0c9): (161, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x0a131): (163, "InterpreterDataMap"),
  ("RO_SPACE", 0x0a199): (164, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x0a201): (165, "ModuleMap"),
  ("RO_SPACE", 0x0a269): (166, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x0a2d1): (167, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x0a339): (168, "PromiseReactionMap"),
  ("RO_SPACE", 0x0a3a1): (169, "PrototypeInfoMap"),
  ("RO_SPACE", 0x0a409): (171, "StackFrameInfoMap"),
  ("RO_SPACE", 0x0a471): (173, "Tuple3Map"),
  ("RO_SPACE", 0x0a4d9): (174, "WasmCompiledModuleMap"),
  ("RO_SPACE", 0x0a541): (175, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x0a5a9): (176, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x0a611): (177, "WasmSharedModuleDataMap"),
  ("RO_SPACE", 0x0a679): (178, "CallableTaskMap"),
  ("RO_SPACE", 0x0a6e1): (179, "CallbackTaskMap"),
  ("RO_SPACE", 0x0a749): (180, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x0a7b1): (181, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x0a819): (182, "PromiseResolveThenableJobTaskMap"),
