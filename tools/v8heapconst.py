...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x03229): "EmptyPropertyCell",
  ("read_only_space", 0x0323d): "EmptyPropertyDictionary",
  ("read_only_space", 0x03265): "EmptyOrderedPropertyDictionary",
  ("read_only_space", 0x032a5): "NoOpInterceptorInfo",
  ("read_only_space", 0x032cd): "EmptyWeakArrayList",
  ("read_only_space", 0x032d9): "InfinityValue",
  ("read_only_space", 0x032e5): "MinusZeroValue",
  ("read_only_space", 0x032f1): "MinusInfinityValue",
  ("read_only_space", 0x032fd): "SelfReferenceMarker",
  ("read_only_space", 0x0333d): "BasicBlockCountersMarker",
  ("read_only_space", 0x03381): "OffHeapTrampolineRelocationInfo",
  ("read_only_space", 0x0338d): "TrampolineTrivialCodeDataContainer",
  ("read_only_space", 0x03399): "TrampolinePromiseRejectionCodeDataContainer",
  ("read_only_space", 0x033a5): "GlobalThisBindingScopeInfo",
  ("read_only_space", 0x033dd): "EmptyFunctionScopeInfo",
  ("read_only_space", 0x03405): "NativeScopeInfo",
  ("read_only_space", 0x03421): "HashSeed",
