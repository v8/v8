...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x061ed): "AsyncFunctionAwaitRejectSharedFun",
  ("read_only_space", 0x06219): "AsyncFunctionAwaitResolveSharedFun",
  ("read_only_space", 0x06245): "AsyncGeneratorAwaitResolveSharedFun",
  ("read_only_space", 0x06271): "AsyncGeneratorAwaitRejectSharedFun",
  ("read_only_space", 0x0629d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("read_only_space", 0x062c9): "AsyncGeneratorReturnResolveSharedFun",
  ("read_only_space", 0x062f5): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("read_only_space", 0x06321): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("read_only_space", 0x0634d): "AsyncIteratorValueUnwrapSharedFun",
  ("read_only_space", 0x06379): "PromiseCapabilityDefaultResolveSharedFun",
  ("read_only_space", 0x063a5): "PromiseCapabilityDefaultRejectSharedFun",
  ("read_only_space", 0x063d1): "PromiseGetCapabilitiesExecutorSharedFun",
  ("read_only_space", 0x063fd): "PromiseThenFinallySharedFun",
  ("read_only_space", 0x06429): "PromiseCatchFinallySharedFun",
  ("read_only_space", 0x06455): "PromiseValueThunkFinallySharedFun",
  ("read_only_space", 0x06481): "PromiseThrowerFinallySharedFun",
  ("read_only_space", 0x064ad): "PromiseAllResolveElementSharedFun",
  ("read_only_space", 0x064d9): "PromiseAllSettledResolveElementSharedFun",
  ("read_only_space", 0x06505): "PromiseAllSettledRejectElementSharedFun",
  ("read_only_space", 0x06531): "PromiseAnyRejectElementSharedFun",
  ("read_only_space", 0x0655d): "ProxyRevokeSharedFun",
  ("read_only_space", 0x06589): "ShadowRealmImportValueFulfilledSFI",
  ("read_only_space", 0x065b5): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("read_only_space", 0x065e1): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
