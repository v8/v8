...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x050a9): (89, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x050f9): (90, "AccessorInfoMap"),
  ("RO_SPACE", 0x05149): (91, "AccessorPairMap"),
  ("RO_SPACE", 0x05199): (92, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x051e9): (93, "AllocationMementoMap"),
  ("RO_SPACE", 0x05239): (94, "AsmWasmDataMap"),
  ("RO_SPACE", 0x05289): (95, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x052d9): (96, "ClassPositionsMap"),
  ("RO_SPACE", 0x05329): (97, "DebugInfoMap"),
  ("RO_SPACE", 0x05379): (98, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x053c9): (99, "FunctionTemplateRareDataMap"),
  ("RO_SPACE", 0x05419): (101, "InterpreterDataMap"),
  ("RO_SPACE", 0x05469): (102, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x054b9): (103, "ModuleMap"),
  ("RO_SPACE", 0x05509): (104, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x05559): (105, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x055a9): (106, "PromiseReactionMap"),
  ("RO_SPACE", 0x055f9): (107, "PrototypeInfoMap"),
  ("RO_SPACE", 0x05649): (108, "ScriptMap"),
  ("RO_SPACE", 0x05699): (109, "StackFrameInfoMap"),
  ("RO_SPACE", 0x056e9): (110, "StackTraceFrameMap"),
  ("RO_SPACE", 0x05739): (112, "Tuple3Map"),
  ("RO_SPACE", 0x05789): (114, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x057d9): (115, "WasmExceptionTagMap"),
  ("RO_SPACE", 0x05829): (116, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x05879): (117, "CallableTaskMap"),
  ("RO_SPACE", 0x058c9): (118, "CallbackTaskMap"),
  ("RO_SPACE", 0x05919): (119, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x05969): (120, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x059b9): (121, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x05a09): (122, "FinalizationGroupCleanupJobTaskMap"),
  ("RO_SPACE", 0x05a59): (123, "AllocationSiteWithWeakNextMap"),
  ("RO_SPACE", 0x05aa9): (123, "AllocationSiteWithoutWeakNextMap"),
  ("RO_SPACE", 0x05af9): (157, "LoadHandler1Map"),
  ("RO_SPACE", 0x05b49): (157, "LoadHandler2Map"),
  ("RO_SPACE", 0x05b99): (157, "LoadHandler3Map"),
  ("RO_SPACE", 0x05be9): (165, "StoreHandler0Map"),
  ("RO_SPACE", 0x05c39): (165, "StoreHandler1Map"),
  ("RO_SPACE", 0x05c89): (165, "StoreHandler2Map"),
  ("RO_SPACE", 0x05cd9): (165, "StoreHandler3Map"),
