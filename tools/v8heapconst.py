...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x054b9): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x054dd): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05501): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05525): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05549): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x0556d): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05591): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x055b5): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x055d9): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x055fd): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05621): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05645): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05669): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x0568d): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x056b1): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x056d5): "PromiseCatchFinallySharedFun",
  ("old_space", 0x056f9): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x0571d): "PromiseThenFinallySharedFun",
  ("old_space", 0x05741): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05765): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05789): "ProxyRevokeSharedFun",
  ("old_space", 0x057ad): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x057d1): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x057f5): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
