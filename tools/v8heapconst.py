...
INSTANCE_TYPES = {
  ...
  2148: "JS_VALID_ITERATOR_WRAPPER_TYPE",
  2149: "JS_WEAK_REF_TYPE",
  2150: "WASM_EXCEPTION_PACKAGE_TYPE",
  2151: "WASM_GLOBAL_OBJECT_TYPE",
  2152: "WASM_INSTANCE_OBJECT_TYPE",
  2153: "WASM_MEMORY_OBJECT_TYPE",
  2154: "WASM_MODULE_OBJECT_TYPE",
  2155: "WASM_SUSPENDER_OBJECT_TYPE",
  2156: "WASM_TABLE_OBJECT_TYPE",
  2157: "WASM_TAG_OBJECT_TYPE",
  2158: "WASM_VALUE_OBJECT_TYPE",
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x053d1): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x053f5): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05419): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0543d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05461): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05485): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x054a9): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x054cd): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x054f1): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05515): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05539): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0555d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05581): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x055a5): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x055c9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x055ed): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05611): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05635): "PromiseThenFinallySharedFun",
  ("old_space", 0x05659): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x0567d): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x056a1): "ProxyRevokeSharedFun",
  ("old_space", 0x056c5): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x056e9): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x0570d): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
