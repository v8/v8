...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x031ed): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x03211): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x03235): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x03259): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x0327d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x032a1): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x032c5): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x032e9): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x0330d): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x03331): "ErrorStackGetterSharedFun",
  ("old_space", 0x03379): "ErrorStackSetterSharedFun",
  ("old_space", 0x033c1): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x033e5): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x03409): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0342d): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x03451): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x03475): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x03499): "PromiseCatchFinallySharedFun",
  ("old_space", 0x034bd): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x034e1): "PromiseThenFinallySharedFun",
  ("old_space", 0x03505): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x03529): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x0354d): "ProxyRevokeSharedFun",
  ("old_space", 0x03571): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x03595): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x035b9): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
