...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x021c1): (261, "WeakArrayListMap"),
  ...
  ("read_only_space", 0x02f79): (206, "WasmTypeInfoMap"),
  ("read_only_space", 0x02fa1): (235, "WeakFixedArrayMap"),
  ("read_only_space", 0x02fc9): (180, "EphemeronHashTableMap"),
  ("read_only_space", 0x02ff1): (241, "EmbedderDataArrayMap"),
  ("read_only_space", 0x03019): (262, "WeakCellMap"),
  ("read_only_space", 0x03041): (32, "StringMap"),
  ("read_only_space", 0x03069): (41, "ConsOneByteStringMap"),
  ("read_only_space", 0x03091): (33, "ConsStringMap"),
  ("read_only_space", 0x030b9): (37, "ThinStringMap"),
  ("read_only_space", 0x030e1): (35, "SlicedStringMap"),
  ("read_only_space", 0x03109): (43, "SlicedOneByteStringMap"),
  ("read_only_space", 0x03131): (34, "ExternalStringMap"),
  ("read_only_space", 0x03159): (42, "ExternalOneByteStringMap"),
  ("read_only_space", 0x03181): (50, "UncachedExternalStringMap"),
  ("read_only_space", 0x031a9): (0, "InternalizedStringMap"),
  ("read_only_space", 0x031d1): (2, "ExternalInternalizedStringMap"),
  ("read_only_space", 0x031f9): (10, "ExternalOneByteInternalizedStringMap"),
  ("read_only_space", 0x03221): (18, "UncachedExternalInternalizedStringMap"),
  ("read_only_space", 0x03249): (26, "UncachedExternalOneByteInternalizedStringMap"),
  ("read_only_space", 0x03271): (58, "UncachedExternalOneByteStringMap"),
  ("read_only_space", 0x03299): (104, "SharedOneByteStringMap"),
  ("read_only_space", 0x032c1): (96, "SharedStringMap"),
  ("read_only_space", 0x032e9): (109, "SharedThinOneByteStringMap"),
  ("read_only_space", 0x03311): (101, "SharedThinStringMap"),
  ("read_only_space", 0x03339): (96, "TwoByteSeqStringMigrationSentinelMap"),
  ("read_only_space", 0x03361): (104, "OneByteSeqStringMigrationSentinelMap"),
...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x03545): "EmptyWeakFixedArray",
  ("read_only_space", 0x0354d): "InfinityValue",
  ("read_only_space", 0x03559): "MinusZeroValue",
  ("read_only_space", 0x03565): "MinusInfinityValue",
  ("read_only_space", 0x03571): "SelfReferenceMarker",
  ("read_only_space", 0x035b1): "BasicBlockCountersMarker",
  ("read_only_space", 0x035f5): "OffHeapTrampolineRelocationInfo",
