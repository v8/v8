...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x053dd): (72, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05405): (73, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x0542d): (74, "CallableTaskMap"),
  ("read_only_space", 0x05455): (75, "CallbackTaskMap"),
  ("read_only_space", 0x0547d): (76, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x054a5): (79, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x054cd): (80, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x054f5): (81, "AccessCheckInfoMap"),
  ("read_only_space", 0x0551d): (82, "AccessorInfoMap"),
  ("read_only_space", 0x05545): (83, "AccessorPairMap"),
  ("read_only_space", 0x0556d): (84, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05595): (85, "AllocationMementoMap"),
  ("read_only_space", 0x055bd): (88, "AsmWasmDataMap"),
  ("read_only_space", 0x055e5): (89, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x0560d): (90, "BreakPointMap"),
  ("read_only_space", 0x05635): (91, "BreakPointInfoMap"),
  ("read_only_space", 0x0565d): (92, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05685): (94, "ClassPositionsMap"),
  ("read_only_space", 0x056ad): (95, "DebugInfoMap"),
  ("read_only_space", 0x056d5): (98, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x056fd): (100, "InterpreterDataMap"),
  ("read_only_space", 0x05725): (101, "PromiseCapabilityMap"),
  ("read_only_space", 0x0574d): (102, "PromiseReactionMap"),
  ("read_only_space", 0x05775): (103, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x0579d): (104, "PrototypeInfoMap"),
  ("read_only_space", 0x057c5): (105, "ScriptMap"),
  ("read_only_space", 0x057ed): (106, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x05815): (107, "StackFrameInfoMap"),
  ("read_only_space", 0x0583d): (108, "StackTraceFrameMap"),
  ("read_only_space", 0x05865): (109, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x0588d): (110, "Tuple2Map"),
  ("read_only_space", 0x058b5): (111, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x058dd): (112, "WasmExceptionTagMap"),
  ("read_only_space", 0x05905): (113, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x0592d): (114, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x05955): (115, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x0597d): (116, "WasmValueMap"),
  ("read_only_space", 0x059a5): (135, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x059cd): (172, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x059f5): (169, "InternalClassMap"),
  ("read_only_space", 0x05a1d): (178, "SmiPairMap"),
  ("read_only_space", 0x05a45): (177, "SmiBoxMap"),
  ("read_only_space", 0x05a6d): (146, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x05a95): (147, "ExportedSubClassMap"),
  ("read_only_space", 0x05abd): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x05ae5): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x05b0d): (134, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x05b35): (170, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x05b5d): (148, "ExportedSubClass2Map"),
  ("read_only_space", 0x05b85): (179, "SortStateMap"),
  ("read_only_space", 0x05bad): (86, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05bd5): (86, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05bfd): (77, "LoadHandler1Map"),
  ("read_only_space", 0x05c25): (77, "LoadHandler2Map"),
  ("read_only_space", 0x05c4d): (77, "LoadHandler3Map"),
  ("read_only_space", 0x05c75): (78, "StoreHandler0Map"),
  ("read_only_space", 0x05c9d): (78, "StoreHandler1Map"),
  ("read_only_space", 0x05cc5): (78, "StoreHandler2Map"),
  ("read_only_space", 0x05ced): (78, "StoreHandler3Map"),
