...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x05c9d): "ErrorStackSetterSharedFun",
  ("old_space", 0x05ce9): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05d11): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05d39): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d61): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05d89): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05db1): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05dd9): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05e01): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05e29): "PromiseThenFinallySharedFun",
  ("old_space", 0x05e51): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05e79): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05ea1): "ProxyRevokeSharedFun",
  ("old_space", 0x05ec9): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05ef1): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05f19): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
