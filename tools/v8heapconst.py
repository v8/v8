...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05439): (72, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05461): (73, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05489): (74, "CallableTaskMap"),
  ("read_only_space", 0x054b1): (75, "CallbackTaskMap"),
  ("read_only_space", 0x054d9): (76, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05501): (79, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05529): (80, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05551): (81, "AccessCheckInfoMap"),
  ("read_only_space", 0x05579): (82, "AccessorInfoMap"),
  ("read_only_space", 0x055a1): (83, "AccessorPairMap"),
  ("read_only_space", 0x055c9): (84, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x055f1): (85, "AllocationMementoMap"),
  ("read_only_space", 0x05619): (88, "AsmWasmDataMap"),
  ("read_only_space", 0x05641): (89, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05669): (90, "BaselineDataMap"),
  ("read_only_space", 0x05691): (91, "BreakPointMap"),
  ("read_only_space", 0x056b9): (92, "BreakPointInfoMap"),
  ("read_only_space", 0x056e1): (93, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05709): (95, "ClassPositionsMap"),
  ("read_only_space", 0x05731): (96, "DebugInfoMap"),
  ("read_only_space", 0x05759): (99, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05781): (101, "InterpreterDataMap"),
  ("read_only_space", 0x057a9): (102, "ModuleRequestMap"),
  ("read_only_space", 0x057d1): (103, "PromiseCapabilityMap"),
  ("read_only_space", 0x057f9): (104, "PromiseReactionMap"),
  ("read_only_space", 0x05821): (105, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x05849): (106, "PrototypeInfoMap"),
  ("read_only_space", 0x05871): (107, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x05899): (108, "ScriptMap"),
  ("read_only_space", 0x058c1): (109, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x058e9): (110, "StackFrameInfoMap"),
  ("read_only_space", 0x05911): (111, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x05939): (112, "Tuple2Map"),
  ("read_only_space", 0x05961): (113, "WasmExceptionTagMap"),
  ("read_only_space", 0x05989): (114, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x059b1): (115, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x059d9): (116, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x05a01): (134, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x05a29): (151, "DescriptorArrayMap"),
  ("read_only_space", 0x05a51): (156, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x05a79): (155, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x05aa1): (172, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x05ac9): (168, "InternalClassMap"),
  ("read_only_space", 0x05af1): (179, "SmiPairMap"),
  ("read_only_space", 0x05b19): (178, "SmiBoxMap"),
  ("read_only_space", 0x05b41): (145, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x05b69): (146, "ExportedSubClassMap"),
  ...
  ("read_only_space", 0x05c09): (169, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x05c31): (147, "ExportedSubClass2Map"),
  ("read_only_space", 0x05c59): (180, "SortStateMap"),
  ("read_only_space", 0x05c81): (183, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x05ca9): (86, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05cd1): (86, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05cf9): (77, "LoadHandler1Map"),
  ("read_only_space", 0x05d21): (77, "LoadHandler2Map"),
  ("read_only_space", 0x05d49): (77, "LoadHandler3Map"),
  ("read_only_space", 0x05d71): (78, "StoreHandler0Map"),
  ("read_only_space", 0x05d99): (78, "StoreHandler1Map"),
  ("read_only_space", 0x05dc1): (78, "StoreHandler2Map"),
