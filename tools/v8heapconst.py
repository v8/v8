...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x09fd9): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x0a041): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x0a0a9): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x0a111): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x0a179): (158, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x0a1e1): (159, "DebugInfoMap"),
  ("RO_SPACE", 0x0a249): (160, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x0a2b1): (162, "InterpreterDataMap"),
  ("RO_SPACE", 0x0a319): (163, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x0a381): (164, "ModuleMap"),
  ("RO_SPACE", 0x0a3e9): (165, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x0a451): (166, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x0a4b9): (167, "PromiseReactionMap"),
  ("RO_SPACE", 0x0a521): (168, "PrototypeInfoMap"),
  ("RO_SPACE", 0x0a589): (170, "StackFrameInfoMap"),
  ("RO_SPACE", 0x0a5f1): (172, "Tuple3Map"),
  ("RO_SPACE", 0x0a659): (173, "ArrayBoilerplateDescriptionMap"),
  ("RO_SPACE", 0x0a6c1): (174, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x0a729): (175, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x0a791): (176, "CallableTaskMap"),
  ("RO_SPACE", 0x0a7f9): (177, "CallbackTaskMap"),
  ("RO_SPACE", 0x0a861): (178, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x0a8c9): (179, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x0a931): (180, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x0a999): (181, "AllocationSiteMap"),
  ("RO_SPACE", 0x0aa01): (181, "AllocationSiteMap"),
