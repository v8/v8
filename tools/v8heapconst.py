...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x054cd): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x054f1): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05515): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05539): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x0555d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05581): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x055a5): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x055c9): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x055ed): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05611): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05635): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05659): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0567d): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x056a1): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x056c5): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x056e9): "PromiseCatchFinallySharedFun",
  ("old_space", 0x0570d): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05731): "PromiseThenFinallySharedFun",
  ("old_space", 0x05755): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05779): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x0579d): "ProxyRevokeSharedFun",
  ("old_space", 0x057c1): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x057e5): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05809): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
