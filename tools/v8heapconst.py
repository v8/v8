...
KNOWN_MAPS = {
    ...
    ("old_space", 0x04b8d): (2124, "ExternalMap"),
    ("old_space", 0x04bb5): (2128, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x04a9d): "ErrorStackAccessor",
  ("old_space", 0x04ab5): "FunctionArgumentsAccessor",
  ("old_space", 0x04acd): "FunctionCallerAccessor",
  ("old_space", 0x04ae5): "FunctionNameAccessor",
  ("old_space", 0x04afd): "FunctionLengthAccessor",
  ("old_space", 0x04b15): "FunctionPrototypeAccessor",
  ("old_space", 0x04b2d): "StringLengthAccessor",
  ("old_space", 0x04b45): "ValueUnavailableAccessor",
  ("old_space", 0x04b5d): "WrappedFunctionLengthAccessor",
  ("old_space", 0x04b75): "WrappedFunctionNameAccessor",
  ("old_space", 0x04b8d): "ExternalMap",
  ("old_space", 0x04bb5): "JSMessageObjectMap",
  ("old_space", 0x04bdd): "EmptyScript",
  ("old_space", 0x04c25): "ManyClosuresCell",
  ("old_space", 0x04c31): "ArrayConstructorProtector",
  ("old_space", 0x04c45): "NoElementsProtector",
  ("old_space", 0x04c59): "MegaDOMProtector",
  ("old_space", 0x04c6d): "IsConcatSpreadableProtector",
  ("old_space", 0x04c81): "ArraySpeciesProtector",
  ("old_space", 0x04c95): "TypedArraySpeciesProtector",
  ("old_space", 0x04ca9): "PromiseSpeciesProtector",
  ("old_space", 0x04cbd): "RegExpSpeciesProtector",
  ("old_space", 0x04cd1): "StringLengthProtector",
  ("old_space", 0x04ce5): "ArrayIteratorProtector",
  ("old_space", 0x04cf9): "ArrayBufferDetachingProtector",
  ("old_space", 0x04d0d): "PromiseHookProtector",
  ("old_space", 0x04d21): "PromiseResolveProtector",
  ("old_space", 0x04d35): "MapIteratorProtector",
  ("old_space", 0x04d49): "PromiseThenProtector",
  ("old_space", 0x04d5d): "SetIteratorProtector",
  ("old_space", 0x04d71): "StringIteratorProtector",
  ("old_space", 0x04d85): "NumberStringPrototypeNoReplaceProtector",
  ("old_space", 0x04d99): "StringSplitCache",
  ("old_space", 0x051a1): "RegExpMultipleCache",
  ("old_space", 0x055a9): "BuiltinsConstantsTable",
  ("old_space", 0x05b0d): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05b31): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05b55): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b79): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05b9d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05bc1): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05be5): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05c09): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05c2d): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c51): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05c75): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05c99): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05cbd): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05ce1): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05d05): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05d29): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05d4d): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05d71): "PromiseThenFinallySharedFun",
  ("old_space", 0x05d95): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05db9): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05ddd): "ProxyRevokeSharedFun",
  ("old_space", 0x05e01): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05e25): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05e49): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
