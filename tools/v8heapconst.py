...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x054c5): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x054e9): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x0550d): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05531): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05555): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05579): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x0559d): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x055c1): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x055e5): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05609): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x0562d): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05651): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05675): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05699): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x056bd): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x056e1): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05705): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05729): "PromiseThenFinallySharedFun",
  ("old_space", 0x0574d): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05771): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05795): "ProxyRevokeSharedFun",
  ("old_space", 0x057b9): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x057dd): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05801): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
