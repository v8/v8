...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x00d5d): (151, "SourceTextModuleMap"),
  ("read_only_space", 0x00d85): (126, "StringTableMap"),
  ("read_only_space", 0x00dad): (152, "SyntheticModuleMap"),
  ("read_only_space", 0x00dd5): (154, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x00dfd): (153, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x00e25): (180, "WeakArrayListMap"),
  ("read_only_space", 0x00e4d): (118, "EphemeronHashTableMap"),
  ("read_only_space", 0x00e75): (162, "EmbedderDataArrayMap"),
  ("read_only_space", 0x00e9d): (181, "WeakCellMap"),
  ...
  ("read_only_space", 0x03959): (170, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x03981): (167, "InternalClassMap"),
  ("read_only_space", 0x039a9): (176, "SmiPairMap"),
  ("read_only_space", 0x039d1): (175, "SmiBoxMap"),
  ("read_only_space", 0x039f9): (149, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x03a21): (150, "ExportedSubClassMap"),
  ...
  ("read_only_space", 0x03ac1): (168, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x03ae9): (177, "SortStateMap"),
  ("read_only_space", 0x03b11): (85, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x03b39): (85, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x03b61): (76, "LoadHandler1Map"),
  ("read_only_space", 0x03b89): (76, "LoadHandler2Map"),
  ("read_only_space", 0x03bb1): (76, "LoadHandler3Map"),
  ("read_only_space", 0x03bd9): (77, "StoreHandler0Map"),
  ("read_only_space", 0x03c01): (77, "StoreHandler1Map"),
  ("read_only_space", 0x03c29): (77, "StoreHandler2Map"),
  ("read_only_space", 0x03c51): (77, "StoreHandler3Map"),
