...
KNOWN_MAPS = {
    ...
    ("old_space", 0x04b75): (2124, "ExternalMap"),
    ("old_space", 0x04b9d): (2128, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x04a3d): "ArgumentsIteratorAccessor",
  ("old_space", 0x04a55): "ArrayLengthAccessor",
  ("old_space", 0x04a6d): "BoundFunctionLengthAccessor",
  ("old_space", 0x04a85): "BoundFunctionNameAccessor",
  ("old_space", 0x04a9d): "FunctionArgumentsAccessor",
  ("old_space", 0x04ab5): "FunctionCallerAccessor",
  ("old_space", 0x04acd): "FunctionNameAccessor",
  ("old_space", 0x04ae5): "FunctionLengthAccessor",
  ("old_space", 0x04afd): "FunctionPrototypeAccessor",
  ("old_space", 0x04b15): "StringLengthAccessor",
  ("old_space", 0x04b2d): "ValueUnavailableAccessor",
  ("old_space", 0x04b45): "WrappedFunctionLengthAccessor",
  ("old_space", 0x04b5d): "WrappedFunctionNameAccessor",
  ("old_space", 0x04b75): "ExternalMap",
  ("old_space", 0x04b9d): "JSMessageObjectMap",
  ("old_space", 0x04bc5): "EmptyScript",
  ("old_space", 0x04c0d): "ManyClosuresCell",
  ("old_space", 0x04c19): "ArrayConstructorProtector",
  ("old_space", 0x04c2d): "NoElementsProtector",
  ("old_space", 0x04c41): "MegaDOMProtector",
  ("old_space", 0x04c55): "IsConcatSpreadableProtector",
  ("old_space", 0x04c69): "ArraySpeciesProtector",
  ("old_space", 0x04c7d): "TypedArraySpeciesProtector",
  ("old_space", 0x04c91): "PromiseSpeciesProtector",
  ("old_space", 0x04ca5): "RegExpSpeciesProtector",
  ("old_space", 0x04cb9): "StringLengthProtector",
  ("old_space", 0x04ccd): "ArrayIteratorProtector",
  ("old_space", 0x04ce1): "ArrayBufferDetachingProtector",
  ("old_space", 0x04cf5): "PromiseHookProtector",
  ("old_space", 0x04d09): "PromiseResolveProtector",
  ("old_space", 0x04d1d): "MapIteratorProtector",
  ("old_space", 0x04d31): "PromiseThenProtector",
  ("old_space", 0x04d45): "SetIteratorProtector",
  ("old_space", 0x04d59): "StringIteratorProtector",
  ("old_space", 0x04d6d): "NumberStringPrototypeNoReplaceProtector",
  ("old_space", 0x04d81): "StringSplitCache",
  ("old_space", 0x05189): "RegExpMultipleCache",
  ("old_space", 0x05591): "BuiltinsConstantsTable",
  ("old_space", 0x05af5): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05b19): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05b3d): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b61): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05b85): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05ba9): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05bcd): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05bf1): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05c15): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c39): "ErrorStackGetterSharedFun",
  ("old_space", 0x05c81): "ErrorStackSetterSharedFun",
  ("old_space", 0x05cc9): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05ced): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05d11): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d35): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05d59): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05d7d): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05da1): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05dc5): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05de9): "PromiseThenFinallySharedFun",
  ("old_space", 0x05e0d): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05e31): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05e55): "ProxyRevokeSharedFun",
  ("old_space", 0x05e79): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05e9d): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05ec1): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
