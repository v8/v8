...
KNOWN_MAPS = {
    ...
    ("old_space", 0x043c5): (2119, "ExternalMap"),
    ("old_space", 0x043ed): (2123, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x053b1): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x053d5): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x053f9): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0541d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05441): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05465): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05489): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x054ad): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x054d1): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x054f5): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05519): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0553d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05561): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05585): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x055a9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x055cd): "PromiseCatchFinallySharedFun",
  ("old_space", 0x055f1): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05615): "PromiseThenFinallySharedFun",
  ("old_space", 0x05639): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x0565d): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05681): "ProxyRevokeSharedFun",
  ("old_space", 0x056a5): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x056c9): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x056ed): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
