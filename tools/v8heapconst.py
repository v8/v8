...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x00169): (164, "MetaMap"),
  ("read_only_space", 0x001e1): (67, "NullMap"),
  ("read_only_space", 0x00241): (158, "DescriptorArrayMap"),
  ("read_only_space", 0x00299): (153, "WeakFixedArrayMap"),
  ("read_only_space", 0x002e1): (162, "OnePointerFillerMap"),
  ("read_only_space", 0x00329): (162, "TwoPointerFillerMap"),
  ...
  ("read_only_space", 0x008d9): (168, "SharedFunctionInfoMap"),
  ("read_only_space", 0x00921): (156, "CodeMap"),
  ("read_only_space", 0x00969): (155, "CellMap"),
  ("read_only_space", 0x009b1): (167, "GlobalPropertyCellMap"),
  ...
  ("read_only_space", 0x00ad1): (161, "FeedbackVectorMap"),
  ...
  ("read_only_space", 0x00ec9): (160, "FeedbackMetadataArrayMap"),
  ...
  ("read_only_space", 0x01079): (137, "FixedDoubleArrayMap"),
  ("read_only_space", 0x010c1): (123, "GlobalDictionaryMap"),
  ("read_only_space", 0x01109): (96, "ManyClosuresCellMap"),
  ("read_only_space", 0x01151): (120, "ModuleInfoMap"),
  ("read_only_space", 0x01199): (124, "NameDictionaryMap"),
  ("read_only_space", 0x011e1): (96, "NoClosuresCellMap"),
  ("read_only_space", 0x01229): (125, "NumberDictionaryMap"),
  ("read_only_space", 0x01271): (96, "OneClosureCellMap"),
  ("read_only_space", 0x012b9): (126, "OrderedHashMapMap"),
  ("read_only_space", 0x01301): (127, "OrderedHashSetMap"),
  ("read_only_space", 0x01349): (128, "OrderedNameDictionaryMap"),
  ("read_only_space", 0x01391): (165, "PreparseDataMap"),
  ("read_only_space", 0x013d9): (166, "PropertyArrayMap"),
  ("read_only_space", 0x01421): (92, "SideEffectCallHandlerInfoMap"),
  ("read_only_space", 0x01469): (92, "SideEffectFreeCallHandlerInfoMap"),
  ("read_only_space", 0x014b1): (92, "NextCallSideEffectFreeCallHandlerInfoMap"),
  ("read_only_space", 0x014f9): (129, "SimpleNumberDictionaryMap"),
  ("read_only_space", 0x01541): (120, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x01589): (148, "SmallOrderedHashMapMap"),
  ("read_only_space", 0x015d1): (149, "SmallOrderedHashSetMap"),
  ("read_only_space", 0x01619): (150, "SmallOrderedNameDictionaryMap"),
  ("read_only_space", 0x01661): (68, "SourceTextModuleMap"),
  ("read_only_space", 0x016a9): (130, "StringTableMap"),
  ("read_only_space", 0x016f1): (69, "SyntheticModuleMap"),
  ("read_only_space", 0x01739): (152, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x01781): (151, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x017c9): (169, "WeakArrayListMap"),
  ("read_only_space", 0x01811): (122, "EphemeronHashTableMap"),
  ("read_only_space", 0x01859): (159, "EmbedderDataArrayMap"),
  ("read_only_space", 0x018a1): (170, "WeakCellMap"),
  ...
  ("read_only_space", 0x01d81): (95, "EnumCacheMap"),
  ("read_only_space", 0x01e19): (86, "ArrayBoilerplateDescriptionMap"),
  ("read_only_space", 0x02001): (98, "InterceptorInfoMap"),
  ("read_only_space", 0x049f1): (71, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x04a39): (72, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x04a81): (73, "CallableTaskMap"),
  ("read_only_space", 0x04ac9): (74, "CallbackTaskMap"),
  ("read_only_space", 0x04b11): (75, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x04b59): (78, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x04ba1): (79, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x04be9): (80, "AccessCheckInfoMap"),
  ("read_only_space", 0x04c31): (81, "AccessorInfoMap"),
  ("read_only_space", 0x04c79): (82, "AccessorPairMap"),
  ("read_only_space", 0x04cc1): (83, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x04d09): (84, "AllocationMementoMap"),
  ("read_only_space", 0x04d51): (87, "AsmWasmDataMap"),
  ("read_only_space", 0x04d99): (88, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x04de1): (89, "BreakPointMap"),
  ("read_only_space", 0x04e29): (90, "BreakPointInfoMap"),
  ("read_only_space", 0x04e71): (91, "CachedTemplateObjectMap"),
  ("read_only_space", 0x04eb9): (93, "ClassPositionsMap"),
  ("read_only_space", 0x04f01): (94, "DebugInfoMap"),
  ("read_only_space", 0x04f49): (97, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x04f91): (100, "InterpreterDataMap"),
  ("read_only_space", 0x04fd9): (101, "PromiseCapabilityMap"),
  ("read_only_space", 0x05021): (102, "PromiseReactionMap"),
  ("read_only_space", 0x05069): (103, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x050b1): (104, "PrototypeInfoMap"),
  ("read_only_space", 0x050f9): (105, "ScriptMap"),
  ("read_only_space", 0x05141): (109, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x05189): (110, "StackFrameInfoMap"),
  ("read_only_space", 0x051d1): (111, "StackTraceFrameMap"),
  ("read_only_space", 0x05219): (112, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x05261): (113, "Tuple2Map"),
  ("read_only_space", 0x052a9): (114, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x052f1): (115, "WasmDebugInfoMap"),
  ("read_only_space", 0x05339): (116, "WasmExceptionTagMap"),
  ("read_only_space", 0x05381): (117, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x053c9): (118, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x05411): (119, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x05459): (99, "InternalClassMap"),
  ("read_only_space", 0x054a1): (107, "SmiPairMap"),
  ("read_only_space", 0x054e9): (106, "SmiBoxMap"),
  ("read_only_space", 0x05531): (108, "SortStateMap"),
  ("read_only_space", 0x05579): (85, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x055c1): (85, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05609): (76, "LoadHandler1Map"),
  ("read_only_space", 0x05651): (76, "LoadHandler2Map"),
  ("read_only_space", 0x05699): (76, "LoadHandler3Map"),
  ("read_only_space", 0x056e1): (77, "StoreHandler0Map"),
  ("read_only_space", 0x05729): (77, "StoreHandler1Map"),
  ("read_only_space", 0x05771): (77, "StoreHandler2Map"),
  ("read_only_space", 0x057b9): (77, "StoreHandler3Map"),
