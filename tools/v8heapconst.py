...
KNOWN_MAPS = {
    ...
    ("read_only_space", 0x07371): (132, "PromiseFulfillReactionJobTaskMap"),
    ("read_only_space", 0x07399): (133, "PromiseRejectReactionJobTaskMap"),
    ("read_only_space", 0x073c1): (134, "CallableTaskMap"),
    ("read_only_space", 0x073e9): (135, "CallbackTaskMap"),
    ("read_only_space", 0x07411): (136, "PromiseResolveThenableJobTaskMap"),
    ("read_only_space", 0x07439): (139, "FunctionTemplateInfoMap"),
    ("read_only_space", 0x07461): (140, "ObjectTemplateInfoMap"),
    ("read_only_space", 0x07489): (141, "AccessCheckInfoMap"),
    ("read_only_space", 0x074b1): (142, "AccessorPairMap"),
    ("read_only_space", 0x074d9): (143, "AliasedArgumentsEntryMap"),
    ("read_only_space", 0x07501): (144, "AllocationMementoMap"),
    ("read_only_space", 0x07529): (147, "AsmWasmDataMap"),
    ("read_only_space", 0x07551): (148, "AsyncGeneratorRequestMap"),
    ("read_only_space", 0x07579): (149, "BreakPointMap"),
    ("read_only_space", 0x075a1): (150, "BreakPointInfoMap"),
    ("read_only_space", 0x075c9): (151, "CachedTemplateObjectMap"),
    ("read_only_space", 0x075f1): (152, "CallSiteInfoMap"),
    ("read_only_space", 0x07619): (153, "ClassPositionsMap"),
    ("read_only_space", 0x07641): (154, "DebugInfoMap"),
    ("read_only_space", 0x07669): (156, "ErrorStackDataMap"),
    ("read_only_space", 0x07691): (158, "FunctionTemplateRareDataMap"),
    ("read_only_space", 0x076b9): (160, "InterpreterDataMap"),
    ("read_only_space", 0x076e1): (161, "ModuleRequestMap"),
    ("read_only_space", 0x07709): (162, "PromiseCapabilityMap"),
    ("read_only_space", 0x07731): (163, "PromiseOnStackMap"),
    ("read_only_space", 0x07759): (164, "PromiseReactionMap"),
    ("read_only_space", 0x07781): (165, "PropertyDescriptorObjectMap"),
    ("read_only_space", 0x077a9): (166, "PrototypeInfoMap"),
    ("read_only_space", 0x077d1): (167, "RegExpBoilerplateDescriptionMap"),
    ("read_only_space", 0x077f9): (168, "ScriptMap"),
    ("read_only_space", 0x07821): (169, "ScriptOrModuleMap"),
    ("read_only_space", 0x07849): (170, "SourceTextModuleInfoEntryMap"),
    ("read_only_space", 0x07871): (171, "StackFrameInfoMap"),
    ("read_only_space", 0x07899): (172, "TemplateObjectDescriptionMap"),
    ("read_only_space", 0x078c1): (173, "Tuple2Map"),
    ("read_only_space", 0x078e9): (174, "WasmExceptionTagMap"),
    ("read_only_space", 0x07911): (175, "WasmIndirectFunctionTableMap"),
    ("read_only_space", 0x07939): (195, "SloppyArgumentsElementsMap"),
    ("read_only_space", 0x07961): (228, "DescriptorArrayMap"),
    ("read_only_space", 0x07989): (217, "UncompiledDataWithoutPreparseDataMap"),
    ("read_only_space", 0x079b1): (215, "UncompiledDataWithPreparseDataMap"),
    ("read_only_space", 0x079d9): (218, "UncompiledDataWithoutPreparseDataWithJobMap"),
    ("read_only_space", 0x07a01): (216, "UncompiledDataWithPreparseDataAndJobMap"),
    ("read_only_space", 0x07a29): (249, "OnHeapBasicBlockProfilerDataMap"),
    ("read_only_space", 0x07a51): (196, "TurbofanBitsetTypeMap"),
    ("read_only_space", 0x07a79): (200, "TurbofanUnionTypeMap"),
    ("read_only_space", 0x07aa1): (199, "TurbofanRangeTypeMap"),
    ("read_only_space", 0x07ac9): (197, "TurbofanHeapConstantTypeMap"),
    ("read_only_space", 0x07af1): (198, "TurbofanOtherNumberConstantTypeMap"),
    ("read_only_space", 0x07b19): (245, "InternalClassMap"),
    ("read_only_space", 0x07b41): (256, "SmiPairMap"),
    ("read_only_space", 0x07b69): (255, "SmiBoxMap"),
    ("read_only_space", 0x07b91): (201, "ExportedSubClassBaseMap"),
    ("read_only_space", 0x07bb9): (202, "ExportedSubClassMap"),
    ("read_only_space", 0x07be1): (226, "AbstractInternalClassSubclass1Map"),
    ("read_only_space", 0x07c09): (227, "AbstractInternalClassSubclass2Map"),
    ("read_only_space", 0x07c31): (194, "InternalClassWithSmiElementsMap"),
    ("read_only_space", 0x07c59): (246, "InternalClassWithStructElementsMap"),
    ("read_only_space", 0x07c81): (203, "ExportedSubClass2Map"),
    ("read_only_space", 0x07ca9): (257, "SortStateMap"),
    ("read_only_space", 0x07cd1): (263, "WasmStringViewIterMap"),
    ("read_only_space", 0x07cf9): (145, "AllocationSiteWithWeakNextMap"),
    ("read_only_space", 0x07d21): (145, "AllocationSiteWithoutWeakNextMap"),
    ("read_only_space", 0x07ded): (137, "LoadHandler1Map"),
    ("read_only_space", 0x07e15): (137, "LoadHandler2Map"),
    ("read_only_space", 0x07e3d): (137, "LoadHandler3Map"),
    ("read_only_space", 0x07e65): (138, "StoreHandler0Map"),
    ("read_only_space", 0x07e8d): (138, "StoreHandler1Map"),
    ("read_only_space", 0x07eb5): (138, "StoreHandler2Map"),
    ("read_only_space", 0x07edd): (138, "StoreHandler3Map"),
