...
KNOWN_MAPS = {
    ...
    ("read_only_space", 0x075b5): (132, "PromiseFulfillReactionJobTaskMap"),
    ("read_only_space", 0x075dd): (133, "PromiseRejectReactionJobTaskMap"),
    ("read_only_space", 0x07605): (134, "CallableTaskMap"),
    ("read_only_space", 0x0762d): (135, "CallbackTaskMap"),
    ("read_only_space", 0x07655): (136, "PromiseResolveThenableJobTaskMap"),
    ("read_only_space", 0x0767d): (139, "FunctionTemplateInfoMap"),
    ("read_only_space", 0x076a5): (140, "ObjectTemplateInfoMap"),
    ("read_only_space", 0x076cd): (141, "AccessCheckInfoMap"),
    ("read_only_space", 0x076f5): (142, "AccessorPairMap"),
    ("read_only_space", 0x0771d): (143, "AliasedArgumentsEntryMap"),
    ("read_only_space", 0x07745): (144, "AllocationMementoMap"),
    ("read_only_space", 0x0776d): (147, "AsmWasmDataMap"),
    ("read_only_space", 0x07795): (148, "AsyncGeneratorRequestMap"),
    ("read_only_space", 0x077bd): (149, "BreakPointMap"),
    ("read_only_space", 0x077e5): (150, "BreakPointInfoMap"),
    ("read_only_space", 0x0780d): (151, "CachedTemplateObjectMap"),
    ("read_only_space", 0x07835): (152, "CallSiteInfoMap"),
    ("read_only_space", 0x0785d): (153, "ClassPositionsMap"),
    ("read_only_space", 0x07885): (154, "DebugInfoMap"),
    ("read_only_space", 0x078ad): (156, "ErrorStackDataMap"),
    ("read_only_space", 0x078d5): (158, "FunctionTemplateRareDataMap"),
    ("read_only_space", 0x078fd): (160, "InterpreterDataMap"),
    ("read_only_space", 0x07925): (161, "ModuleRequestMap"),
    ("read_only_space", 0x0794d): (162, "PromiseCapabilityMap"),
    ("read_only_space", 0x07975): (163, "PromiseOnStackMap"),
    ("read_only_space", 0x0799d): (164, "PromiseReactionMap"),
    ("read_only_space", 0x079c5): (165, "PropertyDescriptorObjectMap"),
    ("read_only_space", 0x079ed): (166, "PrototypeInfoMap"),
    ("read_only_space", 0x07a15): (167, "RegExpBoilerplateDescriptionMap"),
    ("read_only_space", 0x07a3d): (168, "ScriptMap"),
    ("read_only_space", 0x07a65): (169, "ScriptOrModuleMap"),
    ("read_only_space", 0x07a8d): (170, "SourceTextModuleInfoEntryMap"),
    ("read_only_space", 0x07ab5): (171, "StackFrameInfoMap"),
    ("read_only_space", 0x07add): (172, "TemplateObjectDescriptionMap"),
    ("read_only_space", 0x07b05): (173, "Tuple2Map"),
    ("read_only_space", 0x07b2d): (174, "WasmExceptionTagMap"),
    ("read_only_space", 0x07b55): (175, "WasmIndirectFunctionTableMap"),
    ("read_only_space", 0x07b7d): (195, "SloppyArgumentsElementsMap"),
    ("read_only_space", 0x07ba5): (228, "DescriptorArrayMap"),
    ("read_only_space", 0x07bcd): (217, "UncompiledDataWithoutPreparseDataMap"),
    ("read_only_space", 0x07bf5): (215, "UncompiledDataWithPreparseDataMap"),
    ("read_only_space", 0x07c1d): (218, "UncompiledDataWithoutPreparseDataWithJobMap"),
    ("read_only_space", 0x07c45): (216, "UncompiledDataWithPreparseDataAndJobMap"),
    ("read_only_space", 0x07c6d): (249, "OnHeapBasicBlockProfilerDataMap"),
    ("read_only_space", 0x07c95): (196, "TurbofanBitsetTypeMap"),
    ("read_only_space", 0x07cbd): (200, "TurbofanUnionTypeMap"),
    ("read_only_space", 0x07ce5): (199, "TurbofanRangeTypeMap"),
    ("read_only_space", 0x07d0d): (197, "TurbofanHeapConstantTypeMap"),
    ("read_only_space", 0x07d35): (198, "TurbofanOtherNumberConstantTypeMap"),
    ("read_only_space", 0x07d5d): (245, "InternalClassMap"),
    ("read_only_space", 0x07d85): (256, "SmiPairMap"),
    ("read_only_space", 0x07dad): (255, "SmiBoxMap"),
    ("read_only_space", 0x07dd5): (201, "ExportedSubClassBaseMap"),
    ("read_only_space", 0x07dfd): (202, "ExportedSubClassMap"),
    ("read_only_space", 0x07e25): (226, "AbstractInternalClassSubclass1Map"),
    ("read_only_space", 0x07e4d): (227, "AbstractInternalClassSubclass2Map"),
    ("read_only_space", 0x07e75): (194, "InternalClassWithSmiElementsMap"),
    ("read_only_space", 0x07e9d): (246, "InternalClassWithStructElementsMap"),
    ("read_only_space", 0x07ec5): (203, "ExportedSubClass2Map"),
    ("read_only_space", 0x07eed): (257, "SortStateMap"),
    ("read_only_space", 0x07f15): (263, "WasmStringViewIterMap"),
    ("read_only_space", 0x07f3d): (145, "AllocationSiteWithWeakNextMap"),
    ("read_only_space", 0x07f65): (145, "AllocationSiteWithoutWeakNextMap"),
    ("read_only_space", 0x08031): (137, "LoadHandler1Map"),
    ("read_only_space", 0x08059): (137, "LoadHandler2Map"),
    ("read_only_space", 0x08081): (137, "LoadHandler3Map"),
    ("read_only_space", 0x080a9): (138, "StoreHandler0Map"),
    ("read_only_space", 0x080d1): (138, "StoreHandler1Map"),
    ("read_only_space", 0x080f9): (138, "StoreHandler2Map"),
    ("read_only_space", 0x08121): (138, "StoreHandler3Map"),
