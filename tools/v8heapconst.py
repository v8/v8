...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x00149): (162, "MetaMap"),
  ("read_only_space", 0x0018d): (67, "NullMap"),
  ("read_only_space", 0x001c5): (156, "DescriptorArrayMap"),
  ("read_only_space", 0x001f5): (151, "WeakFixedArrayMap"),
  ("read_only_space", 0x0021d): (160, "OnePointerFillerMap"),
  ("read_only_space", 0x00245): (160, "TwoPointerFillerMap"),
  ...
  ("read_only_space", 0x00489): (133, "ByteArrayMap"),
  ("read_only_space", 0x004b1): (118, "FixedArrayMap"),
  ("read_only_space", 0x004d9): (118, "FixedCOWArrayMap"),
  ("read_only_space", 0x00501): (119, "HashTableMap"),
  ("read_only_space", 0x00529): (64, "SymbolMap"),
  ("read_only_space", 0x00551): (40, "OneByteStringMap"),
  ("read_only_space", 0x00579): (131, "ScopeInfoMap"),
  ("read_only_space", 0x005a1): (166, "SharedFunctionInfoMap"),
  ("read_only_space", 0x005c9): (154, "CodeMap"),
  ("read_only_space", 0x005f1): (153, "CellMap"),
  ("read_only_space", 0x00619): (165, "GlobalPropertyCellMap"),
  ("read_only_space", 0x00641): (70, "ForeignMap"),
  ("read_only_space", 0x00669): (152, "TransitionArrayMap"),
  ("read_only_space", 0x00691): (45, "ThinOneByteStringMap"),
  ("read_only_space", 0x006b9): (159, "FeedbackVectorMap"),
  ...
  ("read_only_space", 0x008d5): (132, "ScriptContextTableMap"),
  ("read_only_space", 0x008fd): (129, "ClosureFeedbackCellArrayMap"),
  ("read_only_space", 0x00925): (158, "FeedbackMetadataArrayMap"),
  ("read_only_space", 0x0094d): (118, "ArrayListMap"),
  ("read_only_space", 0x00975): (65, "BigIntMap"),
  ("read_only_space", 0x0099d): (130, "ObjectBoilerplateDescriptionMap"),
  ("read_only_space", 0x009c5): (134, "BytecodeArrayMap"),
  ("read_only_space", 0x009ed): (155, "CodeDataContainerMap"),
  ("read_only_space", 0x00a15): (135, "FixedDoubleArrayMap"),
  ("read_only_space", 0x00a3d): (121, "GlobalDictionaryMap"),
  ("read_only_space", 0x00a65): (93, "ManyClosuresCellMap"),
  ("read_only_space", 0x00a8d): (118, "ModuleInfoMap"),
  ("read_only_space", 0x00ab5): (122, "NameDictionaryMap"),
  ("read_only_space", 0x00add): (93, "NoClosuresCellMap"),
  ("read_only_space", 0x00b05): (123, "NumberDictionaryMap"),
  ("read_only_space", 0x00b2d): (93, "OneClosureCellMap"),
  ("read_only_space", 0x00b55): (124, "OrderedHashMapMap"),
  ("read_only_space", 0x00b7d): (125, "OrderedHashSetMap"),
  ("read_only_space", 0x00ba5): (126, "OrderedNameDictionaryMap"),
  ("read_only_space", 0x00bcd): (163, "PreparseDataMap"),
  ("read_only_space", 0x00bf5): (164, "PropertyArrayMap"),
  ...
  ("read_only_space", 0x00c95): (127, "SimpleNumberDictionaryMap"),
  ("read_only_space", 0x00cbd): (118, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x00ce5): (146, "SmallOrderedHashMapMap"),
  ("read_only_space", 0x00d0d): (147, "SmallOrderedHashSetMap"),
  ("read_only_space", 0x00d35): (148, "SmallOrderedNameDictionaryMap"),
  ("read_only_space", 0x00d5d): (68, "SourceTextModuleMap"),
  ("read_only_space", 0x00d85): (128, "StringTableMap"),
  ("read_only_space", 0x00dad): (69, "SyntheticModuleMap"),
  ("read_only_space", 0x00dd5): (150, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x00dfd): (149, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x00e25): (167, "WeakArrayListMap"),
  ("read_only_space", 0x00e4d): (120, "EphemeronHashTableMap"),
  ("read_only_space", 0x00e75): (157, "EmbedderDataArrayMap"),
  ("read_only_space", 0x00e9d): (168, "WeakCellMap"),
  ...
  ("read_only_space", 0x0324d): (71, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x03275): (72, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x0329d): (73, "CallableTaskMap"),
  ("read_only_space", 0x032c5): (74, "CallbackTaskMap"),
  ("read_only_space", 0x032ed): (75, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x03315): (78, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x0333d): (79, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x03365): (80, "AccessCheckInfoMap"),
  ("read_only_space", 0x0338d): (81, "AccessorInfoMap"),
  ("read_only_space", 0x033b5): (82, "AccessorPairMap"),
  ("read_only_space", 0x033dd): (83, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x03405): (84, "AllocationMementoMap"),
  ("read_only_space", 0x0342d): (87, "AsmWasmDataMap"),
  ("read_only_space", 0x03455): (88, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x0347d): (90, "ClassPositionsMap"),
  ("read_only_space", 0x034a5): (91, "DebugInfoMap"),
  ("read_only_space", 0x034cd): (94, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x034f5): (97, "InterpreterDataMap"),
  ("read_only_space", 0x0351d): (98, "PromiseCapabilityMap"),
  ("read_only_space", 0x03545): (99, "PromiseReactionMap"),
  ("read_only_space", 0x0356d): (100, "PrototypeInfoMap"),
  ("read_only_space", 0x03595): (101, "ScriptMap"),
  ("read_only_space", 0x035bd): (105, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x035e5): (106, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x0360d): (107, "StackFrameInfoMap"),
  ("read_only_space", 0x03635): (108, "StackTraceFrameMap"),
  ("read_only_space", 0x0365d): (109, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x03685): (110, "Tuple2Map"),
  ("read_only_space", 0x036ad): (111, "Tuple3Map"),
  ("read_only_space", 0x036d5): (112, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x036fd): (113, "WasmDebugInfoMap"),
  ("read_only_space", 0x03725): (114, "WasmExceptionTagMap"),
  ("read_only_space", 0x0374d): (115, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x03775): (116, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x0379d): (117, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x037c5): (96, "InternalClassMap"),
  ("read_only_space", 0x037ed): (103, "SmiPairMap"),
  ("read_only_space", 0x03815): (102, "SmiBoxMap"),
  ("read_only_space", 0x0383d): (104, "SortStateMap"),
  ("read_only_space", 0x03865): (85, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x0388d): (85, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x038b5): (76, "LoadHandler1Map"),
  ("read_only_space", 0x038dd): (76, "LoadHandler2Map"),
  ("read_only_space", 0x03905): (76, "LoadHandler3Map"),
  ("read_only_space", 0x0392d): (77, "StoreHandler0Map"),
  ("read_only_space", 0x03955): (77, "StoreHandler1Map"),
  ("read_only_space", 0x0397d): (77, "StoreHandler2Map"),
  ("read_only_space", 0x039a5): (77, "StoreHandler3Map"),
