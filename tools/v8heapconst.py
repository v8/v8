...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x05b15): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05b3d): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b65): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05b8d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05bb5): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05bdd): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05c05): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05c2d): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c55): "ErrorStackGetterSharedFun",
  ("old_space", 0x05ca1): "ErrorStackSetterSharedFun",
  ("old_space", 0x05ced): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05d15): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05d3d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d65): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05d8d): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05db5): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05ddd): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05e05): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05e2d): "PromiseThenFinallySharedFun",
  ("old_space", 0x05e55): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05e7d): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05ea5): "ProxyRevokeSharedFun",
  ("old_space", 0x05ecd): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05ef5): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05f1d): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
