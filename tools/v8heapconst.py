...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x05c79): "ErrorStackSetterSharedFun",
  ("old_space", 0x05cc5): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05ce9): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05d0d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d31): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05d55): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05d79): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05d9d): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05dc1): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05de5): "PromiseThenFinallySharedFun",
  ("old_space", 0x05e09): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05e2d): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05e51): "ProxyRevokeSharedFun",
  ("old_space", 0x05e75): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05e99): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05ebd): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
