...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x05b39): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b61): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05b89): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05bb1): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05bd9): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05c01): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05c29): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c51): "ErrorStackGetterSharedFun",
  ("old_space", 0x05c99): "ErrorStackSetterSharedFun",
  ("old_space", 0x05ce1): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05d09): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05d31): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d59): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05d81): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05da9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05dd1): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05df9): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05e21): "PromiseThenFinallySharedFun",
  ("old_space", 0x05e49): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05e71): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05e99): "ProxyRevokeSharedFun",
  ("old_space", 0x05ec1): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05ee9): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05f11): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
