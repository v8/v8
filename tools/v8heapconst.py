...
KNOWN_MAPS = {
    ...
    ("old_space", 0x04b55): (2124, "ExternalMap"),
    ("old_space", 0x04b7d): (2128, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x04a7d): "FunctionArgumentsAccessor",
  ("old_space", 0x04a95): "FunctionCallerAccessor",
  ("old_space", 0x04aad): "FunctionNameAccessor",
  ("old_space", 0x04ac5): "FunctionLengthAccessor",
  ("old_space", 0x04add): "FunctionPrototypeAccessor",
  ("old_space", 0x04af5): "StringLengthAccessor",
  ("old_space", 0x04b0d): "ValueUnavailableAccessor",
  ("old_space", 0x04b25): "WrappedFunctionLengthAccessor",
  ("old_space", 0x04b3d): "WrappedFunctionNameAccessor",
  ("old_space", 0x04b55): "ExternalMap",
  ("old_space", 0x04b7d): "JSMessageObjectMap",
  ("old_space", 0x04ba5): "EmptyScript",
  ("old_space", 0x04bed): "ManyClosuresCell",
  ("old_space", 0x04bf9): "ArrayConstructorProtector",
  ("old_space", 0x04c0d): "NoElementsProtector",
  ("old_space", 0x04c21): "MegaDOMProtector",
  ("old_space", 0x04c35): "IsConcatSpreadableProtector",
  ("old_space", 0x04c49): "ArraySpeciesProtector",
  ("old_space", 0x04c5d): "TypedArraySpeciesProtector",
  ("old_space", 0x04c71): "PromiseSpeciesProtector",
  ("old_space", 0x04c85): "RegExpSpeciesProtector",
  ("old_space", 0x04c99): "StringLengthProtector",
  ("old_space", 0x04cad): "ArrayIteratorProtector",
  ("old_space", 0x04cc1): "ArrayBufferDetachingProtector",
  ("old_space", 0x04cd5): "PromiseHookProtector",
  ("old_space", 0x04ce9): "PromiseResolveProtector",
  ("old_space", 0x04cfd): "MapIteratorProtector",
  ("old_space", 0x04d11): "PromiseThenProtector",
  ("old_space", 0x04d25): "SetIteratorProtector",
  ("old_space", 0x04d39): "StringIteratorProtector",
  ("old_space", 0x04d4d): "NumberStringPrototypeNoReplaceProtector",
  ("old_space", 0x04d61): "StringSplitCache",
  ("old_space", 0x05169): "RegExpMultipleCache",
  ("old_space", 0x05571): "BuiltinsConstantsTable",
  ("old_space", 0x05ad5): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05af9): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05b1d): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b41): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05b65): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05b89): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05bad): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05bd1): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05bf5): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c19): "ErrorStackGetterSharedFun",
  ("old_space", 0x05c61): "ErrorStackSetterSharedFun",
  ("old_space", 0x05ca9): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05ccd): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05cf1): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d15): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05d39): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05d5d): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05d81): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05da5): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05dc9): "PromiseThenFinallySharedFun",
  ("old_space", 0x05ded): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05e11): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05e35): "ProxyRevokeSharedFun",
  ("old_space", 0x05e59): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05e7d): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05ea1): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
