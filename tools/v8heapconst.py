...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x07b71): "UninitializedValue",
  ("read_only_space", 0x07ba9): "ArgumentsMarker",
  ("read_only_space", 0x07be1): "TerminationException",
  ("read_only_space", 0x07c21): "Exception",
  ("read_only_space", 0x07c3d): "OptimizedOut",
  ("read_only_space", 0x07c75): "StaleRegister",
  ("read_only_space", 0x07cad): "SelfReferenceMarker",
  ("read_only_space", 0x07ced): "BasicBlockCountersMarker",
  ("read_only_space", 0x08205): "EmptyPropertyDictionary",
  ("read_only_space", 0x0822d): "EmptySymbolTable",
  ("read_only_space", 0x08249): "EmptySlowElementDictionary",
  ("read_only_space", 0x0826d): "EmptyOrderedHashMap",
  ("read_only_space", 0x08281): "EmptyOrderedHashSet",
  ("read_only_space", 0x08295): "EmptyOrderedPropertyDictionary",
  ("read_only_space", 0x082b9): "EmptySwissPropertyDictionary",
  ("read_only_space", 0x082d9): "EmptyFeedbackMetadata",
  ("read_only_space", 0x082e5): "GlobalThisBindingScopeInfo",
  ("read_only_space", 0x08305): "EmptyFunctionScopeInfo",
  ("read_only_space", 0x08329): "NativeScopeInfo",
  ("read_only_space", 0x08341): "ShadowRealmScopeInfo",
  ...
  ("old_space", 0x053ad): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x053d1): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x053f5): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05419): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x0543d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05461): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05485): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x054a9): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x054cd): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x054f1): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05515): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05539): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0555d): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05581): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x055a5): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x055c9): "PromiseCatchFinallySharedFun",
  ("old_space", 0x055ed): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05611): "PromiseThenFinallySharedFun",
  ("old_space", 0x05635): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05659): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x0567d): "ProxyRevokeSharedFun",
  ("old_space", 0x056a1): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x056c5): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x056e9): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
