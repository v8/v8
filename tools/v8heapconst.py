...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x05201): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05225): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05249): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0526d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05291): "AsyncGeneratorYieldResolveSharedFun",
  ("old_space", 0x052b5): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x052d9): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x052fd): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05321): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05345): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05369): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0538d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x053b1): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x053d5): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x053f9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x0541d): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05441): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05465): "PromiseThenFinallySharedFun",
  ("old_space", 0x05489): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x054ad): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x054d1): "ProxyRevokeSharedFun",
  ("old_space", 0x054f5): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05519): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x0553d): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
