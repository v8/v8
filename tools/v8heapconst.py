...
KNOWN_MAPS = {
    ...
    ("old_space", 0x043d9): (2124, "ExternalMap"),
    ("old_space", 0x04401): (2128, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x04289): "ArgumentsIteratorAccessor",
  ("old_space", 0x042a1): "ArrayLengthAccessor",
  ("old_space", 0x042b9): "BoundFunctionLengthAccessor",
  ("old_space", 0x042d1): "BoundFunctionNameAccessor",
  ("old_space", 0x042e9): "ErrorStackAccessor",
  ("old_space", 0x04301): "FunctionArgumentsAccessor",
  ("old_space", 0x04319): "FunctionCallerAccessor",
  ("old_space", 0x04331): "FunctionNameAccessor",
  ("old_space", 0x04349): "FunctionLengthAccessor",
  ("old_space", 0x04361): "FunctionPrototypeAccessor",
  ("old_space", 0x04379): "StringLengthAccessor",
  ("old_space", 0x04391): "ValueUnavailableAccessor",
  ("old_space", 0x043a9): "WrappedFunctionLengthAccessor",
  ("old_space", 0x043c1): "WrappedFunctionNameAccessor",
  ("old_space", 0x043d9): "ExternalMap",
  ("old_space", 0x04401): "JSMessageObjectMap",
  ("old_space", 0x04429): "EmptyScript",
  ("old_space", 0x04471): "ManyClosuresCell",
  ("old_space", 0x0447d): "ArrayConstructorProtector",
  ("old_space", 0x04491): "NoElementsProtector",
  ("old_space", 0x044a5): "MegaDOMProtector",
  ("old_space", 0x044b9): "IsConcatSpreadableProtector",
  ("old_space", 0x044cd): "ArraySpeciesProtector",
  ("old_space", 0x044e1): "TypedArraySpeciesProtector",
  ("old_space", 0x044f5): "PromiseSpeciesProtector",
  ("old_space", 0x04509): "RegExpSpeciesProtector",
  ("old_space", 0x0451d): "StringLengthProtector",
  ("old_space", 0x04531): "ArrayIteratorProtector",
  ("old_space", 0x04545): "ArrayBufferDetachingProtector",
  ("old_space", 0x04559): "PromiseHookProtector",
  ("old_space", 0x0456d): "PromiseResolveProtector",
  ("old_space", 0x04581): "MapIteratorProtector",
  ("old_space", 0x04595): "PromiseThenProtector",
  ("old_space", 0x045a9): "SetIteratorProtector",
  ("old_space", 0x045bd): "StringIteratorProtector",
  ("old_space", 0x045d1): "NumberStringPrototypeNoReplaceProtector",
  ("old_space", 0x045e5): "StringSplitCache",
  ("old_space", 0x049ed): "RegExpMultipleCache",
  ("old_space", 0x04df5): "BuiltinsConstantsTable",
  ("old_space", 0x054e1): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05505): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05529): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0554d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05571): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05595): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x055b9): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x055dd): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05601): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05625): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05649): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0566d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05691): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x056b5): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x056d9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x056fd): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05721): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05745): "PromiseThenFinallySharedFun",
  ("old_space", 0x05769): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x0578d): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x057b1): "ProxyRevokeSharedFun",
  ("old_space", 0x057d5): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x057f9): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x0581d): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
