...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x053fd): (72, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05425): (73, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x0544d): (74, "CallableTaskMap"),
  ("read_only_space", 0x05475): (75, "CallbackTaskMap"),
  ("read_only_space", 0x0549d): (76, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x054c5): (79, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x054ed): (80, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05515): (81, "AccessCheckInfoMap"),
  ("read_only_space", 0x0553d): (82, "AccessorInfoMap"),
  ("read_only_space", 0x05565): (83, "AccessorPairMap"),
  ("read_only_space", 0x0558d): (84, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x055b5): (85, "AllocationMementoMap"),
  ("read_only_space", 0x055dd): (88, "AsmWasmDataMap"),
  ("read_only_space", 0x05605): (89, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x0562d): (90, "BaselineDataMap"),
  ("read_only_space", 0x05655): (91, "BreakPointMap"),
  ("read_only_space", 0x0567d): (92, "BreakPointInfoMap"),
  ("read_only_space", 0x056a5): (93, "CachedTemplateObjectMap"),
  ("read_only_space", 0x056cd): (95, "ClassPositionsMap"),
  ("read_only_space", 0x056f5): (96, "DebugInfoMap"),
  ("read_only_space", 0x0571d): (99, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05745): (101, "InterpreterDataMap"),
  ("read_only_space", 0x0576d): (102, "ModuleRequestMap"),
  ("read_only_space", 0x05795): (103, "PromiseCapabilityMap"),
  ("read_only_space", 0x057bd): (104, "PromiseReactionMap"),
  ("read_only_space", 0x057e5): (105, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x0580d): (106, "PrototypeInfoMap"),
  ("read_only_space", 0x05835): (107, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x0585d): (108, "ScriptMap"),
  ("read_only_space", 0x05885): (109, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x058ad): (110, "StackFrameInfoMap"),
  ("read_only_space", 0x058d5): (111, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x058fd): (112, "Tuple2Map"),
  ("read_only_space", 0x05925): (113, "WasmExceptionTagMap"),
  ("read_only_space", 0x0594d): (114, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05975): (115, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x0599d): (116, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x059c5): (135, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x059ed): (152, "DescriptorArrayMap"),
  ("read_only_space", 0x05a15): (157, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x05a3d): (156, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x05a65): (172, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x05a8d): (182, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x05ab5): (169, "InternalClassMap"),
  ("read_only_space", 0x05add): (178, "SmiPairMap"),
  ("read_only_space", 0x05b05): (177, "SmiBoxMap"),
  ("read_only_space", 0x05b2d): (146, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x05b55): (147, "ExportedSubClassMap"),
  ("read_only_space", 0x05b7d): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x05ba5): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x05bcd): (133, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x05bf5): (170, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x05c1d): (148, "ExportedSubClass2Map"),
  ("read_only_space", 0x05c45): (179, "SortStateMap"),
  ("read_only_space", 0x05c6d): (86, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05c95): (86, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05cbd): (77, "LoadHandler1Map"),
  ("read_only_space", 0x05ce5): (77, "LoadHandler2Map"),
  ("read_only_space", 0x05d0d): (77, "LoadHandler3Map"),
  ("read_only_space", 0x05d35): (78, "StoreHandler0Map"),
  ("read_only_space", 0x05d5d): (78, "StoreHandler1Map"),
  ("read_only_space", 0x05d85): (78, "StoreHandler2Map"),
  ("read_only_space", 0x05dad): (78, "StoreHandler3Map"),
