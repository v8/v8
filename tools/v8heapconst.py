...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x054b1): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x054d5): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x054f9): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0551d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05541): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05565): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05589): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x055ad): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x055d1): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x055f5): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05619): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0563d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05661): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05685): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x056a9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x056cd): "PromiseCatchFinallySharedFun",
  ("old_space", 0x056f1): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05715): "PromiseThenFinallySharedFun",
  ("old_space", 0x05739): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x0575d): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05781): "ProxyRevokeSharedFun",
  ("old_space", 0x057a5): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x057c9): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x057ed): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
