...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x054bd): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x054e1): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05505): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05529): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x0554d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05571): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05595): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x055b9): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x055dd): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05601): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05625): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05649): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0566d): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05691): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x056b5): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x056d9): "PromiseCatchFinallySharedFun",
  ("old_space", 0x056fd): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05721): "PromiseThenFinallySharedFun",
  ("old_space", 0x05745): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05769): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x0578d): "ProxyRevokeSharedFun",
  ("old_space", 0x057b1): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x057d5): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x057f9): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
