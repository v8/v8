...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x054c9): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x054ed): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05511): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05535): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05559): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x0557d): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x055a1): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x055c5): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x055e9): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x0560d): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05631): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05655): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05679): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x0569d): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x056c1): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x056e5): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05709): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x0572d): "PromiseThenFinallySharedFun",
  ("old_space", 0x05751): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05775): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05799): "ProxyRevokeSharedFun",
  ("old_space", 0x057bd): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x057e1): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05805): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
