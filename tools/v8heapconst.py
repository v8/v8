...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x052b1): (89, "AccessCheckInfoMap"),
  ("read_only_space", 0x05301): (90, "AccessorInfoMap"),
  ("read_only_space", 0x05351): (91, "AccessorPairMap"),
  ("read_only_space", 0x053a1): (92, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x053f1): (93, "AllocationMementoMap"),
  ("read_only_space", 0x05441): (94, "AsmWasmDataMap"),
  ("read_only_space", 0x05491): (95, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x054e1): (96, "ClassPositionsMap"),
  ("read_only_space", 0x05531): (97, "DebugInfoMap"),
  ("read_only_space", 0x05581): (99, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x055d1): (100, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05621): (102, "InterpreterDataMap"),
  ("read_only_space", 0x05671): (103, "ModuleInfoEntryMap"),
  ("read_only_space", 0x056c1): (104, "ModuleMap"),
  ("read_only_space", 0x05711): (105, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05761): (106, "PromiseCapabilityMap"),
  ("read_only_space", 0x057b1): (107, "PromiseReactionMap"),
  ("read_only_space", 0x05801): (108, "PrototypeInfoMap"),
  ("read_only_space", 0x05851): (109, "ScriptMap"),
  ("read_only_space", 0x058a1): (110, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x058f1): (111, "StackFrameInfoMap"),
  ("read_only_space", 0x05941): (112, "StackTraceFrameMap"),
  ("read_only_space", 0x05991): (113, "Tuple2Map"),
  ("read_only_space", 0x059e1): (114, "Tuple3Map"),
  ("read_only_space", 0x05a31): (116, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x05a81): (117, "WasmDebugInfoMap"),
  ("read_only_space", 0x05ad1): (118, "WasmExceptionTagMap"),
  ("read_only_space", 0x05b21): (119, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05b71): (120, "CallableTaskMap"),
  ("read_only_space", 0x05bc1): (121, "CallbackTaskMap"),
  ("read_only_space", 0x05c11): (122, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05c61): (123, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05cb1): (124, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05d01): (125, "FinalizationGroupCleanupJobTaskMap"),
  ("read_only_space", 0x05d51): (126, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05da1): (126, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05df1): (161, "LoadHandler1Map"),
  ("read_only_space", 0x05e41): (161, "LoadHandler2Map"),
  ("read_only_space", 0x05e91): (161, "LoadHandler3Map"),
  ("read_only_space", 0x05ee1): (169, "StoreHandler0Map"),
  ("read_only_space", 0x05f31): (169, "StoreHandler1Map"),
  ("read_only_space", 0x05f81): (169, "StoreHandler2Map"),
  ("read_only_space", 0x05fd1): (169, "StoreHandler3Map"),
