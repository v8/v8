...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x048d1): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x04ae1): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x04b49): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x04bb1): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x04c19): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x04c81): (158, "AllocationSiteMap"),
  ("RO_SPACE", 0x04ce9): (159, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x04d51): (160, "ContextExtensionMap"),
  ("RO_SPACE", 0x04db9): (161, "DebugInfoMap"),
  ("RO_SPACE", 0x04e21): (162, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x04e89): (164, "InterpreterDataMap"),
  ("RO_SPACE", 0x04ef1): (165, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x04f59): (166, "ModuleMap"),
  ("RO_SPACE", 0x04fc1): (167, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x05029): (168, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x05091): (169, "PromiseReactionMap"),
  ("RO_SPACE", 0x050f9): (170, "PrototypeInfoMap"),
  ("RO_SPACE", 0x05161): (172, "StackFrameInfoMap"),
  ("RO_SPACE", 0x051c9): (174, "Tuple3Map"),
  ("RO_SPACE", 0x05231): (175, "WasmCompiledModuleMap"),
  ("RO_SPACE", 0x05299): (176, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x05301): (177, "WasmSharedModuleDataMap"),
  ("RO_SPACE", 0x05369): (178, "CallableTaskMap"),
  ("RO_SPACE", 0x053d1): (179, "CallbackTaskMap"),
  ("RO_SPACE", 0x05439): (180, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x054a1): (181, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x05509): (182, "PromiseResolveThenableJobTaskMap"),
  ...
  ("MAP_SPACE", 0x02621): (206, "SharedFunctionInfoMap"),
  ("MAP_SPACE", 0x02679): (133, "CodeMap"),
  ("MAP_SPACE", 0x026d1): (193, "FunctionContextMap"),
  ("MAP_SPACE", 0x02729): (199, "CellMap"),
  ("MAP_SPACE", 0x02781): (205, "GlobalPropertyCellMap"),
  ("MAP_SPACE", 0x027d9): (135, "ForeignMap"),
  ("MAP_SPACE", 0x02831): (188, "TransitionArrayMap"),
  ("MAP_SPACE", 0x02889): (202, "FeedbackVectorMap"),
  ...
  ("MAP_SPACE", 0x02a99): (195, "NativeContextMap"),
  ("MAP_SPACE", 0x02af1): (194, "ModuleContextMap"),
  ("MAP_SPACE", 0x02b49): (192, "EvalContextMap"),
  ("MAP_SPACE", 0x02ba1): (196, "ScriptContextMap"),
  ("MAP_SPACE", 0x02bf9): (189, "BlockContextMap"),
  ("MAP_SPACE", 0x02c51): (190, "CatchContextMap"),
  ("MAP_SPACE", 0x02ca9): (197, "WithContextMap"),
  ("MAP_SPACE", 0x02d01): (191, "DebugEvaluateContextMap"),
  ...
  ("MAP_SPACE", 0x03281): (201, "NoClosuresCellMap"),
  ("MAP_SPACE", 0x032d9): (186, "NumberDictionaryMap"),
  ("MAP_SPACE", 0x03331): (201, "OneClosureCellMap"),
  ("MAP_SPACE", 0x03389): (186, "OrderedHashMapMap"),
  ("MAP_SPACE", 0x033e1): (186, "OrderedHashSetMap"),
  ("MAP_SPACE", 0x03439): (204, "PropertyArrayMap"),
  ("MAP_SPACE", 0x03491): (198, "SideEffectCallHandlerInfoMap"),
  ("MAP_SPACE", 0x034e9): (198, "SideEffectFreeCallHandlerInfoMap"),
  ("MAP_SPACE", 0x03541): (186, "SimpleNumberDictionaryMap"),
  ("MAP_SPACE", 0x03599): (183, "SloppyArgumentsElementsMap"),
  ("MAP_SPACE", 0x035f1): (207, "SmallOrderedHashMapMap"),
  ("MAP_SPACE", 0x03649): (208, "SmallOrderedHashSetMap"),
