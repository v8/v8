...
deps = {
  'build':
    Var('chromium_url') + '/chromium/src/build.git' + '@' + '931dc79bc5a009afbb02c915c608f6ecbb94f901',
  'buildtools':
  ...
  'tools/clang':
    Var('chromium_url') + '/chromium/src/tools/clang.git' + '@' + '210eabb02a077da81a41a63cf9c297e8f778e1b0',
  'tools/luci-go': {
      'packages': [
        {
