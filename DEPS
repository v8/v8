...
deps = {
  ...
  "v8/buildtools":
    Var("git_url") + "/chromium/buildtools.git" + "@" + "5378d73123b64907773cc5c1bb027b2f765ff00a",
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "d9ee849b2aa65cef903af3044e03205d92343093",
}
