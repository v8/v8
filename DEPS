...
deps = {
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "b66ad18bb147f02b74b207358140371382b0ef35",
}

deps_os = {
  "android": {
    "v8/third_party/android_tools":
      Var("git_url") + "/android_tools.git" + "@" + "5722f90e94d02a8dc17b6edb93ead6839d5afcee",
  },
  "win": {
