...
deps = {
  ...
  'build':
    Var('chromium_url') + '/chromium/src/build.git' + '@' + '0ad6539347944d45a973fa03f7be898252268f58',
  'buildtools':
  ...
  'buildtools/third_party/libunwind/trunk':
    Var('chromium_url') + '/external/github.com/llvm/llvm-project/libunwind.git' + '@' + '012c3438e0795fa6ad1626f1f5e1c0ab577b91f6',
  'buildtools/win': {
    'packages': [
      {
  ...
  'tools/clang':
    Var('chromium_url') + '/chromium/src/tools/clang.git' + '@' + 'ba74bc78ccf2d360c54e45c337baaf679b017f7a',
  'tools/luci-go': {
      'packages': [
        {
