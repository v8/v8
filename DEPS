...
deps = {
  ...
  "v8/buildtools":
    Var("git_url") + "/chromium/buildtools.git" + "@" + "cf8c4332f5c9d0da4b4782d7f0122df74a16819b",
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "e47364ad9fb37e8255a7a5cdf7891781b3f8256e",
}
