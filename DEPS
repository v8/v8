...
deps = {
  "v8/build/gyp":
    Var("git_url") + "/external/gyp.git" + "@" + "8e8c3178d9d2734a6223b87fbd45ab250baf77e8",
  "v8/third_party/icu":
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "c789a99803595dfa963ba300ac79b760d1304d8c",
}
