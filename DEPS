...
deps = {
  'v8/build':
    Var('chromium_url') + '/chromium/src/build.git' + '@' + 'e9eade234d00c3a93033d815cda1cc78cac826e0',
  'v8/tools/gyp':
    Var('chromium_url') + '/external/gyp.git' + '@' + 'd61a9397e668fa9843c4aa7da9e79460fe590bfb',
  'v8/third_party/depot_tools':
    Var('chromium_url') + '/chromium/tools/depot_tools.git' + '@' + '6f812e132d25df1b561f7182b04903004a3055e4',
  'v8/third_party/icu':
  ...
  'v8/buildtools':
    Var('chromium_url') + '/chromium/buildtools.git' + '@' + '9a90d9aaadeb5e04327ed05775f45132e4b3523f',
  ...
  'v8/third_party/catapult': {
    'url': Var('chromium_url') + '/catapult.git' + '@' + '5c2d9e757a6f8966612c6be9bb21f6344be00bd8',
    'condition': 'checkout_android',
  },
  ...
  'v8/third_party/fuchsia-sdk': {
    'url': Var('chromium_url') + '/chromium/src/third_party/fuchsia-sdk.git' + '@' + 'e4f38ff1fa13e91934ea03493bfb4c3bed822703',
  ...
  'v8/third_party/proguard':
    Var('chromium_url') + '/chromium/src/third_party/proguard.git' + '@' + '63f6c0bd0f86b9b90ec41c4cc93de7a06b5c4102',
  ...
  'v8/tools/clang':
    Var('chromium_url') + '/chromium/src/tools/clang.git' + '@' + 'af36d66948fac3c80f1786c9c7d56897c33a3839',
  'v8/tools/luci-go':
    Var('chromium_url') + '/chromium/src/tools/luci-go.git' + '@' + '445d7c4b6a4f10e188edb395b132e3996b127691',
  'v8/test/wasm-js':
    Var('chromium_url') + '/external/github.com/WebAssembly/spec.git' + '@' + 'b9cddea4dddd103324e45f96e642aebc2b43b7fd',
}
