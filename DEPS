...
deps = {
  "v8/build":
    Var("chromium_url") + "/chromium/src/build.git" + "@" + "225def8ba5affc4d0d7f452077e89d6cc498b1c9",
  "v8/tools/gyp":
    Var("chromium_url") + "/external/gyp.git" + "@" + "eb296f67da078ec01f5e3a9ea9cdc6d26d680161",
  "v8/third_party/icu":
    Var("chromium_url") + "/chromium/deps/icu.git" + "@" + "4b06aadd0556135d3a90a4eb03eca24ef249e03e",
...
deps_os = {
  "android": {
    ...
    "v8/third_party/catapult":
      Var('chromium_url') + "/external/github.com/catapult-project/catapult.git" + "@" + "ada8f7cc7d7aa2d0a7d18016c6510c1d5892bd17",
  },
}
