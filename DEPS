...
deps = {
  "v8/build/gyp":
    Var("git_url") + "/external/gyp.git" + "@" + "2a5511bd901f328db10d0b6415c864a5ff59fc81",
  "v8/third_party/icu":
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "442f528de2269272de9610e9c7186047ce4aaadb",
}
