...
deps = {
  ...
  "v8/buildtools":
    Var("git_url") + "/chromium/buildtools.git" + "@" + "8d89c1b15f80323b54b3305b2be7b26686fd5611",
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "290301c180118e27755bfced176ff61bd0acb1b8",
}
