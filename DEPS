...
deps = {
  "v8/build":
    Var("chromium_url") + "/chromium/src/build.git" + "@" + "7311b7485e1a32d124f42b814c229be2faf0d599",
  "v8/tools/gyp":
...
deps_os = {
  "android": {
    ...
    "v8/third_party/catapult":
      Var('chromium_url') + "/catapult.git" + "@" + "672cabd12c680e8c75d0614c59d97479cbdfc47a",
  },
}
