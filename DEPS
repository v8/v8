...
deps = {
  'v8/build':
    Var('chromium_url') + '/chromium/src/build.git' + '@' + '7db6cfc390a8c0336836472b1c15a062a24ba633',
  'v8/third_party/depot_tools':
    Var('chromium_url') + '/chromium/tools/depot_tools.git' + '@' + '0b62ed79ed5049332f58c06dbdb8e8bc4105010e',
  'v8/third_party/icu':
  ...
  'v8/buildtools':
    Var('chromium_url') + '/chromium/src/buildtools.git' + '@' + '218cb3d12efc52e79dbaf9f8d52d721d8b5a45a7',
  ...
  'v8/buildtools/third_party/libc++/trunk':
    Var('chromium_url') + '/chromium/llvm-project/libcxx.git' + '@' + 'fbddc46986100095d5f7ed1bc2bf795d3bb3e9e4',
  ...
  'v8/third_party/catapult': {
    'url': Var('chromium_url') + '/catapult.git' + '@' + '979fc35bbcca4c9015176a71d8d71abe023d94e8',
    'condition': 'checkout_android',
  },
  ...
  'v8/test/test262/data':
    Var('chromium_url') + '/external/github.com/tc39/test262.git' + '@' + '611919174ffe060503691a0c7e3eb2a65b646124',
  ...
  'v8/tools/clang':
    Var('chromium_url') + '/chromium/src/tools/clang.git' + '@' + 'f8222157207f6d2f0529f354afdcbe00ad7989ea',
  'v8/tools/luci-go': {
      'packages': [
        {
  ...
  'v8/test/wasm-js/data':
    Var('chromium_url') + '/external/github.com/WebAssembly/spec.git' + '@' + '2a28a928bf385bdf375ca09bebde14627c6c17a1',
