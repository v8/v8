...
deps = {
  "v8/build":
    Var("chromium_url") + "/chromium/src/build.git" + "@" + "05cc4b12ce5dbb71658eb26ffa58c9270ea21427",
  "v8/tools/gyp":
...
deps_os = {
  "android": {
    ...
    "v8/third_party/catapult":
      Var('chromium_url') + "/catapult.git" + "@" + "3f41f93f9154b9acb9e5ff9347827355a27341e9",
  },
}
