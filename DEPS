...
deps = {
  ...
  "v8/buildtools":
    Var("git_url") + "/chromium/buildtools.git" + "@" + "3ba3ca22ec610fe95683f6bfdeea9d90c768abd7",
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "0b258f75323161e854038f30334e97ab6aa58eab",
}
