...
vars = {
  ...
  'fuchsia_version': 'version:8.20220706.2.1',
...
deps = {
  ...
  'build':
    Var('chromium_url') + '/chromium/src/build.git' + '@' + 'f855a2b23028d7a155ded0e81916f2a053be9f6f',
  'buildtools':
  ...
  'third_party/google_benchmark/src': {
    'url': Var('chromium_url') + '/external/github.com/google/benchmark.git' + '@' + '7280499e8ed6f0a67268fa0e97ca3a7a72e1cb0c',
  },
