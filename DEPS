...
deps = {
  ...
  'build':
    Var('chromium_url') + '/chromium/src/build.git' + '@' + '8ec71a44aaf9d6edac6949ce3a39e3ce24082be3',
  'buildtools':
  ...
  'tools/clang':
    Var('chromium_url') + '/chromium/src/tools/clang.git' + '@' + '184bc29dd86c3994a02b4f3feca125ffe785319c',
  'tools/luci-go': {
      'packages': [
        {
