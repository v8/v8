...
deps = {
  ...
  "v8/buildtools":
    Var("git_url") + "/chromium/buildtools.git" + "@" + "81863fe70639e85606b541d9d36e9e98c96b957e",
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "fe8d232767c63ce43873ffef101063a5791d171e",
}
