...
deps = {
  "v8/build":
    Var("chromium_url") + "/chromium/src/build.git" + "@" + "58ec82342fa6dc7fc4a08020913559b3ffa2918f",
  "v8/tools/gyp":
...
deps_os = {
  "android": {
    ...
    "v8/third_party/catapult":
      Var('chromium_url') + "/catapult.git" + "@" + "dbe4475f85d6756d5de36e0ba015c4c5555a9686",
  },
}
