...
vars = {
  ...
  # and whatever else without interference from each other.
  'android_sdk_cmdline-tools_version': 'yODElY4RdHopNEfpOnqjRcrpa6JMzbhYYqGD53-DjJwC',
}
...
deps = {
  ...
  'build':
    Var('chromium_url') + '/chromium/src/build.git' + '@' + '103712808f7c6f31c6c769057c17c994e08f3a30',
  'buildtools':
  ...
  'buildtools/third_party/libc++abi/trunk':
    Var('chromium_url') + '/external/github.com/llvm/llvm-project/libcxxabi.git' + '@' + 'c883cb129d0ed07c4ac457666f8d4ea4d7d3d565',
  'buildtools/third_party/libunwind/trunk':
    Var('chromium_url') + '/external/github.com/llvm/llvm-project/libunwind.git' + '@' + 'a7e4ce09ec1b84245c0632006374084626afd268',
  'buildtools/win': {
    'packages': [
      {
  ...
  'third_party/catapult': {
    'url': Var('chromium_url') + '/catapult.git' + '@' + 'fb6990454da9ed24ad473803c53a04173ba0f948',
    'condition': 'checkout_android',
  },
  ...
  'third_party/depot_tools':
    Var('chromium_url') + '/chromium/tools/depot_tools.git' + '@' + '6550ec91db6949f4691a5c5aa1709e0bba2bcbc6',
  'third_party/fuchsia-sdk': {
    'url': Var('chromium_url') + '/chromium/src/third_party/fuchsia-sdk.git' + '@' + '18896843130c33372c455c153ad07d2217bd2085',
    'condition': 'checkout_fuchsia',
  },
  'third_party/google_benchmark/src': {
    'url': Var('chromium_url') + '/external/github.com/google/benchmark.git' + '@' + '713b9177183375c8b1b25595e33daf2a1625df5b',
  },
  'third_party/googletest/src':
    Var('chromium_url') + '/external/github.com/google/googletest.git' + '@' + '159c9ad23e8b276e8c975bb8621c81d4df5fd863',
  'third_party/icu':
    Var('chromium_url') + '/chromium/deps/icu.git' + '@' + '3f443830bd52d3aa5fab3c1aa2b6d0848bb5039d',
  'third_party/instrumented_libraries':
    Var('chromium_url') + '/chromium/src/third_party/instrumented_libraries.git' + '@' + 'eb740e92b1e3f5714877db980363283b038f8c32',
  'third_party/ittapi': {
  ...
  'tools/clang':
    Var('chromium_url') + '/chromium/src/tools/clang.git' + '@' + '7ea32d7ed3a92b628f4269ec1c4f93a389ea01ea',
  ...
  'third_party/abseil-cpp': {
    'url': Var('chromium_url') + '/chromium/src/third_party/abseil-cpp.git' + '@' + '48418f3dd75b4ec99af7d1159f175354db23ca3a',
