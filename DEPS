...
deps = {
  ...
  'build':
    Var('chromium_url') + '/chromium/src/build.git' + '@' + '1d317961e46bbffdffbecbf20a08e7a2a2c800b4',
  'buildtools':
  ...
  'tools/clang':
    Var('chromium_url') + '/chromium/src/tools/clang.git' + '@' + '655af8da84ae565d89ca59f4b77e27084a2b6669',
  'tools/luci-go': {
      'packages': [
        {
