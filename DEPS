...
deps = {
  "v8/build/gyp":
    Var("git_url") + "/external/gyp.git" + "@" + "121d89dfcd4f6ebe1c89524b3f9ca11ddd437e77",
  "v8/third_party/icu":
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "91e7a78800b5849e27e098daa42e6ae8650ad322",
}
