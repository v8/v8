...
deps = {
  "v8/build":
    Var("chromium_url") + "/chromium/src/build.git" + "@" + "8da5cdfbbb27e302754b88e6bf3175f34c55218b",
  "v8/tools/gyp":
  ...
  "v8/tools/clang":
    Var("chromium_url") + "/chromium/src/tools/clang.git" + "@" + "ba46613202a20ae150b74f7eb6842076293cc394",
  "v8/test/wasm-js":
...
deps_os = {
  "android": {
    ...
    "v8/third_party/catapult":
      Var('chromium_url') + "/external/github.com/catapult-project/catapult.git" + "@" + "b1c6aa75f15a1d284805d11f7247a31e8cd38d42",
  },
}
