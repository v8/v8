...
deps = {
  "v8/build":
    Var("git_url") + "/chromium/src/build.git" + "@" + "9f3f50f2d8b3b751c451c76d9bbf648835256dd5",
  "v8/tools/gyp":
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "27056571d3878fee640fe0e3f1b8ba5e9a7570f6",
}
