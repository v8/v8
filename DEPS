...
deps = {
  "v8/build/gyp":
    Var("git_url") + "/external/gyp.git" + "@" + "54b7dfc03f746b6a539ac38f2fb0815d10b54734",
  "v8/third_party/icu":
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "9c45873bbb82dc33f5f88f5c7dbc06ee9ecc7e8f",
}
