...
deps = {
  ...
  "v8/tools/clang":
    Var("git_url") + "/chromium/src/tools/clang.git" + "@" + "c9a343c6a8065127989a05fe2a3fc76c26ad8102",
}

deps_os = {
  "android": {
    "v8/third_party/android_tools":
      Var("git_url") + "/android_tools.git" + "@" + "2bb73b7af7da7116aa54c1474121c28a85d28e6b",
  },
  "win": {
