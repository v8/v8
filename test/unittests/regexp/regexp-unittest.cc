...
TEST_F(TestWithContext, UseCountRegExp) {
...
TEST_F(TestWithContext, UncachedExternalString) {
  v8::HandleScope scope(isolate());
...
TEST_F(TestWithContext, UnicodePropertyEscapeCodeSize) {
...
TEST_F(TestWithContext, RegExpInterruptReentrantExecution) {
