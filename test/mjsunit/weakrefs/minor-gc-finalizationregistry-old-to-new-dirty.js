...
// Flags: --expose-gc --no-incremental-marking --no-single-generation --no-gc-global --handle-weak-ref-weakly-in-minor-gc --no-concurrent-inlining --allow-natives-syntax --scavenger-chaos-mode --scavenger-chaos-mode-threshold=0
