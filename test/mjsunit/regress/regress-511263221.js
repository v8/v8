...
function workerScript() {
  onmessage = function(msg) {
    ...
    try {
      ...
      %Resume("MakeExternalOneByteString");
      ...
      try { %Resume("MakeExternalOneByteString"); } catch(e) {}
