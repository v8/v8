...
function testOneWay(a, b, expectedEquals, expectedFeedback) {
  ...
  assertEquals('CompareOp:' + expectedFeedback, feedback[0][1]);
}
...
// BigInt, BigInt
test(BigInt(1000000000), BigInt(1000000000), true, 'BigInt64');
test(BigInt(1000000000), BigInt(1000000001), false, 'BigInt64');
