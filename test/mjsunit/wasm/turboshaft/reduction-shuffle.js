...
(function I8x16UpperToLowerReduce() {
  ...
  for (let a of int8_array) {
    for (let b of int8_array) {
      ...
      assertEquals(wasm.uadd(b, b, a, a),
                   wasm.uadd_reduce(b, b, a, a));
    }
  }
})();
...
(function I16x8UpperToLowerReduce() {
  ...
  for (let a of int16_array) {
    for (let b of int16_array) {
      assertEquals(wasm.sadd(b, a, a, b),
                   wasm.sadd_reduce(b, a, a, b));
      assertEquals(wasm.uadd(b, a, b, a),
                   wasm.uadd_reduce(b, a, b, a));
    }
  }
})();
