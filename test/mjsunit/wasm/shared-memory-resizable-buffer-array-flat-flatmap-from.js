...
(function ArrayFlatFlatMapFrom() {
  ...
  for (let ctor of ctors) {
    ...
    let expectedLengthTrackingWithOffsetFlat = [2, 3];
    ZeroPad(expectedLengthTrackingWithOffsetFlat, 4, ctor, 1);
    assertEquals(expectedLengthTrackingWithOffsetFlat, ToNumbers(lengthTrackingWithOffsetFlat));
    ...
    let expectedLengthTrackingWithOffsetFlatMap = [3, 4];
    Pad(expectedLengthTrackingWithOffsetFlatMap, 1, 4, ctor, 1);
    assertEquals(expectedLengthTrackingWithOffsetFlatMap,
    ...
    assertEquals(expectedLengthTrackingWithOffsetFlat, ToNumbers(Array.from(lengthTrackingWithOffset)));
  }
})();
