...
(function ArraySlice() {
  ...
  for (let ctor of ctors) {
    ...
    let expectedLengthTrackingWithOffsetSlice = [2, 3];
    ZeroPad(expectedLengthTrackingWithOffsetSlice, 4, ctor, 1);
    assertEquals(expectedLengthTrackingWithOffsetSlice, ToNumbers(lengthTrackingWithOffsetSlice));
