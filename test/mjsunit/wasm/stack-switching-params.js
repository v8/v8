...
let suspend_tag0 = builder.addFunction("suspend_tag0", kSig_v_i)
    .addBody([
        kExprLocalGet, 0,
        kExprI32Const, 1,
        kExprI32Add,
...
builder.addFunction("test_i32", kSig_v_v)
    .addBody([
        kExprBlock, block_sig,
          ...
          kExprContNew, cont_v_i,
          kExprResume, cont_v_i, 1, kOnSuspend, tag_i_i, 0,
          kExprUnreachable,
        kExprEnd,
...
let suspend_tag_ilfdsr_ilfdsr =
  builder.addFunction("suspend_tag_ilfdsr_ilfdsr", sig_v_ilfdsr)
  .addBody([
...
let test_ilfdsr = builder.addFunction("test_ilfdsr", kSig_v_v)
  ...
  .addBody([
      ...
      kExprBlock, block_sig_ilfdsr,
        ...
        kExprContNew, cont_v_ilfdsr,
        kExprResume, cont_v_ilfdsr, 1, kOnSuspend, tag_ilfdsr_ilfdsr, 0,
        kExprUnreachable,
      kExprEnd,
